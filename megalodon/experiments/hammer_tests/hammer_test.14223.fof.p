...
fof(conj_hammer_test_14223,conjecture,c_SNoLt(mul_5FSNo(q,mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))).
