...
fof(c_L1,axiom,(! [X7] : (c_In(X7,c_5FLx) => (! [X8] : (c_In(X8,c_5FLy) => c_SNoLt(add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8)),add_5FSNo(u,mul_5FSNo(X7,X8)))))))).
fof(conj_hammer_test_10468,conjecture,(! [X7] : (c_In(X7,c_5FRx) => (! [X8] : (c_In(X8,c_5FRy) => c_SNoLt(add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8)),add_5FSNo(u,mul_5FSNo(X7,X8)))))))).
