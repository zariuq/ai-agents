...
fof(c_Hxy1,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)))))))).
fof(c_Hxy2,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)))))))).
fof(c_Hxy3,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)))))))).
fof(c_Hxy4,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)))))))).
fof(c_Huy,axiom,c_SNo(mul_5FSNo(u,y))).
fof(c_Huy1,axiom,(! [X5] : (c_In(X5,c_SNoL(u)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(u,X6)),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X5,X6)))))))).
fof(c_Huy2,axiom,(! [X5] : (c_In(X5,c_SNoR(u)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(u,X6)),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X5,X6)))))))).
fof(c_Huy3,axiom,(! [X5] : (c_In(X5,c_SNoL(u)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(u,X6)))))))).
fof(c_Huy4,axiom,(! [X5] : (c_In(X5,c_SNoR(u)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(u,X6)))))))).
fof(c_Hxv,axiom,c_SNo(mul_5FSNo(x,v))).
fof(c_Hxv1,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X5,X6)))))))).
fof(c_Hxv2,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X5,X6)))))))).
fof(c_Hxv3,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(x,X6)))))))).
fof(c_Hxv4,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(x,X6)))))))).
fof(c_Huv,axiom,c_SNo(mul_5FSNo(u,v))).
fof(c_Huv1,axiom,(! [X5] : (c_In(X5,c_SNoL(u)) => (! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(u,X6)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X5,X6)))))))).
fof(c_Huv2,axiom,(! [X5] : (c_In(X5,c_SNoR(u)) => (! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(u,X6)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X5,X6)))))))).
fof(c_Huv3,axiom,(! [X5] : (c_In(X5,c_SNoL(u)) => (! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(u,X6)))))))).
fof(c_Huv4,axiom,(! [X5] : (c_In(X5,c_SNoR(u)) => (! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,v),mul_5FSNo(u,X6)))))))).
...
fof(c_H4,axiom,c_In(c_SNoLev(v),c_SNoLev(y))).
fof(c_H5,axiom,c_SNoEq_5F(c_SNoLev(v),v,y)).
fof(c_H6,axiom,c_In(c_SNoLev(v),y)).
fof(c_Lvy,axiom,c_In(v,c_SNoL(y))).
fof(c_L1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(x,v)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(w,v)))).
fof(c_L2,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(w,v)),add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(u,v)))).
fof(conj_hammer_test_7903,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(w,y),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,v))),add_5FSNo(mul_5FSNo(u,y),add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,y))))).
