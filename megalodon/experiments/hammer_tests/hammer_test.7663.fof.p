...
fof(c_HLI1,axiom,(! [X10] : (c_In(X10,c_SNoL(x)) => (! [X11] : (c_In(X11,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X10,y),add_5FSNo(mul_5FSNo(x,X11),minus_5FSNo(mul_5FSNo(X10,X11)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X10] : (c_In(X10,c_SNoR(x)) => (! [X11] : (c_In(X11,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X10,y),add_5FSNo(mul_5FSNo(x,X11),minus_5FSNo(mul_5FSNo(X10,X11)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X10] : (c_In(X10,c_SNoL(x)) => (! [X11] : (c_In(X11,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X10,y),add_5FSNo(mul_5FSNo(x,X11),minus_5FSNo(mul_5FSNo(X10,X11)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X10] : (c_In(X10,c_SNoR(x)) => (! [X11] : (c_In(X11,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X10,y),add_5FSNo(mul_5FSNo(x,X11),minus_5FSNo(mul_5FSNo(X10,X11)))),c_5FR)))))).
fof(c_Hxy,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_LLx,axiom,(! [X10] : (c_In(X10,c_SNoL(x)) => (! [X11] : (c_SNo(X11) => c_SNo(mul_5FSNo(X10,X11))))))).
fof(c_LRx,axiom,(! [X10] : (c_In(X10,c_SNoR(x)) => (! [X11] : (c_SNo(X11) => c_SNo(mul_5FSNo(X10,X11))))))).
fof(c_LLxy,axiom,(! [X10] : (c_In(X10,c_SNoL(x)) => c_SNo(mul_5FSNo(X10,y))))).
fof(c_LRxy,axiom,(! [X10] : (c_In(X10,c_SNoR(x)) => c_SNo(mul_5FSNo(X10,y))))).
fof(c_LxLy,axiom,(! [X10] : (c_In(X10,c_SNoL(y)) => c_SNo(mul_5FSNo(x,X10))))).
fof(c_LxRy,axiom,(! [X10] : (c_In(X10,c_SNoR(y)) => c_SNo(mul_5FSNo(x,X10))))).
...
fof(c_L3,axiom,(! [X10] : (c_In(X10,c_SNoR(x)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(X10,v1)),add_5FSNo(mul_5FSNo(X10,u1),mul_5FSNo(x,v1)))))).
...
fof(conj_hammer_test_7663,conjecture,(c_In(v0,c_SNoR(u0)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
