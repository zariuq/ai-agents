...
fof(c_Hx1,axiom,c_In(x,c_SNoS_5F(ordsucc(n)))).
fof(c_Hx2,axiom,c_SNoLt(c_Empty,x)).
fof(c_Hx3,axiom,c_SNoEq_5F(c_SNoLev(x),eps_5F(n),x)).
fof(c_Hx1a,axiom,c_In(c_SNoLev(x),ordsucc(n))).
fof(c_Hx1b,axiom,ordinal(c_SNoLev(x))).
fof(c_Hx1c,axiom,c_SNo(x)).
fof(c_Hx1d,axiom,c_SNo_5F(c_SNoLev(x),x)).
fof(c_L1,axiom,nat_5Fp(c_SNoLev(x))).
fof(c_H1,axiom,(? [X3] : (nat_5Fp(X3) & (c_SNoLev(x) = ordsucc(X3))))).
fof(c_Hm1,axiom,nat_5Fp(m)).
fof(c_Hm2,axiom,(c_SNoLev(x) = ordsucc(m))).
fof(conj_hammer_test_5038,conjecture,(x = eps_5F(m))).
