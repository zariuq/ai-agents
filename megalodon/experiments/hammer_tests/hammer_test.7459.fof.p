...
fof(c_Hu0,axiom,c_In(u0,c_SNoL(x))).
fof(c_Hu1,axiom,c_In(u1,c_SNoL(y))).
...
fof(c_Lu0v0lt,axiom,c_SNoLt(u0,v0)).
fof(c_L3,axiom,(! [X11] : (c_In(X11,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,X11)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,X11)))))).
fof(c_L3u1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,u1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,u1)))).
fof(c_L3v1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,v1)))).
fof(c_L3u1imp,axiom,(c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,u1),mul_5FSNo(x,v1))) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
fof(c_L3v1imp,axiom,(c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(u0,v1)),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
fof(c_Hzu1,axiom,c_In(z,c_SNoL(u1))).
fof(c_Hzv1,axiom,c_In(z,c_SNoR(v1))).
fof(c_Hza,axiom,c_SNo(z)).
fof(c_Hzb,axiom,c_In(c_SNoLev(z),c_SNoLev(u1))).
fof(c_Hzc,axiom,c_SNoLt(z,u1)).
fof(c_Lz,axiom,c_In(z,c_SNoL(y))).
fof(c_L4,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,z)),add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(v0,u1)))).
fof(c_L5,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(v0,z)))).
fof(conj_hammer_test_7459,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
