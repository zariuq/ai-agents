...
fof(conj_hammer_test_8297,conjecture,(! [X8] : (c_In(X8,c_SNoL(x)) => (! [X9] : (c_In(X9,c_SNoL(y)) => ((w = add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9))))) => c_In(minus_5FSNo(w),c_5FR_5F27))))))).
