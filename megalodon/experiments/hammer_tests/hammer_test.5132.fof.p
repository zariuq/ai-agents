...
fof(c_H1,axiom,(! [X2] : (! [X3] : (c_SNoCutP(X2,X3) => ((! [X4] : (c_In(X4,X2) => c_In(c_SNoLev(X4),c_SNoLev(z)))) => ((! [X4] : (c_In(X4,X3) => c_In(c_SNoLev(X4),c_SNoLev(z)))) => ((z = c_SNoCut(X2,X3)) => p))))))).
fof(c_LLz,axiom,ordinal(c_SNoLev(z))).
fof(conj_hammer_test_5132,conjecture,p).
