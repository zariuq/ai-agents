...
fof(c_L1,axiom,(! [X11] : (c_In(X11,c_5FLx) => (! [X12] : (c_In(X12,c_5FLy) => c_SNoLt(add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(x,X12)),add_5FSNo(u,mul_5FSNo(X11,X12)))))))).
fof(c_L2,axiom,(! [X11] : (c_In(X11,c_5FRx) => (! [X12] : (c_In(X12,c_5FRy) => c_SNoLt(add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(x,X12)),add_5FSNo(u,mul_5FSNo(X11,X12)))))))).
...
fof(conj_hammer_test_10482,conjecture,(! [X11] : (c_In(X11,binunion(c_5FLxLy_5F27,c_5FRxRy_5F27)) => c_SNoLt(X11,c_SNoCut(c_SNoL(u),c_SNoR(u)))))).
