...
fof(conj_hammer_test_6897,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (! [X5] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNo(X4) => (c_SNo(X5) => (c_SNoLt(add_5FSNo(X0,X2),add_5FSNo(X3,X5)) => (c_SNoLt(add_5FSNo(X1,X5),X4) => c_SNoLt(add_5FSNo(X0,add_5FSNo(X1,X2)),add_5FSNo(X3,X4))))))))))))))))).
