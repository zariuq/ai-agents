...
fof(c_Hw1,axiom,c_In(w,c_SNoS_5F(c_SNoLev(y)))).
fof(c_Hw2,axiom,(u = add_5FSNo(x,w))).
fof(c_Hw3,axiom,c_SNo(w)).
fof(c_Hw4,axiom,c_In(c_SNoLev(w),c_SNoLev(y))).
fof(c_Hw5,axiom,c_SNoLt(y,w)).
fof(c_Hw6,axiom,c_In(v,ordsucc(c_SNoLev(add_5FSNo(x,w))))).
fof(c_Lv,axiom,ordinal(v)).
fof(c_H1,axiom,c_Subq(add_5FSNo(c_SNoLev(x),c_SNoLev(y)),v)).
fof(c_LIHw,axiom,c_Subq(c_SNoLev(add_5FSNo(x,w)),add_5FSNo(c_SNoLev(x),c_SNoLev(w)))).
fof(c_L4a,axiom,c_In(add_5FSNo(c_SNoLev(x),c_SNoLev(w)),add_5FSNo(c_SNoLev(x),c_SNoLev(y)))).
fof(c_L4b,axiom,c_Subq(add_5FSNo(c_SNoLev(x),c_SNoLev(w)),add_5FSNo(c_SNoLev(x),c_SNoLev(y)))).
fof(c_L4c,axiom,c_Subq(v,c_SNoLev(add_5FSNo(x,w)))).
fof(conj_hammer_test_6755,conjecture,c_In(add_5FSNo(c_SNoLev(x),c_SNoLev(w)),add_5FSNo(c_SNoLev(x),c_SNoLev(y)))).
