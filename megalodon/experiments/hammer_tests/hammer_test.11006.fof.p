...
fof(conj_hammer_test_11006,conjecture,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => (c_SNoLt(c_Empty,X2) => ((! [X3] : (int_5Flin_5Fcomb(X0,X1,X3) => (c_SNoLt(c_Empty,X3) => c_SNoLe(X2,X3)))) => gcd_5Freln(X0,X1,X2)))))))).
