...
fof(conj_hammer_test_9130,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(add_5FSNo(x,y),z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(y,w))),add_5FSNo(add_5FSNo(u,mul_5FSNo(v,w)),add_5FSNo(mul_5FSNo(y,z),mul_5FSNo(y,w))))).
