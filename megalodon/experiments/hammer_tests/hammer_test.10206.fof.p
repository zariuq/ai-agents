...
fof(c_L2,axiom,(? [X13] : (c_In(X13,c_5FLx) & c_SNoLe(w0,X13)))).
fof(c_L3,axiom,(? [X13] : (c_In(X13,c_5FLy) & c_SNoLe(w1,X13)))).
...
fof(conj_hammer_test_10206,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1_5F27),mul_5FSNo(w0_5F27,w1))),add_5FSNo(mul_5FSNo(w0_5F27,y),add_5FSNo(mul_5FSNo(x,w1_5F27),mul_5FSNo(w0,w1))))).
