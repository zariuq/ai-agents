...
fof(c_Hx1,axiom,c_In(x,c_SNoS_5F(omega))).
fof(c_Hx2,axiom,(c_SNoLev(x) = c_Empty)).
fof(c_Hx1a,axiom,c_In(c_SNoLev(x),omega)).
fof(c_Hx1b,axiom,ordinal(c_SNoLev(x))).
fof(c_Hx1c,axiom,c_SNo(x)).
fof(c_Hx1d,axiom,c_SNo_5F(c_SNoLev(x),x)).
fof(c_L1,axiom,(x = c_Empty)).
fof(conj_hammer_test_11577,conjecture,c_In(c_Empty,ordsucc(c_Empty))).
