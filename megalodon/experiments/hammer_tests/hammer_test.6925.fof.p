...
fof(c_H1,axiom,c_SNoLt(add_5FSNo(x,a),add_5FSNo(b,c))).
fof(c_H2,axiom,c_SNoLt(add_5FSNo(y,c),u)).
fof(c_H3,axiom,c_SNoLt(add_5FSNo(b,z),add_5FSNo(w,a))).
fof(c_L1,axiom,c_SNoLt(add_5FSNo(x,z),add_5FSNo(c,w))).
fof(c_Lxz,axiom,c_SNo(add_5FSNo(x,z))).
fof(c_Lcw,axiom,c_SNo(add_5FSNo(c,w))).
fof(conj_hammer_test_6925,conjecture,c_SNoLt(add_5FSNo(x,add_5FSNo(y,z)),add_5FSNo(w,u))).
