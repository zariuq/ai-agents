...
fof(c_IHn,axiom,(! [X1] : (c_In(X1,n) => (c_In(ordsucc(c_Empty),X1) => (? [X2] : (prime_5Fnat(X2) & divides_5Fnat(X2,X1))))))).
fof(c_H1,axiom,c_In(ordsucc(c_Empty),n)).
fof(c_H1,axiom,composite_5Fnat(n)).
fof(c__5F,axiom,c_In(n,omega)).
fof(c_H,axiom,(? [X1] : (c_In(X1,omega) & (? [X2] : (c_In(X2,omega) & ((c_In(ordsucc(c_Empty),X1) & c_In(ordsucc(c_Empty),X2)) & (mul_5Fnat(X1,X2) = n))))))).
fof(conj_hammer_test_2163,conjecture,(? [X1] : (prime_5Fnat(X1) & divides_5Fnat(X1,n)))).
