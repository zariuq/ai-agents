...
fof(conj_hammer_test_9359,conjecture,c_SNo(add_5FSNo(add_5FSNo(c_5FM(c_5FM(x,y),z),c_5FM(v,w)),add_5FSNo(c_5FM(v,c_5FM(w1,z)),add_5FSNo(c_5FM(v,c_5FM(y,w2)),c_5FM(x,c_5FM(w1,w2))))))).
