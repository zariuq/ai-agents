...
fof(conj_hammer_test_10590,conjecture,(! [X6] : (c_In(X6,c_SNoR(mul_5FSNo(x,y))) => ((? [X7] : (c_In(X7,c_5FLx) & (? [X8] : (c_In(X8,c_5FRy) & c_SNoLe(add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8)),add_5FSNo(X6,mul_5FSNo(X7,X8))))))) | (? [X7] : (c_In(X7,c_5FRx) & (? [X8] : (c_In(X8,c_5FLy) & c_SNoLe(add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8)),add_5FSNo(X6,mul_5FSNo(X7,X8))))))))))).
