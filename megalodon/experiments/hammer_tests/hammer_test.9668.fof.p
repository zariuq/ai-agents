...
fof(conj_hammer_test_9668,conjecture,(! [X7] : (! [X8] : (! [X9] : (! [X10] : (c_SNo(X7) => (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_SNoLe(X9,X7) => (c_SNoLe(X10,X8) => c_SNoLe(add_5FSNo(mul_5FSNo(X8,X9),mul_5FSNo(X10,X7)),add_5FSNo(mul_5FSNo(X8,X7),mul_5FSNo(X10,X9)))))))))))))).
