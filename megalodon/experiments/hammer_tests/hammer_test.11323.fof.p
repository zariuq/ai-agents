...
fof(c_L2,axiom,(? [X7] : ((ordinal(X7) & (prime_5Fnat(X7) & divides_5Fnat(X7,n))) & (! [X8] : (c_In(X8,X7) => ~ (prime_5Fnat(X8) & divides_5Fnat(X8,n))))))).
...
fof(c_Hpleast,axiom,(! [X7] : (c_In(X7,p) => ~ (prime_5Fnat(X7) & divides_5Fnat(X7,n))))).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,omega) => (divides_5Fnat(X7,p) => ((X7 = ordsucc(c_Empty)) | (X7 = p)))))).
fof(c_HpN,axiom,c_In(p,omega)).
fof(c_H1p,axiom,c_In(ordsucc(c_Empty),p)).
fof(c__5F,axiom,(c_In(p,omega) & c_In(n,omega))).
fof(c_H,axiom,(? [X7] : (c_In(X7,omega) & (mul_5Fnat(p,X7) = n)))).
...
fof(c_Lf1,axiom,(! [X7] : (c_In(X7,k) => prime_5Fnat(f(X7))))).
fof(c_Lf2,axiom,(! [X7] : (c_In(X7,k) => c_In(f(X7),omega)))).
fof(c_Hgk,axiom,(g(k) = p)).
fof(c_Hgi,axiom,(! [X7] : (c_In(X7,k) => (g(X7) = f(X7))))).
fof(c_Hi,axiom,c_In(i,ordsucc(k))).
fof(conj_hammer_test_11323,conjecture,(c_In(i,k) => (prime_5Fnat(g(i)) & (! [X7] : (c_In(X7,i) => c_SNoLe(g(i),g(X7))))))).
