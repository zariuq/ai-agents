...
fof(c_HLR1,axiom,c_SNoCutP(c_5FL1,c_5FR1)).
fof(c_HLR2,axiom,c_SNoCutP(c_5FL2,c_5FR2)).
fof(c_H1,axiom,(! [X4] : (c_In(X4,c_5FL1) => c_SNoLt(X4,c_SNoCut(c_5FL2,c_5FR2))))).
fof(c_H2,axiom,(! [X4] : (c_In(X4,c_5FR2) => c_SNoLt(c_SNoCut(c_5FL1,c_5FR1),X4)))).
fof(c_HLR1a,axiom,((! [X4] : (c_In(X4,c_5FL1) => c_SNo(X4))) & (! [X4] : (c_In(X4,c_5FR1) => c_SNo(X4))))).
fof(c_HLR1a,axiom,(! [X4] : (c_In(X4,c_5FL1) => c_SNo(X4)))).
fof(c_HLR1b,axiom,(! [X4] : (c_In(X4,c_5FR1) => c_SNo(X4)))).
fof(c_HLR1c,axiom,(! [X4] : (c_In(X4,c_5FL1) => (! [X5] : (c_In(X5,c_5FR1) => c_SNoLt(X4,X5)))))).
fof(c_HLR2a,axiom,((! [X4] : (c_In(X4,c_5FL2) => c_SNo(X4))) & (! [X4] : (c_In(X4,c_5FR2) => c_SNo(X4))))).
fof(c_HLR2a,axiom,(! [X4] : (c_In(X4,c_5FL2) => c_SNo(X4)))).
fof(c_HLR2b,axiom,(! [X4] : (c_In(X4,c_5FR2) => c_SNo(X4)))).
fof(c_HLR2c,axiom,(! [X4] : (c_In(X4,c_5FL2) => (! [X5] : (c_In(X5,c_5FR2) => c_SNoLt(X4,X5)))))).
fof(c_H3,axiom,c_SNo(c_SNoCut(c_5FL1,c_5FR1))).
fof(c_H5,axiom,(! [X4] : (c_In(X4,c_5FL1) => c_SNoLt(X4,c_SNoCut(c_5FL1,c_5FR1))))).
fof(c_H6,axiom,(! [X4] : (c_In(X4,c_5FR1) => c_SNoLt(c_SNoCut(c_5FL1,c_5FR1),X4)))).
fof(c_H7,axiom,(! [X4] : (c_SNo(X4) => ((! [X5] : (c_In(X5,c_5FL1) => c_SNoLt(X5,X4))) => ((! [X5] : (c_In(X5,c_5FR1) => c_SNoLt(X4,X5))) => (c_Subq(c_SNoLev(c_SNoCut(c_5FL1,c_5FR1)),c_SNoLev(X4)) & c_SNoEq_5F(c_SNoLev(c_SNoCut(c_5FL1,c_5FR1)),c_SNoCut(c_5FL1,c_5FR1),X4))))))).
fof(c_H8,axiom,c_SNo(c_SNoCut(c_5FL2,c_5FR2))).
fof(c_H10,axiom,(! [X4] : (c_In(X4,c_5FL2) => c_SNoLt(X4,c_SNoCut(c_5FL2,c_5FR2))))).
fof(c_H11,axiom,(! [X4] : (c_In(X4,c_5FR2) => c_SNoLt(c_SNoCut(c_5FL2,c_5FR2),X4)))).
fof(c_H12,axiom,(! [X4] : (c_SNo(X4) => ((! [X5] : (c_In(X5,c_5FL2) => c_SNoLt(X5,X4))) => ((! [X5] : (c_In(X5,c_5FR2) => c_SNoLt(X4,X5))) => (c_Subq(c_SNoLev(c_SNoCut(c_5FL2,c_5FR2)),c_SNoLev(X4)) & c_SNoEq_5F(c_SNoLev(c_SNoCut(c_5FL2,c_5FR2)),c_SNoCut(c_5FL2,c_5FR2),X4))))))).
fof(c_H13,axiom,c_SNoLt(c_SNoCut(c_5FL2,c_5FR2),c_SNoCut(c_5FL1,c_5FR1))).
fof(conj_hammer_test_4685,conjecture,(! [X4] : (c_SNo(X4) => (c_In(c_SNoLev(X4),binintersect(c_SNoLev(c_SNoCut(c_5FL2,c_5FR2)),c_SNoLev(c_SNoCut(c_5FL1,c_5FR1)))) => (c_SNoEq_5F(c_SNoLev(X4),X4,c_SNoCut(c_5FL2,c_5FR2)) => (c_SNoEq_5F(c_SNoLev(X4),X4,c_SNoCut(c_5FL1,c_5FR1)) => (c_SNoLt(c_SNoCut(c_5FL2,c_5FR2),X4) => (c_SNoLt(X4,c_SNoCut(c_5FL1,c_5FR1)) => (nIn(c_SNoLev(X4),c_SNoCut(c_5FL2,c_5FR2)) => (c_In(c_SNoLev(X4),c_SNoCut(c_5FL1,c_5FR1)) => $false)))))))))).
