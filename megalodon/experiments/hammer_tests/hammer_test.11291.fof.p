...
fof(c_L2,axiom,(? [X3] : ((ordinal(X3) & (prime_5Fnat(X3) & divides_5Fnat(X3,n))) & (! [X4] : (c_In(X4,X3) => ~ (prime_5Fnat(X4) & divides_5Fnat(X4,n))))))).
...
fof(c_Hpleast,axiom,(! [X3] : (c_In(X3,p) => ~ (prime_5Fnat(X3) & divides_5Fnat(X3,n))))).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c__5F,axiom,(! [X3] : (c_In(X3,omega) => (divides_5Fnat(X3,p) => ((X3 = ordsucc(c_Empty)) | (X3 = p)))))).
fof(c_HpN,axiom,c_In(p,omega)).
fof(c_H1p,axiom,c_In(ordsucc(c_Empty),p)).
fof(c__5F,axiom,(c_In(p,omega) & c_In(n,omega))).
fof(c_H,axiom,(? [X3] : (c_In(X3,omega) & (mul_5Fnat(p,X3) = n)))).
...
fof(conj_hammer_test_11291,conjecture,c_In(c_Empty,m)).
