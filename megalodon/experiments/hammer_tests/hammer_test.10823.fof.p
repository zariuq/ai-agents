...
fof(c_Hn,axiom,c_In(n,setminus(omega,c_Sing(c_Empty)))).
fof(c_Hn1,axiom,c_In(n,omega)).
fof(c_Hn2,axiom,nIn(n,c_Sing(c_Empty))).
fof(c_LnN,axiom,nat_5Fp(n)).
fof(c_Lno,axiom,ordinal(n)).
fof(c_L0n,axiom,c_In(c_Empty,n)).
fof(c_Hm,axiom,c_In(m,omega)).
fof(c_Hq,axiom,c_In(q,omega)).
fof(c_H,axiom,(? [X4] : (c_In(X4,n) & (m = add_5Fnat(mul_5Fnat(q,n),X4))))).
fof(c_Hr,axiom,c_In(r,n)).
fof(c_H1,axiom,(m = add_5Fnat(mul_5Fnat(q,n),r))).
fof(c_LqN,axiom,nat_5Fp(q)).
fof(c_LqS,axiom,c_SNo(q)).
fof(c_LrN,axiom,nat_5Fp(r)).
fof(c_LrS,axiom,c_SNo(r)).
fof(c_LnS,axiom,c_SNo(n)).
fof(c_LqnS,axiom,c_SNo(mul_5FSNo(q,n))).
fof(c_L2,axiom,(m = add_5FSNo(mul_5FSNo(q,n),r))).
fof(c_L3,axiom,c_SNoLe(c_Empty,r)).
fof(c_H2,axiom,c_SNoLt(c_Empty,r)).
fof(c_L4,axiom,c_In(add_5FSNo(n,minus_5FSNo(r)),n)).
fof(conj_hammer_test_10823,conjecture,(minus_5FSNo(m) = minus_5FSNo(add_5FSNo(mul_5FSNo(q,n),r)))).
