...
fof(conj_hammer_test_6586,conjecture,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (minus_5FSNo(add_5FSNo(X0,add_5FSNo(X1,X2))) = add_5FSNo(minus_5FSNo(X0),add_5FSNo(minus_5FSNo(X1),minus_5FSNo(X2))))))))))).
