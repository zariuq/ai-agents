...
fof(c_Hk,axiom,c_In(k,m)).
fof(conj_hammer_test_1526,conjecture,(! [X2] : (nat_5Fp(X2) => (c_In(add_5Fnat(k,X2),add_5Fnat(m,X2)) => c_In(add_5Fnat(k,ordsucc(X2)),add_5Fnat(m,ordsucc(X2))))))).
