...
fof(c_IH,axiom,(! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(u))) => (c_In(c_SNoLev(X4),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(X4,add_5FSNo(x,y)) => ((? [X5] : (c_In(X5,c_SNoL(x)) & c_SNoLe(X4,add_5FSNo(X5,y)))) | (? [X5] : (c_In(X5,c_SNoL(y)) & c_SNoLe(X4,add_5FSNo(x,X5)))))))))).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(u,add_5FSNo(x,y))).
fof(c_HNC,axiom,~ ((? [X4] : (c_In(X4,c_SNoL(x)) & c_SNoLe(u,add_5FSNo(X4,y)))) | (? [X4] : (c_In(X4,c_SNoL(y)) & c_SNoLe(u,add_5FSNo(x,X4)))))).
...
fof(c_Hxy1,axiom,c_TransSet(c_SNoLev(add_5FSNo(x,y)))).
fof(c__5F,axiom,(! [X4] : (c_In(X4,c_SNoLev(add_5FSNo(x,y))) => c_TransSet(X4)))).
fof(conj_hammer_test_6338,conjecture,c_In(c_SNoLev(z),c_SNoLev(add_5FSNo(x,y)))).
