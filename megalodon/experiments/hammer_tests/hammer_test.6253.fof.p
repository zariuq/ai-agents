...
fof(conj_hammer_test_6253,conjecture,((add_5FSNo(ordsucc(alpha),beta) = ordsucc(add_5FSNo(alpha,beta))) => (add_5FSNo(ordsucc(alpha),beta) = ordsucc(add_5FSNo(alpha,beta))))).
