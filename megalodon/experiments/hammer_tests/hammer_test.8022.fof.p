...
fof(c_H1,axiom,c_In(c_SNoLev(x),c_SNoLev(u))).
fof(c_H2,axiom,c_SNoEq_5F(c_SNoLev(x),u,x)).
fof(c_H3,axiom,nIn(c_SNoLev(x),u)).
fof(c_Lxu,axiom,c_In(x,c_SNoR(u))).
...
fof(c_Luzxy,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,z),mul_5FSNo(x,y)))).
fof(c_Luvxz,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(x,z)))).
fof(conj_hammer_test_8022,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,v),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,z))),add_5FSNo(mul_5FSNo(x,v),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,z))))).
