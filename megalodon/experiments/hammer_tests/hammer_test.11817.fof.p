...
fof(c_IH,axiom,(! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(z))) => (c_SNoLt(x,X4) => (c_SNoLt(add_5FSNo(y,X4),add_5FSNo(x,x)) => (? [X5] : (c_In(X5,c_SNoR(X4)) & (add_5FSNo(y,X5) = add_5FSNo(x,x))))))))).
...
fof(c_H3,axiom,c_SNoLe(add_5FSNo(w,z),add_5FSNo(x,x))).
fof(c_Hw1,axiom,c_SNo(w)).
fof(c_Hw2,axiom,c_In(c_SNoLev(w),c_SNoLev(y))).
fof(conj_hammer_test_11817,conjecture,(c_SNoLt(y,w) => $false)).
