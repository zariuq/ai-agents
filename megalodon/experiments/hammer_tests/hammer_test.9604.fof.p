...
fof(c_SNo_5FM,axiom,(! [X8] : (! [X9] : (c_SNo(X8) => (c_SNo(X9) => c_SNo(c_5FM(X8,X9))))))).
fof(c_DL,axiom,(! [X8] : (! [X9] : (! [X10] : (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_5FM(c_X8,add_5FSNo(X9,X10)) = add_5FSNo(c_5FM(c_X8,X9),c_5FM(c_X8,X10)))))))))).
fof(c_DR,axiom,(! [X8] : (! [X9] : (! [X10] : (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_5FM(add_5FSNo(c_X8,X9),X10) = add_5FSNo(c_5FM(c_X8,X10),c_5FM(X9,X10)))))))))).
fof(c_M_5FLt,axiom,(! [X8] : (! [X9] : (! [X10] : (! [X11] : (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_SNo(X11) => (c_SNoLt(X10,X8) => (c_SNoLt(X11,X9) => c_SNoLt(add_5FSNo(c_5FM(X10,c_X9),c_5FM(c_X8,X11)),add_5FSNo(c_5FM(c_X8,c_X9),c_5FM(X10,X11)))))))))))))).
fof(c_M_5FLe,axiom,(! [X8] : (! [X9] : (! [X10] : (! [X11] : (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_SNo(X11) => (c_SNoLe(X10,X8) => (c_SNoLe(X11,X9) => c_SNoLe(add_5FSNo(c_5FM(X10,c_X9),c_5FM(c_X8,X11)),add_5FSNo(c_5FM(c_X8,c_X9),c_5FM(X10,X11)))))))))))))).
fof(c_Hx,axiom,c_SNo(x)).
fof(c_Hy,axiom,c_SNo(y)).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_IHx,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (c_5FM(X8,c_5FM(y,z)) = c_5FM(c_5FM(X8,y),z))))).
fof(c_IHy,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (c_5FM(x,c_5FM(X8,z)) = c_5FM(c_5FM(x,X8),z))))).
fof(c_IHz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(x,c_5FM(y,X8)) = c_5FM(c_5FM(x,y),X8))))).
fof(c_IHxy,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (c_5FM(X8,c_5FM(X9,z)) = c_5FM(c_5FM(X8,X9),z))))))).
fof(c_IHxz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(X8,c_5FM(y,X9)) = c_5FM(c_5FM(X8,y),X9))))))).
fof(c_IHyz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(x,c_5FM(X8,X9)) = c_5FM(c_5FM(x,X8),X9))))))).
fof(c_IHxyz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(c_X8,c_5FM(X9,X10)) = c_5FM(c_5FM(c_X8,X9),X10))))))))).
...
fof(c_L2,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_SNo(X9) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(y))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(z))) => ((u = add_5FSNo(c_5FM(c_X8,c_5FM(y,z)),add_5FSNo(c_5FM(x,c_X9),minus_5FSNo(c_5FM(c_X8,c_X9))))) => (c_SNoLe(add_5FSNo(c_5FM(x,add_5FSNo(c_5FM(X10,z),c_5FM(y,X11))),c_5FM(c_X8,add_5FSNo(c_X9,c_5FM(X10,X11)))),add_5FSNo(c_5FM(c_X8,add_5FSNo(c_5FM(X10,z),c_5FM(y,X11))),c_5FM(x,add_5FSNo(c_X9,c_5FM(X10,X11))))) => (c_SNoLt(add_5FSNo(c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(c_X8,X10)),z),c_5FM(add_5FSNo(c_5FM(c_X8,y),c_5FM(x,X10)),X11)),add_5FSNo(c_5FM(add_5FSNo(c_5FM(c_X8,y),c_5FM(x,X10)),z),c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(c_X8,X10)),X11))) => c_SNoLt(c_5FM(c_5FM(x,y),z),u))))))))))))).
fof(c_Hv,axiom,c_In(v,c_SNoL(x))).
fof(c_Hw,axiom,c_In(w,c_SNoR(c_5FM(y,z)))).
...
fof(c_Lw,axiom,c_SNo(w)).
fof(c_Lvw,axiom,c_SNo(c_5FM(v,w))).
fof(c_Lvy,axiom,c_SNo(c_5FM(v,y))).
fof(conj_hammer_test_9604,conjecture,(! [X8] : (c_In(X8,c_SNoR(y)) => (! [X9] : (c_In(X9,c_SNoL(z)) => (c_SNoLe(add_5FSNo(c_5FM(X8,z),c_5FM(y,X9)),add_5FSNo(w,c_5FM(X8,X9))) => c_SNoLt(c_5FM(c_5FM(x,y),z),u))))))).
