...
fof(c_LLx,axiom,ordinal(c_SNoLev(x))).
fof(c_LLxa,axiom,c_TransSet(c_SNoLev(x))).
fof(c_LLy,axiom,ordinal(c_SNoLev(y))).
fof(c_LLya,axiom,c_TransSet(c_SNoLev(y))).
fof(c_Hu,axiom,c_In(u,c_SNoL(x))).
fof(c_Hwu,axiom,(w = add_5FSNo(u,y))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(x))).
fof(c_Hu3,axiom,c_SNoLt(u,x)).
fof(c_Lux,axiom,c_In(u,c_SNoS_5F(c_SNoLev(x)))).
fof(c_IHu1,axiom,c_SNo(add_5FSNo(u,y))).
fof(c_IHu2,axiom,(! [X7] : (c_In(X7,c_SNoL(u)) => c_SNoLt(add_5FSNo(X7,y),add_5FSNo(u,y))))).
fof(c_IHu3,axiom,(! [X7] : (c_In(X7,c_SNoR(u)) => c_SNoLt(add_5FSNo(u,y),add_5FSNo(X7,y))))).
fof(c_IHu4,axiom,(! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(u,X7),add_5FSNo(u,y))))).
fof(c_IHu5,axiom,(! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(u,y),add_5FSNo(u,X7))))).
fof(c_Hv,axiom,c_In(v,c_SNoR(x))).
fof(c_Hzv,axiom,(z = add_5FSNo(v,y))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(x))).
fof(c_Hv3,axiom,c_SNoLt(x,v)).
fof(c_IHv1,axiom,c_SNo(add_5FSNo(v,y))).
fof(c_IHv2,axiom,(! [X7] : (c_In(X7,c_SNoL(v)) => c_SNoLt(add_5FSNo(X7,y),add_5FSNo(v,y))))).
fof(c_IHv3,axiom,(! [X7] : (c_In(X7,c_SNoR(v)) => c_SNoLt(add_5FSNo(v,y),add_5FSNo(X7,y))))).
fof(c_IHv4,axiom,(! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(v,X7),add_5FSNo(v,y))))).
fof(c_IHv5,axiom,(! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(v,y),add_5FSNo(v,X7))))).
fof(c_Luv,axiom,c_SNoLt(u,v)).
fof(c_Hq1,axiom,c_SNo(q)).
fof(c_Hq2,axiom,c_In(c_SNoLev(q),binintersect(c_SNoLev(u),c_SNoLev(v)))).
fof(c__5F,axiom,c_SNoEq_5F(c_SNoLev(q),q,u)).
fof(c__5F,axiom,c_SNoEq_5F(c_SNoLev(q),q,v)).
fof(c_Hq5,axiom,c_SNoLt(u,q)).
fof(c_Hq6,axiom,c_SNoLt(q,v)).
fof(c__5F,axiom,nIn(c_SNoLev(q),u)).
fof(c__5F,axiom,c_In(c_SNoLev(q),v)).
fof(c_Hq2u,axiom,c_In(c_SNoLev(q),c_SNoLev(u))).
fof(c_Hq2v,axiom,c_In(c_SNoLev(q),c_SNoLev(v))).
fof(c_Lqx,axiom,c_In(c_SNoLev(q),c_SNoLev(x))).
fof(c_Lqx2,axiom,c_In(q,c_SNoS_5F(c_SNoLev(x)))).
fof(c_IHq1,axiom,c_SNo(add_5FSNo(q,y))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoL(q)) => c_SNoLt(add_5FSNo(X7,y),add_5FSNo(q,y))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoR(q)) => c_SNoLt(add_5FSNo(q,y),add_5FSNo(X7,y))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(q,X7),add_5FSNo(q,y))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(q,y),add_5FSNo(q,X7))))).
fof(conj_hammer_test_5922,conjecture,c_SNo(add_5FSNo(q,y))).
