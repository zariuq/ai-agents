...
fof(c_L1,axiom,(! [X9] : (c_Subq(X9,c_5FX) => (infinite(X9) => (? [X10] : (c_Subq(X10,X9) & (? [X11] : (c_In(X11,X9) & ((nIn(X11,X10) & infinite(X10)) & (! [X12] : (c_Subq(X12,X10) => (equip(X12,n) => (c_5FC(binunion(X12,c_Sing(c_X11))) = c))))))))))))).
fof(c_H,axiom,((! [X9] : (nat_5Fp(X9) => (c_Subq(f_5F27(X9),c_5FX) & infinite(f_5F27(X9))))) & (! [X9] : (c_In(X9,omega) => (! [X10] : (c_In(X10,omega) => (c_Subq(X9,X10) => c_Subq(f_5F27(X10),f_5F27(c_X9))))))))).
fof(c_Hf_271,axiom,(! [X9] : (nat_5Fp(X9) => (c_Subq(f_5F27(X9),c_5FX) & infinite(f_5F27(X9)))))).
fof(c_Hgf_27mm_27Subq,axiom,(! [X9] : (c_In(X9,omega) => (! [X10] : (c_In(X10,omega) => (c_Subq(X9,X10) => c_Subq(f_5F27(X10),f_5F27(c_X9)))))))).
fof(c_Lf_271,axiom,(! [X9] : (nat_5Fp(X9) => (c_Subq(f_5F27(X9),c_5FX) & infinite(f_5F27(X9)))))).
fof(c_Lgf_27mm_27addSubq,axiom,(! [X9] : (c_In(X9,omega) => (! [X10] : (nat_5Fp(X10) => c_Subq(f_5F27(add_5Fnat(c_X9,X10)),f_5F27(c_X9))))))).
fof(c_Lgf_27mm_27Subq,axiom,(! [X9] : (c_In(X9,omega) => (! [X10] : (c_In(X10,omega) => (c_Subq(X9,X10) => c_Subq(f_5F27(X10),f_5F27(c_X9)))))))).
fof(c_Hm,axiom,nat_5Fp(m)).
fof(c_HYSn,axiom,equip(c_5FY,ordsucc(n))).
fof(c_Hf_27mX,axiom,c_Subq(f_5F27(m),c_5FX)).
...
fof(conj_hammer_test_2641,conjecture,(c_In(m,k) => c_In(u,f_5F27(ordsucc(m))))).
