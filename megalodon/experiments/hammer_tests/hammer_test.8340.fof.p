...
fof(c_IHx,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(add_5FSNo(X5,y),z) = add_5FSNo(mul_5FSNo(X5,z),mul_5FSNo(y,z)))))).
fof(c_IHy,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(add_5FSNo(x,X5),z) = add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(X5,z)))))).
fof(c_IHz,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(x,y),X5) = add_5FSNo(mul_5FSNo(x,X5),mul_5FSNo(y,X5)))))).
fof(c_IHxy,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(x))) => (! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(add_5FSNo(X5,X6),z) = add_5FSNo(mul_5FSNo(X5,z),mul_5FSNo(X6,z)))))))).
fof(c_IHxz,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(x))) => (! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(X5,y),X6) = add_5FSNo(mul_5FSNo(X5,X6),mul_5FSNo(y,X6)))))))).
fof(c_IHyz,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(y))) => (! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(x,X5),X6) = add_5FSNo(mul_5FSNo(x,X6),mul_5FSNo(X5,X6)))))))).
fof(c_IHxyz,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(x))) => (! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(y))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(X5,X6),X7) = add_5FSNo(mul_5FSNo(X5,X7),mul_5FSNo(X6,X7)))))))))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X5] : (c_In(X5,c_SNoL(add_5FSNo(x,y))) => (! [X6] : (c_In(X6,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X5,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X5] : (c_In(X5,c_SNoR(add_5FSNo(x,y))) => (! [X6] : (c_In(X6,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X5,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X5] : (c_In(X5,c_SNoL(add_5FSNo(x,y))) => (! [X6] : (c_In(X6,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X5,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X5] : (c_In(X5,c_SNoR(add_5FSNo(x,y))) => (! [X6] : (c_In(X6,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X5,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FR)))))).
...
fof(conj_hammer_test_8340,conjecture,c_SNoCutP(c_5FL,c_5FR)).
