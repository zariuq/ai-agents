...
fof(c_H,axiom,((! [X11] : (c_In(X11,c_5FLx) => c_SNo(X11))) & (! [X11] : (c_In(X11,c_5FRx) => c_SNo(X11))))).
fof(c_HLx,axiom,(! [X11] : (c_In(X11,c_5FLx) => c_SNo(X11)))).
fof(c_HRx,axiom,(! [X11] : (c_In(X11,c_5FRx) => c_SNo(X11)))).
fof(c_HLRx_27,axiom,(! [X11] : (c_In(X11,c_5FLx) => (! [X12] : (c_In(X12,c_5FRx) => c_SNoLt(X11,X12)))))).
fof(c_H,axiom,((! [X11] : (c_In(X11,c_5FLy) => c_SNo(X11))) & (! [X11] : (c_In(X11,c_5FRy) => c_SNo(X11))))).
fof(c_HLy,axiom,(! [X11] : (c_In(X11,c_5FLy) => c_SNo(X11)))).
fof(c_HRy,axiom,(! [X11] : (c_In(X11,c_5FRy) => c_SNo(X11)))).
fof(c_HLRy_27,axiom,(! [X11] : (c_In(X11,c_5FLy) => (! [X12] : (c_In(X12,c_5FRy) => c_SNoLt(X11,X12)))))).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx3,axiom,(! [X11] : (c_In(X11,c_5FLx) => c_SNoLt(X11,x)))).
fof(c_Hx4,axiom,(! [X11] : (c_In(X11,c_5FRx) => c_SNoLt(x,X11)))).
fof(c_Hx5,axiom,(! [X11] : (c_SNo(X11) => ((! [X12] : (c_In(X12,c_5FLx) => c_SNoLt(X12,X11))) => ((! [X12] : (c_In(X12,c_5FRx) => c_SNoLt(X11,X12))) => (c_Subq(c_SNoLev(x),c_SNoLev(X11)) & c_SNoEq_5F(c_SNoLev(x),x,X11))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X11] : (c_In(X11,c_5FLy) => c_SNoLt(X11,y)))).
fof(c_Hy4,axiom,(! [X11] : (c_In(X11,c_5FRy) => c_SNoLt(y,X11)))).
fof(c_Hy5,axiom,(! [X11] : (c_SNo(X11) => ((! [X12] : (c_In(X12,c_5FLy) => c_SNoLt(X12,X11))) => ((! [X12] : (c_In(X12,c_5FRy) => c_SNoLt(X11,X12))) => (c_Subq(c_SNoLev(y),c_SNoLev(X11)) & c_SNoEq_5F(c_SNoLev(y),y,X11))))))).
...
fof(c_L1,axiom,(! [X11] : (c_In(X11,c_5FLx) => (! [X12] : (c_In(X12,c_5FRy) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X11,X12)),add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(x,X12)))))))).
fof(c_L2,axiom,(! [X11] : (c_In(X11,c_5FRx) => (! [X12] : (c_In(X12,c_5FLy) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X11,X12)),add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(x,X12)))))))).
fof(c_LxLy_27I,axiom,(! [X11] : (c_In(X11,c_5FLx) => (! [X12] : (c_In(X12,c_5FLy) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FLxLy_5F27)))))).
fof(c_RxRy_27I,axiom,(! [X11] : (c_In(X11,c_5FRx) => (! [X12] : (c_In(X12,c_5FRy) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FRxRy_5F27)))))).
fof(c_LxRy_27I,axiom,(! [X11] : (c_In(X11,c_5FLx) => (! [X12] : (c_In(X12,c_5FRy) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FLxRy_5F27)))))).
fof(c_RxLy_27I,axiom,(! [X11] : (c_In(X11,c_5FRx) => (! [X12] : (c_In(X12,c_5FLy) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FRxLy_5F27)))))).
...
fof(conj_hammer_test_10588,conjecture,(! [X11] : (c_In(X11,binunion(c_5FLxRy_5F27,c_5FRxLy_5F27)) => c_SNoLt(c_SNoCut(c_SNoL(u),c_SNoR(u)),X11)))).
