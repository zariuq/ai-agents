...
fof(c_IHn,axiom,(! [X7] : (equip(X7,n) => equip(c_Power(X7),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
...
fof(c_L1,axiom,(? [X7] : c_In(X7,c_5FX))).
...
fof(c_H,axiom,((! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X7),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)))) & (! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X8] : (c_In(X8,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X7) = f(X8)) => (X7 = X8)))))))).
fof(c_Hf1,axiom,(! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X7),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
fof(c_Hf2,axiom,(! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X8] : (c_In(X8,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X7) = f(X8)) => (X7 = X8))))))).
fof(c_Hf3,axiom,(! [X7] : (c_In(X7,exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => (? [X8] : (c_In(X8,c_Power(setminus(c_5FX,c_Sing(x)))) & (f(X8) = X7)))))).
fof(c_LfN,axiom,(! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => nat_5Fp(f(X7))))).
fof(c_Hi,axiom,c_In(i,add_5Fnat(exp_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_LiN,axiom,nat_5Fp(i)).
fof(c_H2,axiom,c_Subq(exp_5Fnat(ordsucc(ordsucc(c_Empty)),n),i)).
fof(c_Hk,axiom,nat_5Fp(k)).
fof(c_Hik2n,axiom,(i = add_5Fnat(k,exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_L3,axiom,c_In(k,exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_HY,axiom,c_In(c_5FY,c_Power(setminus(c_5FX,c_Sing(x))))).
fof(c_HYk,axiom,(f(c_Y) = k)).
fof(c_LxnY,axiom,nIn(x,c_5FY)).
fof(c_LxYx,axiom,c_In(x,binunion(c_5FY,c_Sing(x)))).
fof(conj_hammer_test_1871,conjecture,(setminus(binunion(c_5FY,c_Sing(x)),c_Sing(x)) = c_5FY)).
