...
fof(conj_hammer_test_1633,conjecture,(! [X2] : (nat_5Fp(X2) => ((mul_5Fnat(mul_5Fnat(n,m),X2) = mul_5Fnat(n,mul_5Fnat(m,X2))) => (mul_5Fnat(mul_5Fnat(n,m),ordsucc(X2)) = mul_5Fnat(n,mul_5Fnat(m,ordsucc(X2)))))))).
