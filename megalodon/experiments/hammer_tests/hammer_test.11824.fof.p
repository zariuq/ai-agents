...
fof(c_Hy3,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (c_SNo(X3) => c_SNoLe(X3,y))))).
fof(c_Hy1a,axiom,c_SNo(y)).
fof(c_Hy1b,axiom,c_In(c_SNoLev(y),c_SNoLev(x))).
fof(c_Hy1c,axiom,c_SNoLt(y,x)).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_IH,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(z))) => (c_SNoLt(x,X3) => (c_SNoLt(add_5FSNo(y,X3),add_5FSNo(x,x)) => (? [X4] : (c_In(X4,c_SNoR(X3)) & (add_5FSNo(y,X4) = add_5FSNo(x,x))))))))).
fof(c_H1,axiom,c_SNoLt(x,z)).
fof(c_H2,axiom,c_SNoLt(add_5FSNo(y,z),add_5FSNo(x,x))).
fof(c_Lxx,axiom,c_SNo(add_5FSNo(x,x))).
fof(c_Lyz,axiom,c_SNo(add_5FSNo(y,z))).
fof(c_L1,axiom,(! [X3] : (c_In(X3,c_SNoR(y)) => (c_SNoLe(add_5FSNo(X3,z),add_5FSNo(x,x)) => $false)))).
fof(c_L2,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (c_SNoLe(add_5FSNo(y,z),add_5FSNo(X3,x)) => $false)))).
fof(c_L3,axiom,(! [X3] : (c_In(X3,c_SNoR(z)) => (c_SNoLt(add_5FSNo(y,X3),add_5FSNo(x,x)) => (? [X4] : (c_In(X4,c_SNoR(z)) & (add_5FSNo(y,X4) = add_5FSNo(x,x)))))))).
fof(conj_hammer_test_11824,conjecture,(! [X3] : (c_In(X3,c_SNoL(add_5FSNo(x,x))) => (c_In(X3,c_SNoR(add_5FSNo(y,z))) => (? [X4] : (c_In(X4,c_SNoR(z)) & (add_5FSNo(y,X4) = add_5FSNo(x,x)))))))).
