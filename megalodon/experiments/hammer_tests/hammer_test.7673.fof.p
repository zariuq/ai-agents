...
fof(c_HLI1,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X5,y),add_5FSNo(mul_5FSNo(x,X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X5,y),add_5FSNo(mul_5FSNo(x,X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X5,y),add_5FSNo(mul_5FSNo(x,X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X5,y),add_5FSNo(mul_5FSNo(x,X6),minus_5FSNo(mul_5FSNo(X5,X6)))),c_5FR)))))).
fof(c_Hxy,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_LLx,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_SNo(X6) => c_SNo(mul_5FSNo(X5,X6))))))).
fof(c_LRx,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_SNo(X6) => c_SNo(mul_5FSNo(X5,X6))))))).
fof(c_LLxy,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => c_SNo(mul_5FSNo(X5,y))))).
fof(c_LRxy,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => c_SNo(mul_5FSNo(X5,y))))).
fof(c_LxLy,axiom,(! [X5] : (c_In(X5,c_SNoL(y)) => c_SNo(mul_5FSNo(x,X5))))).
fof(c_LxRy,axiom,(! [X5] : (c_In(X5,c_SNoR(y)) => c_SNo(mul_5FSNo(x,X5))))).
fof(c_LLR1,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_Lxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Hp,axiom,(c_SNo(mul_5FSNo(x,y)) => ((! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6))))))) => ((! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6))))))) => ((! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6))))))) => ((! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6))))))) => p)))))).
fof(conj_hammer_test_7673,conjecture,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)),add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)))))))).
