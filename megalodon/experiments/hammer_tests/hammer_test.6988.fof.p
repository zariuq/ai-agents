...
fof(conj_hammer_test_6988,conjecture,(! [X2] : (nat_5Fp(X2) => ((c_In(m,add_5FSNo(n,X2)) => (c_In(m,n) | c_In(add_5FSNo(m,minus_5FSNo(n)),X2))) => (c_In(m,add_5FSNo(n,ordsucc(X2))) => (c_In(m,n) | c_In(add_5FSNo(m,minus_5FSNo(n)),ordsucc(X2)))))))).
