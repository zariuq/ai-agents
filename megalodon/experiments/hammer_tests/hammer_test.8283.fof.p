...
fof(c_IHx,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(minus_5FSNo(X8),y) = minus_5FSNo(mul_5FSNo(X8,y)))))).
fof(c_IHy,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(minus_5FSNo(x),X8) = minus_5FSNo(mul_5FSNo(x,X8)))))).
fof(c_IHxy,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(minus_5FSNo(X8),X9) = minus_5FSNo(mul_5FSNo(X8,X9)))))))).
...
fof(c_Hxye,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_HL_27R_27,axiom,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
fof(c_HL_27I1,axiom,(! [X8] : (c_In(X8,c_SNoL(minus_5FSNo(x))) => (! [X9] : (c_In(X9,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(minus_5FSNo(x),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL_5F27)))))).
fof(c_HL_27I2,axiom,(! [X8] : (c_In(X8,c_SNoR(minus_5FSNo(x))) => (! [X9] : (c_In(X9,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(minus_5FSNo(x),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL_5F27)))))).
fof(c_HR_27I1,axiom,(! [X8] : (c_In(X8,c_SNoL(minus_5FSNo(x))) => (! [X9] : (c_In(X9,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(minus_5FSNo(x),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR_5F27)))))).
fof(c_HR_27I2,axiom,(! [X8] : (c_In(X8,c_SNoR(minus_5FSNo(x))) => (! [X9] : (c_In(X9,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(minus_5FSNo(x),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR_5F27)))))).
fof(c_Hmxye,axiom,(mul_5FSNo(minus_5FSNo(x),y) = c_SNoCut(c_5FL_5F27,c_5FR_5F27))).
fof(c_Hz,axiom,c_In(z,c_5FR)).
fof(c_Hze,axiom,(a = minus_5FSNo(z))).
fof(conj_hammer_test_8283,conjecture,(! [X8] : (c_In(X8,c_SNoL(x)) => (! [X9] : (c_In(X9,c_SNoR(y)) => ((z = add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9))))) => c_In(minus_5FSNo(z),c_5FL_5F27))))))).
