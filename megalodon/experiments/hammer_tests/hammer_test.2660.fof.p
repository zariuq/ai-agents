...
fof(c_H1,axiom,(! [X7] : (c_Subq(X7,c_5FX) => (equip(X7,ordsucc(n)) => c_In(c_5FC(X7),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X7] : (c_Subq(X7,c_5FX) & (? [X8] : (c_In(X8,ordsucc(c)) & (infinite(X7) & (! [X9] : (c_Subq(X9,X7) => (equip(X9,ordsucc(n)) => (c_5FC(X9) = X8)))))))))).
fof(c_L1,axiom,(! [X7] : (c_Subq(X7,c_5FX) => (infinite(X7) => (? [X8] : (c_Subq(X8,X7) & (? [X9] : (c_In(X9,X7) & ((nIn(X9,X8) & infinite(X8)) & (! [X10] : (c_Subq(X10,X8) => (equip(X10,n) => (c_5FC(binunion(X10,c_Sing(c_X9))) = c))))))))))))).
fof(c_H,axiom,((! [X7] : (nat_5Fp(X7) => (c_Subq(f_5F27(X7),c_5FX) & infinite(f_5F27(X7))))) & (! [X7] : (c_In(X7,omega) => (! [X8] : (c_In(X8,omega) => (c_Subq(X7,X8) => c_Subq(f_5F27(X8),f_5F27(c_X7))))))))).
fof(c_Hf_271,axiom,(! [X7] : (nat_5Fp(X7) => (c_Subq(f_5F27(X7),c_5FX) & infinite(f_5F27(X7)))))).
fof(c_Hgf_27mm_27Subq,axiom,(! [X7] : (c_In(X7,omega) => (! [X8] : (c_In(X8,omega) => (c_Subq(X7,X8) => c_Subq(f_5F27(X8),f_5F27(c_X7)))))))).
fof(c_Lf_271,axiom,(! [X7] : (nat_5Fp(X7) => (c_Subq(f_5F27(X7),c_5FX) & infinite(f_5F27(X7)))))).
fof(c_Lgf_27mm_27addSubq,axiom,(! [X7] : (c_In(X7,omega) => (! [X8] : (nat_5Fp(X8) => c_Subq(f_5F27(add_5Fnat(c_X7,X8)),f_5F27(c_X7))))))).
fof(c_Lgf_27mm_27Subq,axiom,(! [X7] : (c_In(X7,omega) => (! [X8] : (c_In(X8,omega) => (c_Subq(X7,X8) => c_Subq(f_5F27(X8),f_5F27(c_X7)))))))).
fof(c_HYSn,axiom,equip(c_5FY,ordsucc(n))).
fof(c_H,axiom,((! [X7] : (c_In(X7,ordsucc(n)) => c_In(h(X7),c_5FY))) & (! [X7] : (c_In(X7,ordsucc(n)) => (! [X8] : (c_In(X8,ordsucc(n)) => ((h(c_X7) = h(X8)) => (X7 = X8)))))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_5FY) => (? [X8] : (c_In(X8,ordsucc(n)) & (h(X8) = X7)))))).
fof(c_Hh1,axiom,(! [X7] : (c_In(X7,ordsucc(n)) => c_In(h(X7),c_5FY)))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,ordsucc(n)) => (! [X8] : (c_In(X8,ordsucc(n)) => ((h(c_X7) = h(X8)) => (X7 = X8))))))).
fof(conj_hammer_test_2660,conjecture,c_In(h(n),c_5FY)).
