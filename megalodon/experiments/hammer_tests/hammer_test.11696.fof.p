...
fof(c_H2,axiom,c_In(n,v)).
fof(c_Hguv,axiom,(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),f(binintersect(u,c_SNoElts_5F(n)))) = f(binintersect(v,c_SNoElts_5F(n))))).
fof(conj_hammer_test_11696,conjecture,c_SNoLt(f(binintersect(v,c_SNoElts_5F(n))),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
