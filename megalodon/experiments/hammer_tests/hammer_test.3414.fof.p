...
fof(c__5F,axiom,(! [X6] : (c_In(X6,alpha) => c_TransSet(X6)))).
fof(c_H1,axiom,(! [X6] : (c_In(X6,alpha) => c_In(ordsucc(X6),alpha)))).
fof(c_Hb,axiom,c_In(beta,alpha)).
fof(c_Lb,axiom,ordinal(beta)).
fof(c_Lsb,axiom,ordinal(ordsucc(beta))).
fof(c_Lsba,axiom,c_In(ordsucc(beta),alpha)).
fof(c_Hc,axiom,c_In(gamma,binintersect(beta,alpha))).
fof(c_Hc2,axiom,c_In(gamma,beta)).
fof(c_Hc1,axiom,c_In(gamma,alpha)).
fof(c_H6,axiom,~ q(gamma)).
fof(c_Lc,axiom,ordinal(gamma)).
fof(c_Lsc,axiom,ordinal(ordsucc(gamma))).
fof(c_Lsca,axiom,c_In(ordsucc(gamma),alpha)).
fof(conj_hammer_test_3414,conjecture,c_In(gamma,beta)).
