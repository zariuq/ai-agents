...
fof(c_HC,axiom,((! [X4] : (c_In(X4,c_5FL) => c_SNo(X4))) & (! [X4] : (c_In(X4,c_5FR) => c_SNo(X4))))).
fof(c_HL,axiom,(! [X4] : (c_In(X4,c_5FL) => c_SNo(X4)))).
fof(c_HR,axiom,(! [X4] : (c_In(X4,c_5FR) => c_SNo(X4)))).
fof(c_HLR,axiom,(! [X4] : (c_In(X4,c_5FL) => (! [X5] : (c_In(X5,c_5FR) => c_SNoLt(X4,X5)))))).
fof(c_LNoC,axiom,c_SNo(c_SNoCut(c_5FL,c_5FR))).
fof(c_LLC,axiom,ordinal(c_SNoLev(c_SNoCut(c_5FL,c_5FR)))).
fof(c_LL,axiom,(! [X4] : (c_In(X4,c_5FL) => c_SNoLt(X4,c_SNoCut(c_5FL,c_5FR))))).
fof(c_LR,axiom,(! [X4] : (c_In(X4,c_5FR) => c_SNoLt(c_SNoCut(c_5FL,c_5FR),X4)))).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_H10,axiom,(! [X4] : (c_In(X4,c_5FL) => c_SNoLt(X4,z)))).
fof(c_H11,axiom,(! [X4] : (c_In(X4,c_5FR) => c_SNoLt(z,X4)))).
...
fof(c_H10,axiom,(c_In(delta,z) & ~ (delta = delta))).
fof(conj_hammer_test_4414,conjecture,$false).
