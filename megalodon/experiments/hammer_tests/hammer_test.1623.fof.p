...
fof(conj_hammer_test_1623,conjecture,(! [X2] : (nat_5Fp(X2) => ((mul_5Fnat(n,add_5Fnat(m,X2)) = add_5Fnat(mul_5Fnat(n,m),mul_5Fnat(n,X2))) => (mul_5Fnat(n,add_5Fnat(m,ordsucc(X2))) = add_5Fnat(mul_5Fnat(n,m),mul_5Fnat(n,ordsucc(X2)))))))).
