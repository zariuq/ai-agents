...
fof(c__5F,axiom,c_In(c_Empty,ordsucc(m))).
fof(conj_hammer_test_1668,conjecture,(c_In(ordsucc(c_Empty),ordsucc(c_Empty)) => c_In(ordsucc(m),mul_5Fnat(ordsucc(m),ordsucc(c_Empty))))).
