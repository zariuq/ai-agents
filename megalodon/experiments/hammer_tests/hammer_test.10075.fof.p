...
fof(c_HLRx1,axiom,(! [X12] : (c_In(X12,c_5FLx) => c_SNo(X12)))).
fof(c_HLRx2,axiom,(! [X12] : (c_In(X12,c_5FRx) => c_SNo(X12)))).
fof(c_HLRx3,axiom,(! [X12] : (c_In(X12,c_5FLx) => (! [X13] : (c_In(X13,c_5FRx) => c_SNoLt(X12,X13)))))).
fof(c_H,axiom,((! [X12] : (c_In(X12,c_5FLy) => c_SNo(X12))) & (! [X12] : (c_In(X12,c_5FRy) => c_SNo(X12))))).
fof(c_HLRy1,axiom,(! [X12] : (c_In(X12,c_5FLy) => c_SNo(X12)))).
fof(c_HLRy2,axiom,(! [X12] : (c_In(X12,c_5FRy) => c_SNo(X12)))).
fof(c_HLRy3,axiom,(! [X12] : (c_In(X12,c_5FLy) => (! [X13] : (c_In(X13,c_5FRy) => c_SNoLt(X12,X13)))))).
...
fof(c_Hz_27,axiom,c_In(z_5F27,c_5FRx)).
fof(c_Hz_27_27,axiom,c_In(z_5F27_5F27,c_5FRy)).
fof(c_Hz_271,axiom,c_SNo(z_5F27)).
fof(c_Hz_27_271,axiom,c_SNo(z_5F27_5F27)).
fof(c_Hz_272,axiom,c_SNoLt(x,z_5F27)).
fof(c_Hz_27_272,axiom,c_SNoLt(y,z_5F27_5F27)).
fof(c_Hwe,axiom,(w = add_5FSNo(mul_5FSNo(z_5F27,y),add_5FSNo(mul_5FSNo(x,z_5F27_5F27),minus_5FSNo(mul_5FSNo(z_5F27,z_5F27_5F27)))))).
fof(c_Hw_27,axiom,c_In(w_5F27,c_5FLx)).
fof(c_Hz_27_27_27,axiom,c_In(z_5F27_5F27_5F27,c_5FRy)).
fof(c_Hw_271,axiom,c_SNo(w_5F27)).
fof(c_Hz_27_27_271,axiom,c_SNo(z_5F27_5F27_5F27)).
fof(c_Hw_272,axiom,c_SNoLt(w_5F27,x)).
fof(c_Hz_27_27_272,axiom,c_SNoLt(y,z_5F27_5F27_5F27)).
fof(c_Hze,axiom,(z = add_5FSNo(mul_5FSNo(w_5F27,y),add_5FSNo(mul_5FSNo(x,z_5F27_5F27_5F27),minus_5FSNo(mul_5FSNo(w_5F27,z_5F27_5F27_5F27)))))).
fof(conj_hammer_test_10075,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(z_5F27,y),add_5FSNo(mul_5FSNo(x,z_5F27_5F27),mul_5FSNo(w_5F27,z_5F27_5F27_5F27))),add_5FSNo(mul_5FSNo(w_5F27,z_5F27_5F27_5F27),add_5FSNo(mul_5FSNo(z_5F27,z_5F27_5F27),mul_5FSNo(x,y))))).
