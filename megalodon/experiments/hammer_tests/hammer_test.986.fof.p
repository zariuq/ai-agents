...
fof(c_H1,axiom,(! [X2] : (c_In(X2,c_Power(c_5FA)) => c_In(c_5FF(X2),c_Power(c_5FA))))).
fof(c_H2,axiom,(! [X2] : (c_In(X2,c_Power(c_5FA)) => (! [X3] : (c_In(X3,c_Power(c_5FA)) => (c_Subq(X2,X3) => c_Subq(c_5FF(c_X2),c_5FF(X3)))))))).
fof(conj_hammer_test_986,conjecture,(? [X2] : (c_In(X2,c_Power(c_5FA)) & (c_5FF(X2) = X2)))).
