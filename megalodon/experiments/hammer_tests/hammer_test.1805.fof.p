...
fof(c_IHn,axiom,(! [X5] : (equip(X5,n) => equip(c_Power(X5),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
...
fof(c_L1,axiom,(? [X5] : c_In(X5,c_5FX))).
...
fof(c_H,axiom,((! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X5),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)))) & (! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X5) = f(X6)) => (X5 = X6)))))))).
fof(c_Hf1,axiom,(! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X5),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
fof(c_Hf2,axiom,(! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X5) = f(X6)) => (X5 = X6))))))).
fof(c_Hf3,axiom,(! [X5] : (c_In(X5,exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => (? [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) & (f(X6) = X5)))))).
fof(c_LfN,axiom,(! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => nat_5Fp(f(X5))))).
fof(c_HY,axiom,c_In(c_5FY,c_Power(c_5FX))).
fof(c_H2,axiom,c_In(x,c_5FY)).
fof(conj_hammer_test_1805,conjecture,c_In(setminus(c_5FY,c_Sing(x)),c_Power(setminus(c_5FX,c_Sing(x))))).
