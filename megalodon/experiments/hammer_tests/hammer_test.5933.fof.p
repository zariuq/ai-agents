...
fof(c_IHu2,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => c_SNoLt(add_5FSNo(X6,y),add_5FSNo(u,y))))).
fof(c_IHu3,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => c_SNoLt(add_5FSNo(u,y),add_5FSNo(X6,y))))).
fof(c_IHu4,axiom,(! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(u,X6),add_5FSNo(u,y))))).
fof(c_IHu5,axiom,(! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(u,y),add_5FSNo(u,X6))))).
...
fof(c_IHv2,axiom,(! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(add_5FSNo(X6,y),add_5FSNo(v,y))))).
fof(c_IHv3,axiom,(! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(add_5FSNo(v,y),add_5FSNo(X6,y))))).
fof(c_IHv4,axiom,(! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(v,X6),add_5FSNo(v,y))))).
fof(c_IHv5,axiom,(! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(v,y),add_5FSNo(v,X6))))).
fof(c_Luv,axiom,c_SNoLt(u,v)).
fof(conj_hammer_test_5933,conjecture,(c_In(c_SNoLev(u),c_SNoLev(v)) => (c_SNoEq_5F(c_SNoLev(u),u,v) => (c_In(c_SNoLev(u),v) => c_SNoLt(add_5FSNo(u,y),add_5FSNo(v,y)))))).
