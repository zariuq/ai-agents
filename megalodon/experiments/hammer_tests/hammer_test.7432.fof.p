...
fof(c_LLx,axiom,(! [X12] : (c_In(X12,c_SNoL(x)) => (! [X13] : (c_SNo(X13) => c_SNo(mul_5FSNo(X12,X13))))))).
fof(c_LRx,axiom,(! [X12] : (c_In(X12,c_SNoR(x)) => (! [X13] : (c_SNo(X13) => c_SNo(mul_5FSNo(X12,X13))))))).
fof(c_LLxy,axiom,(! [X12] : (c_In(X12,c_SNoL(x)) => c_SNo(mul_5FSNo(X12,y))))).
fof(c_LRxy,axiom,(! [X12] : (c_In(X12,c_SNoR(x)) => c_SNo(mul_5FSNo(X12,y))))).
fof(c_LxLy,axiom,(! [X12] : (c_In(X12,c_SNoL(y)) => c_SNo(mul_5FSNo(x,X12))))).
fof(c_LxRy,axiom,(! [X12] : (c_In(X12,c_SNoR(y)) => c_SNo(mul_5FSNo(x,X12))))).
...
fof(c_Hz,axiom,c_In(z,c_SNoL(y))).
fof(c_Hza,axiom,c_SNo(z)).
fof(c_Hzb,axiom,c_In(c_SNoLev(z),c_SNoLev(y))).
fof(c_Hzc,axiom,c_SNoLt(z,y)).
fof(c_Lu0z,axiom,c_SNo(mul_5FSNo(u0,z))).
fof(c_Lv0z,axiom,c_SNo(mul_5FSNo(v0,z))).
fof(c_Hwv0,axiom,c_In(w,c_SNoL(v0))).
fof(c_Hwu0,axiom,c_In(w,c_SNoR(u0))).
fof(c_Hwu0a,axiom,c_SNo(w)).
fof(c_Hwu0b,axiom,c_In(c_SNoLev(w),c_SNoLev(u0))).
fof(c_Hwu0c,axiom,c_SNoLt(u0,w)).
fof(c_LLevwLevx,axiom,c_In(c_SNoLev(w),c_SNoLev(x))).
fof(c_LwSx,axiom,c_In(w,c_SNoS_5F(c_SNoLev(x)))).
fof(c_Lwz,axiom,c_SNo(mul_5FSNo(w,z))).
fof(c_Lwy,axiom,c_SNo(mul_5FSNo(w,y))).
fof(conj_hammer_test_7432,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,z)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,z)))).
