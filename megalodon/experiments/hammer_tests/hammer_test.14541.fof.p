...
fof(divides_5Fnat_5Fdivides_5Fint,axiom,(! [X0] : (! [X1] : (divides_5Fnat(X0,X1) => divides_5Fint(X0,X1))))). % 1066e5b74756a6b53d46017f8512aef92dc8e016c1a197eb26a748ea5260ecec
fof(divides_5Fint_5Fdivides_5Fnat,axiom,(! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,omega) => (divides_5Fint(X0,X1) => divides_5Fnat(X0,X1))))))). % 4355b135f65cb457ff72e939283dc22519534f2361ddb24a467bae98ac97ff1b
fof(divides_5Fint_5Fminus_5FSNo,axiom,(! [X0] : (! [X1] : (divides_5Fint(X0,X1) => divides_5Fint(X0,minus_5FSNo(X1)))))). % 135410a9039a3e963c9117977be5e244aa7c30024caedf6c031fa772ff7daf4e
fof(divides_5Fint_5Fmul_5FSNo_5FL,axiom,(! [X0] : (! [X1] : (! [X2] : (c_In(X2,int) => (divides_5Fint(X0,X1) => divides_5Fint(X0,mul_5FSNo(X1,X2)))))))). % 46ab4b8975c460b038632b50176539c99c0d436e7e408eb922b05e8bd379191e
fof(divides_5Fint_5Fmul_5FSNo_5FR,axiom,(! [X0] : (! [X1] : (! [X2] : (c_In(X2,int) => (divides_5Fint(X0,X1) => divides_5Fint(X0,mul_5FSNo(X2,X1)))))))). % b1ea46803bdb77e7492ff9bf9d93d999296b4e7ade8729dc9357d2338a78adb9
fof(divides_5Fint_5F1,axiom,(! [X0] : (c_In(X0,int) => divides_5Fint(ordsucc(c_Empty),X0)))). % 9b81753befa26a9fdaa95812834981c95a48185b510c7e70c745719bee4aebf9
fof(divides_5Fint_5Fpos_5FLe,axiom,(! [X0] : (! [X1] : (divides_5Fint(X0,X1) => (c_SNoLt(c_Empty,X1) => c_SNoLe(X0,X1)))))). % 60ef83f823a1578e4fccb08a43f4baa2fc8d3666f59b07fb085101193613310c
fof(gcd_5Freln,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : (gcd_5Freln(c_X0,c_X1,c_X2) <=> ((divides_5Fint(c_X2,c_X0) & divides_5Fint(c_X2,c_X1)) & (! [X3] : (divides_5Fint(X3,c_X0) => (divides_5Fint(X3,c_X1) => c_SNoLe(X3,c_X2)))))))))). % cabb2e5877aa0d0224ff2032620989bcd7d3b5fc276da8c7d81ed0c99a4026e5
fof(gcd_5Freln_5Funiq,axiom,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (gcd_5Freln(X0,X1,X2) => (gcd_5Freln(X0,X1,X3) => (X2 = X3)))))))). % 96cc8a71fa111385ad1e7deaf04fdb441b1a0f261201217bfc55fbfb48780f3b
fof(int_5Flin_5Fcomb,axiom,(! [X0:$i] : (! [X1:$i] : (! [X2:$i] : (int_5Flin_5Fcomb(c_X0,c_X1,c_X2) <=> (((c_In(c_X0,int) & c_In(c_X1,int)) & c_In(c_X2,int)) & (? [X3] : (c_In(X3,int) & (? [X4] : (c_In(X4,int) & (add_5FSNo(mul_5FSNo(X3,c_X0),mul_5FSNo(X4,c_X1)) = c_X2))))))))))). % 98cc47d45e63357147c24ddd21e6ba5a9fcbbaad5c13bd9da6b828fb66a96fee
fof(int_5Flin_5Fcomb_5FI,axiom,(! [X0] : (c_In(X0,int) => (! [X1] : (c_In(X1,int) => (! [X2] : (c_In(X2,int) => ((? [X3] : (c_In(X3,int) & (? [X4] : (c_In(X4,int) & (add_5FSNo(mul_5FSNo(X3,X0),mul_5FSNo(X4,X1)) = X2))))) => int_5Flin_5Fcomb(X0,X1,X2))))))))). % f555a053b80383d854ea8042e47c39fecf934f07f46f3d0cb0c9afe2552cc883
fof(int_5Flin_5Fcomb_5FE1,axiom,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => c_In(X0,int)))))). % b7d1f411e8c51b862d01dc046a06e0be9b9aa6b26acd274dc2cbbde802f349d7
fof(int_5Flin_5Fcomb_5FE2,axiom,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => c_In(X1,int)))))). % b1fe5e6d7b54ab7bba993808ca45d97ee454392999eba620e5a34a2cde850458
fof(int_5Flin_5Fcomb_5FE3,axiom,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => c_In(X2,int)))))). % c67bbc4b97f8268d169d51f21b069c7a6e4ea02eb347d45275ef25008e34a7b1
fof(least_5Fpos_5Fint_5Flin_5Fcomb_5Fex,axiom,(! [X0] : (c_In(X0,int) => (! [X1] : (c_In(X1,int) => (~ ((X0 = c_Empty) & (X1 = c_Empty)) => (? [X2] : ((int_5Flin_5Fcomb(X0,X1,X2) & c_SNoLt(c_Empty,X2)) & (! [X3] : (int_5Flin_5Fcomb(X0,X1,X3) => (c_SNoLt(c_Empty,X3) => c_SNoLe(X2,X3)))))))))))). % f531a8b9bd483ab6bc44e3769d839821943b014bd37afa8fb03a1046cfeaad33
fof(int_5Flin_5Fcomb_5Fsym,axiom,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => int_5Flin_5Fcomb(X1,X0,X2)))))). % c81d1b592c254d9f1cdb15f96ecfd1086d784c61a2837340647ffec0896304a3
fof(least_5Fpos_5Fint_5Flin_5Fcomb_5Fdivides_5Fint,axiom,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => (c_SNoLt(c_Empty,X2) => ((! [X3] : (int_5Flin_5Fcomb(X0,X1,X3) => (c_SNoLt(c_Empty,X3) => c_SNoLe(X2,X3)))) => divides_5Fint(X2,X0)))))))). % b6508562cdd1d971e555ae846efe1e92d8dcd329fba6e68ad0a2812575a88f0e
fof(least_5Fpos_5Fint_5Flin_5Fcomb_5Fgcd,axiom,(! [X0] : (! [X1] : (! [X2] : (int_5Flin_5Fcomb(X0,X1,X2) => (c_SNoLt(c_Empty,X2) => ((! [X3] : (int_5Flin_5Fcomb(X0,X1,X3) => (c_SNoLt(c_Empty,X3) => c_SNoLe(X2,X3)))) => gcd_5Freln(X0,X1,X2)))))))). % 9c92242b9ce54c9ef3cc12eecd57176fdbc7e8f0e3e54883cd522ff85db40c29
fof(c_BezoutThm,axiom,(! [X0] : (c_In(X0,int) => (! [X1] : (c_In(X1,int) => (~ ((X0 = c_Empty) & (X1 = c_Empty)) => (! [X2] : (gcd_5Freln(X0,X1,X2) <=> ((int_5Flin_5Fcomb(X0,X1,X2) & c_SNoLt(c_Empty,X2)) & (! [X3] : (int_5Flin_5Fcomb(X0,X1,X3) => (c_SNoLt(c_Empty,X3) => c_SNoLe(X2,X3))))))))))))). % f5d44fcc29c381da8a220db80673272a527ae1f219b7711badba7726d87b94ff
fof(gcd_5Fid,axiom,(! [X0] : (c_In(X0,setminus(omega,c_Sing(c_Empty))) => gcd_5Freln(X0,X0,X0)))). % 0ccc9955020118508dbc47a9933b4a7405afadc20bcda403b24207c21a01c1d2
fof(gcd_5F0,axiom,(! [X0] : (c_In(X0,setminus(omega,c_Sing(c_Empty))) => gcd_5Freln(c_Empty,X0,X0)))). % e79b638d658916e30616d2eacbc1e569b2364ce1f1bd9f652f2b3e033a23f98e
fof(gcd_5Fsym,axiom,(! [X0] : (! [X1] : (! [X2] : (gcd_5Freln(X0,X1,X2) => gcd_5Freln(X1,X0,X2)))))). % 707a60875f9a88bbbf90f968ceb7923fd268981ee1e0bff9693ac2338dbae05d
fof(gcd_5Fminus,axiom,(! [X0] : (! [X1] : (! [X2] : (gcd_5Freln(X0,X1,X2) => gcd_5Freln(X0,minus_5FSNo(X1),X2)))))). % 139a96e3dce0f205fe1880ace019891e2eece84b74540bf58fa1307e530bbcab
fof(euclidean_5Falgorithm_5Fprop_5F1,axiom,(! [X0] : (! [X1] : (! [X2] : (c_In(X1,int) => (gcd_5Freln(X0,add_5FSNo(X1,minus_5FSNo(X0)),X2) => gcd_5Freln(X0,X1,X2))))))). % 045095b28c744fb9b1923c240eeb5cf238ebca4d74fd2708caaeb3d32184d26b
fof(euclidean_5Falgorithm,axiom,(((((((! [X0] : (c_In(X0,setminus(omega,c_Sing(c_Empty))) => gcd_5Freln(X0,X0,X0))) & (! [X0] : (c_In(X0,setminus(omega,c_Sing(c_Empty))) => gcd_5Freln(c_Empty,X0,X0)))) & (! [X0] : (c_In(X0,setminus(omega,c_Sing(c_Empty))) => gcd_5Freln(X0,c_Empty,X0)))) & (! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,omega) => (c_SNoLt(X0,X1) => (! [X2] : (gcd_5Freln(X0,add_5FSNo(X1,minus_5FSNo(X0)),X2) => gcd_5Freln(X0,X1,X2))))))))) & (! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,omega) => (c_SNoLt(X1,X0) => (! [X2] : (gcd_5Freln(X1,X0,X2) => gcd_5Freln(X0,X1,X2))))))))) & (! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,int) => (c_SNoLt(X1,c_Empty) => (! [X2] : (gcd_5Freln(X0,minus_5FSNo(X1),X2) => gcd_5Freln(X0,X1,X2))))))))) & (! [X0] : (c_In(X0,int) => (! [X1] : (c_In(X1,int) => (c_SNoLt(X0,c_Empty) => (! [X2] : (gcd_5Freln(minus_5FSNo(X0),X1,X2) => gcd_5Freln(X0,X1,X2)))))))))). % 7c16d1dd926ecde47066b549e246e1a74435fe26d9c4698ef7de4dc0b14fdb36
fof(c_Euclid_5Flemma,axiom,(! [X0] : (prime_5Fnat(X0) => (! [X1] : (c_In(X1,int) => (! [X2] : (c_In(X2,int) => (divides_5Fint(X0,mul_5FSNo(X1,X2)) => (divides_5Fint(X0,X1) | divides_5Fint(X0,X2)))))))))). % 02e258e10b600a45dc0d4230ab786953cc2bab29c6c7f98ab14bb2321aab86b7
fof(prime_5Fnot_5Fdivides_5Fint_5F1,axiom,(! [X0] : (prime_5Fnat(X0) => ~ divides_5Fint(X0,ordsucc(c_Empty))))). % 5319e4a2ec448f60c83212e401df68da8e43e36922e4be28fb6f8aae48c62463
fof(divides_5Fint_5Fprime_5Fnat_5Feq,axiom,(! [X0] : (! [X1] : (prime_5Fnat(X0) => (prime_5Fnat(X1) => (divides_5Fint(X0,X1) => (X0 = X1))))))). % 0c5aaeddcd13c11877d63144411104af09fbc4ee2f47b38b163445e349b2cb5a
fof(divides_5Fnat_5Fmul_5FSNo_5FR,axiom,(! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,omega) => divides_5Fnat(X0,mul_5FSNo(X0,X1))))))). % 0cec36ace97bf291154f357960bf73e5150d89b20bd0f7bd65e89e9b84af7ec9
fof(divides_5Fnat_5Fmul_5FSNo_5FL,axiom,(! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,omega) => divides_5Fnat(X1,mul_5FSNo(X0,X1))))))). % be1c69e651805c5a3df1dd99b71f896d501c03c28afd88d0e8ae2801224cd428
fof(exp_5FSNo_5Fnat_5F0,axiom,(! [X0] : (c_SNo(X0) => (exp_5FSNo_5Fnat(X0,c_Empty) = ordsucc(c_Empty))))). % 0cce75eb9dc3a78ea5ae1dffbb0d90bb8fb0a5c6185009a65844a32a18691c25
fof(exp_5FSNo_5Fnat_5FS,axiom,(! [X0] : (c_SNo(X0) => (! [X1] : (nat_5Fp(X1) => (exp_5FSNo_5Fnat(X0,ordsucc(X1)) = mul_5FSNo(X0,exp_5FSNo_5Fnat(X0,X1)))))))). % a3cfdc34163db454184b968ef9b60d6306842eaf811785f876e8fbdee04e40d6
fof(exp_5FSNo_5Fnat_5F1,axiom,(! [X0] : (c_SNo(X0) => (exp_5FSNo_5Fnat(X0,ordsucc(c_Empty)) = X0)))). % 997c968e1650d101db21903d1f486413f089be3f10a86e875ede3494e6d71f9f
fof(c_SNo_5Fexp_5FSNo_5Fnat,axiom,(! [X0] : (c_SNo(X0) => (! [X1] : (nat_5Fp(X1) => c_SNo(exp_5FSNo_5Fnat(X0,X1))))))). % 2e79ac0134c4519c3c403c840111ca4605aa24474fff41703f5f21e0e974a9aa
fof(nat_5Fexp_5FSNo_5Fnat,axiom,(! [X0] : (nat_5Fp(X0) => (! [X1] : (nat_5Fp(X1) => nat_5Fp(exp_5FSNo_5Fnat(X0,X1))))))). % 7d739161dcd379b15f3b4bcd25ad170a966c1f55a5348cae88df439fa89fd539
fof(eps_5Fordsucc_5Fhalf_5Fadd,axiom,(! [X0] : (nat_5Fp(X0) => (add_5FSNo(eps_5F(ordsucc(X0)),eps_5F(ordsucc(X0))) = eps_5F(X0))))). % 9353dc5eb19fa58e0b9b6121e3482422e5772fc159bae1d3205bc38d22809d9b
fof(eps_5F1_5Fhalf_5Feq1,axiom,(add_5FSNo(eps_5F(ordsucc(c_Empty)),eps_5F(ordsucc(c_Empty))) = ordsucc(c_Empty))). % c1c058d5e176b92c4082bec2d2a9a79ffd9ec43c623ba0c1d92596e1ad67e4d5
fof(eps_5F1_5Fhalf_5Feq2,axiom,(mul_5FSNo(ordsucc(ordsucc(c_Empty)),eps_5F(ordsucc(c_Empty))) = ordsucc(c_Empty))). % 30142c2c97f49aca9c8cb711d73dd46a754dfc3097ace3ccdf17d0c58001a9d4
fof(double_5Feps_5F1,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => ((add_5FSNo(X0,X0) = add_5FSNo(X1,X2)) => (X0 = mul_5FSNo(eps_5F(ordsucc(c_Empty)),add_5FSNo(X1,X2))))))))))). % d3bd2dbcace8d873bf4f639573dd48ab2ea4ceec4fca017e16748c3feb82ac1b
fof(exp_5FSNo_5F1_5Fbd,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLe(ordsucc(c_Empty),X0) => (! [X1] : (nat_5Fp(X1) => c_SNoLe(ordsucc(c_Empty),exp_5FSNo_5Fnat(X0,X1)))))))). % 55832e79849892be081902459e8ea4f0d07c1480d0e2c8b5d13891021f8ee65e
fof(exp_5FSNo_5F2_5Fbd,axiom,(! [X0] : (nat_5Fp(X0) => c_SNoLt(X0,exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),X0))))). % a37776daef371597ac410712ce7f9f8a5f2277d4af43d40744c340ac37dc35bf
fof(mul_5FSNo_5Feps_5Fpower_5F2,axiom,(! [X0] : (nat_5Fp(X0) => (mul_5FSNo(eps_5F(X0),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),X0)) = ordsucc(c_Empty))))). % 7349fd5f3f2a711d3ec85914c0738b80b9761d82bb17f31f66c219d8c95620c2
fof(eps_5Fbd_5F1,axiom,(! [X0] : (c_In(X0,omega) => c_SNoLe(eps_5F(X0),ordsucc(c_Empty))))). % 61dce1209a8076f1d6f63cd6eed96f4cd7b173bf99e49f0c8aee0c03a4bc2543
fof(mul_5FSNo_5Feps_5Fpower_5F2_27,axiom,(! [X0] : (nat_5Fp(X0) => (mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),X0),eps_5F(X0)) = ordsucc(c_Empty))))). % e3d153731a59188adbfab1f431dffe6ba0bb50c7a035cd102c00eb8c5ebe4231
fof(exp_5FSNo_5Fnat_5Fmul_5Fadd,axiom,(! [X0] : (c_SNo(X0) => (! [X1] : (nat_5Fp(X1) => (! [X2] : (nat_5Fp(X2) => (mul_5FSNo(exp_5FSNo_5Fnat(X0,X1),exp_5FSNo_5Fnat(X0,X2)) = exp_5FSNo_5Fnat(X0,add_5FSNo(X1,X2)))))))))). % 4247e74faaf2853e99d353c548378fc8262d5d25b2bda4d387d8b19c672507d1
fof(exp_5FSNo_5Fnat_5Fmul_5Fadd_27,axiom,(! [X0] : (c_SNo(X0) => (! [X1] : (c_In(X1,omega) => (! [X2] : (c_In(X2,omega) => (mul_5FSNo(exp_5FSNo_5Fnat(X0,X1),exp_5FSNo_5Fnat(X0,X2)) = exp_5FSNo_5Fnat(X0,add_5FSNo(X1,X2)))))))))). % e2ea0bc3b7c086a893a4693af2ba5bb0c23d125e8851efb8d7bbebd5d9cd0569
fof(exp_5FSNo_5Fnat_5Fpos,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (! [X1] : (nat_5Fp(X1) => c_SNoLt(c_Empty,exp_5FSNo_5Fnat(X0,X1)))))))). % 60cb7dbd0d34891942701384d4b0ae300e59658bfc6660a91a4b2dbc54eccf08
fof(mul_5FSNo_5Feps_5Feps_5Fadd_5FSNo,axiom,(! [X0] : (c_In(X0,omega) => (! [X1] : (c_In(X1,omega) => (mul_5FSNo(eps_5F(X0),eps_5F(X1)) = eps_5F(add_5FSNo(X0,X1)))))))). % 8321ba3053191c5e0a1bf6351c7b35cb7c4cc78269d90ac7092260a3f08e81ae
fof(c_SNoS_5Ffinite,axiom,(! [X0] : (c_In(X0,omega) => finite(c_SNoS_5F(X0))))). % 667fce2a83f91722dd4948666a9e0c01fa478a13f690863a65d197c4c2fdfc2b
fof(c_SNoS_5Fomega_5FSNoL_5Ffinite,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => finite(c_SNoL(X0))))). % a18e6ec778a639677183587585d2495cd4c1316102b5dcfb44b0777e64ccd8bf
fof(c_SNoS_5Fomega_5FSNoR_5Ffinite,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => finite(c_SNoR(X0))))). % fb21137fa1fe2812f4d156e228cce1485cb000a8bd7ce8411afcca163c393271
fof(c_SNo_5Fmax_5Fof,axiom,(! [X0:$i] : (! [X1:$i] : (c_SNo_5Fmax_5Fof(c_X0,c_X1) <=> ((c_In(c_X1,c_X0) & c_SNo(c_X1)) & (! [X2] : (c_In(X2,c_X0) => (c_SNo(X2) => c_SNoLe(X2,c_X1))))))))). % d0d2bab5bec1b01114c5a666525127b2277b5d0dfd077db28064bc5de6e0307c
fof(c_SNo_5Fmin_5Fof,axiom,(! [X0:$i] : (! [X1:$i] : (c_SNo_5Fmin_5Fof(c_X0,c_X1) <=> ((c_In(c_X1,c_X0) & c_SNo(c_X1)) & (! [X2] : (c_In(X2,c_X0) => (c_SNo(X2) => c_SNoLe(c_X1,X2))))))))). % 40f47924a1c2c540d43c739db83802689c2dd8fe91b5277b7ee16229de2ef804
fof(double_5FSNo_5Fmax_5F1,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo_5Fmax_5Fof(c_SNoL(X0),X1) => (! [X2] : (c_SNo(X2) => (c_SNoLt(X0,X2) => (c_SNoLt(add_5FSNo(X1,X2),add_5FSNo(X0,X0)) => (? [X3] : (c_In(X3,c_SNoR(X2)) & (add_5FSNo(X1,X3) = add_5FSNo(X0,X0))))))))))))). % 2cd8d67381d6ee41b5b22983735bb7eb80d99906ca5ead0b42a029749776cf6a
fof(double_5FSNo_5Fmin_5F1,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo_5Fmin_5Fof(c_SNoR(X0),X1) => (! [X2] : (c_SNo(X2) => (c_SNoLt(X2,X0) => (c_SNoLt(add_5FSNo(X0,X0),add_5FSNo(X1,X2)) => (? [X3] : (c_In(X3,c_SNoL(X2)) & (add_5FSNo(X1,X3) = add_5FSNo(X0,X0))))))))))))). % 8d81076df5b593fa790a41dbd350d09a5a01ce84bc6c8b7ec039c405e0130a6a
fof(finite_5Fmax_5Fexists,axiom,(! [X0] : ((! [X1] : (c_In(X1,X0) => c_SNo(X1))) => (finite(X0) => (~ (X0 = c_Empty) => (? [X1] : c_SNo_5Fmax_5Fof(X0,X1))))))). % e3b4c51f4c692dc9a63a766658ca9b360b25490f3dde7bf0b7e42d493a3bb91b
fof(finite_5Fmin_5Fexists,axiom,(! [X0] : ((! [X1] : (c_In(X1,X0) => c_SNo(X1))) => (finite(X0) => (~ (X0 = c_Empty) => (? [X1] : c_SNo_5Fmin_5Fof(X0,X1))))))). % 25079c0f4bdcc41ac859aac6b60ccbe287141721b42aaa6d1f05e0e631d61df1
fof(c_SNoS_5Fomega_5FSNoL_5Fmax_5Fexists,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => ((c_SNoL(X0) = c_Empty) | (? [X1] : c_SNo_5Fmax_5Fof(c_SNoL(X0),X1)))))). % 9f10713bfea1db2aa4a34561a699a14a26f3989639effdf2611a8a0abe92b183
fof(c_SNoS_5Fomega_5FSNoR_5Fmin_5Fexists,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => ((c_SNoR(X0) = c_Empty) | (? [X1] : c_SNo_5Fmin_5Fof(c_SNoR(X0),X1)))))). % 9b79bda4b3ccdb07b0944594e850398bb098c0cfe236524574f794a63c15ef50
fof(nonneg_5Fdiadic_5Frational_5Fp_5FSNoS_5Fomega,axiom,(! [X0] : (c_In(X0,omega) => (! [X1] : (nat_5Fp(X1) => c_In(mul_5FSNo(eps_5F(X0),X1),c_SNoS_5F(omega))))))). % 4a1d1240a0652204ef32024452be152e50073561aab4e37093e7de79f31d0281
fof(diadic_5Frational_5Fp,axiom,(! [X0:$i] : (diadic_5Frational_5Fp(c_X0) <=> (? [X1] : (c_In(X1,omega) & (? [X2] : (c_In(X2,int) & (c_X0 = mul_5FSNo(eps_5F(X1),X2))))))))). % 62c4a99438162b47740f55abb9c751741db76e9023d39f3ee5b117fbb7fd3157
fof(diadic_5Frational_5Fp_5FSNoS_5Fomega,axiom,(! [X0] : (diadic_5Frational_5Fp(X0) => c_In(X0,c_SNoS_5F(omega))))). % 1eefe50c1f8ee6c80e6f2670f1f7628cb103928c4f88bd54ff2d1d3224958c0a
fof(int_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (c_In(X0,int) => diadic_5Frational_5Fp(X0)))). % e4ffa5d606db6d7a1b05345232c86ceb84fa88934626f9192b1474c2c6f1a16f
fof(omega_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (c_In(X0,omega) => diadic_5Frational_5Fp(X0)))). % 44ea65965cf1ec5edde65df99a37770461aa983e85233f1e6b621637a0740270
fof(eps_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (c_In(X0,omega) => diadic_5Frational_5Fp(eps_5F(X0))))). % adb1a7e9fe578cb69dc711f51d248ff931e50de2d3012b538c17e772519ca5eb
fof(minus_5FSNo_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (diadic_5Frational_5Fp(X0) => diadic_5Frational_5Fp(minus_5FSNo(X0))))). % 103f4e2a8c1e2afc04e88cf4c1659ad655c3a0d29e6ca80497699a1a710a39fb
fof(mul_5FSNo_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (! [X1] : (diadic_5Frational_5Fp(X0) => (diadic_5Frational_5Fp(X1) => diadic_5Frational_5Fp(mul_5FSNo(X0,X1))))))). % 380eac81f95fc823d6629dc0cc19d9dbc365e040e943368e6ee60683126aef2b
fof(add_5FSNo_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (! [X1] : (diadic_5Frational_5Fp(X0) => (diadic_5Frational_5Fp(X1) => diadic_5Frational_5Fp(add_5FSNo(X0,X1))))))). % e2d5a970bb134cba17aa90649831cc63fc080cc56ca2e2075d03fdf47c90b055
fof(c_SNoS_5Fomega_5Fdiadic_5Frational_5Fp_5Flem,axiom,(! [X0] : (nat_5Fp(X0) => (! [X1] : (c_SNo(X1) => ((c_SNoLev(X1) = X0) => diadic_5Frational_5Fp(X1))))))). % 5559a8ce487ef2b862a8f548da752a7baf522d4389f18800f71133426b3b90fc
fof(c_SNoS_5Fomega_5Fdiadic_5Frational_5Fp,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => diadic_5Frational_5Fp(X0)))). % e90456168493501f12432e697a805a2847bf2527ad12920d059f1798863a238e
fof(mul_5FSNo_5FSNoS_5Fomega,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => (! [X1] : (c_In(X1,c_SNoS_5F(omega)) => c_In(mul_5FSNo(X0,X1),c_SNoS_5F(omega))))))). % 02e38731e1969be064ff03cdd9445fc15ba5f1dc4fd1c13b9e60065a653ecd12
fof(c_SNo_5Frecip_5Fpos_5Fpos,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => (c_SNoLt(c_Empty,X0) => ((mul_5FSNo(X0,X1) = ordsucc(c_Empty)) => c_SNoLt(c_Empty,X1)))))))). % 3c36532382f8e8b72f6c1b9600f87ee471862055a8e57bfcdb1ac804d9449554
fof(c_SNo_5Frecip_5Flem1,axiom,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (c_In(X1,c_SNoL_5Fpos(X0)) => (c_SNo(X2) => ((mul_5FSNo(X1,X2) = ordsucc(c_Empty)) => (c_SNo(X3) => (c_SNoLt(mul_5FSNo(X0,X3),ordsucc(c_Empty)) => (c_SNo(X4) => ((add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X4))) = mul_5FSNo(add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X3))),mul_5FSNo(add_5FSNo(X1,minus_5FSNo(X0)),X2))) => c_SNoLt(ordsucc(c_Empty),mul_5FSNo(X0,X4))))))))))))))))). % c9f4929648138fddc5344f6b2782cbd5426c2e157558dca2b2dbafec063e33c5
fof(c_SNo_5Frecip_5Flem2,axiom,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (c_In(X1,c_SNoL_5Fpos(X0)) => (c_SNo(X2) => ((mul_5FSNo(X1,X2) = ordsucc(c_Empty)) => (c_SNo(X3) => (c_SNoLt(ordsucc(c_Empty),mul_5FSNo(X0,X3)) => (c_SNo(X4) => ((add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X4))) = mul_5FSNo(add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X3))),mul_5FSNo(add_5FSNo(X1,minus_5FSNo(X0)),X2))) => c_SNoLt(mul_5FSNo(X0,X4),ordsucc(c_Empty))))))))))))))))). % f9811a25bee6736a81f323e8389e547b9ea4c52ba240550b1e7d2ec8a64b3b14
fof(c_SNo_5Frecip_5Flem3,axiom,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (c_In(X1,c_SNoR(X0)) => (c_SNo(X2) => ((mul_5FSNo(X1,X2) = ordsucc(c_Empty)) => (c_SNo(X3) => (c_SNoLt(mul_5FSNo(X0,X3),ordsucc(c_Empty)) => (c_SNo(X4) => ((add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X4))) = mul_5FSNo(add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X3))),mul_5FSNo(add_5FSNo(X1,minus_5FSNo(X0)),X2))) => c_SNoLt(mul_5FSNo(X0,X4),ordsucc(c_Empty))))))))))))))))). % cc49f5921059428b9481c597a3dc6f8d4c52561e72ae5ecf4b9d120499aaf1cf
fof(c_SNo_5Frecip_5Flem4,axiom,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (c_In(X1,c_SNoR(X0)) => (c_SNo(X2) => ((mul_5FSNo(X1,X2) = ordsucc(c_Empty)) => (c_SNo(X3) => (c_SNoLt(ordsucc(c_Empty),mul_5FSNo(X0,X3)) => (c_SNo(X4) => ((add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X4))) = mul_5FSNo(add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(X0,X3))),mul_5FSNo(add_5FSNo(X1,minus_5FSNo(X0)),X2))) => c_SNoLt(ordsucc(c_Empty),mul_5FSNo(X0,X4))))))))))))))))). % 083ddb1b36bd78646a442da380f0450a7f37c3cad99fa785b616e04003e468f7
fof(recip_5FSNo_5Fpos_5Fprop1,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (c_SNo(recip_5FSNo_5Fpos(X0)) & (mul_5FSNo(X0,recip_5FSNo_5Fpos(X0)) = ordsucc(c_Empty))))))). % 19c72814f56032bb3f6136dcfef517094d7902c46129450673b3b65e7e4a3736
fof(c_SNo_5Frecip_5FSNo_5Fpos,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => c_SNo(recip_5FSNo_5Fpos(X0)))))). % 6c0c89dfabca9507e317ff17e2ff51cedac67089a504a118a81146ed4ef50bb7
fof(recip_5FSNo_5Fpos_5FinvR,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (mul_5FSNo(X0,recip_5FSNo_5Fpos(X0)) = ordsucc(c_Empty)))))). % 3f0d7d35089af1e3d749c8cafb3fd92399b27e55a9ea5b11821d5c369b2d0cbf
fof(recip_5FSNo_5Fpos_5Fis_5Fpos,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => c_SNoLt(c_Empty,recip_5FSNo_5Fpos(X0)))))). % 781a46c0be55332e136c75e0f11f520a64d3ac28e99005e625175d2a9d5bd130
fof(recip_5FSNo_5Fpos_5Finvol,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => (recip_5FSNo_5Fpos(recip_5FSNo_5Fpos(X0)) = X0))))). % 3b8acd6fe7609dde4cf07e25f2cd3af9b4d7ca51710cc5623d21cf378bf5bccb
fof(recip_5FSNo_5Fpos_5Feps_5F,axiom,(! [X0] : (nat_5Fp(X0) => (recip_5FSNo_5Fpos(eps_5F(X0)) = exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),X0))))). % aa6fa688ed6fb4da7a9465ad5c43b835b814e4f1d63db59a2ed15eeb994d523a
fof(recip_5FSNo_5Fpos_5Fpow_5F2,axiom,(! [X0] : (nat_5Fp(X0) => (recip_5FSNo_5Fpos(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),X0)) = eps_5F(X0))))). % 61af36c7f978b6931fee01e34c53dd61bead93ccb5407cf3212c7b9bebfd100a
fof(recip_5FSNo_5Fpos_5F2,axiom,(recip_5FSNo_5Fpos(ordsucc(ordsucc(c_Empty))) = eps_5F(ordsucc(c_Empty)))). % 41f02a728ab1bd9036bee1cab1470ccfef554714f4880783dcc64357c64dc74e
fof(recip_5FSNo_5Fposcase,axiom,(! [X0] : (c_SNoLt(c_Empty,X0) => (recip_5FSNo(X0) = recip_5FSNo_5Fpos(X0))))). % 7d16911457a7f856ad33a4c141eec7c0f430dc42f0b405f1de64031c61d8cdf4
fof(recip_5FSNo_5Fnegcase,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(X0,c_Empty) => (recip_5FSNo(X0) = minus_5FSNo(recip_5FSNo_5Fpos(minus_5FSNo(X0)))))))). % 988ad3849559e55e0ff9418b5ced8f2fe44d1db8650d18d9ea34373632e23ad1
fof(recip_5FSNo_5F0,axiom,(recip_5FSNo(c_Empty) = c_Empty)). % ec6617bb2574cdc99b0c671dd73e1569ab465d3e03edb147120ec066616a04e0
fof(c_SNo_5Frecip_5FSNo,axiom,(! [X0] : (c_SNo(X0) => c_SNo(recip_5FSNo(X0))))). % 6222bb0933179a3af4ca74cdf561b825a832b7915209cc87ce47c548d31a580f
fof(recip_5FSNo_5FinvR,axiom,(! [X0] : (c_SNo(X0) => (~ (X0 = c_Empty) => (mul_5FSNo(X0,recip_5FSNo(X0)) = ordsucc(c_Empty)))))). % e4d360d72ef46e4267c422ff38a170cb848cb402d3e2822fbf0e26577a4056dc
fof(recip_5FSNo_5FinvL,axiom,(! [X0] : (c_SNo(X0) => (~ (X0 = c_Empty) => (mul_5FSNo(recip_5FSNo(X0),X0) = ordsucc(c_Empty)))))). % a0ab6b84918acba2e35eb241a3e564202ebf8ba5d483a68216709f627a0b5405
fof(mul_5FSNo_5Fnonzero_5Fcancel_5FL,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (~ (X0 = c_Empty) => (c_SNo(X1) => (c_SNo(X2) => ((mul_5FSNo(X0,X1) = mul_5FSNo(X0,X2)) => (X1 = X2)))))))))). % 837ded32a294988a8831d2d67f0fdee970f56365ec41c6e0fe7a3cf2a355df58
fof(recip_5FSNo_5Fpow_5F2,axiom,(! [X0] : (nat_5Fp(X0) => (recip_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),X0)) = eps_5F(X0))))). % 4f57d95ab16b9c77d7553b7cba151e0264052d59e3da9ec0f97aee2775ff489e
fof(recip_5FSNo_5Fof_5Fpos_5Fis_5Fpos,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => c_SNoLt(c_Empty,recip_5FSNo(X0)))))). % bb3f077d7604ea7d3ebd5b3c51fbd6d990862acf3455b968f07ad442f498f6ca
fof(div_5FSNo,axiom,(! [X0:$i] : (! [X1:$i] : (div_5FSNo(c_X0,c_X1) = mul_5FSNo(c_X0,recip_5FSNo(c_X1)))))). % 27f4b5fe59b60da9c8b15247476d431fa3e527c47c22bad7c6d8cb3c2668e2e0
fof(c_SNo_5Fdiv_5FSNo,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => c_SNo(div_5FSNo(X0,X1))))))). % 72935847b1f7763c2aba0f308713d98e9dbc8b4bbbb01f26c72e34a13eef6792
fof(div_5FSNo_5F0_5Fnum,axiom,(! [X0] : (c_SNo(X0) => (div_5FSNo(c_Empty,X0) = c_Empty)))). % dab94729ef1082e4e46f96e9d1c56d58160c77deba346e1c7d619eab96bfa866
fof(div_5FSNo_5F0_5Fdenum,axiom,(! [X0] : (c_SNo(X0) => (div_5FSNo(X0,c_Empty) = c_Empty)))). % 716ac2205e7adf3502eb71276723043af9b1e55a8a554b24b430ae340dd95fc6
fof(mul_5Fdiv_5FSNo_5FinvL,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => (~ (X1 = c_Empty) => (mul_5FSNo(div_5FSNo(X0,X1),X1) = X0))))))). % 97bf2b1602cf1d47fa0e0ee49fcae33fbddb92ae3b9c805d90780e8dde825d0b
fof(mul_5Fdiv_5FSNo_5FinvR,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => (~ (X1 = c_Empty) => (mul_5FSNo(X1,div_5FSNo(X0,X1)) = X0))))))). % 0faa7033548825d858780ae317248734cb28dd25907248a0325d0249a437598b
fof(mul_5Fdiv_5FSNo_5FR,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (mul_5FSNo(div_5FSNo(X0,X1),X2) = div_5FSNo(mul_5FSNo(X0,X2),X1))))))))). % b5700e6a5ce570343c71f27b32608623697de8c1ae78dfde6bccfc0ab9b2c3ea
fof(mul_5Fdiv_5FSNo_5FL,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (mul_5FSNo(X2,div_5FSNo(X0,X1)) = div_5FSNo(mul_5FSNo(X2,X0),X1))))))))). % 203879ecd2ebe96d14e14c334867017ceef1bf9d50264593628093f822c00529
fof(div_5Fmul_5FSNo_5FinvL,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => (~ (X1 = c_Empty) => (div_5FSNo(mul_5FSNo(X0,X1),X1) = X0))))))). % 6d9cb86d9b73b12b77fdf0fe29436d54ae58083ab3640279b498ae679c081081
fof(div_5Fdiv_5FSNo,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (div_5FSNo(div_5FSNo(X0,X1),X2) = div_5FSNo(X0,mul_5FSNo(X1,X2)))))))))). % 4f76b2c5c09d81c33fcc8e8cffdb65f87a39aa3b7b8e096d591ece0ed0f37e59
fof(mul_5Fdiv_5FSNo_5Fboth,axiom,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (mul_5FSNo(div_5FSNo(X0,X1),div_5FSNo(X2,X3)) = div_5FSNo(mul_5FSNo(X0,X2),mul_5FSNo(X1,X3)))))))))))). % dfb7afa3f635dceabfb1ccfa9add6fe06469544d6003018c75db0107ca838c50
fof(recip_5FSNo_5Fpos_5Fpos,axiom,(! [X0] : (c_SNo(X0) => (c_SNoLt(c_Empty,X0) => c_SNoLt(c_Empty,recip_5FSNo_5Fpos(X0)))))). % 781a46c0be55332e136c75e0f11f520a64d3ac28e99005e625175d2a9d5bd130
fof(div_5FSNo_5Fpos_5Fpos,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => (c_SNoLt(c_Empty,X0) => (c_SNoLt(c_Empty,X1) => c_SNoLt(c_Empty,div_5FSNo(X0,X1))))))))). % c6310a12f30be3e22f31379e6873dbbd01a738dc67b4077715d95fee210870c1
fof(div_5FSNo_5Fneg_5Fpos,axiom,(! [X0] : (! [X1] : (c_SNo(X0) => (c_SNo(X1) => (c_SNoLt(X0,c_Empty) => (c_SNoLt(c_Empty,X1) => c_SNoLt(div_5FSNo(X0,X1),c_Empty)))))))). % b095f6c18bde9dee6da0f1f2e0c123e028a8da05ccdbeba838a9f698007c6f09
fof(div_5FSNo_5Fpos_5FLtL,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNoLt(c_Empty,X1) => (c_SNoLt(X0,mul_5FSNo(X2,X1)) => c_SNoLt(div_5FSNo(X0,X1),X2)))))))))). % 3fdf88453d08c33fb3c88793e3c38c953c0133ce5ab1e5160eef50f4644e9cc5
fof(div_5FSNo_5Fpos_5FLtR,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNoLt(c_Empty,X1) => (c_SNoLt(mul_5FSNo(X2,X1),X0) => c_SNoLt(X2,div_5FSNo(X0,X1))))))))))). % f52e00269c910601bbed3316285f3845d5712a8b6891065f097e75ce4b96d2f2
fof(div_5FSNo_5Fpos_5FLtL_27,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNoLt(c_Empty,X1) => (c_SNoLt(div_5FSNo(X0,X1),X2) => c_SNoLt(X0,mul_5FSNo(X2,X1))))))))))). % c463fa06e15a60d2c96d90a90a6255ce50e0e4b460bbfc3e0c2085c749e76e7d
fof(div_5FSNo_5Fpos_5FLtR_27,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNoLt(c_Empty,X1) => (c_SNoLt(X2,div_5FSNo(X0,X1)) => c_SNoLt(mul_5FSNo(X2,X1),X0)))))))))). % ba234b53c794adc49fe6dfea5c3c2d149ee8acb027077279ab258cf1eaa3f57a
fof(mul_5Fdiv_5FSNo_5Fnonzero_5Feq,axiom,(! [X0] : (! [X1] : (! [X2] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (~ (X1 = c_Empty) => ((X0 = mul_5FSNo(X1,X2)) => (div_5FSNo(X0,X1) = X2)))))))))). % 44090bb09637173d898b9233aa7822d0bab4086df25d04d255ebcfc5fe273f3a
fof(c_SNoS_5Fomega_5Fdrat_5Fintvl,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(omega)) => (! [X1] : (c_In(X1,omega) => (? [X2] : (c_In(X2,c_SNoS_5F(omega)) & (c_SNoLt(X2,X0) & c_SNoLt(X0,add_5FSNo(X2,eps_5F(X1))))))))))). % 54f716f83fe0c21645334231849c89f90bd78b9d264a7546bbe8fd788cc6ecc0
fof(c_SNoS_5Fordsucc_5Fomega_5Fbdd_5Fabove,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(ordsucc(omega))) => (c_SNoLt(X0,omega) => (? [X1] : (c_In(X1,omega) & c_SNoLt(X0,X1))))))). % 268e0fc15212bbbf8b2cd1060a14a85ab48cc9cbe4d56194233c6146aa110e57
fof(c_SNoS_5Fordsucc_5Fomega_5Fbdd_5Fbelow,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(ordsucc(omega))) => (c_SNoLt(minus_5FSNo(omega),X0) => (? [X1] : (c_In(X1,omega) & c_SNoLt(minus_5FSNo(X1),X0))))))). % 5f5ab4f335f3e80fe4dcf448f261dd0c371b77e1631db19907316947d3ca84f9
fof(c_SNoS_5Fordsucc_5Fomega_5Fbdd_5Fdrat_5Fintvl,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(ordsucc(omega))) => (c_SNoLt(minus_5FSNo(omega),X0) => (c_SNoLt(X0,omega) => (! [X1] : (c_In(X1,omega) => (? [X2] : (c_In(X2,c_SNoS_5F(omega)) & (c_SNoLt(X2,X0) & c_SNoLt(X0,add_5FSNo(X2,eps_5F(X1))))))))))))). % 042bb4cbdff88a49a2bf60bf33f3b91dd2dbad7bd1e9c1099c362ff00f91fb38
fof(real_5FI,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(ordsucc(omega))) => (~ (X0 = omega) => (~ (X0 = minus_5FSNo(omega)) => ((! [X1] : (c_In(X1,c_SNoS_5F(omega)) => ((! [X2] : (c_In(X2,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X1,minus_5FSNo(X0))),eps_5F(X2)))) => (X1 = X0)))) => c_In(X0,real))))))). % fb08caaf31e36026b6370d4eeb8e9139836d17d6e2818c7a557220e3a042a4e9
fof(real_5FSNo,axiom,(! [X0] : (c_In(X0,real) => c_SNo(X0)))). % 597094bbe3ad1f7180298079a7bfca19d5d9922c889c977624d19ef417dad2c9
fof(real_5FSNoS_5Fomega_5Fprop,axiom,(! [X0] : (c_In(X0,real) => (! [X1] : (c_In(X1,c_SNoS_5F(omega)) => ((! [X2] : (c_In(X2,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X1,minus_5FSNo(X0))),eps_5F(X2)))) => (X1 = X0))))))). % 711379658f1de8a5d62217fab7ce85826816cc331aa186e18c1d3966b29faa00
fof(c_SNoS_5Fomega_5Freal,axiom,c_Subq(c_SNoS_5F(omega),real)). % 4e6fe6e745087d9c0db2e4553f1c88b2116bb2d03429283b75b30459b18767a1
fof(real_5F0,axiom,c_In(c_Empty,real)). % 0734aff4be3535465df2ff21ffa032a10c90587cb0fe785d02ee6f2e4905a5da
fof(real_5F1,axiom,c_In(ordsucc(c_Empty),real)). % 24473dc76d35028c54600391307e8b0832ed6218ee536b67c87d53029abcc511
fof(c_SNoLev_5FIn_5Freal_5FSNoS_5Fomega,axiom,(! [X0] : (c_In(X0,real) => (! [X1] : (c_SNo(X1) => (c_In(c_SNoLev(X1),c_SNoLev(X0)) => c_In(X1,c_SNoS_5F(omega)))))))). % b33d6e4ee94a314054e85d3d02eb8dcf842843ca2defd9ae985f6b8874f21682
fof(real_5FSNoCut_5FSNoS_5Fomega,axiom,(! [X0] : (c_Subq(X0,c_SNoS_5F(omega)) => (! [X1] : (c_Subq(X1,c_SNoS_5F(omega)) => (c_SNoCutP(X0,X1) => (~ (X0 = c_Empty) => (~ (X1 = c_Empty) => ((! [X2] : (c_In(X2,X0) => (? [X3] : (c_In(X3,X0) & c_SNoLt(X2,X3))))) => ((! [X2] : (c_In(X2,X1) => (? [X3] : (c_In(X3,X1) & c_SNoLt(X3,X2))))) => c_In(c_SNoCut(X0,X1),real))))))))))). % 49abb45276c9b75cb5726482ca651ceace3a2020dd5e4da4299e1ed557a500e2
fof(real_5FSNoCut,axiom,(! [X0] : (c_Subq(X0,real) => (! [X1] : (c_Subq(X1,real) => (c_SNoCutP(X0,X1) => (~ (X0 = c_Empty) => (~ (X1 = c_Empty) => ((! [X2] : (c_In(X2,X0) => (? [X3] : (c_In(X3,X0) & c_SNoLt(X2,X3))))) => ((! [X2] : (c_In(X2,X1) => (? [X3] : (c_In(X3,X1) & c_SNoLt(X3,X2))))) => c_In(c_SNoCut(X0,X1),real))))))))))). % 09536d3a0a6afa6b35bd84f0e98397436ef296eb2174f9e2c0883713b5141490
fof(minus_5FSNo_5Fprereal_5F1,axiom,(! [X0] : (c_SNo(X0) => ((! [X1] : (c_In(X1,c_SNoS_5F(omega)) => ((! [X2] : (c_In(X2,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X1,minus_5FSNo(X0))),eps_5F(X2)))) => (X1 = X0)))) => (! [X1] : (c_In(X1,c_SNoS_5F(omega)) => ((! [X2] : (c_In(X2,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X1,minus_5FSNo(minus_5FSNo(X0)))),eps_5F(X2)))) => (X1 = minus_5FSNo(X0))))))))). % 6b44dd7ef98f34a106b021cc200fa4a1494239afa07389240a15e02388e4a4e5
fof(minus_5FSNo_5Fprereal_5F2,axiom,(! [X0] : (c_SNo(X0) => ((! [X1] : (c_In(X1,omega) => (? [X2] : (c_In(X2,c_SNoS_5F(omega)) & (c_SNoLt(X2,X0) & c_SNoLt(X0,add_5FSNo(X2,eps_5F(X1)))))))) => (! [X1] : (c_In(X1,omega) => (? [X2] : (c_In(X2,c_SNoS_5F(omega)) & (c_SNoLt(X2,minus_5FSNo(X0)) & c_SNoLt(minus_5FSNo(X0),add_5FSNo(X2,eps_5F(X1)))))))))))). % 90e5be66050abe8c2151492cc90f216f7481f1eb6285202e9ab146df4946f386
fof(real_5Fminus_5FSNo,axiom,(! [X0] : (c_In(X0,real) => c_In(minus_5FSNo(X0),real)))). % df55736d73c736e3b2d306dfca9796f91142878705866b1aa23564dd1487a954
fof(c_SNo_5Fprereal_5Fincr_5Flower_5Fapprox,axiom,(! [X0] : (c_SNo(X0) => ((! [X1] : (c_In(X1,c_SNoS_5F(omega)) => ((! [X2] : (c_In(X2,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X1,minus_5FSNo(X0))),eps_5F(X2)))) => (X1 = X0)))) => ((! [X1] : (c_In(X1,omega) => (? [X2] : (c_In(X2,c_SNoS_5F(omega)) & (c_SNoLt(X2,X0) & c_SNoLt(X0,add_5FSNo(X2,eps_5F(X1)))))))) => (? [X1] : (c_In(X1,setexp(c_SNoS_5F(omega),omega)) & (! [X2] : (c_In(X2,omega) => ((c_SNoLt(ap(X1,X2),X0) & c_SNoLt(X0,add_5FSNo(ap(X1,X2),eps_5F(X2)))) & (! [X3] : (c_In(X3,X2) => c_SNoLt(ap(X1,X3),ap(X1,X2)))))))))))))). % b9b39c44c1297622194f9ecbe4dea0e490bc3184846ebdd1f126308fb4158e48
fof(c_SNo_5Fprereal_5Fdecr_5Fupper_5Fapprox,axiom,(! [X0] : (c_SNo(X0) => ((! [X1] : (c_In(X1,c_SNoS_5F(omega)) => ((! [X2] : (c_In(X2,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X1,minus_5FSNo(X0))),eps_5F(X2)))) => (X1 = X0)))) => ((! [X1] : (c_In(X1,omega) => (? [X2] : (c_In(X2,c_SNoS_5F(omega)) & (c_SNoLt(X2,X0) & c_SNoLt(X0,add_5FSNo(X2,eps_5F(X1)))))))) => (? [X1] : (c_In(X1,setexp(c_SNoS_5F(omega),omega)) & (! [X2] : (c_In(X2,omega) => ((c_SNoLt(add_5FSNo(ap(X1,X2),minus_5FSNo(eps_5F(X2))),X0) & c_SNoLt(X0,ap(X1,X2))) & (! [X3] : (c_In(X3,X2) => c_SNoLt(ap(X1,X2),ap(X1,X3)))))))))))))). % 5c54956cae8c024b6bf9007e3601f881de2ee1d75b6df13ab4cca7b4ff17435e
fof(c_SNoCutP_5FSNoCut_5Flim,axiom,(! [X0] : (ordinal(X0) => ((! [X1] : (c_In(X1,X0) => c_In(ordsucc(X1),X0))) => (! [X1] : (c_Subq(X1,c_SNoS_5F(X0)) => (! [X2] : (c_Subq(X2,c_SNoS_5F(X0)) => (c_SNoCutP(X1,X2) => c_In(c_SNoLev(c_SNoCut(X1,X2)),ordsucc(X0))))))))))). % bc66c516b13f3b26d3105a54df22d28159e1c10f0371761b12f31840ab5712fb
fof(c_SNoCutP_5FSNoCut_5Fomega,axiom,(! [X0] : (c_Subq(X0,c_SNoS_5F(omega)) => (! [X1] : (c_Subq(X1,c_SNoS_5F(omega)) => (c_SNoCutP(X0,X1) => c_In(c_SNoLev(c_SNoCut(X0,X1)),ordsucc(omega)))))))). % 8392dc053d872a9371df298444a2118c1014f9cfb7e817f5b818c904bd835522
fof(real_5Fadd_5FSNo,axiom,(! [X0] : (c_In(X0,real) => (! [X1] : (c_In(X1,real) => c_In(add_5FSNo(X0,X1),real)))))). % 395f9a44915b2f219ff3380b1469edb4df410ad2ceecfd38c644c7669fa873cd
fof(c_SNoS_5Fordsucc_5Fomega_5Fbdd_5Feps_5Fpos,axiom,(! [X0] : (c_In(X0,c_SNoS_5F(ordsucc(omega))) => (c_SNoLt(c_Empty,X0) => (c_SNoLt(X0,omega) => (? [X1] : (c_In(X1,omega) & c_SNoLt(mul_5FSNo(eps_5F(X1),X0),ordsucc(c_Empty))))))))). % c4a7521a28cae3098ceb7e49d81ba6dbf2e391a8099207f20ba609587b8a2e79
fof(c_Hx,axiom,c_In(x,real)).
fof(c_Hy,axiom,c_In(y,real)).
fof(c_Hx0,axiom,c_SNoLt(c_Empty,x)).
fof(c_Hy0,axiom,c_SNoLt(c_Empty,y)).
fof(c_HC,axiom,nIn(mul_5FSNo(x,y),real)).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx2,axiom,c_In(c_SNoLev(x),ordsucc(omega))).
fof(c_Hx3,axiom,c_In(x,c_SNoS_5F(ordsucc(omega)))).
fof(c_Hx4,axiom,c_SNoLt(minus_5FSNo(omega),x)).
fof(c_Hx5,axiom,c_SNoLt(x,omega)).
fof(c_Hx6,axiom,(! [X12] : (c_In(X12,c_SNoS_5F(omega)) => ((! [X13] : (c_In(X13,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X12,minus_5FSNo(x))),eps_5F(X13)))) => (X12 = x))))).
fof(c_Hx7,axiom,(! [X12] : (c_In(X12,omega) => (? [X13] : (c_In(X13,c_SNoS_5F(omega)) & (c_SNoLt(X13,x) & c_SNoLt(x,add_5FSNo(X13,eps_5F(X12))))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy2,axiom,c_In(c_SNoLev(y),ordsucc(omega))).
fof(c_Hy3,axiom,c_In(y,c_SNoS_5F(ordsucc(omega)))).
fof(c_Hy4,axiom,c_SNoLt(minus_5FSNo(omega),y)).
fof(c_Hy5,axiom,c_SNoLt(y,omega)).
fof(c_Hy6,axiom,(! [X12] : (c_In(X12,c_SNoS_5F(omega)) => ((! [X13] : (c_In(X13,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X12,minus_5FSNo(y))),eps_5F(X13)))) => (X12 = y))))).
fof(c_Hy7,axiom,(! [X12] : (c_In(X12,omega) => (? [X13] : (c_In(X13,c_SNoS_5F(omega)) & (c_SNoLt(X13,y) & c_SNoLt(y,add_5FSNo(X13,eps_5F(X12))))))))).
fof(c_Lxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Lmxy,axiom,c_SNo(minus_5FSNo(mul_5FSNo(x,y)))).
fof(c_Lxy2,axiom,nIn(c_SNoLev(mul_5FSNo(x,y)),omega)).
fof(c_Lxy3,axiom,(! [X12] : (c_SNo(X12) => (c_In(c_SNoLev(X12),omega) => c_In(c_SNoLev(X12),c_SNoLev(mul_5FSNo(x,y))))))).
fof(c_LLx,axiom,c_Subq(c_SNoL(x),c_SNoS_5F(omega))).
fof(c_LRx,axiom,c_Subq(c_SNoR(x),c_SNoS_5F(omega))).
fof(c_LLy,axiom,c_Subq(c_SNoL(y),c_SNoS_5F(omega))).
fof(c_LRy,axiom,c_Subq(c_SNoR(y),c_SNoS_5F(omega))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X12] : (c_In(X12,c_SNoL(x)) => (! [X13] : (c_In(X13,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X12] : (c_In(X12,c_SNoR(x)) => (! [X13] : (c_In(X13,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X12] : (c_In(X12,c_SNoL(x)) => (! [X13] : (c_In(X13,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X12] : (c_In(X12,c_SNoR(x)) => (! [X13] : (c_In(X13,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FR)))))).
fof(c_HxyLR,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_L1,axiom,(! [X12] : (c_In(X12,c_SNoS_5F(omega)) => ((! [X13] : (c_In(X13,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X12,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(X13)))) => (X12 = mul_5FSNo(x,y)))))).
fof(c_LNex,axiom,(? [X12] : (c_In(X12,omega) & (c_SNoLt(mul_5FSNo(eps_5F(X12),x),ordsucc(c_Empty)) & c_SNoLt(mul_5FSNo(eps_5F(X12),y),ordsucc(c_Empty)))))).
fof(c_HN1,axiom,c_In(c_5FN,omega)).
fof(c_HN,axiom,(c_SNoLt(mul_5FSNo(eps_5F(c_5FN),x),ordsucc(c_Empty)) & c_SNoLt(mul_5FSNo(eps_5F(c_5FN),y),ordsucc(c_Empty)))).
fof(c_HN2,axiom,c_SNoLt(mul_5FSNo(eps_5F(c_5FN),x),ordsucc(c_Empty))).
fof(c_HN3,axiom,c_SNoLt(mul_5FSNo(eps_5F(c_5FN),y),ordsucc(c_Empty))).
fof(c_L2,axiom,(! [X12] : (c_In(X12,omega) => (? [X13] : (c_In(X13,c_SNoS_5F(omega)) & (c_SNoLt(X13,mul_5FSNo(x,y)) & c_SNoLt(mul_5FSNo(x,y),add_5FSNo(X13,eps_5F(X12))))))))).
fof(c_HhL1,axiom,c_In(hL,setexp(c_SNoS_5F(omega),omega))).
fof(c_HhL2,axiom,(! [X12] : (c_In(X12,omega) => ((c_SNoLt(ap(hL,X12),mul_5FSNo(x,y)) & c_SNoLt(mul_5FSNo(x,y),add_5FSNo(ap(hL,X12),eps_5F(X12)))) & (! [X13] : (c_In(X13,X12) => c_SNoLt(ap(hL,X13),ap(hL,X12)))))))).
fof(c_HhR1,axiom,c_In(hR,setexp(c_SNoS_5F(omega),omega))).
fof(c_HhR2,axiom,(! [X12] : (c_In(X12,omega) => ((c_SNoLt(add_5FSNo(ap(hR,X12),minus_5FSNo(eps_5F(X12))),mul_5FSNo(x,y)) & c_SNoLt(mul_5FSNo(x,y),ap(hR,X12))) & (! [X13] : (c_In(X13,X12) => c_SNoLt(ap(hR,X12),ap(hR,X13)))))))).
fof(c_LhL,axiom,(! [X12] : (c_In(X12,omega) => c_SNo(ap(hL,X12))))).
fof(c_LhR,axiom,(! [X12] : (c_In(X12,omega) => c_SNo(ap(hR,X12))))).
fof(c_L3,axiom,(! [X12] : (c_In(X12,omega) => c_SNoLt(ap(hL,X12),mul_5FSNo(x,y))))).
fof(c_L4,axiom,(! [X12] : (c_In(X12,omega) => c_SNoLt(mul_5FSNo(x,y),ap(hR,X12))))).
fof(c_L5,axiom,(! [X12] : (c_In(X12,omega) => (! [X13] : (c_In(X13,omega) => c_SNoLt(ap(hL,X12),ap(hR,X13))))))).
fof(c_L6,axiom,(! [X12] : (c_In(X12,omega) => c_SNoLt(mul_5FSNo(x,y),add_5FSNo(ap(hL,X12),eps_5F(X12)))))).
fof(c_L7,axiom,(! [X12] : (c_In(X12,omega) => (! [X13] : (c_In(X13,X12) => c_SNoLt(ap(hL,X13),ap(hL,X12))))))).
fof(c_L8,axiom,(! [X12] : (c_In(X12,omega) => c_SNoLt(add_5FSNo(ap(hR,X12),minus_5FSNo(eps_5F(X12))),mul_5FSNo(x,y))))).
fof(c_L9,axiom,(! [X12] : (c_In(X12,omega) => (! [X13] : (c_In(X13,X12) => c_SNoLt(ap(hR,X12),ap(hR,X13))))))).
fof(c_Hz,axiom,c_In(z,c_5FR)).
fof(c_Hw0,axiom,c_In(w0,c_SNoL(x))).
fof(c_Hz1,axiom,c_In(z1,c_SNoR(y))).
fof(c_Hze,axiom,(z = add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(w0,z1)))))).
fof(c_Hk0,axiom,c_In(k0,omega)).
fof(c_Hk0b,axiom,c_SNoLe(eps_5F(k0),add_5FSNo(x,minus_5FSNo(w0)))).
fof(c_Hk1,axiom,c_In(k1,omega)).
fof(c_Hk1b,axiom,c_SNoLe(eps_5F(k1),add_5FSNo(z1,minus_5FSNo(y)))).
fof(c_Hw01,axiom,c_SNo(w0)).
fof(c_Hw02,axiom,c_In(c_SNoLev(w0),c_SNoLev(x))).
fof(c_Hw03,axiom,c_SNoLt(w0,x)).
fof(c_Hz11,axiom,c_SNo(z1)).
fof(c_Hz12,axiom,c_In(c_SNoLev(z1),c_SNoLev(y))).
fof(c_Hz13,axiom,c_SNoLt(y,z1)).
fof(c_Lek0,axiom,c_SNo(eps_5F(k0))).
fof(c_Lek1,axiom,c_SNo(eps_5F(k1))).
fof(c_Lk0k1,axiom,c_In(add_5FSNo(k0,k1),omega)).
fof(c_Lek0k1,axiom,c_SNo(eps_5F(add_5FSNo(k0,k1)))).
fof(c_Lmek0k1,axiom,c_SNo(minus_5FSNo(eps_5F(add_5FSNo(k0,k1))))).
fof(c_LhRk0k1,axiom,c_SNo(ap(hR,add_5FSNo(k0,k1)))).
fof(c_Lw0y,axiom,c_SNo(mul_5FSNo(w0,y))).
fof(c_Lxz1,axiom,c_SNo(mul_5FSNo(x,z1))).
fof(c_Lw0z1,axiom,c_SNo(mul_5FSNo(w0,z1))).
fof(c_Lmw0z1,axiom,c_SNo(minus_5FSNo(mul_5FSNo(w0,z1)))).
fof(c_Lw0yxz1mw0z1,axiom,c_SNo(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(w0,z1)))))).
fof(c_H1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(w0,z1)))),ap(hR,add_5FSNo(k0,k1)))).
fof(conj_hammer_test_14541,conjecture,c_SNoLt(add_5FSNo(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(w0,z1)))),minus_5FSNo(eps_5F(add_5FSNo(k0,k1)))),add_5FSNo(ap(hR,add_5FSNo(k0,k1)),minus_5FSNo(eps_5F(add_5FSNo(k0,k1)))))).
