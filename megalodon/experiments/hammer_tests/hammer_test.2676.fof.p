...
fof(c_H1,axiom,(! [X5] : (c_Subq(X5,c_5FX) => (equip(X5,ordsucc(n)) => c_In(c_5FC(X5),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X5] : (c_Subq(X5,c_5FX) & (? [X6] : (c_In(X6,ordsucc(c)) & (infinite(X5) & (! [X7] : (c_Subq(X7,X5) => (equip(X7,ordsucc(n)) => (c_5FC(X7) = X6)))))))))).
fof(c_L1,axiom,(! [X5] : (c_Subq(X5,c_5FX) => (infinite(X5) => (? [X6] : (c_Subq(X6,X5) & (? [X7] : (c_In(X7,X5) & ((nIn(X7,X6) & infinite(X6)) & (! [X8] : (c_Subq(X8,X6) => (equip(X8,n) => (c_5FC(binunion(X8,c_Sing(c_X7))) = c))))))))))))).
fof(c_H,axiom,((! [X5] : (nat_5Fp(X5) => (c_Subq(f_5F27(X5),c_5FX) & infinite(f_5F27(X5))))) & (! [X5] : (c_In(X5,omega) => (! [X6] : (c_In(X6,omega) => (c_Subq(X5,X6) => c_Subq(f_5F27(X6),f_5F27(c_X5))))))))).
fof(c_Hf_271,axiom,(! [X5] : (nat_5Fp(X5) => (c_Subq(f_5F27(X5),c_5FX) & infinite(f_5F27(X5)))))).
fof(c_Hgf_27mm_27Subq,axiom,(! [X5] : (c_In(X5,omega) => (! [X6] : (c_In(X6,omega) => (c_Subq(X5,X6) => c_Subq(f_5F27(X6),f_5F27(c_X5)))))))).
fof(c_Lf_271,axiom,(! [X5] : (nat_5Fp(X5) => (c_Subq(f_5F27(X5),c_5FX) & infinite(f_5F27(X5)))))).
fof(c_Lgf_27mm_27addSubq,axiom,(! [X5] : (c_In(X5,omega) => (! [X6] : (nat_5Fp(X6) => c_Subq(f_5F27(add_5Fnat(c_X5,X6)),f_5F27(c_X5))))))).
fof(c_Lgf_27mm_27Subq,axiom,(! [X5] : (c_In(X5,omega) => (! [X6] : (c_In(X6,omega) => (c_Subq(X5,X6) => c_Subq(f_5F27(X6),f_5F27(c_X5)))))))).
fof(conj_hammer_test_2676,conjecture,$false).
