...
fof(c_Hw,axiom,c_In(w,c_5FL_5F27)).
...
fof(c_Hz0a,axiom,c_SNo(z0)).
fof(c_Hz0b,axiom,c_In(c_SNoLev(z0),c_SNoLev(x))).
fof(c_Hz0c,axiom,c_SNoLt(x,z0)).
fof(c_Hz1a,axiom,c_SNo(z1)).
fof(c_Hz1b,axiom,c_In(c_SNoLev(z1),c_SNoLev(y))).
fof(c_Hz1c,axiom,c_SNoLt(y,z1)).
fof(c_L4,axiom,(? [X13] : (c_In(X13,c_5FRx) & c_SNoLe(X13,z0)))).
fof(c_L5,axiom,(? [X13] : (c_In(X13,c_5FRy) & c_SNoLe(X13,z1)))).
fof(c_Hz0_271,axiom,c_In(z0_5F27,c_5FRx)).
fof(c_Hz0_272,axiom,c_SNoLe(z0_5F27,z0)).
fof(c_Hz1_271,axiom,c_In(z1_5F27,c_5FRy)).
fof(c_Hz1_272,axiom,c_SNoLe(z1_5F27,z1)).
fof(conj_hammer_test_10267,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(z0_5F27,z1),mul_5FSNo(x,z1_5F27))),add_5FSNo(mul_5FSNo(z0_5F27,y),add_5FSNo(mul_5FSNo(x,z1_5F27),mul_5FSNo(z0,z1))))).
