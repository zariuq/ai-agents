...
fof(c_Hx6,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(omega)) => ((! [X9] : (c_In(X9,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X8,minus_5FSNo(x))),eps_5F(X9)))) => (X8 = x))))).
fof(c_Hx7,axiom,(! [X8] : (c_In(X8,omega) => (? [X9] : (c_In(X9,c_SNoS_5F(omega)) & (c_SNoLt(X9,x) & c_SNoLt(x,add_5FSNo(X9,eps_5F(X8))))))))).
...
fof(c_Hy6,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(omega)) => ((! [X9] : (c_In(X9,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X8,minus_5FSNo(y))),eps_5F(X9)))) => (X8 = y))))).
fof(c_Hy7,axiom,(! [X8] : (c_In(X8,omega) => (? [X9] : (c_In(X9,c_SNoS_5F(omega)) & (c_SNoLt(X9,y) & c_SNoLt(y,add_5FSNo(X9,eps_5F(X8))))))))).
...
fof(c_Lxy3,axiom,(! [X8] : (c_SNo(X8) => (c_In(c_SNoLev(X8),omega) => c_In(c_SNoLev(X8),c_SNoLev(mul_5FSNo(x,y))))))).
...
fof(c_HLI1,axiom,(! [X8] : (c_In(X8,c_SNoL(x)) => (! [X9] : (c_In(X9,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X8] : (c_In(X8,c_SNoR(x)) => (! [X9] : (c_In(X9,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X8] : (c_In(X8,c_SNoL(x)) => (! [X9] : (c_In(X9,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X8] : (c_In(X8,c_SNoR(x)) => (! [X9] : (c_In(X9,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR)))))).
fof(c_HxyLR,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_L1,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(omega)) => ((! [X9] : (c_In(X9,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X8,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(X9)))) => (X8 = mul_5FSNo(x,y)))))).
fof(c_LNex,axiom,(? [X8] : (c_In(X8,omega) & (c_SNoLt(mul_5FSNo(eps_5F(X8),x),ordsucc(c_Empty)) & c_SNoLt(mul_5FSNo(eps_5F(X8),y),ordsucc(c_Empty)))))).
...
fof(c_Hk,axiom,c_In(k,omega)).
fof(c_Lek,axiom,c_SNo(eps_5F(k))).
fof(c_Lk1,axiom,c_In(add_5FSNo(k,ordsucc(c_Empty)),omega)).
fof(c_Lk2,axiom,c_In(add_5FSNo(k,ordsucc(ordsucc(c_Empty))),omega)).
fof(c_Lk_27,axiom,c_In(add_5FSNo(c_5FN,add_5FSNo(k,ordsucc(ordsucc(c_Empty)))),omega)).
fof(c_Lek_27,axiom,c_SNo(eps_5F(add_5FSNo(c_5FN,add_5FSNo(k,ordsucc(ordsucc(c_Empty))))))).
fof(c_Hq1,axiom,c_In(q,c_SNoS_5F(omega))).
fof(c_Hqpos,axiom,c_SNoLt(c_Empty,q)).
fof(c_Hq2,axiom,c_SNoLt(q,x)).
fof(c_Hq3,axiom,c_SNoLt(x,add_5FSNo(q,eps_5F(add_5FSNo(c_5FN,add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))))).
fof(c_Hq1a,axiom,c_In(c_SNoLev(q),omega)).
fof(c_Hq1b,axiom,ordinal(c_SNoLev(q))).
fof(c_Hq1c,axiom,c_SNo(q)).
fof(c_Hq1d,axiom,c_SNo_5F(c_SNoLev(q),q)).
fof(c_Hq_271,axiom,c_In(q_5F27,c_SNoS_5F(omega))).
fof(c_Hq_27pos,axiom,c_SNoLt(c_Empty,q_5F27)).
fof(c_Hq_272,axiom,c_SNoLt(q_5F27,y)).
fof(c_Hq_273,axiom,c_SNoLt(y,add_5FSNo(q_5F27,eps_5F(add_5FSNo(c_5FN,add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))))).
fof(c_Hq_271a,axiom,c_In(c_SNoLev(q_5F27),omega)).
fof(c_Hq_271b,axiom,ordinal(c_SNoLev(q_5F27))).
fof(c_Hq_271c,axiom,c_SNo(q_5F27)).
fof(c_Hq_271d,axiom,c_SNo_5F(c_SNoLev(q_5F27),q_5F27)).
fof(c_Lqq_27,axiom,c_SNo(mul_5FSNo(q,q_5F27))).
fof(c_LeN,axiom,c_SNo(eps_5F(c_5FN))).
fof(c_Lek1,axiom,c_SNo(eps_5F(add_5FSNo(k,ordsucc(c_Empty))))).
fof(c_Lek2,axiom,c_SNo(eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))).
fof(c_LeNek2,axiom,c_SNo(mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty))))))).
fof(c_LeNek2sq,axiom,c_SNo(mul_5FSNo(mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty))))),mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))))).
fof(conj_hammer_test_14225,conjecture,c_SNoLt(mul_5FSNo(mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty))))),mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))),eps_5F(add_5FSNo(k,ordsucc(c_Empty))))).
