...
fof(c_H,axiom,c_SNo(mul_5FSNo(v0,y))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoL(v0)) => (! [X11] : (c_In(X11,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X10,y),mul_5FSNo(v0,X11)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X10,X11)))))))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoR(v0)) => (! [X11] : (c_In(X11,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X10,y),mul_5FSNo(v0,X11)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X10,X11)))))))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoL(v0)) => (! [X11] : (c_In(X11,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X10,X11)),add_5FSNo(mul_5FSNo(X10,y),mul_5FSNo(v0,X11)))))))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoR(v0)) => (! [X11] : (c_In(X11,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X10,X11)),add_5FSNo(mul_5FSNo(X10,y),mul_5FSNo(v0,X11)))))))).
fof(conj_hammer_test_7271,conjecture,c_SNo(mul_5FSNo(v0,y))).
