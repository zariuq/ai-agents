...
fof(conj_hammer_test_14176,conjecture,c_SNoLt(mul_5FSNo(x,y),mul_5FSNo(add_5FSNo(q,eps_5F(add_5FSNo(c_5FN,add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))),add_5FSNo(q_5F27,eps_5F(add_5FSNo(c_5FN,add_5FSNo(k,ordsucc(ordsucc(c_Empty))))))))).
