...
fof(c_Hwe,axiom,(a = minus_5FSNo(w))).
fof(conj_hammer_test_8298,conjecture,(! [X8] : (c_In(X8,c_SNoR(x)) => (! [X9] : (c_In(X9,c_SNoR(y)) => ((w = add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9))))) => c_In(minus_5FSNo(w),c_5FR_5F27))))))).
