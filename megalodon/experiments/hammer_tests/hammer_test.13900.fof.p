...
fof(conj_hammer_test_13900,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(eps_5F(k),eps_5F(k_5F27)),q),add_5FSNo(mul_5FSNo(add_5FSNo(x,minus_5FSNo(v)),add_5FSNo(y,minus_5FSNo(w))),q))).
