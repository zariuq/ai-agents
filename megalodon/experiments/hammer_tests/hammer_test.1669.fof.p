...
fof(conj_hammer_test_1669,conjecture,(! [X1] : (nat_5Fp(X1) => (c_In(c_Empty,ordsucc(m)) => (c_In(ordsucc(c_Empty),ordsucc(ordsucc(X1))) => c_In(ordsucc(m),mul_5Fnat(ordsucc(m),ordsucc(ordsucc(X1))))))))).
