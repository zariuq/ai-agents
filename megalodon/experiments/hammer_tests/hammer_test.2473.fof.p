...
fof(c_L1b,axiom,(! [X11] : (c_Subq(X11,c_5FX_5F27) => (infinite(X11) => (? [X12] : (c_Subq(X12,X11) & (? [X13] : (c_In(X13,X11) & ((nIn(X13,X12) & infinite(X12)) & (! [X14] : (c_Subq(X14,X12) => (equip(X14,n) => c_In(c_5FC(binunion(X14,c_Sing(c_X13))),c))))))))))))).
fof(c_H,axiom,((! [X11] : (nat_5Fp(X11) => (c_Subq(f_5F27(X11),c_5FX_5F27) & infinite(f_5F27(X11))))) & (! [X11] : (c_In(X11,omega) => (! [X12] : (c_In(X12,omega) => (c_Subq(X11,X12) => c_Subq(f_5F27(X12),f_5F27(c_X11))))))))).
fof(c_Hf_271,axiom,(! [X11] : (nat_5Fp(X11) => (c_Subq(f_5F27(X11),c_5FX_5F27) & infinite(f_5F27(X11)))))).
fof(c_Hgf_27mm_27Subq,axiom,(! [X11] : (c_In(X11,omega) => (! [X12] : (c_In(X12,omega) => (c_Subq(X11,X12) => c_Subq(f_5F27(X12),f_5F27(c_X11)))))))).
fof(c_Hm,axiom,nat_5Fp(m)).
fof(c_HYSn,axiom,equip(c_5FY,ordsucc(n))).
fof(c_Hf_27mX_27,axiom,c_Subq(f_5F27(m),c_5FX_5F27)).
fof(c_Hf_27minf,axiom,infinite(f_5F27(m))).
fof(c_Lmo,axiom,ordinal(m)).
fof(c_Hu1,axiom,c_In(u,c_5FY)).
fof(c_Hk,axiom,c_In(k,omega)).
fof(c_Lko,axiom,ordinal(k)).
fof(conj_hammer_test_2473,conjecture,(c_In(m,k) => c_In(u,f_5F27(ordsucc(m))))).
