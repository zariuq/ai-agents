...
fof(c_H1,axiom,nIn(y,c_5FX)).
fof(c_H2,axiom,equip(c_5FN,c_5FX)).
fof(c_Hf1,axiom,(! [X4] : (c_In(X4,c_5FN) => c_In(f(X4),c_5FX)))).
fof(c_Hf2,axiom,(! [X4] : (c_In(X4,c_5FN) => (! [X5] : (c_In(X5,c_5FN) => ((f(c_X4) = f(X5)) => (X4 = X5))))))).
fof(c_Hf3,axiom,(! [X4] : (c_In(X4,c_5FX) => (? [X5] : (c_In(X5,c_5FN) & (f(X5) = X4)))))).
fof(conj_hammer_test_934,conjecture,equip(ordsucc(c_5FN),binunion(c_5FX,c_Sing(y)))).
