...
fof(c__5F,axiom,c_SNo(mul_5FSNo(u0,y))).
fof(c__5F,axiom,(! [X11] : (c_In(X11,c_SNoL(u0)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(u0,X12)),add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(X11,X12)))))))).
fof(c__5F,axiom,(! [X11] : (c_In(X11,c_SNoR(u0)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(u0,X12)),add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(X11,X12)))))))).
fof(c__5F,axiom,(! [X11] : (c_In(X11,c_SNoL(u0)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(X11,X12)),add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(u0,X12)))))))).
fof(c_IHx4,axiom,(! [X11] : (c_In(X11,c_SNoR(u0)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(X11,X12)),add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(u0,X12)))))))).
fof(conj_hammer_test_7646,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(z,v1)),add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(u0,v1)))).
