...
fof(c_L1,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(u,mul_5FSNo(X5,X6)))))))).
fof(c_L2,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (! [X6] : (c_In(X6,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(u,mul_5FSNo(X5,X6)))))))).
...
fof(conj_hammer_test_8072,conjecture,(! [X5] : (c_In(X5,c_5FL) => c_SNoLt(X5,c_SNoCut(c_SNoL(u),c_SNoR(u)))))).
