...
fof(c_Ha2,axiom,(! [X4] : (c_In(X4,alpha) => c_TransSet(X4)))).
fof(c_IH,axiom,(! [X4] : (c_In(X4,alpha) => (! [X5] : (c_In(X5,c_SNoS_5F(X4)) => c_Subq(c_SNoLev(minus_5FSNo(X5)),c_SNoLev(X5))))))).
fof(c_Hx,axiom,c_In(x,c_SNoS_5F(alpha))).
fof(c_Hx1,axiom,c_In(c_SNoLev(x),alpha)).
fof(c_Hx2,axiom,ordinal(c_SNoLev(x))).
fof(c_Hx3,axiom,c_SNo(x)).
fof(c_Hx4,axiom,c_SNo_5F(c_SNoLev(x),x)).
fof(c_Hw2,axiom,c_In(beta,ordsucc(c_SNoLev(w)))).
fof(conj_hammer_test_5663,conjecture,(! [X4] : (c_In(X4,c_SNoR(x)) => ((w = minus_5FSNo(X4)) => c_In(beta,c_SNoLev(x)))))).
