...
fof(c_H1,axiom,(! [X6] : (c_Subq(X6,c_5FX) => (equip(X6,ordsucc(n)) => c_In(c_5FC(X6),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X6] : (c_Subq(X6,c_5FX) & (? [X7] : (c_In(X7,ordsucc(c)) & (infinite(X6) & (! [X8] : (c_Subq(X8,X6) => (equip(X8,ordsucc(n)) => (c_5FC(X8) = X7)))))))))).
fof(c_L1,axiom,(! [X6] : (c_Subq(X6,c_5FX) => (infinite(X6) => (? [X7] : (c_Subq(X7,X6) & (? [X8] : (c_In(X8,X6) & ((nIn(X8,X7) & infinite(X7)) & (! [X9] : (c_Subq(X9,X7) => (equip(X9,n) => (c_5FC(binunion(X9,c_Sing(c_X8))) = c))))))))))))).
fof(c_H,axiom,((! [X6] : (nat_5Fp(X6) => (c_Subq(f_5F27(X6),c_5FX) & infinite(f_5F27(X6))))) & (! [X6] : (c_In(X6,omega) => (! [X7] : (c_In(X7,omega) => (c_Subq(X6,X7) => c_Subq(f_5F27(X7),f_5F27(c_X6))))))))).
fof(c_Hf_271,axiom,(! [X6] : (nat_5Fp(X6) => (c_Subq(f_5F27(X6),c_5FX) & infinite(f_5F27(X6)))))).
fof(c_Hgf_27mm_27Subq,axiom,(! [X6] : (c_In(X6,omega) => (! [X7] : (c_In(X7,omega) => (c_Subq(X6,X7) => c_Subq(f_5F27(X7),f_5F27(c_X6)))))))).
fof(c_Lf_271,axiom,(! [X6] : (nat_5Fp(X6) => (c_Subq(f_5F27(X6),c_5FX) & infinite(f_5F27(X6)))))).
fof(c_Hm,axiom,c_In(m,omega)).
fof(conj_hammer_test_2544,conjecture,(! [X6] : (nat_5Fp(X6) => (c_Subq(f_5F27(add_5Fnat(m,X6)),f_5F27(m)) => c_Subq(f_5F27(add_5Fnat(m,ordsucc(X6))),f_5F27(m)))))).
