...
fof(c_H1,axiom,(! [X1] : (! [X2] : (c_SNo(X1) => (c_SNo(X2) => ((! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(X1))) => c_5FP(X3,X2))) => ((! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(X2))) => c_5FP(c_X1,X3))) => ((! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(X1))) => (! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X2))) => c_5FP(X3,X4))))) => c_5FP(X1,X2))))))))).
fof(c_L1,axiom,(! [X1] : (ordinal(X1) => (! [X2] : (ordinal(X2) => (! [X3] : (c_In(X3,c_SNoS_5F(X1)) => (! [X4] : (c_In(X4,c_SNoS_5F(X2)) => c_5FP(X3,X4)))))))))).
fof(conj_hammer_test_5435,conjecture,(! [X1] : (! [X2] : (c_SNo(X1) => (c_SNo(X2) => c_5FP(X1,X2)))))).
