...
fof(c_Hu,axiom,c_In(u,c_SNoL(add_5FSNo(y,z)))).
fof(c_Hwu,axiom,(w = add_5FSNo(x,u))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(y,z)))).
fof(c_Hu3,axiom,c_SNoLt(u,add_5FSNo(y,z))).
fof(conj_hammer_test_6492,conjecture,((? [X5] : (c_In(X5,c_SNoL(y)) & c_SNoLe(u,add_5FSNo(X5,z)))) => c_SNoLt(add_5FSNo(x,u),add_5FSNo(add_5FSNo(x,y),z)))).
