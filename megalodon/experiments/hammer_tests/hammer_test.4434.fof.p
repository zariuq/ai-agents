...
fof(c_HC,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HC,axiom,((! [X5] : (c_In(X5,c_5FL) => c_SNo(X5))) & (! [X5] : (c_In(X5,c_5FR) => c_SNo(X5))))).
fof(c_HL,axiom,(! [X5] : (c_In(X5,c_5FL) => c_SNo(X5)))).
fof(c_HR,axiom,(! [X5] : (c_In(X5,c_5FR) => c_SNo(X5)))).
fof(c_HLR,axiom,(! [X5] : (c_In(X5,c_5FL) => (! [X6] : (c_In(X6,c_5FR) => c_SNoLt(X5,X6)))))).
fof(c_LNoC,axiom,c_SNo(c_SNoCut(c_5FL,c_5FR))).
fof(c_LLC,axiom,ordinal(c_SNoLev(c_SNoCut(c_5FL,c_5FR)))).
fof(c_LL,axiom,(! [X5] : (c_In(X5,c_5FL) => c_SNoLt(X5,c_SNoCut(c_5FL,c_5FR))))).
fof(c_LR,axiom,(! [X5] : (c_In(X5,c_5FR) => c_SNoLt(c_SNoCut(c_5FL,c_5FR),X5)))).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_H10,axiom,(! [X5] : (c_In(X5,c_5FL) => c_SNoLt(X5,z)))).
fof(c_H11,axiom,(! [X5] : (c_In(X5,c_5FR) => c_SNoLt(z,X5)))).
fof(c_LLz,axiom,ordinal(c_SNoLev(z))).
fof(c_H15,axiom,c_In(delta,z)).
fof(c_Ld,axiom,ordinal(delta)).
fof(c_Lsd,axiom,ordinal(ordsucc(delta))).
fof(c_He,axiom,c_In(eps,ordsucc(delta))).
fof(c_He1,axiom,c_In(eps,delta)).
fof(conj_hammer_test_4434,conjecture,(c_In(eps,z) <=> (c_In(eps,z) | (eps = delta)))).
