...
fof(c_IH,axiom,(! [X5] : (c_In(X5,n) => (! [X6] : (c_SNo(X6) => ((c_SNoLev(X6) = X5) => diadic_5Frational_5Fp(X6))))))).
fof(c_Hx,axiom,c_SNo(x)).
fof(c_Hxn,axiom,(c_SNoLev(x) = n)).
fof(c_HC,axiom,~ diadic_5Frational_5Fp(x)).
fof(c_LxSo,axiom,c_In(x,c_SNoS_5F(omega))).
fof(c_L1,axiom,(? [X5] : c_SNo_5Fmax_5Fof(c_SNoL(x),X5))).
fof(c_L2,axiom,(? [X5] : c_SNo_5Fmin_5Fof(c_SNoR(x),X5))).
fof(c_Hy,axiom,c_SNo_5Fmax_5Fof(c_SNoL(x),y)).
fof(c_H,axiom,(c_In(y,c_SNoL(x)) & c_SNo(y))).
fof(c_Hy1,axiom,c_In(y,c_SNoL(x))).
fof(c_Hy2,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => (c_SNo(X5) => c_SNoLe(X5,y))))).
fof(c__5F,axiom,c_SNo(y)).
fof(c_Hy1b,axiom,c_In(c_SNoLev(y),c_SNoLev(x))).
fof(c_Hy1c,axiom,c_SNoLt(y,x)).
fof(c_Hz,axiom,c_SNo_5Fmin_5Fof(c_SNoR(x),z)).
fof(c_H,axiom,(c_In(z,c_SNoR(x)) & c_SNo(z))).
fof(c_Hz1,axiom,c_In(z,c_SNoR(x))).
fof(c_Hz2,axiom,c_SNo(z)).
fof(c_Hz3,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => (c_SNo(X5) => c_SNoLe(z,X5))))).
fof(c__5F,axiom,c_SNo(z)).
fof(c_Hz1b,axiom,c_In(c_SNoLev(z),c_SNoLev(x))).
fof(c_Hz1c,axiom,c_SNoLt(x,z)).
fof(c_Lxx,axiom,c_SNo(add_5FSNo(x,x))).
fof(c_Lyz,axiom,c_SNo(add_5FSNo(y,z))).
fof(c_Ldry,axiom,diadic_5Frational_5Fp(y)).
fof(c_Ldrz,axiom,diadic_5Frational_5Fp(z)).
fof(c_H1,axiom,c_SNoLt(add_5FSNo(y,z),add_5FSNo(x,x))).
fof(conj_hammer_test_12060,conjecture,$false).
