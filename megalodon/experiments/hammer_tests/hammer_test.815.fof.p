...
fof(c_H1,axiom,(! [X2] : (c_In(X2,c_Power(c_5FA)) => c_In(f(X2),c_5FA)))).
fof(c_H2,axiom,(! [X2] : (c_In(X2,c_Power(c_5FA)) => (! [X3] : (c_In(X3,c_Power(c_5FA)) => ((f(c_X2) = f(X3)) => (X2 = X3))))))).
fof(conj_hammer_test_815,conjecture,$false).
