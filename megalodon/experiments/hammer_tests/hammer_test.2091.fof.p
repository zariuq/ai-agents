...
fof(c_HX,axiom,finite(c_5FX)).
fof(c_Hz,axiom,nIn(z,c_5FX)).
fof(c_IH,axiom,(! [X3] : (c_Subq(X3,c_5FX) => finite(X3)))).
fof(c_H1,axiom,c_Subq(c_5FY,binunion(c_5FX,c_Sing(z)))).
fof(c_H2,axiom,c_In(z,c_5FY)).
fof(c_L1,axiom,(c_5FY = binunion(setminus(c_5FY,c_Sing(z)),c_Sing(z)))).
fof(conj_hammer_test_2091,conjecture,finite(binunion(setminus(c_5FY,c_Sing(z)),c_Sing(z)))).
