...
fof(conj_hammer_test_14543,conjecture,(c_SNoLe(ap(hR,add_5FSNo(k0,k1)),add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(w0,z1))))) => c_SNoLe(ap(hR,add_5FSNo(k0,k1)),add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(w0,z1))))))).
