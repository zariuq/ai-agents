...
fof(c_IHL,axiom,(! [X2] : (c_In(X2,c_5FL) => (minus_5FSNo(minus_5FSNo(X2)) = X2)))).
fof(c_IHR,axiom,(! [X2] : (c_In(X2,c_5FR) => (minus_5FSNo(minus_5FSNo(X2)) = X2)))).
fof(c_H,axiom,((! [X2] : (c_In(X2,c_5FL) => c_SNo(X2))) & (! [X2] : (c_In(X2,c_5FR) => c_SNo(X2))))).
fof(c_HLR1,axiom,(! [X2] : (c_In(X2,c_5FL) => c_SNo(X2)))).
fof(c_HLR2,axiom,(! [X2] : (c_In(X2,c_5FR) => c_SNo(X2)))).
fof(c_HLR3,axiom,(! [X2] : (c_In(X2,c_5FL) => (! [X3] : (c_In(X3,c_5FR) => c_SNoLt(X2,X3)))))).
fof(c_LCLR,axiom,c_SNo(c_SNoCut(c_5FL,c_5FR))).
fof(c_LmCLR,axiom,c_SNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR)))).
fof(c_LmmCLR,axiom,c_SNo(minus_5FSNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR))))).
fof(c_L1,axiom,(c_Subq(c_SNoLev(c_SNoCut(c_5FL,c_5FR)),c_SNoLev(minus_5FSNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR))))) & c_SNoEq_5F(c_SNoLev(c_SNoCut(c_5FL,c_5FR)),c_SNoCut(c_5FL,c_5FR),minus_5FSNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR)))))).
fof(conj_hammer_test_5697,conjecture,(minus_5FSNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR))) = c_SNoCut(c_5FL,c_5FR))).
