...
fof(c_Hp1,axiom,(! [X3] : (c_SNo(X3) => (c_In(c_SNoLev(X3),binintersect(c_SNoLev(x),c_SNoLev(y))) => (c_SNoEq_5F(c_SNoLev(X3),X3,x) => (c_SNoEq_5F(c_SNoLev(X3),X3,y) => (c_SNoLt(x,X3) => (c_SNoLt(X3,y) => (nIn(c_SNoLev(X3),x) => (c_In(c_SNoLev(X3),y) => p)))))))))).
fof(c_Hp2,axiom,(c_In(c_SNoLev(x),c_SNoLev(y)) => (c_SNoEq_5F(c_SNoLev(x),x,y) => (c_In(c_SNoLev(x),y) => p)))).
fof(c_Hp3,axiom,(c_In(c_SNoLev(y),c_SNoLev(x)) => (c_SNoEq_5F(c_SNoLev(y),x,y) => (nIn(c_SNoLev(y),x) => p)))).
fof(c_LLx,axiom,ordinal(c_SNoLev(x))).
fof(c_LLy,axiom,ordinal(c_SNoLev(y))).
fof(conj_hammer_test_4225,conjecture,p).
