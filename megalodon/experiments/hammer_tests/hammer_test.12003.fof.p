...
fof(c_Hx,axiom,diadic_5Frational_5Fp(x)).
fof(c_Hk,axiom,c_In(k,omega)).
fof(c_Lek,axiom,c_SNo(eps_5F(k))).
fof(c_H,axiom,(? [X6] : (c_In(X6,int) & (x = mul_5FSNo(eps_5F(k),X6))))).
fof(c_Hm,axiom,c_In(m,int)).
fof(c_Hxkm,axiom,(x = mul_5FSNo(eps_5F(k),m))).
fof(c_Lm,axiom,c_SNo(m)).
fof(c_Lekm,axiom,c_SNo(mul_5FSNo(eps_5F(k),m))).
fof(c_Hy,axiom,diadic_5Frational_5Fp(y)).
fof(c_Hl,axiom,c_In(l,omega)).
fof(c_Lel,axiom,c_SNo(eps_5F(l))).
fof(c_H,axiom,(? [X6] : (c_In(X6,int) & (y = mul_5FSNo(eps_5F(l),X6))))).
fof(c_Hn,axiom,c_In(n,int)).
fof(c_Hyln,axiom,(y = mul_5FSNo(eps_5F(l),n))).
fof(c_Ln,axiom,c_SNo(n)).
fof(c_Leln,axiom,c_SNo(mul_5FSNo(eps_5F(l),n))).
fof(c_L2l,axiom,c_In(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),l),int)).
fof(c_L2lm,axiom,c_In(mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),l),m),int)).
fof(c_L2k,axiom,c_In(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),k),int)).
fof(c_L2kn,axiom,c_In(mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),k),n),int)).
fof(conj_hammer_test_12003,conjecture,(add_5FSNo(x,y) = add_5FSNo(mul_5FSNo(mul_5FSNo(eps_5F(k),eps_5F(l)),mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),l),m)),mul_5FSNo(mul_5FSNo(eps_5F(k),eps_5F(l)),mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),k),n))))).
