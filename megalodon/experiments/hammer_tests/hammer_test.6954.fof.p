...
fof(c_Ha,axiom,c_SNo(a)).
fof(c_Hb,axiom,c_SNo(b)).
fof(c_Hc,axiom,c_SNo(c)).
fof(c_H1,axiom,c_SNoLt(add_5FSNo(x,a),add_5FSNo(b,v))).
fof(c_H2,axiom,c_SNoLt(y,add_5FSNo(c,u))).
fof(c_H3,axiom,c_SNoLt(add_5FSNo(b,c),add_5FSNo(w,a))).
fof(c_L1,axiom,c_SNoLt(add_5FSNo(b,y),add_5FSNo(w,add_5FSNo(u,a)))).
fof(c_Lxy,axiom,c_SNo(add_5FSNo(x,y))).
fof(c_Lwuv,axiom,c_SNo(add_5FSNo(w,add_5FSNo(u,v)))).
fof(c_Lwua,axiom,c_SNo(add_5FSNo(w,add_5FSNo(u,a)))).
fof(c_Lby,axiom,c_SNo(add_5FSNo(b,y))).
fof(conj_hammer_test_6954,conjecture,c_SNoLt(add_5FSNo(x,add_5FSNo(w,add_5FSNo(u,a))),add_5FSNo(add_5FSNo(w,add_5FSNo(u,v)),b))).
