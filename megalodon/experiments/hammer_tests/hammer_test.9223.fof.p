...
fof(conj_hammer_test_9223,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(y,w)))),add_5FSNo(add_5FSNo(u,mul_5FSNo(v,w)),add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(x,w))))).
