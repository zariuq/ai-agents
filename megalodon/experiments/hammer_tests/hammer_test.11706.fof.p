...
fof(c_L2npLt2n2n,axiom,(! [X5] : (c_SNo(X5) => (c_SNoLt(X5,exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => c_SNoLt(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),X5),add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))))))).
...
fof(c_Hg1,axiom,(! [X5] : (c_In(n,X5) => (g(X5) = f(binintersect(X5,c_SNoElts_5F(n))))))).
fof(c_Hg2,axiom,(! [X5] : (nIn(n,X5) => (g(X5) = add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),f(binintersect(X5,c_SNoElts_5F(n)))))))).
...
fof(conj_hammer_test_11706,conjecture,(c_SNoLev(u) = ordsucc(n))).
