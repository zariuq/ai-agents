...
fof(c_H1,axiom,~ ((a = c_Empty) & (b = c_Empty))).
fof(c_LaS,axiom,c_SNo(a)).
fof(c_LbS,axiom,c_SNo(b)).
fof(conj_hammer_test_10932,conjecture,(? [X2] : ((int_5Flin_5Fcomb(a,b,X2) & c_SNoLt(c_Empty,X2)) & (! [X3] : (int_5Flin_5Fcomb(a,b,X3) => (c_SNoLt(c_Empty,X3) => c_SNoLe(X2,X3))))))).
