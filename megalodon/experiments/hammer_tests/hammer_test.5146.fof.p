...
fof(c_H1,axiom,(! [X1] : (! [X2] : (c_SNoCutP(X1,X2) => ((! [X3] : (c_In(X3,X1) => c_5FP(X3))) => ((! [X3] : (c_In(X3,X2) => c_5FP(X3))) => c_5FP(c_SNoCut(c_X1,X2)))))))).
fof(conj_hammer_test_5146,conjecture,(! [X1] : (ordinal(X1) => ((! [X2] : (c_In(X2,X1) => (! [X3] : (c_SNo(X3) => (c_In(c_SNoLev(X3),X2) => c_5FP(X3)))))) => (! [X2] : (c_SNo(X2) => (c_In(c_SNoLev(X2),X1) => c_5FP(X2)))))))).
