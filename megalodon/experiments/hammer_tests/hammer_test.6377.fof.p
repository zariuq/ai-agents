...
fof(c_H2,axiom,(? [X5] : (c_In(X5,c_SNoL(y)) & c_SNoLe(z,add_5FSNo(x,X5))))).
fof(c_Hv,axiom,c_In(v,c_SNoL(y))).
fof(c_H3,axiom,c_SNoLe(z,add_5FSNo(x,v))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(y))).
fof(c_Hv3,axiom,c_SNoLt(v,y)).
fof(conj_hammer_test_6377,conjecture,c_SNoLe(z,add_5FSNo(x,v))).
