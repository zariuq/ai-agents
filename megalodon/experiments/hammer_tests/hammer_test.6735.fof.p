...
fof(c_H,axiom,c_TransSet(add_5FSNo(c_SNoLev(x),c_SNoLev(y)))).
fof(c__5F,axiom,(! [X5] : (c_In(X5,add_5FSNo(c_SNoLev(x),c_SNoLev(y))) => c_TransSet(X5)))).
fof(conj_hammer_test_6735,conjecture,c_Subq(add_5FSNo(c_SNoLev(x),c_SNoLev(w)),add_5FSNo(c_SNoLev(x),c_SNoLev(y)))).
