...
fof(c_L2,axiom,(? [X8] : ((ordinal(X8) & (prime_5Fnat(X8) & divides_5Fnat(X8,n))) & (! [X9] : (c_In(X9,X8) => ~ (prime_5Fnat(X9) & divides_5Fnat(X9,n))))))).
...
fof(c_Hpleast,axiom,(! [X8] : (c_In(X8,p) => ~ (prime_5Fnat(X8) & divides_5Fnat(X8,n))))).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c__5F,axiom,(! [X8] : (c_In(X8,omega) => (divides_5Fnat(X8,p) => ((X8 = ordsucc(c_Empty)) | (X8 = p)))))).
fof(c_HpN,axiom,c_In(p,omega)).
fof(c_H1p,axiom,c_In(ordsucc(c_Empty),p)).
fof(c__5F,axiom,(c_In(p,omega) & c_In(n,omega))).
fof(c_H,axiom,(? [X8] : (c_In(X8,omega) & (mul_5Fnat(p,X8) = n)))).
...
fof(c_Lf1,axiom,(! [X8] : (c_In(X8,k) => prime_5Fnat(f(X8))))).
fof(c_Lf2,axiom,(! [X8] : (c_In(X8,k) => c_In(f(X8),omega)))).
fof(c_Hgk,axiom,(g(k) = p)).
fof(c_Hgi,axiom,(! [X8] : (c_In(X8,k) => (g(X8) = f(X8))))).
fof(c_Hk_27,axiom,c_In(k_5F27,omega)).
fof(c_Lg_271,axiom,(! [X8] : (c_In(X8,k_5F27) => prime_5Fnat(g_5F27(X8))))).
fof(c_Lg_272,axiom,(! [X8] : (c_In(X8,k_5F27) => c_In(g_5F27(X8),omega)))).
fof(c_Lk_27N,axiom,nat_5Fp(k_5F27)).
fof(conj_hammer_test_11341,conjecture,((k_5F27 = c_Empty) => ((k_5F27 = ordsucc(k)) & (! [X8] : (c_In(X8,ordsucc(k)) => (g_5F27(X8) = g(X8))))))).
