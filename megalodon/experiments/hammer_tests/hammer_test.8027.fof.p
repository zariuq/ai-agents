...
fof(conj_hammer_test_8027,conjecture,(c_In(c_SNoLev(v),c_SNoLev(y)) => (c_SNoEq_5F(c_SNoLev(v),v,y) => (c_In(c_SNoLev(v),y) => c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,v)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,v))))))).
