...
fof(c_Hu,axiom,c_In(u,c_SNoL(mul_5FSNo(y,z)))).
fof(c_Hu_27u,axiom,(u_5F27 = add_5FSNo(mul_5FSNo(x,z),u))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(mul_5FSNo(y,z)))).
fof(c_Hu3,axiom,c_SNoLt(u,mul_5FSNo(y,z))).
fof(c_Hv,axiom,c_In(v,c_SNoR(y))).
fof(c_Hw,axiom,c_In(w,c_SNoR(z))).
fof(c_Hvw,axiom,c_SNoLe(add_5FSNo(u,mul_5FSNo(v,w)),add_5FSNo(mul_5FSNo(v,z),mul_5FSNo(y,w)))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(y))).
fof(c_Hv3,axiom,c_SNoLt(y,v)).
...
fof(c_Lxv,axiom,c_SNo(add_5FSNo(x,v))).
...
fof(c_Luxz,axiom,c_SNo(add_5FSNo(u,mul_5FSNo(x,z)))).
fof(c_Lvwxw,axiom,c_SNo(add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(x,w)))).
fof(c_Lvzxw,axiom,c_SNo(add_5FSNo(mul_5FSNo(v,z),mul_5FSNo(x,w)))).
fof(conj_hammer_test_9043,conjecture,c_SNoLe(add_5FSNo(add_5FSNo(u,mul_5FSNo(v,w)),add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(x,w))),add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(y,w)))))).
