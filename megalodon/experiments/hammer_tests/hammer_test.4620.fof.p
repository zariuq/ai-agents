...
fof(c_LC,axiom,c_SNoCutP(c_SNoL(z),c_SNoR(z))).
fof(c_H1,axiom,c_SNo(c_SNoCut(c_SNoL(z),c_SNoR(z)))).
fof(c_H3,axiom,(! [X1] : (c_In(X1,c_SNoL(z)) => c_SNoLt(X1,c_SNoCut(c_SNoL(z),c_SNoR(z)))))).
fof(c_H4,axiom,(! [X1] : (c_In(X1,c_SNoR(z)) => c_SNoLt(c_SNoCut(c_SNoL(z),c_SNoR(z)),X1)))).
fof(c_L4,axiom,ordinal(c_SNoLev(c_SNoCut(c_SNoL(z),c_SNoR(z))))).
fof(c_L5,axiom,(! [X1] : (c_In(X1,c_SNoL(z)) => c_SNoLt(X1,z)))).
fof(c_L6,axiom,(! [X1] : (c_In(X1,c_SNoR(z)) => c_SNoLt(z,X1)))).
fof(c_H6,axiom,c_Subq(c_SNoLev(c_SNoCut(c_SNoL(z),c_SNoR(z))),c_SNoLev(z))).
fof(c_H8,axiom,(c_In(c_SNoLev(c_SNoCut(c_SNoL(z),c_SNoR(z))),c_SNoLev(z)) | (c_SNoLev(c_SNoCut(c_SNoL(z),c_SNoR(z))) = c_SNoLev(z)))).
fof(conj_hammer_test_4620,conjecture,(c_SNoLev(c_SNoCut(c_SNoL(z),c_SNoR(z))) = c_SNoLev(z))).
