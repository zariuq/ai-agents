...
fof(c_H1m,axiom,c_In(ordsucc(c_Empty),m)).
fof(c_H1,axiom,divides_5Fnat(m,n)).
fof(c_H2,axiom,divides_5Fnat(m,ordsucc(n))).
fof(c_H,axiom,(c_In(m,omega) & c_In(n,omega))).
fof(c_Hm,axiom,c_In(m,omega)).
fof(c_Hn,axiom,c_In(n,omega)).
fof(c_H,axiom,(? [X4] : (c_In(X4,omega) & (mul_5Fnat(m,X4) = n)))).
fof(c_Hk,axiom,c_In(k,omega)).
fof(c_Hmk,axiom,(mul_5Fnat(m,k) = n)).
fof(c__5F,axiom,(c_In(m,omega) & c_In(ordsucc(n),omega))).
fof(c_H,axiom,(? [X4] : (c_In(X4,omega) & (mul_5Fnat(m,X4) = ordsucc(n))))).
fof(c_Hk_27,axiom,c_In(k_5F27,omega)).
fof(c_Hmk_27,axiom,(mul_5Fnat(m,k_5F27) = ordsucc(n))).
fof(c_Lm,axiom,nat_5Fp(m)).
fof(c_Ln,axiom,nat_5Fp(n)).
fof(c_Lk,axiom,nat_5Fp(k)).
fof(c_Lk_27,axiom,nat_5Fp(k_5F27)).
fof(c_L1,axiom,(add_5Fnat(ordsucc(c_Empty),n) = ordsucc(n))).
fof(conj_hammer_test_2192,conjecture,$false).
