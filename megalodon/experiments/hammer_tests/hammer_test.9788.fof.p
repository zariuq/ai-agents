...
fof(conj_hammer_test_9788,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNoLe(c_Empty,X0) => (c_SNoLe(c_Empty,X1) => (c_SNoLe(X0,X2) => (c_SNoLe(X1,X3) => c_SNoLe(mul_5FSNo(X0,X1),mul_5FSNo(X2,X3))))))))))))))).
