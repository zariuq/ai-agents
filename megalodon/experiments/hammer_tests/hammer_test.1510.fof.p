...
fof(conj_hammer_test_1510,conjecture,(! [X1] : (nat_5Fp(X1) => ((add_5Fnat(ordsucc(n),X1) = ordsucc(add_5Fnat(n,X1))) => (add_5Fnat(ordsucc(n),ordsucc(X1)) = ordsucc(add_5Fnat(n,ordsucc(X1)))))))).
