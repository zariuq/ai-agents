...
fof(c_SNo_5FM,axiom,(! [X10] : (! [X11] : (c_SNo(X10) => (c_SNo(X11) => c_SNo(c_5FM(X10,X11))))))).
fof(c_DL,axiom,(! [X10] : (! [X11] : (! [X12] : (c_SNo(X10) => (c_SNo(X11) => (c_SNo(X12) => (c_5FM(c_X10,add_5FSNo(X11,X12)) = add_5FSNo(c_5FM(c_X10,X11),c_5FM(c_X10,X12)))))))))).
fof(c_DR,axiom,(! [X10] : (! [X11] : (! [X12] : (c_SNo(X10) => (c_SNo(X11) => (c_SNo(X12) => (c_5FM(add_5FSNo(c_X10,X11),X12) = add_5FSNo(c_5FM(c_X10,X12),c_5FM(X11,X12)))))))))).
fof(c_M_5FLt,axiom,(! [X10] : (! [X11] : (! [X12] : (! [X13] : (c_SNo(X10) => (c_SNo(X11) => (c_SNo(X12) => (c_SNo(X13) => (c_SNoLt(X12,X10) => (c_SNoLt(X13,X11) => c_SNoLt(add_5FSNo(c_5FM(X12,c_X11),c_5FM(c_X10,X13)),add_5FSNo(c_5FM(c_X10,c_X11),c_5FM(X12,X13)))))))))))))).
fof(c_M_5FLe,axiom,(! [X10] : (! [X11] : (! [X12] : (! [X13] : (c_SNo(X10) => (c_SNo(X11) => (c_SNo(X12) => (c_SNo(X13) => (c_SNoLe(X12,X10) => (c_SNoLe(X13,X11) => c_SNoLe(add_5FSNo(c_5FM(X12,c_X11),c_5FM(c_X10,X13)),add_5FSNo(c_5FM(c_X10,c_X11),c_5FM(X12,X13)))))))))))))).
fof(c_Hx,axiom,c_SNo(x)).
fof(c_Hy,axiom,c_SNo(y)).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_IHx,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(x))) => (c_5FM(X10,c_5FM(y,z)) = c_5FM(c_5FM(X10,y),z))))).
fof(c_IHy,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(y))) => (c_5FM(x,c_5FM(X10,z)) = c_5FM(c_5FM(x,X10),z))))).
fof(c_IHz,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(x,c_5FM(y,X10)) = c_5FM(c_5FM(x,y),X10))))).
fof(c_IHxy,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(x))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(y))) => (c_5FM(X10,c_5FM(X11,z)) = c_5FM(c_5FM(X10,X11),z))))))).
fof(c_IHxz,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(x))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(X10,c_5FM(y,X11)) = c_5FM(c_5FM(X10,y),X11))))))).
fof(c_IHyz,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(y))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(x,c_5FM(X10,X11)) = c_5FM(c_5FM(x,X10),X11))))))).
fof(c_IHxyz,axiom,(! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(x))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(y))) => (! [X12] : (c_In(X12,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(c_X10,c_5FM(X11,X12)) = c_5FM(c_5FM(c_X10,X11),X12))))))))).
fof(c_Hu,axiom,c_In(u,c_5FR)).
fof(c_Lxy,axiom,c_SNo(c_5FM(x,y))).
fof(c_Lyz,axiom,c_SNo(c_5FM(y,z))).
fof(c_Lxyz2,axiom,c_SNo(c_5FM(c_5FM(x,y),z))).
fof(c_Hv,axiom,c_In(v,c_SNoS_5F(c_SNoLev(x)))).
fof(c_Hw,axiom,c_SNo(w)).
fof(c_Hw1,axiom,c_In(w1,c_SNoS_5F(c_SNoLev(y)))).
fof(c_Hw2,axiom,c_In(w2,c_SNoS_5F(c_SNoLev(z)))).
fof(c_Hue,axiom,(u = add_5FSNo(c_5FM(v,c_5FM(y,z)),add_5FSNo(c_5FM(x,w),minus_5FSNo(c_5FM(v,w)))))).
fof(c_H1,axiom,c_SNoLe(add_5FSNo(c_5FM(x,add_5FSNo(c_5FM(w1,z),c_5FM(y,w2))),c_5FM(v,add_5FSNo(w,c_5FM(w1,w2)))),add_5FSNo(c_5FM(v,add_5FSNo(c_5FM(w1,z),c_5FM(y,w2))),c_5FM(x,add_5FSNo(w,c_5FM(w1,w2)))))).
fof(c_H2,axiom,c_SNoLt(add_5FSNo(c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(v,w1)),z),c_5FM(add_5FSNo(c_5FM(v,y),c_5FM(x,w1)),w2)),add_5FSNo(c_5FM(add_5FSNo(c_5FM(v,y),c_5FM(x,w1)),z),c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(v,w1)),w2)))).
fof(c_Hv1,axiom,c_In(c_SNoLev(v),c_SNoLev(x))).
fof(c_Hv2,axiom,ordinal(c_SNoLev(v))).
fof(c_Hv3,axiom,c_SNo(v)).
fof(c_Hv4,axiom,c_SNo_5F(c_SNoLev(v),v)).
fof(c_Hw11,axiom,c_In(c_SNoLev(w1),c_SNoLev(y))).
fof(c_Hw12,axiom,ordinal(c_SNoLev(w1))).
fof(c_Hw13,axiom,c_SNo(w1)).
fof(c_Hw14,axiom,c_SNo_5F(c_SNoLev(w1),w1)).
fof(c_Hw21,axiom,c_In(c_SNoLev(w2),c_SNoLev(z))).
fof(c_Hw22,axiom,ordinal(c_SNoLev(w2))).
fof(c_Hw23,axiom,c_SNo(w2)).
fof(c_Hw24,axiom,c_SNo_5F(c_SNoLev(w2),w2)).
fof(c_Lvyz,axiom,c_SNo(c_5FM(v,c_5FM(y,z)))).
fof(c_Lxw,axiom,c_SNo(c_5FM(x,w))).
fof(c_Lxw1,axiom,c_SNo(c_5FM(x,w1))).
fof(c_Lvw,axiom,c_SNo(c_5FM(v,w))).
fof(c_Lvw1,axiom,c_SNo(c_5FM(v,w1))).
fof(c_Lvy,axiom,c_SNo(c_5FM(v,y))).
fof(c_Lw1z,axiom,c_SNo(c_5FM(w1,z))).
fof(c_Lyw2,axiom,c_SNo(c_5FM(y,w2))).
fof(c_Lvw1z,axiom,c_SNo(c_5FM(v,c_5FM(w1,z)))).
fof(c_Lvyw2,axiom,c_SNo(c_5FM(v,c_5FM(y,w2)))).
fof(c_Lw1w2,axiom,c_SNo(c_5FM(w1,w2))).
fof(c_Lxw1w2,axiom,c_SNo(c_5FM(x,c_5FM(w1,w2)))).
fof(c_Lxw1z,axiom,c_SNo(c_5FM(x,c_5FM(w1,z)))).
fof(c_Lxyw2,axiom,c_SNo(c_5FM(x,c_5FM(y,w2)))).
fof(c_Lvyzxw,axiom,c_SNo(add_5FSNo(c_5FM(v,c_5FM(y,z)),c_5FM(x,w)))).
fof(c_Lxyzvw,axiom,c_SNo(add_5FSNo(c_5FM(c_5FM(x,y),z),c_5FM(v,w)))).
fof(c_Lvw1w2,axiom,c_SNo(c_5FM(v,c_5FM(w1,w2)))).
fof(c_Lww1w2,axiom,c_SNo(add_5FSNo(w,c_5FM(w1,w2)))).
fof(c_Lvww1w2,axiom,c_SNo(c_5FM(v,add_5FSNo(w,c_5FM(w1,w2))))).
fof(c_Lvw1zyw2,axiom,c_SNo(c_5FM(v,add_5FSNo(c_5FM(w1,z),c_5FM(y,w2))))).
fof(c_Lvwvw1w2,axiom,c_SNo(add_5FSNo(c_5FM(v,w),c_5FM(v,c_5FM(w1,w2))))).
fof(c_Lvyzxw1zxyw2vwvw1w2,axiom,c_SNo(add_5FSNo(c_5FM(v,c_5FM(y,z)),add_5FSNo(c_5FM(x,c_5FM(w1,z)),add_5FSNo(c_5FM(x,c_5FM(y,w2)),add_5FSNo(c_5FM(v,w),c_5FM(v,c_5FM(w1,w2)))))))).
fof(c_Lvw1zvyw2xw1w2,axiom,c_SNo(add_5FSNo(c_5FM(v,c_5FM(w1,z)),add_5FSNo(c_5FM(v,c_5FM(y,w2)),c_5FM(x,c_5FM(w1,w2)))))).
fof(conj_hammer_test_9588,conjecture,c_SNoLe(add_5FSNo(c_5FM(v,c_5FM(y,z)),add_5FSNo(c_5FM(x,c_5FM(w1,z)),add_5FSNo(c_5FM(x,c_5FM(y,w2)),add_5FSNo(c_5FM(v,w),c_5FM(v,c_5FM(w1,w2)))))),add_5FSNo(add_5FSNo(c_5FM(v,c_5FM(y,z)),c_5FM(x,w)),add_5FSNo(c_5FM(v,c_5FM(w1,z)),add_5FSNo(c_5FM(v,c_5FM(y,w2)),c_5FM(x,c_5FM(w1,w2))))))).
