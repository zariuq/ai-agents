...
fof(c_LI,axiom,(! [X2] : (c_SNo(X2) => (c_In(c_SNoLev(X2),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(X2,add_5FSNo(x,y)) => ((? [X3] : (c_In(X3,c_SNoL(x)) & c_SNoLe(X2,add_5FSNo(X3,y)))) | (? [X3] : (c_In(X3,c_SNoL(y)) & c_SNoLe(X2,add_5FSNo(x,X3)))))))))).
fof(conj_hammer_test_6380,conjecture,(! [X2] : (c_In(X2,c_SNoL(add_5FSNo(x,y))) => ((? [X3] : (c_In(X3,c_SNoL(x)) & c_SNoLe(X2,add_5FSNo(X3,y)))) | (? [X3] : (c_In(X3,c_SNoL(y)) & c_SNoLe(X2,add_5FSNo(x,X3)))))))).
