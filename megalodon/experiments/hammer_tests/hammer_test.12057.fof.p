...
fof(c_IH,axiom,(! [X4] : (c_In(X4,n) => (! [X5] : (c_SNo(X5) => ((c_SNoLev(X5) = X4) => diadic_5Frational_5Fp(X5))))))).
...
fof(c_L1,axiom,(? [X4] : c_SNo_5Fmax_5Fof(c_SNoL(x),X4))).
fof(c_L2,axiom,(? [X4] : c_SNo_5Fmin_5Fof(c_SNoR(x),X4))).
...
fof(c_Hy3,axiom,(! [X4] : (c_In(X4,c_SNoL(x)) => (c_SNo(X4) => c_SNoLe(X4,y))))).
...
fof(c_Hz3,axiom,(! [X4] : (c_In(X4,c_SNoR(x)) => (c_SNo(X4) => c_SNoLe(z,X4))))).
...
fof(conj_hammer_test_12057,conjecture,((add_5FSNo(x,x) = add_5FSNo(y,z)) => $false)).
