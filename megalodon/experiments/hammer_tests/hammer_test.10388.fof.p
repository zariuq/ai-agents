...
fof(c_Hw1a,axiom,c_SNo(w1)).
fof(c_Hw1b,axiom,c_In(c_SNoLev(w1),c_SNoLev(y))).
fof(c_Hw1c,axiom,c_SNoLt(w1,y)).
fof(c_L8,axiom,(? [X13] : (c_In(X13,c_5FRx) & c_SNoLe(X13,z0)))).
fof(c_L9,axiom,(? [X13] : (c_In(X13,c_5FLy) & c_SNoLe(w1,X13)))).
fof(c_Hz0_271,axiom,c_In(z0_5F27,c_5FRx)).
fof(c_Hz0_272,axiom,c_SNoLe(z0_5F27,z0)).
fof(c_Hw1_271,axiom,c_In(w1_5F27,c_5FLy)).
fof(c_Hw1_272,axiom,c_SNoLe(w1,w1_5F27)).
fof(conj_hammer_test_10388,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(z0_5F27,y),add_5FSNo(mul_5FSNo(x,w1_5F27),mul_5FSNo(z0,w1))),add_5FSNo(mul_5FSNo(z0_5F27,y),add_5FSNo(mul_5FSNo(x,w1),mul_5FSNo(z0,w1_5F27))))).
