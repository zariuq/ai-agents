...
fof(conj_hammer_test_9676,conjecture,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X8,X7),z) = mul_5FSNo(X8,mul_5FSNo(X7,z)))))))).
