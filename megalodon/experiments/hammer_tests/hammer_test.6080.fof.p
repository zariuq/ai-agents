...
fof(c_IHx,axiom,(! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(x))) => (add_5FSNo(X2,y) = add_5FSNo(y,X2))))).
fof(c_IHy,axiom,(! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(y))) => (add_5FSNo(x,X2) = add_5FSNo(X2,x))))).
fof(c_IHxy,axiom,(! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(x))) => (! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(y))) => (add_5FSNo(X2,X3) = add_5FSNo(X3,X2))))))).
fof(c_IHLx,axiom,(! [X2] : (c_In(X2,c_SNoL(x)) => (add_5FSNo(X2,y) = add_5FSNo(y,X2))))).
fof(c_IHRx,axiom,(! [X2] : (c_In(X2,c_SNoR(x)) => (add_5FSNo(X2,y) = add_5FSNo(y,X2))))).
fof(c_IHLy,axiom,(! [X2] : (c_In(X2,c_SNoL(y)) => (add_5FSNo(x,X2) = add_5FSNo(X2,x))))).
fof(conj_hammer_test_6080,conjecture,(! [X2] : (c_In(X2,c_SNoR(y)) => (add_5FSNo(x,X2) = add_5FSNo(X2,x))))).
