...
fof(conj_hammer_test_14035,conjecture,c_SNoLe(add_5FSNo(add_5FSNo(mul_5FSNo(x,w),add_5FSNo(minus_5FSNo(mul_5FSNo(x,y)),add_5FSNo(minus_5FSNo(mul_5FSNo(v,w)),mul_5FSNo(v,y)))),mul_5FSNo(x,y)),q)).
