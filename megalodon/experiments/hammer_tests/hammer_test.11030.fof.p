...
fof(c_Hm,axiom,c_In(m,setminus(omega,c_Sing(c_Empty)))).
fof(c_Hm1,axiom,c_In(m,omega)).
fof(c_Hm2,axiom,nIn(m,c_Sing(c_Empty))).
fof(c_LmN,axiom,nat_5Fp(m)).
fof(c_Lmo,axiom,ordinal(m)).
fof(c_LmZ,axiom,c_In(m,int)).
fof(c_LmS,axiom,c_SNo(m)).
fof(c_Lmpos,axiom,c_SNoLt(c_Empty,m)).
fof(conj_hammer_test_11030,conjecture,((divides_5Fint(m,m) & divides_5Fint(m,m)) & (! [X1] : (divides_5Fint(X1,m) => (divides_5Fint(X1,m) => c_SNoLe(X1,m)))))).
