...
fof(c_Hu0,axiom,c_In(u0,c_SNoS_5F(c_SNoLev(x)))).
fof(c_Hv0,axiom,c_In(v0,c_SNoS_5F(c_SNoLev(x)))).
fof(c_Hu1,axiom,c_In(u1,c_SNoS_5F(c_SNoLev(y)))).
fof(c_Hv1,axiom,c_In(v1,c_SNoS_5F(c_SNoLev(y)))).
fof(c_Hu1a,axiom,c_In(c_SNoLev(u1),c_SNoLev(y))).
fof(c_Hu1b,axiom,ordinal(c_SNoLev(u1))).
fof(c_Hu1c,axiom,c_SNo(u1)).
fof(c__5F,axiom,c_SNo_5F(c_SNoLev(u1),u1)).
fof(c_Hv1a,axiom,c_In(c_SNoLev(v1),c_SNoLev(y))).
fof(c_Hv1b,axiom,ordinal(c_SNoLev(v1))).
fof(c_Hv1c,axiom,c_SNo(v1)).
fof(c__5F,axiom,c_SNo_5F(c_SNoLev(v1),v1)).
...
fof(c_Hp,axiom,(c_SNo(mul_5FSNo(u0,y)) => (c_SNo(mul_5FSNo(x,u1)) => (c_SNo(mul_5FSNo(u0,u1)) => (c_SNo(mul_5FSNo(v0,y)) => (c_SNo(mul_5FSNo(x,v1)) => (c_SNo(mul_5FSNo(v0,v1)) => (c_SNo(mul_5FSNo(u0,v1)) => (c_SNo(mul_5FSNo(v0,u1)) => (((u = add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),minus_5FSNo(mul_5FSNo(u0,u1))))) => ((v = add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),minus_5FSNo(mul_5FSNo(v0,v1))))) => (c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))) => c_SNoLt(u,v)))) => p)))))))))).
...
fof(c_H1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
fof(c_L1,axiom,(add_5FSNo(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),minus_5FSNo(mul_5FSNo(u0,u1)))),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(v0,v1))) = add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))))).
fof(c_L2,axiom,(add_5FSNo(add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),minus_5FSNo(mul_5FSNo(v0,v1)))),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(v0,v1))) = add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
fof(conj_hammer_test_7302,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
