...
fof(c_L2n1,axiom,nat_5Fp(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_L2n2,axiom,ordinal(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_L2n3,axiom,c_SNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_L2n2n1,axiom,nat_5Fp(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_L2n2n2,axiom,ordinal(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_L2n2n3,axiom,c_SNo(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_L2npLt2n2n,axiom,(! [X6] : (c_SNo(X6) => (c_SNoLt(X6,exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => c_SNoLt(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),X6),add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))))))).
fof(c_L2nLt2n2n,axiom,c_SNoLt(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_Hg1,axiom,(! [X6] : (c_In(n,X6) => (g(X6) = f(binintersect(X6,c_SNoElts_5F(n))))))).
fof(c_Hg2,axiom,(! [X6] : (nIn(n,X6) => (g(X6) = add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),f(binintersect(X6,c_SNoElts_5F(n)))))))).
fof(c_Hu0a,axiom,c_SNo(u)).
fof(c_Hu0b,axiom,(c_SNoLev(u) = ordsucc(n))).
fof(c_Hu2,axiom,c_SNo(binintersect(u,c_SNoElts_5F(n)))).
fof(c_Hu3,axiom,(c_SNoLev(binintersect(u,c_SNoElts_5F(n))) = n)).
fof(c_Lfu1,axiom,nat_5Fp(f(binintersect(u,c_SNoElts_5F(n))))).
fof(c_Lfu2,axiom,ordinal(f(binintersect(u,c_SNoElts_5F(n))))).
fof(c_Lfu3,axiom,c_SNo(f(binintersect(u,c_SNoElts_5F(n))))).
fof(c_Lfu4,axiom,c_SNoLt(f(binintersect(u,c_SNoElts_5F(n))),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_Hv0a,axiom,c_SNo(v)).
fof(c_Hv0b,axiom,(c_SNoLev(v) = ordsucc(n))).
fof(c_Hv2,axiom,c_SNo(binintersect(v,c_SNoElts_5F(n)))).
fof(c_Hv3,axiom,(c_SNoLev(binintersect(v,c_SNoElts_5F(n))) = n)).
fof(c_Lfv1,axiom,nat_5Fp(f(binintersect(v,c_SNoElts_5F(n))))).
fof(c_Lfv2,axiom,ordinal(f(binintersect(v,c_SNoElts_5F(n))))).
fof(c_Lfv3,axiom,c_SNo(f(binintersect(v,c_SNoElts_5F(n))))).
fof(c_Lfv4,axiom,c_SNoLt(f(binintersect(v,c_SNoElts_5F(n))),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_LnLu,axiom,c_In(n,c_SNoLev(u))).
fof(c_LnLv,axiom,c_In(n,c_SNoLev(v))).
fof(c_H1,axiom,nIn(n,u)).
fof(c_H2,axiom,nIn(n,v)).
fof(c_Hguv,axiom,(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),f(binintersect(u,c_SNoElts_5F(n)))) = add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),f(binintersect(v,c_SNoElts_5F(n)))))).
fof(c_Luv,axiom,(binintersect(u,c_SNoElts_5F(n)) = binintersect(v,c_SNoElts_5F(n)))).
fof(c_Hi,axiom,c_In(i,ordsucc(n))).
fof(c_H3,axiom,c_In(i,n)).
fof(conj_hammer_test_11721,conjecture,(c_In(i,binintersect(v,c_SNoElts_5F(n))) <=> c_In(i,v))).
