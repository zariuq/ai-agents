...
fof(c_HLRx1,axiom,(! [X11] : (c_In(X11,c_5FLx) => c_SNo(X11)))).
fof(c_HLRx2,axiom,(! [X11] : (c_In(X11,c_5FRx) => c_SNo(X11)))).
fof(c_HLRx3,axiom,(! [X11] : (c_In(X11,c_5FLx) => (! [X12] : (c_In(X12,c_5FRx) => c_SNoLt(X11,X12)))))).
fof(c_H,axiom,((! [X11] : (c_In(X11,c_5FLy) => c_SNo(X11))) & (! [X11] : (c_In(X11,c_5FRy) => c_SNo(X11))))).
fof(c_HLRy1,axiom,(! [X11] : (c_In(X11,c_5FLy) => c_SNo(X11)))).
fof(c_HLRy2,axiom,(! [X11] : (c_In(X11,c_5FRy) => c_SNo(X11)))).
fof(c_HLRy3,axiom,(! [X11] : (c_In(X11,c_5FLy) => (! [X12] : (c_In(X12,c_5FRy) => c_SNoLt(X11,X12)))))).
...
fof(c_HL_27I1,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FL_5F27)))))).
fof(c_HL_27I2,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FL_5F27)))))).
fof(c_HR_27I1,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FR_5F27)))))).
fof(c_HR_27I2,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FR_5F27)))))).
...
fof(c_L8,axiom,(? [X11] : (c_In(X11,c_5FRx) & c_SNoLe(X11,z0)))).
fof(conj_hammer_test_10343,conjecture,(? [X11] : (c_In(X11,c_5FLy) & c_SNoLe(w1,X11)))).
