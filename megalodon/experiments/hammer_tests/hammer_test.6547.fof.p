...
fof(c_Hu,axiom,c_In(u,c_SNoR(add_5FSNo(x,y)))).
fof(c_Hvu,axiom,(v = add_5FSNo(u,z))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(add_5FSNo(x,y),u)).
fof(conj_hammer_test_6547,conjecture,((? [X5] : (c_In(X5,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X5),u))) => c_SNoLt(add_5FSNo(x,add_5FSNo(y,z)),add_5FSNo(u,z)))).
