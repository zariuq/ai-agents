...
fof(c_Hzu0,axiom,c_In(z,c_SNoL(u0))).
fof(c_Hzv0,axiom,c_In(z,c_SNoR(v0))).
fof(c_L4,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(z,v1)),add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(u0,v1)))).
fof(c_L5,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(z,v1)))).
fof(c_Lz,axiom,c_In(z,c_SNoL(x))).
fof(conj_hammer_test_7374,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
