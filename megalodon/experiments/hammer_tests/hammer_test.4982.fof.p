...
fof(c_Hm,axiom,c_In(m,ordsucc(n))).
fof(c_Lm,axiom,nat_5Fp(m)).
fof(c_H1,axiom,(? [X3] : (nat_5Fp(X3) & (m = ordsucc(X3))))).
fof(c_Hk,axiom,nat_5Fp(k)).
fof(c_Hmk,axiom,(m = ordsucc(k))).
fof(c_Lm,axiom,nat_5Fp(m)).
fof(c_LSk,axiom,c_In(ordsucc(k),ordsucc(n))).
fof(conj_hammer_test_4982,conjecture,c_In(k,n)).
