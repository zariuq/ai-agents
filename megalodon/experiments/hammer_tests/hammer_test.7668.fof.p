...
fof(c_HLI1,axiom,(! [X4] : (c_In(X4,c_SNoL(x)) => (! [X5] : (c_In(X5,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X4,y),add_5FSNo(mul_5FSNo(x,X5),minus_5FSNo(mul_5FSNo(X4,X5)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X4] : (c_In(X4,c_SNoR(x)) => (! [X5] : (c_In(X5,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X4,y),add_5FSNo(mul_5FSNo(x,X5),minus_5FSNo(mul_5FSNo(X4,X5)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X4] : (c_In(X4,c_SNoL(x)) => (! [X5] : (c_In(X5,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X4,y),add_5FSNo(mul_5FSNo(x,X5),minus_5FSNo(mul_5FSNo(X4,X5)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X4] : (c_In(X4,c_SNoR(x)) => (! [X5] : (c_In(X5,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X4,y),add_5FSNo(mul_5FSNo(x,X5),minus_5FSNo(mul_5FSNo(X4,X5)))),c_5FR)))))).
fof(c_Hxy,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_LLx,axiom,(! [X4] : (c_In(X4,c_SNoL(x)) => (! [X5] : (c_SNo(X5) => c_SNo(mul_5FSNo(X4,X5))))))).
fof(c_LRx,axiom,(! [X4] : (c_In(X4,c_SNoR(x)) => (! [X5] : (c_SNo(X5) => c_SNo(mul_5FSNo(X4,X5))))))).
fof(c_LLxy,axiom,(! [X4] : (c_In(X4,c_SNoL(x)) => c_SNo(mul_5FSNo(X4,y))))).
fof(c_LRxy,axiom,(! [X4] : (c_In(X4,c_SNoR(x)) => c_SNo(mul_5FSNo(X4,y))))).
fof(c_LxLy,axiom,(! [X4] : (c_In(X4,c_SNoL(y)) => c_SNo(mul_5FSNo(x,X4))))).
fof(c_LxRy,axiom,(! [X4] : (c_In(X4,c_SNoR(y)) => c_SNo(mul_5FSNo(x,X4))))).
fof(c_LLR1,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(conj_hammer_test_7668,conjecture,c_SNo(mul_5FSNo(x,y))).
