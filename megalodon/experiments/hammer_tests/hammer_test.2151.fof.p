...
fof(c_H2,axiom,~ composite_5Fnat(n)).
fof(conj_hammer_test_2151,conjecture,((c_In(n,omega) & c_In(ordsucc(c_Empty),n)) & (! [X1] : (c_In(X1,omega) => (divides_5Fnat(X1,n) => ((X1 = ordsucc(c_Empty)) | (X1 = n))))))).
