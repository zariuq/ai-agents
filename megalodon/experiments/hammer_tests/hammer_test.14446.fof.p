...
fof(conj_hammer_test_14446,conjecture,(c_SNoLe(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(z0,z1)))),ap(hL,add_5FSNo(k0,k1))) => c_SNoLe(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(z0,z1)))),ap(hL,add_5FSNo(k0,k1))))).
