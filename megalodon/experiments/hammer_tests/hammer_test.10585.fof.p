...
fof(c_Hu3,axiom,c_SNoLt(mul_5FSNo(x,y),u)).
fof(c_L1,axiom,(! [X12] : (c_In(X12,c_5FLx) => (! [X13] : (c_In(X13,c_5FRy) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X12,X13)),add_5FSNo(mul_5FSNo(X12,y),mul_5FSNo(x,X13)))))))).
fof(c_L2,axiom,(! [X12] : (c_In(X12,c_5FRx) => (! [X13] : (c_In(X13,c_5FLy) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X12,X13)),add_5FSNo(mul_5FSNo(X12,y),mul_5FSNo(x,X13)))))))).
...
fof(c_Hz,axiom,c_In(z,c_SNoL(u))).
fof(c_Hz1,axiom,c_SNo(z)).
fof(c_Hz2,axiom,c_In(c_SNoLev(z),c_SNoLev(u))).
fof(c_Hz3,axiom,c_SNoLt(z,u)).
fof(c_H1,axiom,c_SNoLt(mul_5FSNo(x,y),z)).
fof(conj_hammer_test_10585,conjecture,c_SNoLt(z,mul_5FSNo(x,y))).
