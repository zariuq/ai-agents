...
fof(c_Hc,axiom,ordinal(gamma)).
fof(c_Hc1,axiom,c_In(gamma,alpha)).
fof(c_Hd,axiom,c_In(delta,gamma)).
fof(c_Hsd,axiom,c_In(ordsucc(delta),gamma)).
fof(conj_hammer_test_3295,conjecture,c_In(ordsucc(delta),alpha)).
