...
fof(c_IHx,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(X3,mul_5FSNo(y,z)) = mul_5FSNo(mul_5FSNo(X3,y),z))))).
fof(c_IHy,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(x,mul_5FSNo(X3,z)) = mul_5FSNo(mul_5FSNo(x,X3),z))))).
fof(c_IHz,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(x,mul_5FSNo(y,X3)) = mul_5FSNo(mul_5FSNo(x,y),X3))))).
fof(c_IHxy,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(x))) => (! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(X3,mul_5FSNo(X4,z)) = mul_5FSNo(mul_5FSNo(X3,X4),z))))))).
fof(c_IHxz,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(x))) => (! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(X3,mul_5FSNo(y,X4)) = mul_5FSNo(mul_5FSNo(X3,y),X4))))))).
fof(c_IHyz,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(y))) => (! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(x,mul_5FSNo(X3,X4)) = mul_5FSNo(mul_5FSNo(x,X3),X4))))))).
fof(c_IHxyz,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(x))) => (! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(y))) => (! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(X3,mul_5FSNo(X4,X5)) = mul_5FSNo(mul_5FSNo(X3,X4),X5))))))))).
fof(c_Lxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Lyz,axiom,c_SNo(mul_5FSNo(y,z))).
fof(c_Lxyz1,axiom,c_SNo(mul_5FSNo(x,mul_5FSNo(y,z)))).
fof(conj_hammer_test_9642,conjecture,c_SNo(mul_5FSNo(mul_5FSNo(x,y),z))).
