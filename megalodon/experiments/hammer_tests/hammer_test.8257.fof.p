...
fof(c_IHx,axiom,(! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(minus_5FSNo(X2),y) = minus_5FSNo(mul_5FSNo(X2,y)))))).
fof(c_IHy,axiom,(! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(minus_5FSNo(x),X2) = minus_5FSNo(mul_5FSNo(x,X2)))))).
fof(c_IHxy,axiom,(! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(x))) => (! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(minus_5FSNo(X2),X3) = minus_5FSNo(mul_5FSNo(X2,X3)))))))).
fof(conj_hammer_test_8257,conjecture,c_SNo(minus_5FSNo(x))).
