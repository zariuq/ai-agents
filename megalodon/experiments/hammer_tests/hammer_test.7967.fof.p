...
fof(c_H1,axiom,c_In(c_SNoLev(u),c_SNoLev(x))).
fof(c_H2,axiom,c_SNoEq_5F(c_SNoLev(u),u,x)).
fof(c_H3,axiom,c_In(c_SNoLev(u),x)).
fof(c_Lux,axiom,c_In(u,c_SNoL(x))).
...
fof(c_Luyxz,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,z)))).
fof(c_Luvxz,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(x,z)))).
fof(c_Lxyuz,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,z)))).
fof(c_Lxvuz,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(u,z)))).
fof(c_L1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,z)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,z)))).
fof(c_L2,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(u,z)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(x,z)))).
fof(conj_hammer_test_7967,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,v))),add_5FSNo(mul_5FSNo(x,y),add_5FSNo(mul_5FSNo(u,z),mul_5FSNo(x,v))))).
