...
fof(c_HL,axiom,c_Subq(c_5FL,c_SNoS_5F(omega))).
fof(c_HR,axiom,c_Subq(c_5FR,c_SNoS_5F(omega))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_H,axiom,((! [X5] : (c_In(X5,c_5FL) => c_SNo(X5))) & (! [X5] : (c_In(X5,c_5FR) => c_SNo(X5))))).
fof(c_HLR1,axiom,(! [X5] : (c_In(X5,c_5FL) => c_SNo(X5)))).
fof(c_HLR2,axiom,(! [X5] : (c_In(X5,c_5FR) => c_SNo(X5)))).
fof(c_HLR3,axiom,(! [X5] : (c_In(X5,c_5FL) => (! [X6] : (c_In(X6,c_5FR) => c_SNoLt(X5,X6)))))).
fof(c_HL0,axiom,~ (c_5FL = c_Empty)).
fof(c_HR0,axiom,~ (c_5FR = c_Empty)).
fof(c_HL1,axiom,(! [X5] : (c_In(X5,c_5FL) => (? [X6] : (c_In(X6,c_5FL) & c_SNoLt(X5,X6)))))).
fof(c_HR1,axiom,(! [X5] : (c_In(X5,c_5FR) => (? [X6] : (c_In(X6,c_5FR) & c_SNoLt(X6,X5)))))).
fof(c_H1,axiom,c_SNo(c_SNoCut(c_5FL,c_5FR))).
fof(c_H3,axiom,(! [X5] : (c_In(X5,c_5FL) => c_SNoLt(X5,c_SNoCut(c_5FL,c_5FR))))).
fof(c_H4,axiom,(! [X5] : (c_In(X5,c_5FR) => c_SNoLt(c_SNoCut(c_5FL,c_5FR),X5)))).
fof(c_H5,axiom,(! [X5] : (c_SNo(X5) => ((! [X6] : (c_In(X6,c_5FL) => c_SNoLt(X6,X5))) => ((! [X6] : (c_In(X6,c_5FR) => c_SNoLt(X5,X6))) => (c_Subq(c_SNoLev(c_SNoCut(c_5FL,c_5FR)),c_SNoLev(X5)) & c_SNoEq_5F(c_SNoLev(c_SNoCut(c_5FL,c_5FR)),c_SNoCut(c_5FL,c_5FR),X5))))))).
fof(c_H6,axiom,(c_SNoLev(c_SNoCut(c_5FL,c_5FR)) = omega)).
fof(c_Hq,axiom,c_In(q,c_SNoS_5F(omega))).
fof(c_H7,axiom,(! [X5] : (c_In(X5,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(c_SNoCut(c_5FL,c_5FR)))),eps_5F(X5))))).
fof(c_Hq1,axiom,c_In(c_SNoLev(q),omega)).
fof(c_Hq2,axiom,ordinal(c_SNoLev(q))).
fof(c_Hq3,axiom,c_SNo(q)).
fof(c_Hq4,axiom,c_SNo_5F(c_SNoLev(q),q)).
fof(c_Hw,axiom,c_In(w,c_5FL)).
fof(c_H8,axiom,c_SNoLe(q,w)).
fof(c_H9,axiom,c_In(w_5F27,c_5FL)).
fof(c_H10,axiom,c_SNoLt(w,w_5F27)).
fof(c_LqL1,axiom,c_In(add_5FSNo(w_5F27,minus_5FSNo(q)),c_SNoS_5F(omega))).
fof(c_Hw_27q1,axiom,c_In(c_SNoLev(add_5FSNo(w_5F27,minus_5FSNo(q))),omega)).
fof(c_Hw_27q2,axiom,ordinal(c_SNoLev(add_5FSNo(w_5F27,minus_5FSNo(q))))).
fof(c_Hw_27q3,axiom,c_SNo(add_5FSNo(w_5F27,minus_5FSNo(q)))).
fof(c_Hw_27q4,axiom,c_SNo_5F(c_SNoLev(add_5FSNo(w_5F27,minus_5FSNo(q))),add_5FSNo(w_5F27,minus_5FSNo(q)))).
fof(c_LqL2,axiom,c_SNoLt(c_Empty,add_5FSNo(w_5F27,minus_5FSNo(q)))).
fof(c_LqL3,axiom,c_In(add_5FSNo(w_5F27,minus_5FSNo(q)),c_SNoS_5F(ordsucc(c_SNoLev(add_5FSNo(w_5F27,minus_5FSNo(q))))))).
fof(conj_hammer_test_12971,conjecture,$false).
