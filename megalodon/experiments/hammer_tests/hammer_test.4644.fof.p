...
fof(conj_hammer_test_4644,conjecture,(! [X0] : (! [X1] : (c_SNoCutP(X0,X1) => (! [X2] : (c_SNo(X2) => ((! [X3] : (c_In(X3,X0) => c_SNoLt(X3,X2))) => ((! [X3] : (c_In(X3,X1) => c_SNoLt(X2,X3))) => (c_Subq(c_SNoLev(c_SNoCut(X0,X1)),c_SNoLev(X2)) & c_SNoEq_5F(c_SNoLev(c_SNoCut(X0,X1)),c_SNoCut(X0,X1),X2)))))))))).
