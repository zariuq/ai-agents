...
fof(c_H1,axiom,(! [X1] : (c_In(X1,omega) => c_In(g(X1),c_Power(omega))))).
fof(c_H2,axiom,(! [X1] : (c_In(X1,c_Power(omega)) => (? [X2] : (c_In(X2,omega) & (g(X2) = X1)))))).
fof(conj_hammer_test_1966,conjecture,$false).
