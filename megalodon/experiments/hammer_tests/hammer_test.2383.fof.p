...
fof(c_H3,axiom,~ (! [X9] : (c_Subq(X9,c_5FX_5F27) => (infinite(X9) => (? [X10] : (c_Subq(X10,X9) & (? [X11] : (c_In(X11,X9) & ((nIn(X11,X10) & infinite(X10)) & (! [X12] : (c_Subq(X12,X10) => (equip(X12,n) => c_In(c_5FC(binunion(X12,c_Sing(c_X11))),c))))))))))))).
fof(c_HH_27X_27,axiom,c_Subq(c_5FH_5F27,setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H,axiom,(? [X9] : (c_In(X9,ordsucc(c)) & (infinite(c_5FH_5F27) & (! [X10] : (c_Subq(X10,c_5FH_5F27) => (equip(X10,n) => (c_5FC(binunion(X10,c_Sing(x))) = X9)))))))).
fof(c_Hi,axiom,c_In(i,ordsucc(c))).
fof(c_H,axiom,(infinite(c_5FH_5F27) & (! [X9] : (c_Subq(X9,c_5FH_5F27) => (equip(X9,n) => (c_5FC(binunion(X9,c_Sing(x))) = i)))))).
fof(c_HH_27inf,axiom,infinite(c_5FH_5F27)).
fof(c_HH_27hom,axiom,(! [X9] : (c_Subq(X9,c_5FH_5F27) => (equip(X9,n) => (c_5FC(binunion(X9,c_Sing(x))) = i))))).
fof(c_H4,axiom,c_In(i,c)).
fof(c_HZX_27,axiom,c_Subq(c_5FZ,c_5FX_5F27)).
fof(c_HZ,axiom,infinite(c_5FZ)).
fof(c_H5,axiom,~ (? [X9] : (c_Subq(X9,c_5FZ) & (? [X10] : (c_In(X10,c_5FZ) & ((nIn(X10,X9) & infinite(X9)) & (! [X11] : (c_Subq(X11,X9) => (equip(X11,n) => c_In(c_5FC(binunion(X11,c_Sing(c_X10))),c)))))))))).
fof(conj_hammer_test_2383,conjecture,(? [X9] : c_In(X9,c_5FZ))).
