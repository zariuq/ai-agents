...
fof(c_H1,axiom,(? [X9] : (c_In(X9,c_SNoR(x)) & c_SNoLe(add_5FSNo(X9,y),v)))).
fof(c_Hu,axiom,c_In(u,c_SNoR(x))).
fof(c_Hvu,axiom,c_SNoLe(add_5FSNo(u,y),v)).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(x))).
fof(c_Hu3,axiom,c_SNoLt(x,u)).
fof(c_Luw,axiom,c_SNo(mul_5FSNo(u,w))).
fof(c_Luz,axiom,c_SNo(mul_5FSNo(u,z))).
fof(c_Luy,axiom,c_SNo(add_5FSNo(u,y))).
fof(conj_hammer_test_8795,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(y,z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(u,w)))),add_5FSNo(mul_5FSNo(u,z),add_5FSNo(mul_5FSNo(y,z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(x,w)))))).
