...
fof(c_H1,axiom,(! [X1] : (c_SNo(X1) => ((! [X2] : (c_In(X2,c_SNoS_5F(c_SNoLev(X1))) => c_5FP(X2))) => c_5FP(X1))))).
fof(conj_hammer_test_5410,conjecture,(! [X1] : (ordinal(X1) => ((! [X2] : (c_In(X2,X1) => (! [X3] : (c_In(X3,c_SNoS_5F(X2)) => c_5FP(X3))))) => (! [X2] : (c_In(X2,c_SNoS_5F(X1)) => c_5FP(X2))))))).
