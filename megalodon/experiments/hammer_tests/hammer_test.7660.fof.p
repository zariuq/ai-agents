...
fof(c_L7,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(z,v1)))).
fof(conj_hammer_test_7660,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(u0,v1)),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(x,v1)))).
