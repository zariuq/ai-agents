...
fof(c_L1,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_SNo(X9) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(y))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(z))) => ((u = add_5FSNo(c_5FM(c_X8,c_5FM(y,z)),add_5FSNo(c_5FM(x,c_X9),minus_5FSNo(c_5FM(c_X8,c_X9))))) => (c_SNoLe(add_5FSNo(c_5FM(c_X8,add_5FSNo(c_5FM(X10,z),c_5FM(y,X11))),c_5FM(x,add_5FSNo(c_X9,c_5FM(X10,X11)))),add_5FSNo(c_5FM(x,add_5FSNo(c_5FM(X10,z),c_5FM(y,X11))),c_5FM(c_X8,add_5FSNo(c_X9,c_5FM(X10,X11))))) => (c_SNoLt(add_5FSNo(c_5FM(add_5FSNo(c_5FM(c_X8,y),c_5FM(x,X10)),z),c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(c_X8,X10)),X11)),add_5FSNo(c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(c_X8,X10)),z),c_5FM(add_5FSNo(c_5FM(c_X8,y),c_5FM(x,X10)),X11))) => c_SNoLt(u,c_5FM(c_5FM(x,y),z)))))))))))))).
...
fof(conj_hammer_test_9431,conjecture,(! [X8] : (c_In(X8,c_SNoL(y)) => (! [X9] : (c_In(X9,c_SNoR(z)) => (c_SNoLe(add_5FSNo(c_5FM(X8,z),c_5FM(y,X9)),add_5FSNo(w,c_5FM(X8,X9))) => c_SNoLt(u,c_5FM(c_5FM(x,y),z)))))))).
