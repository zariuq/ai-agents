...
fof(conj_hammer_test_7017,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNoLe(add_5FSNo(X0,X1),add_5FSNo(X3,X2)) => c_SNoLe(add_5FSNo(X0,add_5FSNo(X1,minus_5FSNo(X2))),X3))))))))))).
