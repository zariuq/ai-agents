...
fof(c_Hd1,axiom,int_5Flin_5Fcomb(a,b,d)).
fof(c_Hd2,axiom,c_SNoLt(c_Empty,d)).
fof(c_Hd3,axiom,(! [X7] : (int_5Flin_5Fcomb(a,b,X7) => (c_SNoLt(c_Empty,X7) => c_SNoLe(d,X7))))).
fof(c_Ha,axiom,c_In(a,int)).
fof(c_Hb,axiom,c_In(b,int)).
fof(c_HdZ,axiom,c_In(d,int)).
fof(c_Hm,axiom,c_In(m,int)).
fof(c_Hn,axiom,c_In(n,int)).
fof(c_H2,axiom,(add_5FSNo(mul_5FSNo(m,a),mul_5FSNo(n,b)) = d)).
fof(c_LaS,axiom,c_SNo(a)).
fof(c_LbS,axiom,c_SNo(b)).
fof(c_LmS,axiom,c_SNo(m)).
fof(c_LnS,axiom,c_SNo(n)).
fof(c_LdN,axiom,nat_5Fp(d)).
fof(c_Ld1,axiom,c_In(d,setminus(omega,c_Sing(c_Empty)))).
fof(c_LdS,axiom,c_SNo(d)).
fof(c_Hq,axiom,c_In(q,int)).
fof(c_H,axiom,(? [X7] : (c_In(X7,d) & (a = add_5FSNo(mul_5FSNo(q,d),X7))))).
fof(c_Hr,axiom,c_In(r,d)).
fof(c_H1,axiom,(a = add_5FSNo(mul_5FSNo(q,d),r))).
fof(c_LqS,axiom,c_SNo(q)).
fof(c_LmqS,axiom,c_SNo(minus_5FSNo(q))).
fof(c_LrN,axiom,nat_5Fp(r)).
fof(c_Lrnn,axiom,c_SNoLe(c_Empty,r)).
fof(c_Lrd,axiom,c_SNoLt(r,d)).
fof(c_LqdS,axiom,c_SNo(mul_5FSNo(q,d))).
fof(c_LrS,axiom,c_SNo(r)).
fof(conj_hammer_test_10996,conjecture,(add_5FSNo(a,mul_5FSNo(minus_5FSNo(q),add_5FSNo(mul_5FSNo(m,a),mul_5FSNo(n,b)))) = add_5FSNo(mul_5FSNo(add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(q,m))),a),mul_5FSNo(minus_5FSNo(mul_5FSNo(q,n)),b)))).
