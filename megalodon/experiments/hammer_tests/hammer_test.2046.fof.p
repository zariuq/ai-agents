...
fof(c_H1,axiom,finite(c_5FX)).
fof(c_Hn,axiom,c_In(n,omega)).
fof(c_H2,axiom,equip(c_5FX,n)).
fof(c_Hf1,axiom,(! [X4] : (c_In(X4,n) => c_In(f(X4),c_5FX)))).
fof(c_Hf2,axiom,(! [X4] : (c_In(X4,n) => (! [X5] : (c_In(X5,n) => ((f(c_X4) = f(X5)) => (X4 = X5))))))).
fof(c_Hf3,axiom,(! [X4] : (c_In(X4,c_5FX) => (? [X5] : (c_In(X5,n) & (f(X5) = X4)))))).
fof(c_H3,axiom,nIn(y,c_5FX)).
fof(conj_hammer_test_2046,conjecture,c_In(ordsucc(n),omega)).
