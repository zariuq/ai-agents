...
fof(c_Hx,axiom,c_In(x,c_5FX)).
fof(c_H1,axiom,equip(c_5FX,ordsucc(c_5FN))).
fof(c_Hf1,axiom,(! [X5] : (c_In(X5,ordsucc(c_5FN)) => c_In(f(X5),c_5FX)))).
fof(c_Hf2,axiom,(! [X5] : (c_In(X5,ordsucc(c_5FN)) => (! [X6] : (c_In(X6,ordsucc(c_5FN)) => ((f(c_X5) = f(X6)) => (X5 = X6))))))).
fof(c_Hf3,axiom,(! [X5] : (c_In(X5,c_5FX) => (? [X6] : (c_In(X6,ordsucc(c_5FN)) & (f(X6) = X5)))))).
fof(c_Hw,axiom,c_In(w,ordsucc(c_5FN))).
fof(c_Hfw,axiom,(f(w) = x)).
fof(c_H2,axiom,c_In(w,c_5FN)).
fof(c_L1,axiom,~ (f(c_5FN) = x)).
fof(c_L2,axiom,(! [X5] : (c_In(X5,c_5FN) => ~ (f(X5) = f(c_5FN))))).
fof(conj_hammer_test_966,conjecture,equip(c_5FN,setminus(c_5FX,c_Sing(x)))).
