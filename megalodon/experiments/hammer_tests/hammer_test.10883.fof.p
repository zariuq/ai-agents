...
fof(conj_hammer_test_10883,conjecture,(! [X0] : (c_In(X0,int) => (! [X1] : (c_In(X1,int) => (! [X2] : (c_In(X2,int) => ((? [X3] : (c_In(X3,int) & (? [X4] : (c_In(X4,int) & (add_5FSNo(mul_5FSNo(X3,X0),mul_5FSNo(X4,X1)) = X2))))) => int_5Flin_5Fcomb(X0,X1,X2))))))))).
