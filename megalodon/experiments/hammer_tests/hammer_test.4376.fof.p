...
fof(c_HC,axiom,((! [X2] : (c_In(X2,c_5FL) => c_SNo(X2))) & (! [X2] : (c_In(X2,c_5FR) => c_SNo(X2))))).
fof(c_HL,axiom,(! [X2] : (c_In(X2,c_5FL) => c_SNo(X2)))).
fof(c_HR,axiom,(! [X2] : (c_In(X2,c_5FR) => c_SNo(X2)))).
fof(c_HLR,axiom,(! [X2] : (c_In(X2,c_5FL) => (! [X3] : (c_In(X3,c_5FR) => c_SNoLt(X2,X3)))))).
fof(c_LNoC,axiom,c_SNo(c_SNoCut(c_5FL,c_5FR))).
fof(c_LLC,axiom,ordinal(c_SNoLev(c_SNoCut(c_5FL,c_5FR)))).
fof(c_LL,axiom,(! [X2] : (c_In(X2,c_5FL) => c_SNoLt(X2,c_SNoCut(c_5FL,c_5FR))))).
fof(c_LR,axiom,(! [X2] : (c_In(X2,c_5FR) => c_SNoLt(c_SNoCut(c_5FL,c_5FR),X2)))).
fof(conj_hammer_test_4376,conjecture,(! [X2] : (c_In(X2,c_5FR) => c_SNoLt(c_SNoCut(c_5FL,c_5FR),X2)))).
