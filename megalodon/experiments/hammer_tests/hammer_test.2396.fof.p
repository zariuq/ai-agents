...
fof(c_Hc,axiom,nat_5Fp(c)).
fof(c_Hn,axiom,nat_5Fp(n)).
fof(c_HX,axiom,infinite(c_5FX)).
fof(c_H1,axiom,(! [X11] : (c_Subq(X11,c_5FX) => (equip(X11,ordsucc(n)) => c_In(c_5FC(X11),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X11] : (c_Subq(X11,c_5FX) & (? [X12] : (c_In(X12,ordsucc(c)) & (infinite(X11) & (! [X13] : (c_Subq(X13,X11) => (equip(X13,ordsucc(n)) => (c_5FC(X13) = X12)))))))))).
fof(c_HX_27X,axiom,c_Subq(c_5FX_5F27,c_5FX)).
fof(c_HX_27,axiom,infinite(c_5FX_5F27)).
fof(c_H2_27,axiom,~ (? [X11] : (c_Subq(X11,c_5FX_5F27) & (? [X12] : (c_In(X12,c_5FX_5F27) & ((nIn(X12,X11) & infinite(X11)) & (! [X13] : (c_Subq(X13,X11) => (equip(X13,n) => (c_5FC(binunion(X13,c_Sing(c_X12))) = c)))))))))).
fof(c_L1a,axiom,(? [X11] : c_In(X11,c_5FX_5F27))).
fof(c_Hx,axiom,c_In(x,c_5FX_5F27)).
fof(c_LX_27xinf,axiom,infinite(setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H3,axiom,~ (! [X11] : (c_Subq(X11,c_5FX_5F27) => (infinite(X11) => (? [X12] : (c_Subq(X12,X11) & (? [X13] : (c_In(X13,X11) & ((nIn(X13,X12) & infinite(X12)) & (! [X14] : (c_Subq(X14,X12) => (equip(X14,n) => c_In(c_5FC(binunion(X14,c_Sing(c_X13))),c))))))))))))).
fof(c_HH_27X_27,axiom,c_Subq(c_5FH_5F27,setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H,axiom,(? [X11] : (c_In(X11,ordsucc(c)) & (infinite(c_5FH_5F27) & (! [X12] : (c_Subq(X12,c_5FH_5F27) => (equip(X12,n) => (c_5FC(binunion(X12,c_Sing(x))) = X11)))))))).
fof(c_Hi,axiom,c_In(i,ordsucc(c))).
fof(c_H,axiom,(infinite(c_5FH_5F27) & (! [X11] : (c_Subq(X11,c_5FH_5F27) => (equip(X11,n) => (c_5FC(binunion(X11,c_Sing(x))) = i)))))).
fof(c_HH_27inf,axiom,infinite(c_5FH_5F27)).
fof(c_HH_27hom,axiom,(! [X11] : (c_Subq(X11,c_5FH_5F27) => (equip(X11,n) => (c_5FC(binunion(X11,c_Sing(x))) = i))))).
fof(c_H4,axiom,c_In(i,c)).
fof(c_HZX_27,axiom,c_Subq(c_5FZ,c_5FX_5F27)).
fof(c_HZ,axiom,infinite(c_5FZ)).
fof(c_H5,axiom,~ (? [X11] : (c_Subq(X11,c_5FZ) & (? [X12] : (c_In(X12,c_5FZ) & ((nIn(X12,X11) & infinite(X11)) & (! [X13] : (c_Subq(X13,X11) => (equip(X13,n) => c_In(c_5FC(binunion(X13,c_Sing(c_X12))),c)))))))))).
fof(c_L1b1,axiom,(? [X11] : c_In(X11,c_5FZ))).
fof(c_Hy,axiom,c_In(y,c_5FZ)).
fof(c_LZyinf,axiom,infinite(setminus(c_5FZ,c_Sing(y)))).
fof(c_LZyX_27,axiom,c_Subq(setminus(c_5FZ,c_Sing(y)),c_5FX_5F27)).
fof(c_LZyX,axiom,c_Subq(setminus(c_5FZ,c_Sing(y)),c_5FX)).
fof(conj_hammer_test_2396,conjecture,$false).
