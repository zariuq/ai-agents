...
fof(c_Hf1,axiom,(! [X4] : (c_Subq(X4,c_5FX) => (infinite(X4) => (c_Subq(f(X4),X4) & infinite(f(X4))))))).
fof(c_Hg1,axiom,(! [X4] : (c_Subq(X4,c_5FX) => (infinite(X4) => (c_In(g(X4),X4) & nIn(g(X4),f(X4))))))).
fof(c_Hf_270,axiom,(f_5F27(c_Empty) = f(c_5FX))).
fof(c_Hf_27S,axiom,(! [X4] : (nat_5Fp(X4) => (f_5F27(ordsucc(X4)) = f(f_5F27(X4)))))).
fof(c_Lf_271,axiom,(! [X4] : (nat_5Fp(X4) => (c_Subq(f_5F27(X4),c_5FX) & infinite(f_5F27(X4)))))).
fof(c_Lgf_27mm_27addSubq,axiom,(! [X4] : (c_In(X4,omega) => (! [X5] : (nat_5Fp(X5) => c_Subq(f_5F27(add_5Fnat(c_X4,X5)),f_5F27(c_X4))))))).
fof(c_Lgf_27mm_27Subq,axiom,(! [X4] : (c_In(X4,omega) => (! [X5] : (c_In(X5,omega) => (c_Subq(X4,X5) => c_Subq(f_5F27(X5),f_5F27(c_X4)))))))).
fof(c_Lgf_27injlem,axiom,(! [X4] : (c_In(X4,omega) => (! [X5] : (c_In(X5,X4) => ~ (g(f_5F27(X5)) = g(f_5F27(c_X4)))))))).
fof(conj_hammer_test_2312,conjecture,(((! [X4] : (nat_5Fp(X4) => (c_Subq(f_5F27(X4),c_5FX) & infinite(f_5F27(X4))))) & (! [X4] : (c_In(X4,omega) => (! [X5] : (c_In(X5,omega) => (c_Subq(X4,X5) => c_Subq(f_5F27(X5),f_5F27(c_X4)))))))) & (! [X4] : (c_In(X4,omega) => (! [X5] : (c_In(X5,omega) => ((g(f_5F27(c_X4)) = g(f_5F27(X5))) => (X4 = X5)))))))).
