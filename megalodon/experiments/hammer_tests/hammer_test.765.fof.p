...
fof(c_H1,axiom,(! [X1] : (nat_5Fp(X1) => ((! [X2] : (c_In(X2,X1) => p(X2))) => p(X1))))).
fof(c_L1,axiom,(! [X1] : (nat_5Fp(X1) => (! [X2] : (c_In(X2,X1) => p(X2)))))).
fof(conj_hammer_test_765,conjecture,(! [X1] : (nat_5Fp(X1) => p(X1)))).
