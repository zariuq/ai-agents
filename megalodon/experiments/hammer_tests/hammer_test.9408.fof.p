...
fof(conj_hammer_test_9408,conjecture,c_SNoLt(add_5FSNo(c_5FM(add_5FSNo(c_5FM(v,y),c_5FM(x,w1)),z),c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(v,w1)),w2)),add_5FSNo(c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(v,w1)),z),c_5FM(add_5FSNo(c_5FM(v,y),c_5FM(x,w1)),w2)))).
