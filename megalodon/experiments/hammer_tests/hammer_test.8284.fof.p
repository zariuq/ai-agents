...
fof(conj_hammer_test_8284,conjecture,(! [X8] : (c_In(X8,c_SNoR(x)) => (! [X9] : (c_In(X9,c_SNoL(y)) => ((z = add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9))))) => c_In(minus_5FSNo(z),c_5FL_5F27))))))).
