...
fof(c_Hw,axiom,c_In(w,c_SNoL(y))).
...
fof(c_Lymw,axiom,c_SNo(add_5FSNo(y,minus_5FSNo(w)))).
...
fof(c_Hk_272,axiom,c_SNoLe(eps_5F(k_5F27),add_5FSNo(y,minus_5FSNo(w)))).
...
fof(c_L1a,axiom,c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(add_5FSNo(k,k_5F27)))).
fof(conj_hammer_test_13906,conjecture,c_SNoLe(add_5FSNo(add_5FSNo(add_5FSNo(mul_5FSNo(x,y),add_5FSNo(minus_5FSNo(mul_5FSNo(x,w)),minus_5FSNo(mul_5FSNo(v,y)))),mul_5FSNo(v,w)),q),mul_5FSNo(x,y))).
