...
fof(c_IH,axiom,(! [X2] : (c_In(X2,beta) => (add_5FSNo(ordsucc(alpha),X2) = ordsucc(add_5FSNo(alpha,X2)))))).
fof(c_La,axiom,c_SNo(alpha)).
fof(c_Lb,axiom,c_SNo(beta)).
fof(c_Lab,axiom,ordinal(add_5FSNo(alpha,beta))).
fof(c_LSa,axiom,ordinal(ordsucc(alpha))).
fof(c_LSa2,axiom,c_SNo(ordsucc(alpha))).
fof(c_LSab,axiom,ordinal(add_5FSNo(ordsucc(alpha),beta))).
fof(c__5F,axiom,(! [X2] : (c_In(X2,c_Empty) => c_SNoLt(add_5FSNo(ordsucc(alpha),beta),X2)))).
fof(c_L1,axiom,c_In(add_5FSNo(alpha,beta),add_5FSNo(ordsucc(alpha),beta))).
fof(c_H3,axiom,c_In(ordsucc(add_5FSNo(alpha,beta)),add_5FSNo(ordsucc(alpha),beta))).
fof(c_Lz,axiom,ordinal(ordsucc(add_5FSNo(alpha,beta)))).
fof(c_Lz1,axiom,c_TransSet(ordsucc(add_5FSNo(alpha,beta)))).
fof(c_Lz2,axiom,c_SNo(ordsucc(add_5FSNo(alpha,beta)))).
fof(c_L2,axiom,(c_Subq(c_SNoLev(add_5FSNo(ordsucc(alpha),beta)),c_SNoLev(ordsucc(add_5FSNo(alpha,beta)))) & c_SNoEq_5F(c_SNoLev(add_5FSNo(ordsucc(alpha),beta)),add_5FSNo(ordsucc(alpha),beta),ordsucc(add_5FSNo(alpha,beta))))).
fof(conj_hammer_test_6252,conjecture,$false).
