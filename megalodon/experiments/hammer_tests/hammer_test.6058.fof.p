...
fof(conj_hammer_test_6058,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNoLe(X0,X2) => (c_SNoLe(X1,X3) => c_SNoLe(add_5FSNo(X0,X1),add_5FSNo(X2,X3))))))))))))).
