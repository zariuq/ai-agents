...
fof(c_IHLx,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => ((c_SNo(minus_5FSNo(X6)) & (! [X7] : (c_In(X7,c_SNoL(X6)) => c_SNoLt(minus_5FSNo(X6),minus_5FSNo(X7))))) & (! [X7] : (c_In(X7,c_SNoR(X6)) => c_SNoLt(minus_5FSNo(X7),minus_5FSNo(X6)))))))).
fof(c_IHRx,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => ((c_SNo(minus_5FSNo(X6)) & (! [X7] : (c_In(X7,c_SNoL(X6)) => c_SNoLt(minus_5FSNo(X6),minus_5FSNo(X7))))) & (! [X7] : (c_In(X7,c_SNoR(X6)) => c_SNoLt(minus_5FSNo(X7),minus_5FSNo(X6)))))))).
fof(c_Hu,axiom,c_In(u,c_SNoR(x))).
fof(c_Hwu,axiom,(w = minus_5FSNo(u))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(x))).
fof(c_Hu3,axiom,c_SNoLt(x,u)).
fof(c_Hu1a,axiom,ordinal(c_SNoLev(u))).
fof(c_Hu1b,axiom,c_SNo_5F(c_SNoLev(u),u)).
fof(c_Hv,axiom,c_In(v,c_SNoL(x))).
fof(c_Hzv,axiom,(z = minus_5FSNo(v))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(x))).
fof(c_Hv3,axiom,c_SNoLt(v,x)).
fof(c_Hv1a,axiom,ordinal(c_SNoLev(v))).
fof(c_Hv1b,axiom,c_SNo_5F(c_SNoLev(v),v)).
fof(c_H2,axiom,(c_SNo(minus_5FSNo(v)) & (! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(minus_5FSNo(v),minus_5FSNo(X6)))))).
fof(c_H2,axiom,c_SNo(minus_5FSNo(v))).
fof(c_H3,axiom,(! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(minus_5FSNo(v),minus_5FSNo(X6))))).
fof(c_H4,axiom,(! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(minus_5FSNo(X6),minus_5FSNo(v))))).
fof(c_H5,axiom,(c_SNo(minus_5FSNo(u)) & (! [X6] : (c_In(X6,c_SNoL(u)) => c_SNoLt(minus_5FSNo(u),minus_5FSNo(X6)))))).
fof(c_H5,axiom,c_SNo(minus_5FSNo(u))).
fof(c_H6,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => c_SNoLt(minus_5FSNo(u),minus_5FSNo(X6))))).
fof(c_H7,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => c_SNoLt(minus_5FSNo(X6),minus_5FSNo(u))))).
fof(c_Lvu,axiom,c_SNoLt(v,u)).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_Hz1,axiom,c_In(c_SNoLev(z),binintersect(c_SNoLev(v),c_SNoLev(u)))).
fof(c_Hz2,axiom,c_SNoEq_5F(c_SNoLev(z),z,v)).
fof(c_Hz3,axiom,c_SNoEq_5F(c_SNoLev(z),z,u)).
fof(c_Hz4,axiom,c_SNoLt(v,z)).
fof(c_Hz5,axiom,c_SNoLt(z,u)).
fof(c_Hz6,axiom,nIn(c_SNoLev(z),v)).
fof(c_Hz7,axiom,c_In(c_SNoLev(z),u)).
fof(c_Hza,axiom,ordinal(c_SNoLev(z))).
fof(c_Hzb,axiom,c_SNo_5F(c_SNoLev(z),z)).
fof(conj_hammer_test_5598,conjecture,c_SNoLt(minus_5FSNo(u),minus_5FSNo(v))).
