...
fof(conj_hammer_test_9855,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (mul_5FSNo(mul_5FSNo(X0,X1),mul_5FSNo(X2,X3)) = mul_5FSNo(mul_5FSNo(X0,X2),mul_5FSNo(X1,X3)))))))))))).
