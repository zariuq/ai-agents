...
fof(c_L2npLt2n2n,axiom,(! [X4] : (c_SNo(X4) => (c_SNoLt(X4,exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => c_SNoLt(add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),X4),add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n))))))).
...
fof(c_Hg1,axiom,(! [X4] : (c_In(n,X4) => (g(X4) = f(binintersect(X4,c_SNoElts_5F(n))))))).
fof(c_Hg2,axiom,(! [X4] : (nIn(n,X4) => (g(X4) = add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),f(binintersect(X4,c_SNoElts_5F(n)))))))).
fof(c_Hm,axiom,c_In(m,add_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n),exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),n)))).
fof(c_Lm1,axiom,nat_5Fp(m)).
fof(conj_hammer_test_11733,conjecture,c_SNo(m)).
