...
fof(c_H,axiom,((! [X8] : (c_In(X8,c_5FLx) => c_SNo(X8))) & (! [X8] : (c_In(X8,c_5FRx) => c_SNo(X8))))).
fof(c_HLRx1,axiom,(! [X8] : (c_In(X8,c_5FLx) => c_SNo(X8)))).
fof(c_HLRx2,axiom,(! [X8] : (c_In(X8,c_5FRx) => c_SNo(X8)))).
fof(c_HLRx3,axiom,(! [X8] : (c_In(X8,c_5FLx) => (! [X9] : (c_In(X9,c_5FRx) => c_SNoLt(X8,X9)))))).
fof(c_H,axiom,((! [X8] : (c_In(X8,c_5FLy) => c_SNo(X8))) & (! [X8] : (c_In(X8,c_5FRy) => c_SNo(X8))))).
fof(c_HLRy1,axiom,(! [X8] : (c_In(X8,c_5FLy) => c_SNo(X8)))).
fof(c_HLRy2,axiom,(! [X8] : (c_In(X8,c_5FRy) => c_SNo(X8)))).
fof(c_HLRy3,axiom,(! [X8] : (c_In(X8,c_5FLy) => (! [X9] : (c_In(X9,c_5FRy) => c_SNoLt(X8,X9)))))).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx3,axiom,(! [X8] : (c_In(X8,c_5FLx) => c_SNoLt(X8,x)))).
fof(c_Hx4,axiom,(! [X8] : (c_In(X8,c_5FRx) => c_SNoLt(x,X8)))).
fof(c_Hx5,axiom,(! [X8] : (c_SNo(X8) => ((! [X9] : (c_In(X9,c_5FLx) => c_SNoLt(X9,X8))) => ((! [X9] : (c_In(X9,c_5FRx) => c_SNoLt(X8,X9))) => (c_Subq(c_SNoLev(x),c_SNoLev(X8)) & c_SNoEq_5F(c_SNoLev(x),x,X8))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X8] : (c_In(X8,c_5FLy) => c_SNoLt(X8,y)))).
fof(c_Hy4,axiom,(! [X8] : (c_In(X8,c_5FRy) => c_SNoLt(y,X8)))).
fof(c_Hy5,axiom,(! [X8] : (c_SNo(X8) => ((! [X9] : (c_In(X9,c_5FLy) => c_SNoLt(X9,X8))) => ((! [X9] : (c_In(X9,c_5FRy) => c_SNoLt(X8,X9))) => (c_Subq(c_SNoLev(y),c_SNoLev(X8)) & c_SNoEq_5F(c_SNoLev(y),y,X8))))))).
fof(c_HLR_27,axiom,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
fof(c_HL_27I1,axiom,(! [X8] : (c_In(X8,c_SNoL(x)) => (! [X9] : (c_In(X9,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL_5F27)))))).
fof(c_HL_27I2,axiom,(! [X8] : (c_In(X8,c_SNoR(x)) => (! [X9] : (c_In(X9,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL_5F27)))))).
fof(c_HR_27I1,axiom,(! [X8] : (c_In(X8,c_SNoL(x)) => (! [X9] : (c_In(X9,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR_5F27)))))).
fof(c_HR_27I2,axiom,(! [X8] : (c_In(X8,c_SNoR(x)) => (! [X9] : (c_In(X9,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X8,y),add_5FSNo(mul_5FSNo(x,X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR_5F27)))))).
fof(c_HLR_27eq,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL_5F27,c_5FR_5F27))).
fof(conj_hammer_test_10143,conjecture,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
