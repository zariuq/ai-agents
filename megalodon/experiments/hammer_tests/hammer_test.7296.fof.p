...
fof(conj_hammer_test_7296,conjecture,(add_5FSNo(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),minus_5FSNo(mul_5FSNo(u0,u1)))),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(v0,v1))) = add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))))).
