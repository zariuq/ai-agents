...
fof(c_IH,axiom,(! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(u))) => (c_In(c_SNoLev(X4),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(add_5FSNo(x,y),X4) => ((? [X5] : (c_In(X5,c_SNoR(x)) & c_SNoLe(add_5FSNo(X5,y),X4))) | (? [X5] : (c_In(X5,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X5),X4))))))))).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(add_5FSNo(x,y),u)).
fof(c_HNC,axiom,~ ((? [X4] : (c_In(X4,c_SNoR(x)) & c_SNoLe(add_5FSNo(X4,y),u))) | (? [X4] : (c_In(X4,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X4),u))))).
