...
fof(c_Hzb,axiom,c_In(c_SNoLev(z),c_SNoLev(v0))).
fof(c_Hzc,axiom,c_SNoLt(v0,z)).
fof(c_Lz,axiom,c_In(z,c_SNoR(x))).
fof(conj_hammer_test_7631,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
