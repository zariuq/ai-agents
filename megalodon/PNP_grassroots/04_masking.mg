...
(*   - Inverse: (π,σ)⁻¹ = (π⁻¹, σ∘π)                                        *)
(*                                                                           *)
(* PROVABILITY NOTE: These group axioms ARE derivable from the definitions   *)
(* using the helper theorems perm_compose_id_l and sign_xor_zero_l, plus:    *)
(*   - perm_inv m (perm_id m) = perm_id m                                    *)
(*   - perm_compose m f (perm_id m) = f (right identity)                     *)
(*   - perm_compose m (perm_inv m π) π = perm_id m                          *)
(* Kept as axioms to avoid scope creep; derivation is mechanical.            *)
(* ========================================================================= *)
