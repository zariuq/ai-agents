% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16281.mg.html#A16281
...
thf(c_HF1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => ((c_In @ ((c_F1 @ X36) @ X37)) @ int)))))).
thf(c_HG1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => ((c_In @ ((c_G1 @ X36) @ X37)) @ int)))))).
...
thf(c_HU1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((c_In @ (((c_U1 @ X36) @ X37) @ X38)) @ int)))))))).
thf(c_HV1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((c_In @ (((c_V1 @ X36) @ X37) @ X38)) @ int)))))))).
thf(c_HW1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => ((c_In @ ((c_W1 @ X36) @ X37)) @ int)))))).
...
thf(c_H1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F2 @ X36) @ X37) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X37)) @ X36))))))).
thf(c_H2,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H3,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_H2 @ X36) = X36)))).
thf(c_H4,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_U2 @ X36) @ X37) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X37) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37)) @ X36)))))))).
thf(c_H5,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_V2 @ X36) = ((c_U2 @ c_G2) @ (c_H2 @ X36)))))).
thf(c_H6,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F1 @ X36) @ X37) = ((add_5FSNo @ (c_V2 @ X36)) @ X37))))))).
thf(c_H7,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_G1 @ X36) @ X37) = ((add_5FSNo @ X37) @ X37))))))).
thf(c_H8,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_H1 @ X36) @ X37) = X37)))))).
thf(c_H9,axiom,(c_I1 = (ordsucc @ c_Empty))).
thf(c_H10,axiom,(c_J1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H11,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((((c_U1 @ X36) @ X37) @ X38) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X37) @ ((c_F1 @ (((c_U1 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38)) @ (((c_V1 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38))))))))))).
thf(c_H12,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((((c_V1 @ X36) @ X37) @ X38) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X38) @ ((c_G1 @ (((c_U1 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38)) @ (((c_V1 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38))))))))))).
thf(c_H13,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_W1 @ X36) @ X37) = (((c_U1 @ ((c_H1 @ X36) @ X37)) @ c_I1) @ c_J1))))))).
thf(c_H14,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F0 @ X36) @ X37) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((c_W1 @ X36) @ X37)) @ X36)) @ X36)) @ X36))))))).
...
thf(c_H20,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F3 @ X36) @ X37) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X36) @ X36)) @ X36))) @ (minus_5FSNo @ X37))))))))).
thf(c_H21,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_G3 @ X36) @ X37) = ((add_5FSNo @ X37) @ X37))))))).
...
thf(c_H32,axiom,(c_J4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H36,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_FAST @ X36) = ((add_5FSNo @ (c_W3 @ X36)) @ (minus_5FSNo @ (c_W4 @ X36))))))).
thf(a16281,conjecture,(! [X36:$i] : (((c_In @ X36) @ int) => (((c_SNoLe @ c_Empty) @ X36) => ((c_SMALL @ X36) = (c_FAST @ X36)))))).
