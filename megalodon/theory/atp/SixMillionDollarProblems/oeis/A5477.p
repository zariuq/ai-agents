% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A5477.mg.html#A5477
...
thf(c_H1,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F0 @ X33) @ X34) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ X33) @ X34)) @ X33)))))))).
...
thf(c_H9,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F1 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X33) @ X33)))))).
...
thf(c_H14,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = ((mul_5FSNo @ (c_W0 @ X33)) @ (c_V1 @ X33)))))).
thf(c_H15,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X33)) @ X33))))).
...
thf(c_H25,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F4 @ X33) @ X34) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X34)) @ X33))))))).
thf(c_H26,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_G4 @ X33) @ X34) = ((add_5FSNo @ X34) @ X34))))))).
thf(c_H27,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H4 @ X33) = X33)))).
thf(c_H28,axiom,(c_I4 = (ordsucc @ c_Empty))).
thf(c_H29,axiom,(c_J4 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(a5477,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
