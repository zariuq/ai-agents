% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A333385.mg.html#A333385
...
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((mul_5FSNo @ X33) @ X33))))).
thf(c_H7,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(c_H2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H9,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U2 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H10,axiom,(c_V2 = ((c_U2 @ c_G2) @ c_H2))).
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F1 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ c_V2) @ X33)) @ X33))))).
thf(c_H12,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G1 @ X33) = X33)))).
thf(c_H13,axiom,(c_H1 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(c_H16,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = ((add_5FSNo @ (c_V0 @ X33)) @ (c_V1 @ X33)))))).
...
thf(c_H21,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(c_H33,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_FAST @ X33) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W3 @ X33))) @ (c_W4 @ X33)))))).
thf(a333385,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
