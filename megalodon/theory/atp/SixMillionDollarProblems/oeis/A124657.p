% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A124657.mg.html#A124657
...
thf(c_H1,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F0 @ X12) @ X13) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X13)) @ X12))))))).
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12))))).
...
thf(c_H8,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G1 @ X12) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12)))))).
...
thf(a124657,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
