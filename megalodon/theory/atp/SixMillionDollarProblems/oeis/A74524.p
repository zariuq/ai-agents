% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A74524.mg.html#A74524
...
thf(c_H1,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F0 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ X27) @ X27)) @ X26)) @ X26)) @ X26))) @ X26))))))).
thf(c_H2,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_G0 @ X26) @ X27) = ((add_5FSNo @ ((add_5FSNo @ X27) @ X27)) @ X27))))))).
thf(c_H3,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H0 @ X26) = X26)))).
...
thf(c_H9,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_SMALL @ X26) = ((add_5FSNo @ (c_W0 @ X26)) @ (ordsucc @ c_Empty)))))).
...
thf(c_H22,axiom,(c_J2 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H26,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_FAST @ X26) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_W1 @ X26)) @ (c_W2 @ X26))))))).
thf(a74524,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
