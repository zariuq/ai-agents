% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A73554.mg.html#A73554
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X25))))).
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F0 @ X25) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (c_V1 @ X25)) @ X25)))))).
thf(c_H7,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G0 @ X25) = X25)))).
thf(c_H8,axiom,(c_F2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H9,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G2 @ X25) = X25)))).
thf(c_H10,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = X25)))).
thf(c_H11,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U2 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ c_F2))))))).
thf(c_H12,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V2 @ X25) = ((c_U2 @ (c_G2 @ X25)) @ (c_H2 @ X25)))))).
thf(c_H13,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H0 @ X25) = (c_V2 @ X25))))).
thf(c_H14,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U0 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ (c_F0 @ ((c_U0 @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X26))))))))).
thf(c_H15,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V0 @ X25) = ((c_U0 @ (c_G0 @ X25)) @ (c_H0 @ X25)))))).
thf(c_H16,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_SMALL @ X25) = (c_V0 @ X25))))).
thf(c_H17,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F3 @ X25) @ X26) = ((add_5FSNo @ ((mul_5FSNo @ X25) @ X26)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
thf(c_H18,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_G3 @ X25) @ X26) = X26)))))).
thf(c_H19,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H3 @ X25) = ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H25,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_FAST @ X25) = ((add_5FSNo @ ((mul_5FSNo @ (c_W3 @ X25)) @ (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))) @ (minus_5FSNo @ (ordsucc @ c_Empty)))))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a73554,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
