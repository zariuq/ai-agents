% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A97781.mg.html#A97781
...
thf(a97781,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
