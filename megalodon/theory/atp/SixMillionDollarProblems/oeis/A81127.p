% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A81127.mg.html#A81127
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F1 @ X20) @ X21) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X21)) @ X20))))))).
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ (c_V1 @ X20)) @ (minus_5FSNo @ X20)))))).
thf(c_H7,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_G0 @ X20) = ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H8,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H0 @ X20) = X20)))).
...
thf(c_H10,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V0 @ X20) = ((c_U0 @ (c_G0 @ X20)) @ (c_H0 @ X20)))))).
...
thf(c_H15,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_I2 @ X20) = X20)))).
...
thf(a81127,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
