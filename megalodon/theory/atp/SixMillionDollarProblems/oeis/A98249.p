% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A98249.mg.html#A98249
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F1 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X29))))))).
...
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F3 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X29))))))).
...
thf(c_H18,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U3 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ ((c_F3 @ ((c_U3 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29)) @ X28)))))))).
thf(c_H19,axiom,(c_V3 = ((c_U3 @ c_G3) @ c_H3))).
thf(c_H20,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ c_V3) @ X28)) @ (minus_5FSNo @ X29)))))))).
...
thf(c_H24,axiom,(c_J2 = ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ (ordsucc @ c_Empty))))).
...
thf(a98249,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
