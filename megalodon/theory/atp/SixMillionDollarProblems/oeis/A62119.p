% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A62119.mg.html#A62119
...
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X12)) @ (c_V1 @ X12)))))).
thf(a62119,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
