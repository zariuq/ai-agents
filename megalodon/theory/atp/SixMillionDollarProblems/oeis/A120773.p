% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A120773.mg.html#A120773
...
thf(c_H1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_F0 @ X36) = ((add_5FSNo @ X36) @ X36))))).
thf(c_H2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_G0 @ X36) = ((mul_5FSNo @ X36) @ X36))))).
...
thf(c_H6,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_F1 @ X36) = ((add_5FSNo @ ((add_5FSNo @ X36) @ X36)) @ X36))))).
...
thf(c_H11,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_SMALL @ X36) = ((add_5FSNo @ (c_V0 @ X36)) @ (minus_5FSNo @ (c_V1 @ X36))))))).
thf(c_H12,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F2 @ X36) @ X37) = ((mul_5FSNo @ X36) @ X37))))))).
thf(c_H13,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_G2 @ X36) @ X37) = ((add_5FSNo @ X37) @ X37))))))).
thf(c_H14,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_H2 @ X36) = ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H36,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_FAST @ X36) = ((add_5FSNo @ ((mul_5FSNo @ (c_W2 @ X36)) @ (c_W3 @ X36))) @ (minus_5FSNo @ (c_W4 @ X36))))))).
thf(a120773,conjecture,(! [X36:$i] : (((c_In @ X36) @ int) => (((c_SNoLe @ c_Empty) @ X36) => ((c_SMALL @ X36) = (c_FAST @ X36)))))).
