% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16226.mg.html#A16226
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X25) @ X25))))))).
...
thf(c_H11,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F0 @ X25) @ X26) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X25) @ X26)) @ (minus_5FSNo @ X25))) @ (c_V2 @ X25)))))))).
...
thf(c_H18,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_G3 @ X25) @ X26) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))))))))).
...
thf(a16226,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
