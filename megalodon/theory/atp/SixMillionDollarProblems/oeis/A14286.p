% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A14286.mg.html#A14286
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X19))))))).
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_G0 @ X18) = ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H13,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I1 @ X18) = ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(c_H14,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_J1 @ X18) = ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W1 @ X18)))))).
thf(a14286,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
