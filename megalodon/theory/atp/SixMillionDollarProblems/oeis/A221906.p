% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A221906.mg.html#A221906
...
thf(c_H1,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F0 @ X17) @ X18) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X17) @ (minus_5FSNo @ X18)))))))))).
...
thf(c_H17,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_FAST @ X17) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X17) @ X17))) @ (c_V1 @ X17)))))).
thf(a221906,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
