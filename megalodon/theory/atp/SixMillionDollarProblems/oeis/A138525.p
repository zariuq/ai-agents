% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A138525.mg.html#A138525
...
thf(c_H2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G1 @ X20) @ X21) = ((add_5FSNo @ X21) @ X21))))))).
...
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ X21) @ X21)) @ (minus_5FSNo @ X21))) @ X20)))))))).
thf(c_H13,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G2 @ X20) @ X21) = ((add_5FSNo @ X21) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(c_H16,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_J2 @ X20) = ((add_5FSNo @ X20) @ X20))))).
...
thf(c_H19,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_W2 @ X20) = (((c_U2 @ (c_H2 @ X20)) @ c_I2) @ (c_J2 @ X20)))))).
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ ((mul_5FSNo @ (c_W2 @ X20)) @ (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ c_Empty) @ (ordsucc @ (ordsucc @ c_Empty))))) @ (ordsucc @ c_Empty)))))).
thf(a138525,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
