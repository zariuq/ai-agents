% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A74614.mg.html#A74614
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X28) @ (minus_5FSNo @ X29))) @ X28)) @ X28))))))).
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G0 @ X28) @ X29) = ((add_5FSNo @ X29) @ X29))))))).
thf(c_H3,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H0 @ X28) = ((add_5FSNo @ X28) @ X28))))).
...
thf(c_H10,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((mul_5FSNo @ X28) @ X28))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((add_5FSNo @ (c_V1 @ X28)) @ (c_W3 @ X28)))))).
thf(a74614,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
