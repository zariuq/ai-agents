% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A28006.mg.html#A28006
...
thf(c_H1,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F2 @ X43) @ X44) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X43) @ X43))) @ X43))) @ ((mul_5FSNo @ ((mul_5FSNo @ X44) @ X44)) @ X44)))))))).
...
thf(c_H20,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F5 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X43) @ X43))) @ X43)) @ X44))))))).
thf(c_H21,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_G5 @ X43) @ X44) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X44) @ X44))))))))).
thf(c_H22,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => ((c_H5 @ X43) = X43)))).
thf(c_H23,axiom,(c_I5 = (ordsucc @ c_Empty))).
thf(c_H24,axiom,(c_J5 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H38,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F3 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X43) @ X44)) @ X43)) @ ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X43) @ X43)) @ X43)) @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(a28006,conjecture,(! [X43:$i] : (((c_In @ X43) @ int) => (((c_SNoLe @ c_Empty) @ X43) => ((c_SMALL @ X43) = (c_FAST @ X43)))))).
