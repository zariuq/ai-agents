% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13815.mg.html#A13815
...
thf(c_H1,axiom,(! [X38:$i] : (((c_In @ X38) @ int) => ((c_F1 @ X38) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X38)))))).
...
thf(c_H19,axiom,(! [X38:$i] : (((c_In @ X38) @ int) => ((c_H3 @ X38) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X38)))))).
thf(c_H20,axiom,(c_I3 = (ordsucc @ c_Empty))).
thf(c_H21,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(c_H25,axiom,(! [X38:$i] : (((c_In @ X38) @ int) => ((c_F4 @ X38) = ((mul_5FSNo @ ((mul_5FSNo @ X38) @ X38)) @ X38))))).
...
thf(c_H31,axiom,(c_J5 = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty)))).
...
thf(c_H38,axiom,(! [X38:$i] : (((c_In @ X38) @ int) => ((c_FAST @ X38) = ((mul_5FSNo @ (c_W3 @ X38)) @ (c_V4 @ X38)))))).
thf(a13815,conjecture,(! [X38:$i] : (((c_In @ X38) @ int) => (((c_SNoLe @ c_Empty) @ X38) => ((c_SMALL @ X38) = (c_FAST @ X38)))))).
