% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A257583.mg.html#A257583
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F0 @ X25) @ X26) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X25) @ X26)))))))).
thf(c_H2,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G0 @ X25) = ((add_5FSNo @ X25) @ X25))))).
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_SMALL @ X25) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V0 @ X25)))))).
thf(c_H7,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F1 @ X25) @ X26) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X25) @ X26)))))))).
thf(c_H8,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G1 @ X25) = X25)))).
thf(c_H9,axiom,(c_H1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H10,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U1 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X26)) @ X25)))))))).
thf(c_H11,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V1 @ X25) = ((c_U1 @ (c_G1 @ X25)) @ c_H1))))).
...
thf(c_H21,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_J3 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X25))))).
...
thf(c_H25,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_FAST @ X25) = ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X25))) @ (c_V2 @ X25))) @ (c_W3 @ X25)))))).
thf(a257583,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
