% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9976.mg.html#A9976
...
thf(c_H7,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_F1 @ X17) = ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X17) @ X17)) @ X17)) @ X17)) @ X17))))).
...
thf(a9976,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
