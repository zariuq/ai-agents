% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A272263.mg.html#A272263
...
thf(c_H9,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_SMALL @ X23) = ((add_5FSNo @ (c_W0 @ X23)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H12,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_F2 @ X23) @ X24) = ((add_5FSNo @ X23) @ X24))))))).
...
thf(c_H22,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_V1 @ X23) = ((c_U1 @ (c_G1 @ X23)) @ (c_H1 @ X23)))))).
thf(c_H23,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_FAST @ X23) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X23))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a272263,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
