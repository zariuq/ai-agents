% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A14298.mg.html#A14298
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F0 @ X28) = ((add_5FSNo @ X28) @ X28))))).
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G0 @ X28) = X28)))).
thf(c_H3,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F1 @ X28) @ X29) = ((mul_5FSNo @ X28) @ X29))))))).
thf(c_H4,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G1 @ X28) @ X29) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X29))))))).
thf(c_H5,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H1 @ X28) = ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H6,axiom,(c_I1 = (ordsucc @ c_Empty))).
thf(c_H7,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_J1 @ X28) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X28) @ X28)))))).
...
thf(c_H10,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_W1 @ X28) = (((c_U1 @ (c_H1 @ X28)) @ c_I1) @ (c_J1 @ X28)))))).
thf(c_H11,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H0 @ X28) = (c_W1 @ X28))))).
thf(c_H12,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U0 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ (c_F0 @ ((c_U0 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29))))))))).
...
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F2 @ X28) = ((add_5FSNo @ X28) @ X28))))).
...
thf(c_H21,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G3 @ X28) @ X29) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X29))))))).
...
thf(c_H24,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_J3 @ X28) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X28) @ X28)))))).
...
thf(c_H27,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_W3 @ X28) = (((c_U3 @ (c_H3 @ X28)) @ c_I3) @ (c_J3 @ X28)))))).
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((mul_5FSNo @ (c_V2 @ X28)) @ (c_W3 @ X28)))))).
thf(a14298,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
