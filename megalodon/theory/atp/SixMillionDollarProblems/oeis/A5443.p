% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A5443.mg.html#A5443
...
thf(c_HI3,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_In @ (c_I3 @ X28)) @ int)))).
thf(c_HJ3,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_In @ (c_J3 @ X28)) @ int)))).
...
thf(c_H16,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G2 @ X28) = ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H17,axiom,(c_H2 = (ordsucc @ c_Empty))).
thf(c_H18,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U2 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29)) @ X28)))))))).
thf(c_H19,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_V2 @ X28) = ((c_U2 @ (c_G2 @ X28)) @ c_H2))))).
thf(c_H20,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F3 @ X28) @ X29) = ((add_5FSNo @ X28) @ X29))))))).
thf(c_H21,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G3 @ X28) = X28)))).
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H3 @ X28) = ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(c_H23,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_I3 @ X28) = X28)))).
thf(c_H24,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_J3 @ X28) = X28)))).
...
thf(c_H26,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (! [X30:$i] : (((c_In @ X30) @ int) => ((((c_V3 @ X28) @ X29) @ X30) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X30) @ (c_G3 @ (((c_U3 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30))))))))))).
thf(c_H27,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_W3 @ X28) = (((c_U3 @ (c_H3 @ X28)) @ (c_I3 @ X28)) @ (c_J3 @ X28)))))).
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((mul_5FSNo @ (c_V2 @ X28)) @ (c_W3 @ X28)))))).
thf(a5443,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
