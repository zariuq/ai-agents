% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A25937.mg.html#A25937
...
thf(c_H1,axiom,(! [X45:$i] : (((c_In @ X45) @ int) => (! [X46:$i] : (((c_In @ X46) @ int) => (((c_F2 @ X45) @ X46) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X45) @ X45)) @ X45))) @ X46))))))).
...
thf(c_H9,axiom,(! [X45:$i] : (((c_In @ X45) @ int) => (! [X46:$i] : (((c_In @ X46) @ int) => (((c_F1 @ X45) @ X46) = ((add_5FSNo @ ((add_5FSNo @ ((c_W2 @ X45) @ X46)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X45) @ X45)) @ X45)))) @ X45))))))).
...
thf(c_H35,axiom,(! [X45:$i] : (((c_In @ X45) @ int) => (! [X46:$i] : (((c_In @ X46) @ int) => (((c_F4 @ X45) @ X46) = ((add_5FSNo @ ((add_5FSNo @ ((c_V5 @ X45) @ X46)) @ X45)) @ X45))))))).
...
thf(c_H40,axiom,(! [X45:$i] : (((c_In @ X45) @ int) => (! [X46:$i] : (((c_In @ X46) @ int) => (((c_F3 @ X45) @ X46) = ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X45) @ X46)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X45) @ X45)) @ X45)))) @ X45))))))).
...
thf(a25937,conjecture,(! [X45:$i] : (((c_In @ X45) @ int) => (((c_SNoLe @ c_Empty) @ X45) => ((c_SMALL @ X45) = (c_FAST @ X45)))))).
