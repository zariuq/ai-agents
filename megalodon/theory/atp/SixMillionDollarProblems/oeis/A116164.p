% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A116164.mg.html#A116164
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X15)) @ (c_V0 @ X15)))))).
...
thf(a116164,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
