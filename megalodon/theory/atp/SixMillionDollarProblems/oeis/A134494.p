% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A134494.mg.html#A134494
...
thf(c_H13,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_I1 @ X26) = ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ c_Empty) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty)))))).
...
thf(c_H20,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H2 @ X26) = ((add_5FSNo @ ((add_5FSNo @ X26) @ X26)) @ X26))))).
...
thf(a134494,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
