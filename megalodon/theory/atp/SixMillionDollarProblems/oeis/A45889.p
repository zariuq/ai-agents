% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A45889.mg.html#A45889
...
thf(c_H1,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_F2 @ X32) = ((add_5FSNo @ ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32))))).
...
thf(c_H5,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V2 @ X32) @ X33) = ((c_U2 @ ((c_G2 @ X32) @ X33)) @ ((c_H2 @ X32) @ X33)))))))).
...
thf(c_H17,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_F5 @ X32) = ((add_5FSNo @ X32) @ X32))))).
thf(c_H18,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_G5 @ X32) = X32)))).
thf(c_H19,axiom,(c_H5 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(c_H21,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_V5 @ X32) = ((c_U5 @ (c_G5 @ X32)) @ c_H5))))).
thf(c_H22,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_F4 @ X32) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ (c_V5 @ X32))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty))) @ X32))))).
thf(c_H23,axiom,(c_G4 = (ordsucc @ c_Empty))).
thf(c_H24,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_H4 @ X32) @ X33) = X33)))))).
...
thf(a45889,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
