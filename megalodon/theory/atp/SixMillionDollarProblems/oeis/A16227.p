% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16227.mg.html#A16227
...
thf(a16227,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
