% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A199413.mg.html#A199413
...
thf(c_H2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_G0 @ X20) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X20))))).
thf(c_H3,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F1 @ X20) = ((add_5FSNo @ X20) @ X20))))).
thf(c_H4,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_G1 @ X20) = X20)))).
thf(c_H5,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_U1 @ X20) @ X21) = (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ X21) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X21))))))))).
thf(c_H7,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V1 @ X20) = ((c_U1 @ (c_G1 @ X20)) @ c_H1))))).
thf(c_H8,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H0 @ X20) = (c_V1 @ X20))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (c_W2 @ X20))))))).
thf(a199413,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
