% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A109105.mg.html#A109105
...
thf(c_HG1,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => ((c_In @ ((c_G1 @ X26) @ X27)) @ int)))))).
...
thf(c_HG2,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_In @ (c_G2 @ X26)) @ int)))).
...
thf(c_H1,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F0 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))) @ (minus_5FSNo @ X27)))))))).
thf(c_H2,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_G0 @ X26) @ X27) = ((add_5FSNo @ X26) @ X27))))))).
thf(c_H3,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H0 @ X26) = ((add_5FSNo @ X26) @ X26))))).
...
thf(c_H9,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_SMALL @ X26) = ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W0 @ X26)))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H10,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F1 @ X26) @ X27) = ((mul_5FSNo @ X26) @ X27))))))).
thf(c_H11,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_G1 @ X26) @ X27) = X27)))))).
...
thf(c_H16,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => ((((c_V1 @ X26) @ X27) @ X28) = (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ X28) @ ((c_G1 @ (((c_U1 @ ((add_5FSNo @ X26) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X27) @ X28)) @ (((c_V1 @ ((add_5FSNo @ X26) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X27) @ X28))))))))))).
thf(c_H17,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_W1 @ X26) = (((c_U1 @ (c_H1 @ X26)) @ c_I1) @ c_J1))))).
thf(c_H18,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F2 @ X26) @ X27) = ((add_5FSNo @ X26) @ X27))))))).
thf(c_H19,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_G2 @ X26) = X26)))).
thf(c_H20,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H2 @ X26) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26)))))).
thf(c_H21,axiom,(c_I2 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(c_H24,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => ((((c_V2 @ X26) @ X27) @ X28) = (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ X28) @ (c_G2 @ (((c_U2 @ ((add_5FSNo @ X26) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X27) @ X28))))))))))).
thf(c_H25,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_W2 @ X26) = (((c_U2 @ (c_H2 @ X26)) @ c_I2) @ c_J2))))).
thf(c_H26,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_FAST @ X26) = ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W1 @ X26))) @ (c_W2 @ X26))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(a109105,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
