% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9984.mg.html#A9984
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F0 @ X25) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ c_V1) @ X25)))))).
...
thf(a9984,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
