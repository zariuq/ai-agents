% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A7574.mg.html#A7574
...
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_G0 @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18))))).
...
thf(c_H9,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_SMALL @ X18) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_W0 @ X18)) @ (minus_5FSNo @ X18))))))).
...
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = ((add_5FSNo @ ((add_5FSNo @ (c_W1 @ X18)) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ X18)))))).
thf(a7574,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
