% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A52584.mg.html#A52584
...
thf(c_H4,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G1 @ X22) = ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H8,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H0 @ X22) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_V1 @ X22)))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_V2 @ X22))) @ (c_V3 @ X22)))))).
thf(a52584,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
