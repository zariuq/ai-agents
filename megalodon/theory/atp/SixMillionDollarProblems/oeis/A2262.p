% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A2262.mg.html#A2262
...
thf(c_H1,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F0 @ X12) @ X13) = ((add_5FSNo @ X12) @ (minus_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ ((add_5FSNo @ X13) @ (minus_5FSNo @ X12))) @ c_Empty)) @ X13) @ c_Empty))))))))).
...
thf(c_H7,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F1 @ X12) @ X13) = ((add_5FSNo @ X12) @ (minus_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ ((add_5FSNo @ X13) @ (minus_5FSNo @ X12))) @ c_Empty)) @ X13) @ c_Empty))))))))).
...
thf(a2262,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
