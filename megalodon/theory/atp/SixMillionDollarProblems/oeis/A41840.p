% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A41840.mg.html#A41840
...
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ c_V1) @ X28)) @ X29))))))).
thf(c_H7,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G0 @ X28) = X28)))).
thf(c_H8,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H0 @ X28) = X28)))).
thf(c_H9,axiom,(c_I0 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F3 @ X28) = ((add_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X28))))).
thf(c_H16,axiom,(c_G3 = (ordsucc @ c_Empty))).
thf(c_H17,axiom,(c_H3 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H20,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ c_V3) @ X28)) @ X29))))))).
thf(c_H21,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G2 @ X28) = X28)))).
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H2 @ X28) = X28)))).
thf(c_H23,axiom,(c_I2 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(a41840,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
