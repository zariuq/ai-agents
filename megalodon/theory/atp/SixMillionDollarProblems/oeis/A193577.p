% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A193577.mg.html#A193577
...
thf(a193577,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
