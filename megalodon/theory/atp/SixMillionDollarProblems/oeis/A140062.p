% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A140062.mg.html#A140062
...
thf(c_H1,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F1 @ X22) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X22)) @ X22)))))).
...
thf(c_H6,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F0 @ X22) = ((add_5FSNo @ ((add_5FSNo @ c_V1) @ X22)) @ X22))))).
...
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((mul_5FSNo @ X22) @ X22))))).
thf(c_H13,axiom,(c_G2 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(c_H2 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H16,axiom,(c_V2 = ((c_U2 @ c_G2) @ c_H2))).
thf(c_H17,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F3 @ X22) = ((add_5FSNo @ X22) @ X22))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ c_V2)) @ ((add_5FSNo @ (c_V3 @ X22)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))) @ (ordsucc @ c_Empty)))))).
thf(a140062,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
