% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A15013.mg.html#A15013
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F1 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ ((add_5FSNo @ X20) @ X20))))))).
...
thf(c_H13,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G2 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ ((add_5FSNo @ X21) @ X21))))))))).
thf(c_H14,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H2 @ X20) = X20)))).
thf(c_H15,axiom,(c_I2 = (ordsucc @ c_Empty))).
thf(c_H16,axiom,(c_J2 = ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ (ordsucc @ c_Empty))))).
...
thf(a15013,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
