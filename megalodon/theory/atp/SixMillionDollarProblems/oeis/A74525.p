% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A74525.mg.html#A74525
...
thf(c_H9,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_SMALL @ X28) = ((add_5FSNo @ (c_W0 @ X28)) @ (ordsucc @ c_Empty)))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_V1 @ X28)) @ (c_W3 @ X28))))))).
thf(a74525,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
