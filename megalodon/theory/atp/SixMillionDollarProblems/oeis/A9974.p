% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9974.mg.html#A9974
...
thf(c_H21,axiom,(c_J3 = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))).
...
thf(a9974,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
