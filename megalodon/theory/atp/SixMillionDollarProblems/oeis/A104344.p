% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A104344.mg.html#A104344
...
thf(c_H2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G1 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X21))))))).
...
thf(a104344,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
