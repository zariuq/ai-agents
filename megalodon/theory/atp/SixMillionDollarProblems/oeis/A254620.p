% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A254620.mg.html#A254620
...
thf(c_H3,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H1 @ X28) = ((add_5FSNo @ X28) @ X28))))).
...
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X29) @ X29))) @ (c_V1 @ X28)))))))).
...
thf(c_H13,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G2 @ X28) @ X29) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X29))))))).
...
thf(c_H24,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(a254620,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
