% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A155594.mg.html#A155594
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F0 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X25) @ X25)))))).
thf(c_H2,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G0 @ X25) = X25)))).
thf(c_H3,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X25) @ X25))) @ X25))))).
...
thf(c_H22,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_W3 @ X25)))))).
...
thf(c_H25,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_FAST @ X25) = ((add_5FSNo @ (c_V2 @ X25)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a155594,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
