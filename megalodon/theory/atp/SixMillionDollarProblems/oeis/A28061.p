% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A28061.mg.html#A28061
...
thf(a28061,conjecture,(! [X60:$i] : (((c_In @ X60) @ int) => (((c_SNoLe @ c_Empty) @ X60) => ((c_SMALL @ X60) = (c_FAST @ X60)))))).
