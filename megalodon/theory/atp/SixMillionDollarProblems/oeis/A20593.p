% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20593.mg.html#A20593
...
thf(c_H1,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F1 @ X43) @ X44) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X43) @ X43)) @ X43))) @ ((mul_5FSNo @ ((mul_5FSNo @ X44) @ X44)) @ X44)))))))).
...
thf(c_H9,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F2 @ X43) @ X44) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X44)) @ X43))))))).
thf(c_H10,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H11,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => ((c_H2 @ X43) = X43)))).
thf(c_H12,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_U2 @ X43) @ X44) = (((c_If_5Fi @ ((c_SNoLe @ X43) @ c_Empty)) @ X44) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X44)) @ X43)))))))).
thf(c_H13,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => ((c_V2 @ X43) = ((c_U2 @ c_G2) @ (c_H2 @ X43)))))).
thf(c_H14,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F0 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((c_W1 @ X43) @ X44)) @ (minus_5FSNo @ X43))) @ (c_V2 @ X43)))))))).
...
thf(c_H20,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F5 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ X44) @ X44)) @ X43)) @ X43)) @ X43))))))).
thf(c_H21,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_G5 @ X43) @ X44) = ((add_5FSNo @ X44) @ X44))))))).
...
thf(c_H29,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => ((c_G6 @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H38,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F3 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X43) @ X44)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X43) @ X43))) @ X43)))) @ X43))))))).
...
thf(a20593,conjecture,(! [X43:$i] : (((c_In @ X43) @ int) => (((c_SNoLe @ c_Empty) @ X43) => ((c_SMALL @ X43) = (c_FAST @ X43)))))).
