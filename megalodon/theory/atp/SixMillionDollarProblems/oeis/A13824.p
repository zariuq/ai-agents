% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13824.mg.html#A13824
...
thf(c_H2,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G0 @ X22) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X22) @ X22))) @ X22)))))).
...
thf(c_H7,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((mul_5FSNo @ X22) @ X22))))).
thf(c_H8,axiom,(c_G2 = (ordsucc @ c_Empty))).
thf(c_H9,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H2 @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X22) @ X22)))))).
thf(c_H10,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_U2 @ X22) @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ X23) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X23))))))))).
thf(c_H11,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_V2 @ X22) = ((c_U2 @ c_G2) @ (c_H2 @ X22)))))).
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F1 @ X22) = ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V2 @ X22))) @ X22))))).
...
thf(c_H19,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H1 @ X22) = (c_V3 @ X22))))).
...
thf(a13824,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
