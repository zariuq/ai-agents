% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A17953.mg.html#A17953
...
thf(c_H1,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F2 @ X50) = ((add_5FSNo @ ((add_5FSNo @ X50) @ X50)) @ X50))))).
...
thf(c_H36,axiom,(c_J8 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(a17953,conjecture,(! [X50:$i] : (((c_In @ X50) @ int) => (((c_SNoLe @ c_Empty) @ X50) => ((c_SMALL @ X50) = (c_FAST @ X50)))))).
