% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1589.mg.html#A1589
...
thf(c_H2,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G0 @ X22) = ((add_5FSNo @ X22) @ X22))))).
...
thf(c_H6,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F1 @ X22) = ((mul_5FSNo @ X22) @ X22))))).
thf(c_H7,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H1 @ X22) = X22)))).
thf(c_H9,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_U1 @ X22) @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ X23) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X23))))))))).
thf(c_H10,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_V1 @ X22) = ((c_U1 @ c_G1) @ (c_H1 @ X22)))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X22) @ X22)) @ X22)) @ X22)) @ (c_V2 @ X22)))))).
thf(a1589,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
