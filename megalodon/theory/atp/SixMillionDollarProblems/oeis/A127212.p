% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A127212.mg.html#A127212
...
thf(c_H1,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_F0 @ X31) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X31) @ X31))) @ X31))))).
thf(c_H2,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G0 @ X31) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X31))))).
thf(c_H3,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F1 @ X31) @ X32) = ((add_5FSNo @ X31) @ X32))))))).
thf(c_H4,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G1 @ X31) = X31)))).
thf(c_H5,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H1 @ X31) = X31)))).
...
thf(c_H11,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H0 @ X31) = (c_W1 @ X31))))).
...
thf(c_H26,axiom,(c_I3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
thf(c_H27,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(a127212,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
