% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A7489.mg.html#A7489
...
thf(c_HV1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => ((c_In @ ((c_V1 @ X20) @ X21)) @ int)))))).
...
thf(c_HI2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_In @ (c_I2 @ X20)) @ int)))).
thf(c_HJ2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_In @ (c_J2 @ X20)) @ int)))).
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F1 @ X20) @ X21) = ((mul_5FSNo @ X20) @ X21))))))).
thf(c_H2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G1 @ X20) @ X21) = X21)))))).
thf(c_H3,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H4,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_U1 @ X20) @ X21) = (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ X21) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X21)) @ X20)))))))).
thf(c_H5,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_V1 @ X20) @ X21) = ((c_U1 @ ((c_G1 @ X20) @ X21)) @ c_H1))))))).
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F0 @ X20) @ X21) = ((add_5FSNo @ ((c_V1 @ X20) @ X21)) @ X20))))))).
thf(c_H7,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_G0 @ X20) = X20)))).
thf(c_H8,axiom,(c_H0 = c_Empty)).
thf(c_H9,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_U0 @ X20) @ X21) = (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ X21) @ ((c_F0 @ ((c_U0 @ ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X21)) @ X20)))))))).
thf(c_H10,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V0 @ X20) = ((c_U0 @ (c_G0 @ X20)) @ c_H0))))).
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = (c_V0 @ X20))))).
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X20) @ X21)))))))).
thf(c_H13,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G2 @ X20) @ X21) = ((add_5FSNo @ X21) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
thf(c_H14,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H2 @ X20) = ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H15,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_I2 @ X20) = (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ c_Empty) @ (ordsucc @ c_Empty)))))).
thf(c_H16,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_J2 @ X20) = X20)))).
...
thf(c_H19,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_W2 @ X20) = (((c_U2 @ (c_H2 @ X20)) @ (c_I2 @ X20)) @ (c_J2 @ X20)))))).
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = (c_W2 @ X20))))).
thf(a7489,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
