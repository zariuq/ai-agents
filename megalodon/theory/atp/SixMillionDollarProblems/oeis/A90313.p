% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A90313.mg.html#A90313
...
thf(c_HG0,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_In @ (c_G0 @ X18)) @ int)))).
...
thf(c_HG1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_In @ (c_G1 @ X18)) @ int)))).
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))) @ ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ ((mul_5FSNo @ X18) @ X19)) @ c_Empty)) @ X19) @ X18)) @ X18))) @ X19))))))).
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_G0 @ X18) = X18)))).
...
thf(c_H7,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (! [X20:$i] : (((c_In @ X20) @ int) => ((((c_V0 @ X18) @ X19) @ X20) = (((c_If_5Fi @ ((c_SNoLe @ X18) @ c_Empty)) @ X20) @ (c_G0 @ (((c_U0 @ ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X19) @ X20))))))))))).
thf(c_H8,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_W0 @ X18) = (((c_U0 @ (c_H0 @ X18)) @ c_I0) @ c_J0))))).
thf(c_H9,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_SMALL @ X18) = (c_W0 @ X18))))).
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))) @ X18)) @ X19))))))).
thf(c_H11,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_G1 @ X18) = X18)))).
thf(c_H12,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H1 @ X18) = ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H13,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I1 @ X18) = ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X18) @ c_Empty)) @ c_Empty) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))) @ (ordsucc @ c_Empty)))))).
...
thf(c_H16,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (! [X20:$i] : (((c_In @ X20) @ int) => ((((c_V1 @ X18) @ X19) @ X20) = (((c_If_5Fi @ ((c_SNoLe @ X18) @ c_Empty)) @ X20) @ (c_G1 @ (((c_U1 @ ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X19) @ X20))))))))))).
thf(c_H17,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_W1 @ X18) = (((c_U1 @ (c_H1 @ X18)) @ (c_I1 @ X18)) @ c_J1))))).
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = ((mul_5FSNo @ (c_W1 @ X18)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(a90313,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
