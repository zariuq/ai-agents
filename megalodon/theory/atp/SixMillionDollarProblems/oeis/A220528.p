% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A220528.mg.html#A220528
...
thf(c_HI0,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_In @ (c_I0 @ X28)) @ int)))).
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((mul_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X29))))))).
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G0 @ X28) @ X29) = X29)))))).
thf(c_H3,axiom,(c_H0 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H4,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_I0 @ X28) = X28)))).
thf(c_H5,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_J0 @ X28) = X28)))).
...
thf(c_H8,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_W0 @ X28) = (((c_U0 @ c_H0) @ (c_I0 @ X28)) @ (c_J0 @ X28)))))).
thf(c_H9,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X28) @ X28)) @ X28))) @ X28))))).
thf(c_H10,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G1 @ X28) = X28)))).
...
thf(c_H14,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_SMALL @ X28) = ((add_5FSNo @ ((add_5FSNo @ (c_W0 @ X28)) @ (c_V1 @ X28))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X28) @ X28)) @ X28))) @ X28)))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (c_V2 @ X28)) @ X28)) @ (c_W3 @ X28))) @ ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X28)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))) @ X28)))))).
thf(a220528,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
