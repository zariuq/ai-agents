% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16237.mg.html#A16237
...
thf(c_HV2,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => ((c_In @ ((c_V2 @ X33) @ X34)) @ int)))))).
...
thf(c_H1,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F1 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X33) @ X33))) @ X33))))).
thf(c_H2,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_G1 @ X33) @ X34) = X34)))))).
thf(c_H3,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X33) @ X33)))))).
thf(c_H4,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_G2 @ X33) @ X34) = X34)))))).
thf(c_H5,axiom,(c_H2 = (ordsucc @ c_Empty))).
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U2 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H7,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_V2 @ X33) @ X34) = ((c_U2 @ ((c_G2 @ X33) @ X34)) @ c_H2))))))).
thf(c_H8,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_H1 @ X33) @ X34) = ((c_V2 @ X33) @ X34))))))).
...
thf(c_H10,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_V1 @ X33) @ X34) = ((c_U1 @ ((c_G1 @ X33) @ X34)) @ ((c_H1 @ X33) @ X34)))))))).
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F0 @ X33) @ X34) = ((add_5FSNo @ ((c_V1 @ X33) @ X34)) @ X33))))))).
thf(c_H12,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G0 @ X33) = X33)))).
thf(c_H13,axiom,(c_H0 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U0 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ ((c_F0 @ ((c_U0 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34)) @ X33)))))))).
thf(c_H15,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V0 @ X33) = ((c_U0 @ (c_G0 @ X33)) @ c_H0))))).
thf(c_H16,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = (c_V0 @ X33))))).
thf(c_H17,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F3 @ X33) @ X34) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X33) @ X34)))))))).
thf(c_H18,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_G3 @ X33) @ X34) = X34)))))).
thf(c_H19,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H3 @ X33) = X33)))).
thf(c_H20,axiom,(c_I3 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H21,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H22,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (! [X35:$i] : (((c_In @ X35) @ int) => ((((c_U3 @ X33) @ X34) @ X35) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ ((c_F3 @ (((c_U3 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34) @ X35)) @ (((c_V3 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34) @ X35))))))))))).
thf(c_H23,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (! [X35:$i] : (((c_In @ X35) @ int) => ((((c_V3 @ X33) @ X34) @ X35) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X35) @ ((c_G3 @ (((c_U3 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34) @ X35)) @ (((c_V3 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34) @ X35))))))))))).
thf(c_H24,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_W3 @ X33) = (((c_U3 @ (c_H3 @ X33)) @ c_I3) @ c_J3))))).
thf(c_H25,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F4 @ X33) @ X34) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X33) @ X34)))))))).
...
thf(c_H33,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_FAST @ X33) = ((add_5FSNo @ (c_W3 @ X33)) @ (minus_5FSNo @ (c_W4 @ X33))))))).
thf(a16237,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
