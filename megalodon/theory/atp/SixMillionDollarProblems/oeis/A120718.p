% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A120718.mg.html#A120718
...
thf(c_H1,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F1 @ X31) @ X32) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X32))))))).
thf(c_H2,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_G1 @ X31) @ X32) = ((add_5FSNo @ X31) @ X32))))))).
...
thf(c_H7,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => ((((c_V1 @ X31) @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X31) @ c_Empty)) @ X33) @ ((c_G1 @ (((c_U1 @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32) @ X33)) @ (((c_V1 @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32) @ X33))))))))))).
...
thf(c_H17,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H2 @ X31) = ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(c_H31,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_FAST @ X31) = ((mul_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X31) @ c_Empty)) @ c_Empty) @ (c_W2 @ X31))) @ (c_W3 @ X31)))))).
thf(a120718,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
