% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A97816.mg.html#A97816
...
thf(c_H3,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F1 @ X25) @ X26) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X25) @ X26)))))))).
...
thf(a97816,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
