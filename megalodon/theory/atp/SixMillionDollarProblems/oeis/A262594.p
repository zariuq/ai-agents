% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A262594.mg.html#A262594
...
thf(c_HG3,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_G3 @ X42) @ X43)) @ int)))))).
...
thf(c_HF7,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_F7 @ X42) @ X43)) @ int)))))).
thf(c_HG7,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_G7 @ X42) @ X43)) @ int)))))).
thf(c_HH7,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_In @ (c_H7 @ X42)) @ int)))).
...
thf(c_HG6,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_In @ (c_G6 @ X42)) @ int)))).
thf(c_HH6,axiom,((c_In @ c_H6) @ int)).
thf(c_HU6,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_U6 @ X42) @ X43)) @ int)))))).
thf(c_HV6,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_In @ (c_V6 @ X42)) @ int)))).
thf(c_HF5,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_In @ (c_F5 @ X42)) @ int)))).
thf(c_HG5,axiom,((c_In @ c_G5) @ int)).
thf(c_HH5,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_H5 @ X42) @ X43)) @ int)))))).
...
thf(c_H1,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_F3 @ X42) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X42) @ X42))))))).
thf(c_H2,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G3 @ X42) @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
...
thf(c_H5,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_V3 @ X42) @ X43) = ((c_U3 @ ((c_G3 @ X42) @ X43)) @ c_H3))))))).
thf(c_H6,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F2 @ X42) @ X43) = ((add_5FSNo @ ((c_V3 @ X42) @ X43)) @ X42))))))).
...
thf(c_H10,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_V2 @ X42) @ X43) = ((c_U2 @ ((c_G2 @ X42) @ X43)) @ c_H2))))))).
thf(c_H11,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F1 @ X42) @ X43) = ((add_5FSNo @ ((c_V2 @ X42) @ X43)) @ X42))))))).
thf(c_H12,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G1 @ X42) @ X43) = X43)))))).
...
thf(c_H21,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_SMALL @ X42) = ((add_5FSNo @ (c_V0 @ X42)) @ X42))))).
thf(c_H22,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F7 @ X42) @ X43) = ((add_5FSNo @ X42) @ X43))))))).
thf(c_H23,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G7 @ X42) @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
thf(c_H24,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_H7 @ X42) = X42)))).
thf(c_H25,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_U7 @ X42) @ X43) = (((c_If_5Fi @ ((c_SNoLe @ X42) @ c_Empty)) @ X43) @ ((c_F7 @ ((c_U7 @ ((add_5FSNo @ X42) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X43)) @ X42)))))))).
thf(c_H26,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_V7 @ X42) @ X43) = ((c_U7 @ ((c_G7 @ X42) @ X43)) @ (c_H7 @ X42)))))))).
thf(c_H27,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F6 @ X42) @ X43) = ((add_5FSNo @ ((c_V7 @ X42) @ X43)) @ (minus_5FSNo @ X43)))))))).
thf(c_H28,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_G6 @ X42) = X42)))).
thf(c_H29,axiom,(c_H6 = (ordsucc @ c_Empty))).
...
thf(c_H31,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_V6 @ X42) = ((c_U6 @ (c_G6 @ X42)) @ c_H6))))).
thf(c_H32,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_F5 @ X42) = (c_V6 @ X42))))).
thf(c_H33,axiom,(c_G5 = (ordsucc @ c_Empty))).
thf(c_H34,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_H5 @ X42) @ X43) = X43)))))).
thf(c_H35,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_U5 @ X42) @ X43) = (((c_If_5Fi @ ((c_SNoLe @ X42) @ c_Empty)) @ X43) @ (c_F5 @ ((c_U5 @ ((add_5FSNo @ X42) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X43))))))))).
thf(c_H36,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_V5 @ X42) @ X43) = ((c_U5 @ c_G5) @ ((c_H5 @ X42) @ X43)))))))).
thf(c_H37,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F4 @ X42) @ X43) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((c_V5 @ X42) @ X43)) @ X42)) @ X42)) @ X42)) @ (((c_If_5Fi @ ((c_SNoLe @ ((add_5FSNo @ X42) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ c_Empty)) @ (ordsucc @ c_Empty)) @ X42)))))))).
thf(c_H38,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_G4 @ X42) = X42)))).
thf(c_H39,axiom,(c_H4 = (ordsucc @ c_Empty))).
...
thf(a262594,conjecture,(! [X42:$i] : (((c_In @ X42) @ int) => (((c_SNoLe @ c_Empty) @ X42) => ((c_SMALL @ X42) = (c_FAST @ X42)))))).
