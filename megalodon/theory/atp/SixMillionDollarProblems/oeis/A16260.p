% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16260.mg.html#A16260
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X25) @ X25)))))))).
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F2 @ X25) @ X26) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X26)) @ X25))))))).
thf(c_H7,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = X25)))).
thf(c_H9,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U2 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X26)) @ X25)))))))).
thf(c_H10,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V2 @ X25) = ((c_U2 @ c_G2) @ (c_H2 @ X25)))))).
thf(c_H11,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F0 @ X25) @ X26) = ((add_5FSNo @ ((c_V1 @ X25) @ X26)) @ (c_V2 @ X25)))))))).
...
thf(c_H18,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_G3 @ X25) @ X26) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26)))))))))).
thf(c_H19,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H3 @ X25) = X25)))).
thf(c_H20,axiom,(c_I3 = (ordsucc @ c_Empty))).
thf(c_H21,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(a16260,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
