% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A195615.mg.html#A195615
...
thf(c_H1,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F1 @ X31) @ X32) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X31) @ (minus_5FSNo @ X32))) @ X31)) @ X31))))))).
thf(c_H2,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G1 @ X31) = X31)))).
thf(c_H3,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_H1 @ X31) @ X32) = X32)))))).
...
thf(c_H10,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G0 @ X31) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X31)))))).
...
thf(c_H17,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H2 @ X31) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X31) @ X31)) @ X31)))))).
...
thf(a195615,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
