% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A199416.mg.html#A199416
...
thf(a199416,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
