% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A253826.mg.html#A253826
...
thf(c_HI2,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_In @ (c_I2 @ X31)) @ int)))).
...
thf(c_H1,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F1 @ X31) @ X32) = ((add_5FSNo @ ((add_5FSNo @ X32) @ (minus_5FSNo @ X31))) @ (minus_5FSNo @ X31)))))))).
thf(c_H2,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G1 @ X31) = X31)))).
thf(c_H3,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_H1 @ X31) @ X32) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X32) @ X32)))))))).
...
thf(c_H9,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F0 @ X31) @ X32) = ((add_5FSNo @ ((c_W1 @ X31) @ X32)) @ X31))))))).
...
thf(c_H15,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F2 @ X31) @ X32) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X31) @ X31)) @ X31))) @ (minus_5FSNo @ X32)))))))).
...
thf(c_H18,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_I2 @ X31) = ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X31) @ c_Empty)) @ c_Empty) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty)))))).
...
thf(c_H22,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_W2 @ X31) = (((c_U2 @ (c_H2 @ X31)) @ (c_I2 @ X31)) @ c_J2))))).
thf(c_H23,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F3 @ X31) @ X32) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X31) @ X31)) @ X31))) @ (minus_5FSNo @ X32)))))))).
...
thf(a253826,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
