% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A24141.mg.html#A24141
...
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((add_5FSNo @ (c_V0 @ X20)) @ (minus_5FSNo @ X20)))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ (c_W2 @ X20)) @ (minus_5FSNo @ X20)))))).
thf(a24141,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
