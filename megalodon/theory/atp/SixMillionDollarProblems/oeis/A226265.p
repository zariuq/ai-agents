% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A226265.mg.html#A226265
...
thf(c_H1,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F1 @ X22) = ((add_5FSNo @ ((mul_5FSNo @ X22) @ X22)) @ X22))))).
...
thf(c_H6,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F0 @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ c_V1) @ X22)))))).
thf(c_H7,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G0 @ X22) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X22))))).
...
thf(c_H11,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_SMALL @ X22) = ((mul_5FSNo @ (c_V0 @ X22)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((add_5FSNo @ X22) @ X22))))).
thf(c_H13,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G2 @ X22) = X22)))).
...
thf(c_H17,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F3 @ X22) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X22)) @ X22))))).
thf(c_H18,axiom,(c_G3 = (ordsucc @ c_Empty))).
thf(c_H19,axiom,(c_H3 = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H20,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_U3 @ X22) @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ X23) @ (c_F3 @ ((c_U3 @ ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X23))))))))).
thf(c_H21,axiom,(c_V3 = ((c_U3 @ c_G3) @ c_H3))).
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V2 @ X22))) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ c_V3))))).
thf(a226265,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
