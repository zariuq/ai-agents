% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9989.mg.html#A9989
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X28))) @ X28))))).
...
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F0 @ X28) = ((mul_5FSNo @ c_V1) @ X28))))).
...
thf(a9989,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
