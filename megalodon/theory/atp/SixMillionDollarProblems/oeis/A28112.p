% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A28112.mg.html#A28112
...
thf(c_H21,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F0 @ X60) @ X61) = ((add_5FSNo @ ((c_V1 @ X60) @ X61)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ X60))))))))).
...
thf(c_H55,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F5 @ X60) @ X61) = ((add_5FSNo @ ((c_V6 @ X60) @ X61)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ X60))))))))).
...
thf(a28112,conjecture,(! [X60:$i] : (((c_In @ X60) @ int) => (((c_SNoLe @ c_Empty) @ X60) => ((c_SMALL @ X60) = (c_FAST @ X60)))))).
