% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A101927.mg.html#A101927
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F0 @ X15) @ X16) = ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X15) @ X15)) @ ((add_5FSNo @ X16) @ (minus_5FSNo @ ((mul_5FSNo @ X16) @ X16))))) @ (minus_5FSNo @ X15))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(c_H7,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F1 @ X15) @ X16) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X16) @ X16))) @ ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ X15))))))))).
...
thf(a101927,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
