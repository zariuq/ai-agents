% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13777.mg.html#A13777
...
thf(c_H2,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_G0 @ X17) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X17) @ X17))))))).
...
thf(c_H17,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_FAST @ X17) = ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ (c_V1 @ X17)))))).
thf(a13777,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
