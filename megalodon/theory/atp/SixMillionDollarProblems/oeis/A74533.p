% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A74533.mg.html#A74533
...
thf(c_H17,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_F3 @ X35) = ((add_5FSNo @ ((mul_5FSNo @ X35) @ X35)) @ X35))))).
...
thf(a74533,conjecture,(! [X35:$i] : (((c_In @ X35) @ int) => (((c_SNoLe @ c_Empty) @ X35) => ((c_SMALL @ X35) = (c_FAST @ X35)))))).
