% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13720.mg.html#A13720
...
thf(a13720,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
