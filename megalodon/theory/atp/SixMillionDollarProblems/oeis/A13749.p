% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13749.mg.html#A13749
...
thf(c_H7,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G0 @ X33) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X33) @ X33)) @ X33)))))).
...
thf(c_H27,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H4 @ X33) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X33))))).
thf(c_H28,axiom,(c_I4 = (ordsucc @ c_Empty))).
thf(c_H29,axiom,(c_J4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(a13749,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
