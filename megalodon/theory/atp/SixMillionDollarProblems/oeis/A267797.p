% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A267797.mg.html#A267797
...
thf(c_H3,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_H0 @ X23) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X23))) @ X23)))))).
...
thf(c_H10,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_F1 @ X23) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((mul_5FSNo @ X23) @ X23))) @ X23))))).
...
thf(c_H15,axiom,(c_I2 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(a267797,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
