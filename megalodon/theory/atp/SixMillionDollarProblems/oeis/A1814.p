% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1814.mg.html#A1814
...
thf(c_HJ1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_In @ (c_J1 @ X15)) @ int)))).
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F0 @ X15) @ X16) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X15) @ X16))) @ X15)))))))).
...
thf(c_H8,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_G1 @ X15) @ X16) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X16))))))).
thf(c_H9,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_H1 @ X15) = X15)))).
thf(c_H10,axiom,(c_I1 = (ordsucc @ c_Empty))).
thf(c_H11,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_J1 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X15))))).
...
thf(c_H14,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_W1 @ X15) = (((c_U1 @ (c_H1 @ X15)) @ c_I1) @ (c_J1 @ X15)))))).
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X15) @ X15))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X15))) @ (c_W1 @ X15)))))).
thf(a1814,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
