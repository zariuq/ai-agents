% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A24102.mg.html#A24102
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((add_5FSNo @ (c_V0 @ X15)) @ (minus_5FSNo @ X15)))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((add_5FSNo @ (c_W1 @ X15)) @ (minus_5FSNo @ X15)))))).
thf(a24102,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
