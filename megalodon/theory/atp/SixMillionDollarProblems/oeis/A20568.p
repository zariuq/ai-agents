% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20568.mg.html#A20568
...
thf(c_H45,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F5 @ X50) @ X51) = ((add_5FSNo @ ((c_V6 @ X50) @ X51)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X50) @ X50)) @ X50)))))))))).
...
thf(a20568,conjecture,(! [X50:$i] : (((c_In @ X50) @ int) => (((c_SNoLe @ c_Empty) @ X50) => ((c_SMALL @ X50) = (c_FAST @ X50)))))).
