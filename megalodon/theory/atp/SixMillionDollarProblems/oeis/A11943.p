% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A11943.mg.html#A11943
...
thf(c_H1,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_F0 @ X23) @ X24) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X23) @ X23))) @ (minus_5FSNo @ X24)))))))).
...
thf(c_H15,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_I2 @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X23) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H23,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_FAST @ X23) = ((add_5FSNo @ (c_V1 @ X23)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a11943,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
