% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A189356.mg.html#A189356
...
thf(c_HG0,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_In @ (c_G0 @ X26)) @ int)))).
...
thf(c_HI2,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_In @ (c_I2 @ X26)) @ int)))).
...
thf(c_H2,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_G0 @ X26) = X26)))).
...
thf(c_H7,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => ((((c_V0 @ X26) @ X27) @ X28) = (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ X28) @ (c_G0 @ (((c_U0 @ ((add_5FSNo @ X26) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X27) @ X28))))))))))).
thf(c_H8,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_W0 @ X26) = (((c_U0 @ (c_H0 @ X26)) @ c_I0) @ c_J0))))).
thf(c_H9,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_SMALL @ X26) = (c_W0 @ X26))))).
thf(c_H10,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F1 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))) @ (minus_5FSNo @ X27)))))))).
...
thf(c_H18,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F2 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))) @ (minus_5FSNo @ X27)))))))).
thf(c_H19,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_G2 @ X26) = X26)))).
thf(c_H20,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H2 @ X26) = ((add_5FSNo @ X26) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H21,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_I2 @ X26) = ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ c_Empty) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty)))))).
...
thf(c_H25,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_W2 @ X26) = (((c_U2 @ (c_H2 @ X26)) @ (c_I2 @ X26)) @ c_J2))))).
thf(c_H26,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_FAST @ X26) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (c_W1 @ X26)) @ (c_W2 @ X26))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a189356,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
