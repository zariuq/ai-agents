% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A59174.mg.html#A59174
...
thf(c_HF3,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_F3 @ X42) @ X43)) @ int)))))).
thf(c_HG3,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => ((c_In @ ((c_G3 @ X42) @ X43)) @ int)))))).
thf(c_HH3,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_In @ (c_H3 @ X42)) @ int)))).
...
thf(c_H1,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F3 @ X42) @ X43) = ((add_5FSNo @ X42) @ X43))))))).
thf(c_H2,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G3 @ X42) @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
thf(c_H3,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_H3 @ X42) = X42)))).
thf(c_H4,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_U3 @ X42) @ X43) = (((c_If_5Fi @ ((c_SNoLe @ X42) @ c_Empty)) @ X43) @ ((c_F3 @ ((c_U3 @ ((add_5FSNo @ X42) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X43)) @ X42)))))))).
thf(c_H5,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_V3 @ X42) @ X43) = ((c_U3 @ ((c_G3 @ X42) @ X43)) @ (c_H3 @ X42)))))))).
thf(c_H6,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F2 @ X42) @ X43) = ((c_V3 @ X42) @ X43))))))).
...
thf(c_H11,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F1 @ X42) @ X43) = ((add_5FSNo @ ((c_V2 @ X42) @ X43)) @ X43))))))).
thf(c_H12,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G1 @ X42) @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(c_H21,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_SMALL @ X42) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (c_V0 @ X42)) @ X42)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X42) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
thf(c_H22,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F7 @ X42) @ X43) = ((add_5FSNo @ X42) @ X43))))))).
thf(c_H23,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G7 @ X42) @ X43) = X43)))))).
...
thf(c_H27,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F6 @ X42) @ X43) = ((c_V7 @ X42) @ X43))))))).
thf(c_H28,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G6 @ X42) @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(c_H32,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_F5 @ X42) @ X43) = ((add_5FSNo @ ((c_V6 @ X42) @ X43)) @ X43))))))).
thf(c_H33,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => (! [X43:$i] : (((c_In @ X43) @ int) => (((c_G5 @ X42) @ X43) = ((add_5FSNo @ X43) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(c_H42,axiom,(! [X42:$i] : (((c_In @ X42) @ int) => ((c_FAST @ X42) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (c_V4 @ X42)) @ X42)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X42) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
thf(a59174,conjecture,(! [X42:$i] : (((c_In @ X42) @ int) => (((c_SNoLe @ c_Empty) @ X42) => ((c_SMALL @ X42) = (c_FAST @ X42)))))).
