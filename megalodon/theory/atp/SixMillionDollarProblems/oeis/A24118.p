% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A24118.mg.html#A24118
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F1 @ X20) = ((mul_5FSNo @ X20) @ X20))))).
thf(c_H7,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H1 @ X20) = X20)))).
...
thf(c_H10,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V1 @ X20) = ((c_U1 @ c_G1) @ (c_H1 @ X20)))))).
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((add_5FSNo @ (c_V0 @ X20)) @ (minus_5FSNo @ (c_V1 @ X20))))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ (c_W2 @ X20)) @ (minus_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X20) @ X20)) @ X20)) @ X20))))))).
thf(a24118,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
