% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A101609.mg.html#A101609
...
thf(c_H1,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F2 @ X32) @ X33) = ((mul_5FSNo @ X32) @ X33))))))).
thf(c_H2,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G2 @ X32) @ X33) = X33)))))).
thf(c_H3,axiom,(c_H2 = (ordsucc @ c_Empty))).
thf(c_H4,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_U2 @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X32) @ c_Empty)) @ X33) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X33)) @ X32)))))))).
thf(c_H5,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V2 @ X32) @ X33) = ((c_U2 @ ((c_G2 @ X32) @ X33)) @ c_H2))))))).
thf(c_H6,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F1 @ X32) @ X33) = ((add_5FSNo @ ((c_V2 @ X32) @ X33)) @ (minus_5FSNo @ ((mul_5FSNo @ X32) @ X33))))))))).
...
thf(c_H11,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F0 @ X32) @ X33) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X32) @ X33)) @ ((mul_5FSNo @ X32) @ X33))) @ X32))))))).
...
thf(c_H16,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_SMALL @ X32) = ((mul_5FSNo @ (c_V0 @ X32)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H17,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F5 @ X32) @ X33) = ((mul_5FSNo @ X32) @ X33))))))).
thf(c_H18,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G5 @ X32) @ X33) = ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
thf(c_H19,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_H5 @ X32) @ X33) = X33)))))).
thf(c_H20,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_U5 @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X32) @ c_Empty)) @ X33) @ ((c_F5 @ ((c_U5 @ ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X33)) @ X32)))))))).
thf(c_H21,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V5 @ X32) @ X33) = ((c_U5 @ ((c_G5 @ X32) @ X33)) @ ((c_H5 @ X32) @ X33)))))))).
thf(c_H22,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F4 @ X32) @ X33) = ((add_5FSNo @ ((c_V5 @ X32) @ X33)) @ (minus_5FSNo @ ((mul_5FSNo @ X32) @ X33))))))))).
thf(c_H23,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G4 @ X32) @ X33) = ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
thf(c_H24,axiom,(c_H4 = (ordsucc @ c_Empty))).
thf(c_H25,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_U4 @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X32) @ c_Empty)) @ X33) @ ((c_F4 @ ((c_U4 @ ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X33)) @ X32)))))))).
thf(c_H26,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V4 @ X32) @ X33) = ((c_U4 @ ((c_G4 @ X32) @ X33)) @ c_H4))))))).
thf(c_H27,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F3 @ X32) @ X33) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((c_V4 @ X32) @ X33)) @ X32)) @ X33)) @ X32))))))).
thf(c_H28,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_G3 @ X32) = X32)))).
thf(c_H29,axiom,(c_H3 = c_Empty)).
...
thf(c_H32,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_FAST @ X32) = ((mul_5FSNo @ (c_V3 @ X32)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(a101609,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
