% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A280211.mg.html#A280211
...
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G0 @ X28) = ((mul_5FSNo @ X28) @ X28))))).
...
thf(c_H5,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_V0 @ X28) = ((c_U0 @ (c_G0 @ X28)) @ (c_H0 @ X28)))))).
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_SMALL @ X28) = (c_V0 @ X28))))).
thf(c_H7,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((add_5FSNo @ X28) @ X28))))).
thf(c_H8,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G1 @ X28) = ((add_5FSNo @ ((add_5FSNo @ X28) @ X28)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H9,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H1 @ X28) = X28)))).
thf(c_H10,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U1 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29))))))))).
thf(c_H11,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_V1 @ X28) = ((c_U1 @ (c_G1 @ X28)) @ (c_H1 @ X28)))))).
thf(c_H12,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((mul_5FSNo @ X28) @ X29))))))).
thf(c_H13,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G2 @ X28) @ X29) = ((add_5FSNo @ X29) @ X29))))))).
thf(c_H14,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H2 @ X28) = ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(c_H21,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G3 @ X28) @ X29) = ((add_5FSNo @ X29) @ X29))))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((mul_5FSNo @ ((mul_5FSNo @ (c_V1 @ X28)) @ (c_W2 @ X28))) @ (c_W3 @ X28)))))).
thf(a280211,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
