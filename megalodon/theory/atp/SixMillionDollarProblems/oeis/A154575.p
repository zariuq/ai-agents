% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A154575.mg.html#A154575
...
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12)))))).
...
thf(c_H6,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_SMALL @ X12) = ((add_5FSNo @ ((add_5FSNo @ (c_V0 @ X12)) @ X12)) @ X12))))).
thf(c_H7,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_F1 @ X12) = ((mul_5FSNo @ X12) @ X12))))).
thf(c_H8,axiom,(c_G1 = (ordsucc @ c_Empty))).
thf(c_H9,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H1 @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12)))))).
...
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ (c_V1 @ X12)) @ X12)) @ X12)))))).
thf(a154575,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
