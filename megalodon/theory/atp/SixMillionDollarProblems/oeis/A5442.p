% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A5442.mg.html#A5442
...
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H3 @ X28) = ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(a5442,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
