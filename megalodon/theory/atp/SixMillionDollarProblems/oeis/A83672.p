% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A83672.mg.html#A83672
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ X18) @ X19)) @ X19))))))).
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G0 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ X18) @ X18)) @ X19))))))).
thf(c_H3,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H0 @ X18) = ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H4,axiom,(c_I0 = (ordsucc @ c_Empty))).
thf(c_H5,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_J0 @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18))))).
...
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((add_5FSNo @ X19) @ (minus_5FSNo @ X18)))))))).
thf(c_H11,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G1 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ X19) @ X19)) @ X19))))))).
...
thf(c_H14,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_J1 @ X18) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ X18)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H17,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_W1 @ X18) = (((c_U1 @ (c_H1 @ X18)) @ c_I1) @ (c_J1 @ X18)))))).
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = (c_W1 @ X18))))).
thf(a83672,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
