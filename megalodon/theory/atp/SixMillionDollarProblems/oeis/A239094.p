% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A239094.mg.html#A239094
...
thf(c_H1,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_F2 @ X32) = ((mul_5FSNo @ ((mul_5FSNo @ X32) @ X32)) @ X32))))).
thf(c_H2,axiom,(c_G2 = (ordsucc @ c_Empty))).
thf(c_H3,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_H2 @ X32) @ X33) = ((mul_5FSNo @ X33) @ X33))))))).
...
thf(c_H6,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F1 @ X32) @ X33) = ((add_5FSNo @ ((mul_5FSNo @ ((c_V2 @ X32) @ X33)) @ X33)) @ X32))))))).
thf(c_H7,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G1 @ X32) @ X33) = ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
...
thf(c_H17,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_F5 @ X32) = ((mul_5FSNo @ ((mul_5FSNo @ X32) @ X32)) @ X32))))).
thf(c_H18,axiom,(c_G5 = (ordsucc @ c_Empty))).
thf(c_H19,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_H5 @ X32) @ X33) = ((mul_5FSNo @ X33) @ X33))))))).
thf(c_H20,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_U5 @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X32) @ c_Empty)) @ X33) @ (c_F5 @ ((c_U5 @ ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X33))))))))).
thf(c_H21,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V5 @ X32) @ X33) = ((c_U5 @ c_G5) @ ((c_H5 @ X32) @ X33)))))))).
thf(c_H22,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F4 @ X32) @ X33) = ((add_5FSNo @ ((mul_5FSNo @ ((c_V5 @ X32) @ X33)) @ X33)) @ X32))))))).
thf(c_H23,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G4 @ X32) @ X33) = X33)))))).
thf(c_H24,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_H4 @ X32) = X32)))).
...
thf(c_H26,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V4 @ X32) @ X33) = ((c_U4 @ ((c_G4 @ X32) @ X33)) @ (c_H4 @ X32)))))))).
thf(c_H27,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F3 @ X32) @ X33) = ((c_V4 @ X32) @ X33))))))).
thf(c_H28,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_G3 @ X32) = ((add_5FSNo @ X32) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(a239094,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
