% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A155644.mg.html#A155644
...
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X33) @ X33))) @ X33))))).
thf(c_H12,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G2 @ X33) = X33)))).
thf(c_H13,axiom,(c_H2 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U2 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H15,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V2 @ X33) = ((c_U2 @ (c_G2 @ X33)) @ c_H2))))).
thf(c_H16,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_V0 @ X33)) @ (minus_5FSNo @ (c_V2 @ X33)))))))).
...
thf(c_H33,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_FAST @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_W3 @ X33)) @ (minus_5FSNo @ (c_W4 @ X33)))))))).
thf(a155644,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
