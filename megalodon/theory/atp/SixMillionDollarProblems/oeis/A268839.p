% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A268839.mg.html#A268839
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ ((add_5FSNo @ (c_V1 @ X20)) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ X20)))))).
...
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((add_5FSNo @ (c_V0 @ X20)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))) @ (c_W2 @ X20)))))).
thf(a268839,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
