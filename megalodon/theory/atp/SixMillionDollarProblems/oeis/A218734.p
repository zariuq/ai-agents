% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A218734.mg.html#A218734
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F1 @ X20) @ X21) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X21))) @ X20))))))).
thf(c_H2,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H3,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H1 @ X20) = X20)))).
...
thf(c_H5,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V1 @ X20) = ((c_U1 @ c_G1) @ (c_H1 @ X20)))))).
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_V1 @ X20)) @ X20)))))).
...
thf(c_H16,axiom,(c_J2 = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))).
...
thf(a218734,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
