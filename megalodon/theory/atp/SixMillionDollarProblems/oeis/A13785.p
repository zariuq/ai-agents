% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13785.mg.html#A13785
...
thf(c_H2,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X25) @ X25)))))).
thf(c_H3,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H4,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H1 @ X25) = X25)))).
thf(c_H5,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U1 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X26))))))))).
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V1 @ X25) = ((c_U1 @ c_G1) @ (c_H1 @ X25)))))).
thf(c_H7,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G0 @ X25) = (c_V1 @ X25))))).
...
thf(c_H12,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F2 @ X25) = ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X25) @ X25)) @ X25))) @ X25))))).
...
thf(c_H18,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(a13785,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
