% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A81076.mg.html#A81076
...
thf(c_H1,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_F0 @ X23) @ X24) = ((add_5FSNo @ X24) @ (minus_5FSNo @ X23)))))))).
...
thf(c_H9,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_SMALL @ X23) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W0 @ X23))))))).
thf(c_H10,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_F1 @ X23) = ((mul_5FSNo @ X23) @ X23))))).
thf(c_H11,axiom,(c_G1 = (ordsucc @ c_Empty))).
thf(c_H12,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_F2 @ X23) @ X24) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X23) @ (minus_5FSNo @ X24))) @ X23)) @ X23))))))).
...
thf(c_H15,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_I2 @ X23) = ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X23) @ c_Empty)) @ c_Empty) @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(a81076,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
