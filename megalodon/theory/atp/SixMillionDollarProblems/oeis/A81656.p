% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A81656.mg.html#A81656
...
thf(c_H3,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ ((add_5FSNo @ X25) @ X25)) @ X25))))).
...
thf(c_H22,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = ((add_5FSNo @ (c_W3 @ X25)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(a81656,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
