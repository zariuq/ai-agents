% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A97726.mg.html#A97726
...
thf(a97726,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
