% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A64749.mg.html#A64749
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X20) @ (c_W2 @ X20))))))).
thf(a64749,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
