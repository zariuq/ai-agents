% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A28035.mg.html#A28035
...
thf(a28035,conjecture,(! [X45:$i] : (((c_In @ X45) @ int) => (((c_SNoLe @ c_Empty) @ X45) => ((c_SMALL @ X45) = (c_FAST @ X45)))))).
