% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A250212.mg.html#A250212
...
thf(c_H3,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_H2 @ X32) @ X33) = X33)))))).
...
thf(c_H6,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F1 @ X32) @ X33) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((c_V2 @ X32) @ X33)) @ X33)) @ X33)) @ X33)) @ X32))))))).
thf(c_H7,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G1 @ X32) @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X33))))))).
...
thf(c_H28,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_G3 @ X32) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X32))))).
...
thf(a250212,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
