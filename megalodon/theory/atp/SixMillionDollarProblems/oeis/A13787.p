% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13787.mg.html#A13787
...
thf(c_H1,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F0 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X33) @ X33)) @ X33))) @ X33))))).
thf(c_H2,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F1 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X33) @ X33)))))).
thf(c_H3,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H4,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H1 @ X33) = X33)))).
thf(c_H5,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U1 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V1 @ X33) = ((c_U1 @ c_G1) @ (c_H1 @ X33)))))).
thf(c_H7,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G0 @ X33) = (c_V1 @ X33))))).
...
thf(c_H16,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H3 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X33))))).
thf(c_H17,axiom,(c_I3 = (ordsucc @ c_Empty))).
thf(c_H18,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H27,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H4 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X33) @ X33)))))).
...
thf(a13787,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
