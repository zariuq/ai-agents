% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A10797.mg.html#A10797
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X25) @ X25)) @ X25)) @ (minus_5FSNo @ X25)))))).
thf(c_H2,axiom,(c_G1 = (ordsucc @ c_Empty))).
thf(c_H3,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_H1 @ X25) @ X26) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X26))))))).
...
thf(c_H12,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F2 @ X25) @ X26) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X26)) @ ((mul_5FSNo @ X25) @ X26)))))))).
...
thf(a10797,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
