% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A159941.mg.html#A159941
...
thf(c_H1,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => (! [X8:$i] : (((c_In @ X8) @ int) => (((c_F0 @ X7) @ X8) = ((add_5FSNo @ ((mul_5FSNo @ X8) @ X8)) @ X7))))))).
thf(c_H2,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => ((c_G0 @ X7) = X7)))).
...
thf(c_H6,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => ((c_SMALL @ X7) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (c_V0 @ X7))))))))).
thf(c_H7,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => ((c_FAST @ X7) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X7) @ X7))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ X7) @ X7)) @ X7)))))))))).
thf(a159941,conjecture,(! [X7:$i] : (((c_In @ X7) @ int) => (((c_SNoLe @ c_Empty) @ X7) => ((c_SMALL @ X7) = (c_FAST @ X7)))))).
