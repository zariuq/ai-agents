% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13727.mg.html#A13727
...
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F0 @ X28) = ((add_5FSNo @ ((add_5FSNo @ (c_V1 @ X28)) @ (minus_5FSNo @ X28))) @ (minus_5FSNo @ X28)))))).
...
thf(c_H24,axiom,(c_J3 = ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(a13727,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
