% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A11557.mg.html#A11557
...
thf(a11557,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
