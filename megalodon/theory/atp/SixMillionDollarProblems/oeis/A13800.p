% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13800.mg.html#A13800
...
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F0 @ X33) = ((mul_5FSNo @ ((add_5FSNo @ c_V1) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))) @ X33))))).
...
thf(a13800,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
