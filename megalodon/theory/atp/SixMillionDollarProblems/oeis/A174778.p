% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A174778.mg.html#A174778
...
thf(c_H2,axiom,(c_G1 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H10,axiom,(c_J0 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H2 @ X28) = ((add_5FSNo @ X28) @ X28))))).
thf(c_H23,axiom,(c_I2 = c_Empty)).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((mul_5FSNo @ (c_W2 @ X28)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
thf(a174778,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
