% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A307168.mg.html#A307168
...
thf(c_H9,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F2 @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X28) @ X28)))))).
thf(c_H10,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H11,axiom,(c_H2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H12,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U2 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29))))))))).
thf(c_H13,axiom,(c_V2 = ((c_U2 @ c_G2) @ c_H2))).
thf(c_H14,axiom,(c_I0 = c_V2)).
thf(c_H15,axiom,(c_J0 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H23,axiom,(c_I3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(a307168,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
