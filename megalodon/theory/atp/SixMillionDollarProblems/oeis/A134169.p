% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A134169.mg.html#A134169
...
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X22) @ X22))) @ (minus_5FSNo @ X22)))))).
thf(c_H13,axiom,(c_G2 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F3 @ X22) = ((add_5FSNo @ X22) @ X22))))).
thf(c_H15,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G3 @ X22) = ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H19,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H2 @ X22) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ c_Empty) @ (c_V3 @ X22)))))).
...
thf(a134169,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
