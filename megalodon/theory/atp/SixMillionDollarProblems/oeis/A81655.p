% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A81655.mg.html#A81655
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((add_5FSNo @ (c_V0 @ X15)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(a81655,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
