% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1594.mg.html#A1594
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F0 @ X25) = ((mul_5FSNo @ X25) @ X25))))).
thf(c_H2,axiom,(c_G0 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H3,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H0 @ X25) = X25)))).
...
thf(c_H5,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V0 @ X25) = ((c_U0 @ c_G0) @ (c_H0 @ X25)))))).
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X25) @ X25)) @ X25)))))).
...
thf(c_H11,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_SMALL @ X25) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (c_V0 @ X25)) @ X25)) @ X25)) @ (c_V1 @ X25)))))).
thf(c_H12,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F2 @ X25) = ((mul_5FSNo @ ((mul_5FSNo @ X25) @ X25)) @ X25))))).
thf(c_H13,axiom,(c_G2 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = ((mul_5FSNo @ X25) @ X25))))).
...
thf(c_H16,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V2 @ X25) = ((c_U2 @ c_G2) @ (c_H2 @ X25)))))).
...
thf(c_H21,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H25,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_FAST @ X25) = ((add_5FSNo @ (c_V2 @ X25)) @ (c_W3 @ X25)))))).
thf(a1594,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
