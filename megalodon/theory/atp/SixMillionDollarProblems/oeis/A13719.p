% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13719.mg.html#A13719
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F0 @ X25) = ((mul_5FSNo @ ((add_5FSNo @ c_V1) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))) @ X25))))).
...
thf(c_H12,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F2 @ X25) = ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X25) @ X25)) @ X25))) @ X25))) @ X25))))).
...
thf(a13719,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
