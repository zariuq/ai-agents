% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A163309.mg.html#A163309
...
thf(c_HI2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_In @ (c_I2 @ X28)) @ int)))).
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F1 @ X28) @ X29) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X29)) @ X28))))))).
...
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((add_5FSNo @ (c_V1 @ X28)) @ (minus_5FSNo @ X29)))))))).
thf(c_H7,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G0 @ X28) @ X29) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X28) @ X29))) @ X29)))))))).
...
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ ((add_5FSNo @ X28) @ (minus_5FSNo @ X29))) @ (minus_5FSNo @ X29))))) @ (minus_5FSNo @ X29)))))))).
...
thf(c_H18,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_I2 @ X28) = ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ c_Empty) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ (ordsucc @ c_Empty)))))).
...
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_W2 @ X28) = (((c_U2 @ (c_H2 @ X28)) @ (c_I2 @ X28)) @ c_J2))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((mul_5FSNo @ (c_W2 @ X28)) @ (c_V3 @ X28)))))).
thf(a163309,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
