% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A259546.mg.html#A259546
...
thf(c_H9,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_SMALL @ X18) = ((mul_5FSNo @ ((mul_5FSNo @ X18) @ X18)) @ (c_W0 @ X18)))))).
...
thf(c_H12,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H1 @ X18) = ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(c_H13,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I1 @ X18) = X18)))).
...
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = ((mul_5FSNo @ ((mul_5FSNo @ X18) @ X18)) @ (c_W1 @ X18)))))).
thf(a259546,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
