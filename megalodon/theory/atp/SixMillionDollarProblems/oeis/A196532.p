% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A196532.mg.html#A196532
...
thf(c_H3,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_H1 @ X27) @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X28) @ X28)))))))).
...
thf(c_H26,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_V4 @ X27) = ((c_U4 @ (c_G4 @ X27)) @ c_H4))))).
thf(c_H27,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_FAST @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (c_V2 @ X27)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X27))) @ (c_V4 @ X27)))))).
thf(a196532,conjecture,(! [X27:$i] : (((c_In @ X27) @ int) => (((c_SNoLe @ c_Empty) @ X27) => ((c_SMALL @ X27) = (c_FAST @ X27)))))).
