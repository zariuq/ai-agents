% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A22397.mg.html#A22397
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((add_5FSNo @ X28) @ X29))))))).
...
thf(c_H5,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X28) @ X28)))))).
thf(c_H6,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H7,axiom,(c_H1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U1 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29))))))))).
...
thf(c_H19,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F3 @ X28) = ((mul_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X28))))).
thf(c_H20,axiom,(c_G3 = (ordsucc @ c_Empty))).
thf(c_H21,axiom,(c_H3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U3 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ (c_F3 @ ((c_U3 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29))))))))).
thf(c_H23,axiom,(c_V3 = ((c_U3 @ c_G3) @ c_H3))).
thf(c_H24,axiom,(c_J2 = c_V3)).
...
thf(c_H26,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (! [X30:$i] : (((c_In @ X30) @ int) => ((((c_V2 @ X28) @ X29) @ X30) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X30) @ ((c_G2 @ (((c_U2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30)) @ (((c_V2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30))))))))))).
...
thf(a22397,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
