% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A177071.mg.html#A177071
...
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X12) @ X12)))) @ X12))))).
...
thf(c_H9,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H1 @ X12) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X12) @ X12)))) @ X12))))).
...
thf(a177071,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
