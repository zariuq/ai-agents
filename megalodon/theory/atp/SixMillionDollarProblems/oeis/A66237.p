% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A66237.mg.html#A66237
...
thf(a66237,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
