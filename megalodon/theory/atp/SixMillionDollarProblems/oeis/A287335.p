% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A287335.mg.html#A287335
...
thf(c_H1,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F0 @ X12) @ X13) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ X13) @ X13)) @ X12)) @ X13))))))).
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ ((add_5FSNo @ X12) @ X12)) @ X12)))))).
...
thf(c_H9,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H1 @ X12) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X12)))))).
...
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X12))) @ X12)) @ X12)))))).
thf(a287335,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
