% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A158455.mg.html#A158455
...
thf(c_H1,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F0 @ X17) @ X18) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X17) @ X18)))))))).
thf(c_H2,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_G0 @ X17) = X17)))).
thf(c_H3,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_H0 @ X17) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X17) @ X17)))))))).
...
thf(c_H9,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_H1 @ X17) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X17) @ X17)))))))).
...
thf(a158455,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
