% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A7559.mg.html#A7559
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F0 @ X15) @ X16) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X16) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))) @ X16)) @ X16)) @ X15))))))).
...
thf(a7559,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
