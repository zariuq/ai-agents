% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A45925.mg.html#A45925
...
thf(a45925,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
