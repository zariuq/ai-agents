% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A140230.mg.html#A140230
...
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G0 @ X18) @ X19) = ((add_5FSNo @ X19) @ (minus_5FSNo @ X18)))))))).
...
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((add_5FSNo @ X18) @ (minus_5FSNo @ X19)))))))).
...
thf(a140230,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
