% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A64752.mg.html#A64752
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F1 @ X20) @ X21) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ X20) @ X21)) @ X20)) @ X21))))))).
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = (c_V1 @ X20))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ (c_W2 @ X20)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a64752,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
