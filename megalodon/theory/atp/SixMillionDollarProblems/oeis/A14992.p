% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A14992.mg.html#A14992
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_F0 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X15) @ X15))) @ X15)))))))).
...
thf(a14992,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
