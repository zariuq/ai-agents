% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13822.mg.html#A13822
...
thf(c_H2,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_G0 @ X17) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X17) @ X17))) @ X17))))).
...
thf(c_H7,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_F1 @ X17) = ((mul_5FSNo @ ((add_5FSNo @ X17) @ X17)) @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X17) @ X17)) @ X17)) @ X17)))))).
...
thf(a13822,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
