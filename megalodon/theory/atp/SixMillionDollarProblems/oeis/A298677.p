% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A298677.mg.html#A298677
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F1 @ X28) @ X29) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X28)) @ ((add_5FSNo @ X28) @ X29)))))))).
...
thf(a298677,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
