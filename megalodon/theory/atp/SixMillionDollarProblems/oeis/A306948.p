% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A306948.mg.html#A306948
...
thf(c_H1,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F2 @ X32) @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ ((mul_5FSNo @ X32) @ X33))))))))).
thf(c_H2,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G2 @ X32) @ X33) = ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(c_H6,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F1 @ X32) @ X33) = ((add_5FSNo @ ((c_V2 @ X32) @ X33)) @ X32))))))).
thf(c_H7,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G1 @ X32) @ X33) = X33)))))).
thf(c_H8,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => ((c_H1 @ X32) = X32)))).
...
thf(c_H10,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V1 @ X32) @ X33) = ((c_U1 @ ((c_G1 @ X32) @ X33)) @ (c_H1 @ X32)))))))).
thf(c_H11,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F0 @ X32) @ X33) = ((c_V1 @ X32) @ X33))))))).
...
thf(c_H17,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F5 @ X32) @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ ((mul_5FSNo @ X32) @ X33))))))))).
...
thf(c_H21,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_V5 @ X32) @ X33) = ((c_U5 @ ((c_G5 @ X32) @ X33)) @ c_H5))))))).
thf(c_H22,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F4 @ X32) @ X33) = ((add_5FSNo @ ((c_V5 @ X32) @ X33)) @ X32))))))).
...
thf(a306948,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
