% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20571.mg.html#A20571
...
thf(c_H11,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F0 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X43) @ X44)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X43) @ X43)) @ X43)))) @ X43))))))).
...
thf(a20571,conjecture,(! [X43:$i] : (((c_In @ X43) @ int) => (((c_SNoLe @ c_Empty) @ X43) => ((c_SMALL @ X43) = (c_FAST @ X43)))))).
