% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A282901.mg.html#A282901
...
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G0 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X18) @ X19)) @ X19)) @ X19))))))).
thf(c_H3,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H0 @ X18) = X18)))).
thf(c_H4,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I0 @ X18) = (((c_If_5Fi @ ((c_SNoLe @ X18) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X18) @ (minus_5FSNo @ X19))) @ X18)))))))).
...
thf(a282901,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
