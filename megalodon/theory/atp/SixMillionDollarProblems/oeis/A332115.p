% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A332115.mg.html#A332115
...
thf(c_HF0,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_F0 @ X36)) @ int)))).
thf(c_HG0,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_G0 @ X36)) @ int)))).
thf(c_HH0,axiom,((c_In @ c_H0) @ int)).
thf(c_HU0,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => ((c_In @ ((c_U0 @ X36) @ X37)) @ int)))))).
thf(c_HV0,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_V0 @ X36)) @ int)))).
thf(c_HF1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_F1 @ X36)) @ int)))).
thf(c_HG1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_G1 @ X36)) @ int)))).
thf(c_HH1,axiom,((c_In @ c_H1) @ int)).
thf(c_HU1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => ((c_In @ ((c_U1 @ X36) @ X37)) @ int)))))).
thf(c_HV1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_V1 @ X36)) @ int)))).
...
thf(c_HG2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => ((c_In @ ((c_G2 @ X36) @ X37)) @ int)))))).
thf(c_HH2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_H2 @ X36)) @ int)))).
thf(c_HI2,axiom,((c_In @ c_I2) @ int)).
thf(c_HJ2,axiom,((c_In @ c_J2) @ int)).
thf(c_HU2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((c_In @ (((c_U2 @ X36) @ X37) @ X38)) @ int)))))))).
thf(c_HV2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((c_In @ (((c_V2 @ X36) @ X37) @ X38)) @ int)))))))).
thf(c_HW2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_In @ (c_W2 @ X36)) @ int)))).
...
thf(c_H1,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_F0 @ X36) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X36) @ X36))) @ X36))))))).
thf(c_H2,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_G0 @ X36) = ((add_5FSNo @ X36) @ X36))))).
thf(c_H3,axiom,(c_H0 = (ordsucc @ c_Empty))).
thf(c_H4,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_U0 @ X36) @ X37) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X37) @ (c_F0 @ ((c_U0 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37))))))))).
thf(c_H5,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_V0 @ X36) = ((c_U0 @ (c_G0 @ X36)) @ c_H0))))).
thf(c_H6,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_F1 @ X36) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X36) @ X36))) @ X36)))))).
thf(c_H7,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_G1 @ X36) = X36)))).
thf(c_H8,axiom,(c_H1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H9,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_U1 @ X36) @ X37) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X37) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37))))))))).
thf(c_H10,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_V1 @ X36) = ((c_U1 @ (c_G1 @ X36)) @ c_H1))))).
thf(c_H11,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_SMALL @ X36) = ((add_5FSNo @ (c_V0 @ X36)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X36))))))).
thf(c_H12,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F2 @ X36) @ X37) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X36) @ X37)))))))).
thf(c_H13,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_G2 @ X36) @ X37) = X37)))))).
thf(c_H14,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_H2 @ X36) = X36)))).
...
thf(c_H17,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((((c_U2 @ X36) @ X37) @ X38) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X37) @ ((c_F2 @ (((c_U2 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38)) @ (((c_V2 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38))))))))))).
thf(c_H18,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (! [X38:$i] : (((c_In @ X38) @ int) => ((((c_V2 @ X36) @ X37) @ X38) = (((c_If_5Fi @ ((c_SNoLe @ X36) @ c_Empty)) @ X38) @ ((c_G2 @ (((c_U2 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38)) @ (((c_V2 @ ((add_5FSNo @ X36) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X37) @ X38))))))))))).
thf(c_H19,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_W2 @ X36) = (((c_U2 @ (c_H2 @ X36)) @ c_I2) @ c_J2))))).
...
thf(c_H27,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_W3 @ X36) = (((c_U3 @ (c_H3 @ X36)) @ c_I3) @ c_J3))))).
thf(c_H28,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_F4 @ X36) @ X37) = ((mul_5FSNo @ X36) @ X37))))))).
thf(c_H29,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => (! [X37:$i] : (((c_In @ X37) @ int) => (((c_G4 @ X36) @ X37) = X37)))))).
thf(c_H30,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_H4 @ X36) = X36)))).
thf(c_H31,axiom,(c_I4 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(c_H35,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_W4 @ X36) = (((c_U4 @ (c_H4 @ X36)) @ c_I4) @ c_J4))))).
thf(c_H36,axiom,(! [X36:$i] : (((c_In @ X36) @ int) => ((c_FAST @ X36) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_W2 @ X36))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_W3 @ X36)))) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ (c_W4 @ X36)))))).
thf(a332115,conjecture,(! [X36:$i] : (((c_In @ X36) @ int) => (((c_SNoLe @ c_Empty) @ X36) => ((c_SMALL @ X36) = (c_FAST @ X36)))))).
