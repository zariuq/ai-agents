% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A304832.mg.html#A304832
...
thf(c_HI0,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => ((c_In @ (c_I0 @ X10)) @ int)))).
...
thf(c_H1,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => (! [X11:$i] : (((c_In @ X11) @ int) => (((c_F0 @ X10) @ X11) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ X11)) @ X11)) @ X10))))))).
thf(c_H2,axiom,(c_G0 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H3,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => ((c_H0 @ X10) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X10))))).
thf(c_H4,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => ((c_I0 @ X10) = X10)))).
...
thf(c_H8,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => ((c_W0 @ X10) = (((c_U0 @ (c_H0 @ X10)) @ (c_I0 @ X10)) @ (c_J0 @ X10)))))).
thf(c_H9,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => ((c_SMALL @ X10) = (c_W0 @ X10))))).
thf(c_H10,axiom,(! [X10:$i] : (((c_In @ X10) @ int) => ((c_FAST @ X10) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X10) @ X10)) @ X10))))) @ (minus_5FSNo @ X10))) @ ((mul_5FSNo @ X10) @ X10)))))).
thf(a304832,conjecture,(! [X10:$i] : (((c_In @ X10) @ int) => (((c_SNoLe @ c_Empty) @ X10) => ((c_SMALL @ X10) = (c_FAST @ X10)))))).
