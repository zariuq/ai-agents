% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13747.mg.html#A13747
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F0 @ X28) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X28) @ X28))) @ X28)))))).
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G0 @ X28) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X28) @ X28)) @ X28)))))).
...
thf(c_H7,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((mul_5FSNo @ X28) @ X28))))).
thf(c_H8,axiom,(c_G1 = (ordsucc @ c_Empty))).
thf(c_H9,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((mul_5FSNo @ X28) @ X29))))))).
thf(c_H10,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_G2 @ X28) @ X29) = X29)))))).
thf(c_H11,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H2 @ X28) = X28)))).
...
thf(c_H14,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (! [X30:$i] : (((c_In @ X30) @ int) => ((((c_U2 @ X28) @ X29) @ X30) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ ((c_F2 @ (((c_U2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30)) @ (((c_V2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30))))))))))).
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (! [X30:$i] : (((c_In @ X30) @ int) => ((((c_V2 @ X28) @ X29) @ X30) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X30) @ ((c_G2 @ (((c_U2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30)) @ (((c_V2 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29) @ X30))))))))))).
thf(c_H16,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_W2 @ X28) = (((c_U2 @ (c_H2 @ X28)) @ c_I2) @ c_J2))))).
thf(c_H17,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H1 @ X28) = (c_W2 @ X28))))).
...
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H3 @ X28) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X28))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((mul_5FSNo @ (c_V1 @ X28)) @ (c_W3 @ X28)))))).
thf(a13747,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
