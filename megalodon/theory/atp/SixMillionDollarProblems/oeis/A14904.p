% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A14904.mg.html#A14904
...
thf(c_H6,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F0 @ X17) @ X18) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ ((mul_5FSNo @ c_V1) @ X17)) @ X18)))))))).
...
thf(c_H12,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F2 @ X17) @ X18) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))) @ X17)) @ X18))))))).
thf(c_H13,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_G2 @ X17) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X17))))).
...
thf(a14904,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
