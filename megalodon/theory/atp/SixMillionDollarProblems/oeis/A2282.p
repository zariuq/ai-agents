% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A2282.mg.html#A2282
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_F0 @ X15) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X15) @ X15)))) @ X15)))))).
...
thf(c_H7,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F1 @ X15) @ X16) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X15) @ X16)))))))).
...
thf(c_H10,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_I1 @ X15) = (((c_If_5Fi @ ((c_SNoLe @ X15) @ c_Empty)) @ c_Empty) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ ((mul_5FSNo @ (c_W1 @ X15)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(a2282,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
