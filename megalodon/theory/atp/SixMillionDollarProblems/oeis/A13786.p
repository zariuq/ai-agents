% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13786.mg.html#A13786
...
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G0 @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X28) @ X28))))))).
...
thf(c_H22,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H3 @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X28) @ X28)))))).
...
thf(a13786,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
