% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A184368.mg.html#A184368
...
thf(c_H1,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_F0 @ X31) = ((add_5FSNo @ ((add_5FSNo @ X31) @ X31)) @ X31))))).
thf(c_H2,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G0 @ X31) = X31)))).
thf(c_H3,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F1 @ X31) @ X32) = ((add_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X31) @ X31))) @ X32))))))).
thf(c_H4,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G1 @ X31) = X31)))).
thf(c_H5,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H1 @ X31) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X31))))).
thf(c_H6,axiom,(c_I1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H7,axiom,(c_J1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => ((((c_U1 @ X31) @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X31) @ c_Empty)) @ X32) @ ((c_F1 @ (((c_U1 @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32) @ X33)) @ (((c_V1 @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32) @ X33))))))))))).
thf(c_H9,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => ((((c_V1 @ X31) @ X32) @ X33) = (((c_If_5Fi @ ((c_SNoLe @ X31) @ c_Empty)) @ X33) @ (c_G1 @ (((c_U1 @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32) @ X33))))))))))).
thf(c_H10,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_W1 @ X31) = (((c_U1 @ (c_H1 @ X31)) @ c_I1) @ c_J1))))).
thf(c_H11,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H0 @ X31) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_W1 @ X31)))))).
thf(c_H12,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_U0 @ X31) @ X32) = (((c_If_5Fi @ ((c_SNoLe @ X31) @ c_Empty)) @ X32) @ (c_F0 @ ((c_U0 @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X32))))))))).
thf(c_H13,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_V0 @ X31) = ((c_U0 @ (c_G0 @ X31)) @ (c_H0 @ X31)))))).
thf(c_H14,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_SMALL @ X31) = (c_V0 @ X31))))).
thf(c_H15,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F2 @ X31) @ X32) = ((add_5FSNo @ ((add_5FSNo @ X31) @ X31)) @ X32))))))).
thf(c_H16,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G2 @ X31) = X31)))).
thf(c_H17,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H2 @ X31) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X31))))).
thf(c_H18,axiom,(c_I2 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ c_Empty)))).
...
thf(c_H26,axiom,(c_I3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(a184368,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
