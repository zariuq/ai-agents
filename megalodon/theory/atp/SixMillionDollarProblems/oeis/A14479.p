% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A14479.mg.html#A14479
...
thf(c_H1,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F0 @ X12) @ X13) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ X12) @ X13)) @ X12)))))))).
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = X12)))).
thf(c_H3,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H0 @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X12))))).
...
thf(c_H7,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F1 @ X12) @ X13) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X12) @ X13)))))))).
...
thf(c_H11,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_V1 @ X12) = ((c_U1 @ (c_G1 @ X12)) @ c_H1))))).
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12)) @ X12))) @ (c_V1 @ X12)))))).
thf(a14479,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
