% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A19664.mg.html#A19664
...
thf(c_H1,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F1 @ X40) @ X41) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X41) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41)) @ ((mul_5FSNo @ X41) @ X41)))))))).
...
thf(c_H20,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_F5 @ X40) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X40)) @ ((mul_5FSNo @ X40) @ X40)))))).
thf(c_H21,axiom,(c_G5 = (ordsucc @ c_Empty))).
thf(c_H22,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_F6 @ X40) = ((add_5FSNo @ X40) @ X40))))).
thf(c_H23,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_G6 @ X40) = X40)))).
thf(c_H24,axiom,(c_H6 = (ordsucc @ c_Empty))).
thf(c_H25,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_U6 @ X40) @ X41) = (((c_If_5Fi @ ((c_SNoLe @ X40) @ c_Empty)) @ X41) @ (c_F6 @ ((c_U6 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41))))))))).
thf(c_H26,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_V6 @ X40) = ((c_U6 @ (c_G6 @ X40)) @ c_H6))))).
thf(c_H27,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_H5 @ X40) = (c_V6 @ X40))))).
thf(c_H28,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_U5 @ X40) @ X41) = (((c_If_5Fi @ ((c_SNoLe @ X40) @ c_Empty)) @ X41) @ (c_F5 @ ((c_U5 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41))))))))).
thf(c_H29,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_V5 @ X40) = ((c_U5 @ c_G5) @ (c_H5 @ X40)))))).
thf(c_H30,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_F4 @ X40) = (c_V5 @ X40))))).
...
thf(c_H35,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F3 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X40) @ X41)) @ X40)) @ ((mul_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X40) @ X40)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(a19664,conjecture,(! [X40:$i] : (((c_In @ X40) @ int) => (((c_SNoLe @ c_Empty) @ X40) => ((c_SMALL @ X40) = (c_FAST @ X40)))))).
