% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A203579.mg.html#A203579
...
thf(c_H2,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_G0 @ X23) @ X24) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X23) @ X23)) @ X24)))))))).
...
thf(a203579,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
