% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A128800.mg.html#A128800
...
thf(a128800,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
