% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20766.mg.html#A20766
...
thf(c_H36,axiom,(c_J8 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(a20766,conjecture,(! [X50:$i] : (((c_In @ X50) @ int) => (((c_SNoLe @ c_Empty) @ X50) => ((c_SMALL @ X50) = (c_FAST @ X50)))))).
