% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A79472.mg.html#A79472
...
thf(c_H26,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_I3 @ X31) = (((c_If_5Fi @ ((c_SNoLe @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ c_Empty)) @ X31) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(a79472,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
