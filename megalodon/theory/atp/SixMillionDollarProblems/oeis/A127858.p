% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A127858.mg.html#A127858
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F1 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (minus_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X21)) @ X20))))))))).
...
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((add_5FSNo @ ((mul_5FSNo @ X20) @ X21)) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ (c_W2 @ X20)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(a127858,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
