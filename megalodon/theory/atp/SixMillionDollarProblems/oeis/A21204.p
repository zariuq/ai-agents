% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A21204.mg.html#A21204
...
thf(c_HF2,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => ((c_In @ ((c_F2 @ X40) @ X41)) @ int)))))).
...
thf(c_H9,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F2 @ X40) @ X41) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X41)) @ X40))))))).
thf(c_H10,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H11,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_H2 @ X40) = X40)))).
thf(c_H12,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_U2 @ X40) @ X41) = (((c_If_5Fi @ ((c_SNoLe @ X40) @ c_Empty)) @ X41) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41)) @ X40)))))))).
thf(c_H13,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_V2 @ X40) = ((c_U2 @ c_G2) @ (c_H2 @ X40)))))).
thf(c_H14,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F0 @ X40) @ X41) = ((add_5FSNo @ ((c_W1 @ X40) @ X41)) @ ((add_5FSNo @ (c_V2 @ X40)) @ (minus_5FSNo @ X40))))))))).
...
thf(c_H35,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F3 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X40) @ X41)) @ X40)) @ ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X40) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ X40)) @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(a21204,conjecture,(! [X40:$i] : (((c_In @ X40) @ int) => (((c_SNoLe @ c_Empty) @ X40) => ((c_SMALL @ X40) = (c_FAST @ X40)))))).
