% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A103458.mg.html#A103458
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (((c_If_5Fi @ ((c_SNoLe @ X15) @ c_Empty)) @ c_Empty) @ (c_V0 @ X15))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (((c_If_5Fi @ ((c_SNoLe @ X15) @ c_Empty)) @ c_Empty) @ (c_W1 @ X15))))))).
thf(a103458,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
