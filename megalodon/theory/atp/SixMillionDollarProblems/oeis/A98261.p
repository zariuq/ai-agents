% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A98261.mg.html#A98261
...
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ c_V1)) @ X28)) @ X29))))))).
...
thf(a98261,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
