% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13814.mg.html#A13814
...
thf(c_H1,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F1 @ X33) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X33)))))).
...
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F0 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ c_V1) @ X33)) @ X33))))).
thf(c_H7,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G0 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X33) @ X33))))))).
...
thf(c_H18,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(c_H29,axiom,(c_J4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(a13814,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
