% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A74542.mg.html#A74542
...
thf(c_HG1,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_In @ (c_G1 @ X35)) @ int)))).
...
thf(c_HH0,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_In @ (c_H0 @ X35)) @ int)))).
...
thf(c_H1,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_F0 @ X35) = ((add_5FSNo @ X35) @ X35))))).
thf(c_H2,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_G0 @ X35) = X35)))).
thf(c_H3,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_F1 @ X35) = ((add_5FSNo @ ((add_5FSNo @ X35) @ X35)) @ X35))))).
thf(c_H4,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_G1 @ X35) = X35)))).
thf(c_H5,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H6,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => (! [X36:$i] : (((c_In @ X36) @ int) => (((c_U1 @ X35) @ X36) = (((c_If_5Fi @ ((c_SNoLe @ X35) @ c_Empty)) @ X36) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X35) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X36))))))))).
thf(c_H7,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_V1 @ X35) = ((c_U1 @ (c_G1 @ X35)) @ c_H1))))).
thf(c_H8,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_F2 @ X35) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X35) @ X35)))))).
...
thf(c_H13,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_H0 @ X35) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_V1 @ X35)) @ (c_V2 @ X35))))))).
thf(c_H14,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => (! [X36:$i] : (((c_In @ X36) @ int) => (((c_U0 @ X35) @ X36) = (((c_If_5Fi @ ((c_SNoLe @ X35) @ c_Empty)) @ X36) @ (c_F0 @ ((c_U0 @ ((add_5FSNo @ X35) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X36))))))))).
thf(c_H15,axiom,(! [X35:$i] : (((c_In @ X35) @ int) => ((c_V0 @ X35) = ((c_U0 @ (c_G0 @ X35)) @ (c_H0 @ X35)))))).
...
thf(c_H31,axiom,(c_J5 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(a74542,conjecture,(! [X35:$i] : (((c_In @ X35) @ int) => (((c_SNoLe @ c_Empty) @ X35) => ((c_SMALL @ X35) = (c_FAST @ X35)))))).
