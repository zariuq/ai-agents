% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A65140.mg.html#A65140
...
thf(c_H4,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_G1 @ X25) = ((add_5FSNo @ X25) @ X25))))).
...
thf(c_H14,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X25))))).
thf(c_H15,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U2 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X26)) @ X25)))))))).
thf(c_H16,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_V2 @ X25) = ((c_U2 @ (c_G2 @ X25)) @ (c_H2 @ X25)))))).
thf(c_H17,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F3 @ X25) @ X26) = ((mul_5FSNo @ X25) @ X26))))))).
thf(c_H18,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_G3 @ X25) @ X26) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X26))))))).
...
thf(c_H21,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_J3 @ X25) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X25))))).
...
thf(a65140,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
