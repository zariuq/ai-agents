% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A199300.mg.html#A199300
...
thf(c_H3,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_H0 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X15) @ X15)))))).
...
thf(c_H10,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_I1 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X15) @ X15)))))).
...
thf(a199300,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
