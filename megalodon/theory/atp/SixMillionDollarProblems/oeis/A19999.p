% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A19999.mg.html#A19999
...
thf(c_H1,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F0 @ X12) @ X13) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X13)) @ X12)))))))).
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = X12)))).
thf(c_H3,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H0 @ X12) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12))))).
...
thf(c_H7,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F1 @ X12) @ X13) = ((mul_5FSNo @ ((mul_5FSNo @ X12) @ (ordsucc @ (ordsucc @ c_Empty)))) @ X13))))))).
...
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((mul_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X12)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X12))) @ (c_V1 @ X12)))))).
thf(a19999,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
