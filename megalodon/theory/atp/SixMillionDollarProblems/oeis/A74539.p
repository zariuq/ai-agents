% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A74539.mg.html#A74539
...
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F1 @ X33) @ X34) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X34) @ X34)) @ X34)) @ X34))))))).
...
thf(c_H14,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = ((add_5FSNo @ (c_V0 @ X33)) @ (c_W1 @ X33)))))).
thf(c_H15,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X33) @ X33)) @ X33)) @ X33))))).
thf(c_H16,axiom,(c_G2 = (ordsucc @ c_Empty))).
thf(c_H17,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F3 @ X33) = ((add_5FSNo @ X33) @ X33))))).
thf(c_H18,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G3 @ X33) = X33)))).
thf(c_H19,axiom,(c_H3 = (ordsucc @ c_Empty))).
thf(c_H20,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U3 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F3 @ ((c_U3 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H21,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V3 @ X33) = ((c_U3 @ (c_G3 @ X33)) @ c_H3))))).
thf(c_H22,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H2 @ X33) = (c_V3 @ X33))))).
...
thf(c_H33,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_FAST @ X33) = ((add_5FSNo @ (c_V2 @ X33)) @ (c_W4 @ X33)))))).
thf(a74539,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
