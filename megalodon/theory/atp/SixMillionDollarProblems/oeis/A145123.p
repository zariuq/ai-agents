% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A145123.mg.html#A145123
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X28) @ X28))) @ X28)))))).
...
thf(a145123,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
