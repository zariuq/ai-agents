% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A4400.mg.html#A4400
...
thf(c_H2,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G1 @ X20) @ X21) = ((add_5FSNo @ X21) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ (c_W2 @ X20)) @ (ordsucc @ c_Empty)))))).
thf(a4400,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
