% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A180844.mg.html#A180844
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X19) @ X19)) @ X19)) @ X18)) @ X18))))))).
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G0 @ X18) @ X19) = ((add_5FSNo @ ((add_5FSNo @ X19) @ X19)) @ X19))))))).
...
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X19) @ X19)) @ X19)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18)))))))).
...
thf(a180844,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
