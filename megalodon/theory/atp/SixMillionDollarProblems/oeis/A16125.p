% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16125.mg.html#A16125
...
thf(a16125,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
