% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A178248.mg.html#A178248
...
thf(a178248,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
