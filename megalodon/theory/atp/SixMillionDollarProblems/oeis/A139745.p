% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A139745.mg.html#A139745
...
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X33) @ X33)) @ X33))) @ X33))))).
...
thf(c_H16,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = ((add_5FSNo @ (c_V0 @ X33)) @ (minus_5FSNo @ (c_V2 @ X33))))))).
...
thf(a139745,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
