% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A34000.mg.html#A34000
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F0 @ X15) @ X16) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X16) @ X16)) @ X16))) @ X15))))))).
...
thf(c_H8,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_G1 @ X15) @ X16) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X16)))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ (c_W1 @ X15)) @ ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X15) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ X15)) @ X15)) @ X15)))))).
thf(a34000,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
