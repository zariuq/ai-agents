% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A121200.mg.html#A121200
...
thf(c_H9,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_SMALL @ X26) = ((add_5FSNo @ ((add_5FSNo @ (c_W0 @ X26)) @ X26)) @ X26))))).
...
thf(c_H26,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_FAST @ X26) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X26) @ (c_W1 @ X26))) @ X26)) @ (c_W2 @ X26)))))).
thf(a121200,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
