% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A10842.mg.html#A10842
...
thf(c_H1,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_F1 @ X27) = ((add_5FSNo @ X27) @ X27))))).
thf(c_H2,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_G1 @ X27) @ X28) = X28)))))).
thf(c_H3,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H4,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_U1 @ X27) @ X28) = (((c_If_5Fi @ ((c_SNoLe @ X27) @ c_Empty)) @ X28) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X27) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X28))))))))).
thf(c_H5,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_V1 @ X27) @ X28) = ((c_U1 @ ((c_G1 @ X27) @ X28)) @ c_H1))))))).
thf(c_H6,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F0 @ X27) @ X28) = ((add_5FSNo @ ((mul_5FSNo @ X27) @ X28)) @ ((c_V1 @ X27) @ X28)))))))).
...
thf(c_H12,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_F3 @ X27) = ((add_5FSNo @ X27) @ X27))))).
...
thf(c_H15,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_U3 @ X27) @ X28) = (((c_If_5Fi @ ((c_SNoLe @ X27) @ c_Empty)) @ X28) @ (c_F3 @ ((c_U3 @ ((add_5FSNo @ X27) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X28))))))))).
thf(c_H16,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_V3 @ X27) @ X28) = ((c_U3 @ ((c_G3 @ X27) @ X28)) @ c_H3))))))).
thf(c_H17,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F2 @ X27) @ X28) = ((add_5FSNo @ ((c_V3 @ X27) @ X28)) @ ((mul_5FSNo @ X27) @ X28)))))))).
thf(c_H18,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_G2 @ X27) = ((add_5FSNo @ X27) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H27,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_FAST @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (c_V2 @ X27)) @ X27)) @ (c_V4 @ X27)))))).
thf(a10842,conjecture,(! [X27:$i] : (((c_In @ X27) @ int) => (((c_SNoLe @ c_Empty) @ X27) => ((c_SMALL @ X27) = (c_FAST @ X27)))))).
