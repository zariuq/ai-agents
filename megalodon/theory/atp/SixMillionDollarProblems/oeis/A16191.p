% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16191.mg.html#A16191
...
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F2 @ X33) @ X34) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X34)) @ X33))))))).
thf(c_H7,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H2 @ X33) = X33)))).
thf(c_H9,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U2 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34)) @ X33)))))))).
thf(c_H10,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V2 @ X33) = ((c_U2 @ c_G2) @ (c_H2 @ X33)))))).
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F0 @ X33) @ X34) = ((add_5FSNo @ ((c_V1 @ X33) @ X34)) @ (c_V2 @ X33)))))))).
...
thf(c_H17,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F3 @ X33) @ X34) = ((mul_5FSNo @ X33) @ X34))))))).
...
thf(c_H28,axiom,(c_I4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H33,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_FAST @ X33) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W3 @ X33))) @ (minus_5FSNo @ (c_W4 @ X33))))))).
thf(a16191,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
