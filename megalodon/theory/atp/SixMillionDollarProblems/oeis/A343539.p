% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A343539.mg.html#A343539
...
thf(c_H9,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_SMALL @ X18) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X18) @ X18))) @ (c_W0 @ X18)))))).
...
thf(c_H13,axiom,(c_I1 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = ((mul_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X18) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (c_W1 @ X18))) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X18) @ X18))))))).
thf(a343539,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
