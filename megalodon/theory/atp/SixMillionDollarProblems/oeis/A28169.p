% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A28169.mg.html#A28169
...
thf(c_H1,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_F3 @ X60) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ X60)))))).
...
thf(c_H16,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F1 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V2 @ X60) @ X61)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ X60)))) @ X60))))))).
...
thf(c_H21,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F0 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X60) @ X61)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X60) @ X60)))) @ X60))))))).
...
thf(c_H36,axiom,(c_J10 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H55,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F5 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V6 @ X60) @ X61)) @ X60)) @ ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ X60)) @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(a28169,conjecture,(! [X60:$i] : (((c_In @ X60) @ int) => (((c_SNoLe @ c_Empty) @ X60) => ((c_SMALL @ X60) = (c_FAST @ X60)))))).
