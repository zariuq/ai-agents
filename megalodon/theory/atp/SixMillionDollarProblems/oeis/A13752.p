% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13752.mg.html#A13752
...
thf(a13752,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
