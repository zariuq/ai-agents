% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A94797.mg.html#A94797
...
thf(c_H2,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_G0 @ X15) = ((add_5FSNo @ X15) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X15) @ (c_W1 @ X15))))))).
thf(a94797,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
