% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20537.mg.html#A20537
...
thf(c_H3,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F1 @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X22)))))).
thf(c_H4,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G1 @ X22) = ((add_5FSNo @ X22) @ X22))))).
...
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X22) @ X22)) @ X22)) @ (minus_5FSNo @ X22))))) @ X22))))).
...
thf(a20537,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
