% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A88920.mg.html#A88920
...
thf(c_H1,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_F0 @ X23) @ X24) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ ((add_5FSNo @ X24) @ (minus_5FSNo @ X23))) @ (minus_5FSNo @ X23))))))))).
...
thf(a88920,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
