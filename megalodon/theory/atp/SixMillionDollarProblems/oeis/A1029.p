% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1029.mg.html#A1029
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X20))) @ X20))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ (c_W2 @ X20)) @ (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))))))).
thf(a1029,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
