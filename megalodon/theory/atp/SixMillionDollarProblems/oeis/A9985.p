% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9985.mg.html#A9985
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F1 @ X20) = ((add_5FSNo @ ((mul_5FSNo @ X20) @ X20)) @ X20))))).
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ ((mul_5FSNo @ c_V1) @ X20)) @ (minus_5FSNo @ X20)))))).
...
thf(a9985,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
