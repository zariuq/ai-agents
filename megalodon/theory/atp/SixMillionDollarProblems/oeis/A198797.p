% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A198797.mg.html#A198797
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V0 @ X15))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W1 @ X15))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a198797,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
