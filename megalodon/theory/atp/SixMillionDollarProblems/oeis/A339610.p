% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A339610.mg.html#A339610
...
thf(c_HG0,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => ((c_In @ ((c_G0 @ X18) @ X19)) @ int)))))).
thf(c_HH0,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_In @ (c_H0 @ X18)) @ int)))).
thf(c_HI0,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_In @ (c_I0 @ X18)) @ int)))).
...
thf(c_HJ1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_In @ (c_J1 @ X18)) @ int)))).
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = X19)))))).
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G0 @ X18) @ X19) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X18) @ X19)))))))).
thf(c_H3,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H0 @ X18) = X18)))).
thf(c_H4,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I0 @ X18) = X18)))).
...
thf(c_H7,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (! [X20:$i] : (((c_In @ X20) @ int) => ((((c_V0 @ X18) @ X19) @ X20) = (((c_If_5Fi @ ((c_SNoLe @ X18) @ c_Empty)) @ X20) @ ((c_G0 @ (((c_U0 @ ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X19) @ X20)) @ (((c_V0 @ ((add_5FSNo @ X18) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X19) @ X20))))))))))).
thf(c_H8,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_W0 @ X18) = (((c_U0 @ (c_H0 @ X18)) @ (c_I0 @ X18)) @ c_J0))))).
thf(c_H9,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_SMALL @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W0 @ X18)))))).
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((add_5FSNo @ X18) @ X19))))))).
thf(c_H11,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_G1 @ X18) = X18)))).
thf(c_H12,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H1 @ X18) = X18)))).
thf(c_H13,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I1 @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18))))).
thf(c_H14,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_J1 @ X18) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ X18)))))).
...
thf(c_H17,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_W1 @ X18) = (((c_U1 @ (c_H1 @ X18)) @ (c_I1 @ X18)) @ (c_J1 @ X18)))))).
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = (c_W1 @ X18))))).
thf(a339610,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
