% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16133.mg.html#A16133
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F0 @ X20) @ X21) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X20) @ X21)) @ X20)) @ X20))))))).
...
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ X21) @ X21)) @ X20)) @ X20))))))).
...
thf(a16133,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
