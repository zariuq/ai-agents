% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13760.mg.html#A13760
...
thf(a13760,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
