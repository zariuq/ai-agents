% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A255433.mg.html#A255433
...
thf(c_H1,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F0 @ X17) @ X18) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X17) @ X18)) @ X18)) @ X18)) @ X17))))))).
...
thf(c_H7,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F1 @ X17) @ X18) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ ((mul_5FSNo @ X18) @ X18)) @ X18))) @ X17))))))).
thf(c_H8,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_G1 @ X17) = ((add_5FSNo @ X17) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H9,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H10,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_U1 @ X17) @ X18) = (((c_If_5Fi @ ((c_SNoLe @ X17) @ c_Empty)) @ X18) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X17) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X18)) @ X17)))))))).
thf(c_H11,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_V1 @ X17) = ((c_U1 @ (c_G1 @ X17)) @ c_H1))))).
...
thf(c_H14,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_H2 @ X17) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X17))))).
...
thf(a255433,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
