% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A26108.mg.html#A26108
...
thf(c_HG3,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_G3 @ X60) @ X61)) @ int)))))).
thf(c_HH3,axiom,((c_In @ c_H3) @ int)).
thf(c_HU3,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_U3 @ X60) @ X61)) @ int)))))).
thf(c_HV3,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_V3 @ X60) @ X61)) @ int)))))).
thf(c_HF4,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_F4 @ X60) @ X61)) @ int)))))).
thf(c_HG4,axiom,((c_In @ c_G4) @ int)).
thf(c_HH4,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_In @ (c_H4 @ X60)) @ int)))).
...
thf(c_HF2,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_F2 @ X60) @ X61)) @ int)))))).
thf(c_HG2,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_G2 @ X60) @ X61)) @ int)))))).
...
thf(c_HF9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_F9 @ X60) @ X61)) @ int)))))).
thf(c_HG9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_G9 @ X60) @ X61)) @ int)))))).
thf(c_HH9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_In @ (c_H9 @ X60)) @ int)))).
thf(c_HI9,axiom,((c_In @ c_I9) @ int)).
thf(c_HJ9,axiom,((c_In @ c_J9) @ int)).
thf(c_HU9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (! [X62:$i] : (((c_In @ X62) @ int) => ((c_In @ (((c_U9 @ X60) @ X61) @ X62)) @ int)))))))).
thf(c_HV9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (! [X62:$i] : (((c_In @ X62) @ int) => ((c_In @ (((c_V9 @ X60) @ X61) @ X62)) @ int)))))))).
thf(c_HW9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_In @ (c_W9 @ X60)) @ int)))).
thf(c_HF10,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_In @ (c_F10 @ X60)) @ int)))).
thf(c_HG10,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_In @ (c_G10 @ X60)) @ int)))).
thf(c_HH10,axiom,((c_In @ c_H10) @ int)).
thf(c_HU10,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => ((c_In @ ((c_U10 @ X60) @ X61)) @ int)))))).
thf(c_HV10,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_In @ (c_V10 @ X60)) @ int)))).
...
thf(c_H1,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_F3 @ X60) = ((add_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ X60))))).
thf(c_H2,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_G3 @ X60) @ X61) = ((add_5FSNo @ X61) @ X61))))))).
thf(c_H3,axiom,(c_H3 = (ordsucc @ c_Empty))).
thf(c_H4,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_U3 @ X60) @ X61) = (((c_If_5Fi @ ((c_SNoLe @ X60) @ c_Empty)) @ X61) @ (c_F3 @ ((c_U3 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61))))))))).
thf(c_H5,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_V3 @ X60) @ X61) = ((c_U3 @ ((c_G3 @ X60) @ X61)) @ c_H3))))))).
thf(c_H6,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F4 @ X60) @ X61) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X61)) @ X60))))))).
thf(c_H7,axiom,(c_G4 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_H4 @ X60) = X60)))).
thf(c_H9,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_U4 @ X60) @ X61) = (((c_If_5Fi @ ((c_SNoLe @ X60) @ c_Empty)) @ X61) @ ((c_F4 @ ((c_U4 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61)) @ X60)))))))).
thf(c_H10,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_V4 @ X60) = ((c_U4 @ c_G4) @ (c_H4 @ X60)))))).
thf(c_H11,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F2 @ X60) @ X61) = ((add_5FSNo @ ((c_V3 @ X60) @ X61)) @ (c_V4 @ X60)))))))).
thf(c_H12,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_G2 @ X60) @ X61) = X61)))))).
thf(c_H13,axiom,(c_H2 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_U2 @ X60) @ X61) = (((c_If_5Fi @ ((c_SNoLe @ X60) @ c_Empty)) @ X61) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61)) @ X60)))))))).
thf(c_H15,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_V2 @ X60) @ X61) = ((c_U2 @ ((c_G2 @ X60) @ X61)) @ c_H2))))))).
thf(c_H16,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F1 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V2 @ X60) @ X61)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X60) @ X60)))) @ X60))))))).
...
thf(c_H21,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F0 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X60) @ X61)) @ X60)) @ X60))))))).
...
thf(c_H27,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F9 @ X60) @ X61) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X60) @ X61)))))))).
thf(c_H28,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_G9 @ X60) @ X61) = X61)))))).
thf(c_H29,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_H9 @ X60) = X60)))).
thf(c_H30,axiom,(c_I9 = (ordsucc @ c_Empty))).
thf(c_H31,axiom,(c_J9 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
thf(c_H32,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (! [X62:$i] : (((c_In @ X62) @ int) => ((((c_U9 @ X60) @ X61) @ X62) = (((c_If_5Fi @ ((c_SNoLe @ X60) @ c_Empty)) @ X61) @ ((c_F9 @ (((c_U9 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61) @ X62)) @ (((c_V9 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61) @ X62))))))))))).
thf(c_H33,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (! [X62:$i] : (((c_In @ X62) @ int) => ((((c_V9 @ X60) @ X61) @ X62) = (((c_If_5Fi @ ((c_SNoLe @ X60) @ c_Empty)) @ X62) @ ((c_G9 @ (((c_U9 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61) @ X62)) @ (((c_V9 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61) @ X62))))))))))).
thf(c_H34,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_W9 @ X60) = (((c_U9 @ (c_H9 @ X60)) @ c_I9) @ c_J9))))).
thf(c_H35,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_F10 @ X60) = ((add_5FSNo @ X60) @ X60))))).
thf(c_H36,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_G10 @ X60) = X60)))).
thf(c_H37,axiom,(c_H10 = (ordsucc @ c_Empty))).
thf(c_H38,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_U10 @ X60) @ X61) = (((c_If_5Fi @ ((c_SNoLe @ X60) @ c_Empty)) @ X61) @ (c_F10 @ ((c_U10 @ ((add_5FSNo @ X60) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X61))))))))).
thf(c_H39,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_V10 @ X60) = ((c_U10 @ (c_G10 @ X60)) @ c_H10))))).
thf(c_H40,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => ((c_F8 @ X60) = ((mul_5FSNo @ (c_W9 @ X60)) @ (c_V10 @ X60)))))).
...
thf(c_H45,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F7 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V8 @ X60) @ X61)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X60) @ X60)))) @ X60))))))).
...
thf(c_H55,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F5 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V6 @ X60) @ X61)) @ X60)) @ ((mul_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X60) @ X60)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(a26108,conjecture,(! [X60:$i] : (((c_In @ X60) @ int) => (((c_SNoLe @ c_Empty) @ X60) => ((c_SMALL @ X60) = (c_FAST @ X60)))))).
