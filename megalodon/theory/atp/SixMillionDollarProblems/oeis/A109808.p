% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A109808.mg.html#A109808
...
thf(a109808,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
