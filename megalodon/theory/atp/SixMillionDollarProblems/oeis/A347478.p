% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A347478.mg.html#A347478
...
thf(c_H2,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G0 @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X22)))))).
...
thf(c_H6,axiom,(c_F1 = c_Empty)).
thf(c_H7,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G1 @ X22) = X22)))).
thf(c_H8,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H9,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_U1 @ X22) @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ X23) @ c_F1))))))).
thf(c_H10,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_V1 @ X22) = ((c_U1 @ (c_G1 @ X22)) @ c_H1))))).
thf(c_H11,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_SMALL @ X22) = ((add_5FSNo @ (c_V0 @ X22)) @ (minus_5FSNo @ (c_V1 @ X22))))))).
...
thf(c_H16,axiom,(c_H3 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(c_H19,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H2 @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V3 @ X22)))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((add_5FSNo @ ((add_5FSNo @ (c_V2 @ X22)) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ c_Empty) @ (ordsucc @ c_Empty))))))).
thf(a347478,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
