% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A143248.mg.html#A143248
...
thf(c_H1,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F0 @ X17) @ X18) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X18)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18)) @ X17)))))))).
...
thf(c_H6,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_SMALL @ X17) = (((c_If_5Fi @ ((c_SNoLe @ X17) @ c_Empty)) @ c_Empty) @ (c_V0 @ X17)))))).
thf(c_H7,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_F1 @ X17) = ((mul_5FSNo @ X17) @ X17))))).
thf(c_H8,axiom,(c_G1 = (ordsucc @ c_Empty))).
thf(c_H9,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F2 @ X17) @ X18) = ((mul_5FSNo @ X17) @ X18))))))).
...
thf(c_H12,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_U2 @ X17) @ X18) = (((c_If_5Fi @ ((c_SNoLe @ X17) @ c_Empty)) @ X18) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X17) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X18)) @ X17)))))))).
thf(c_H13,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_V2 @ X17) = ((c_U2 @ (c_G2 @ X17)) @ (c_H2 @ X17)))))).
thf(c_H14,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_H1 @ X17) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X17)) @ (c_V2 @ X17)))))).
...
thf(c_H17,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_FAST @ X17) = ((mul_5FSNo @ (c_V1 @ X17)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X17)))))).
thf(a143248,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
