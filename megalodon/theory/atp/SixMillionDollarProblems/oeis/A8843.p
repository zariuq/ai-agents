% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A8843.mg.html#A8843
...
thf(c_H15,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_I2 @ X23) = ((add_5FSNo @ ((mul_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X23) @ c_Empty)) @ c_Empty) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty)))))).
...
thf(a8843,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
