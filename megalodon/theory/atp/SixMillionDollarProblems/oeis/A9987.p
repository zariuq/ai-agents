% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9987.mg.html#A9987
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F1 @ X25) = ((add_5FSNo @ ((mul_5FSNo @ X25) @ X25)) @ X25))))).
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F0 @ X25) = ((add_5FSNo @ ((mul_5FSNo @ c_V1) @ X25)) @ X25))))).
...
thf(a9987,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
