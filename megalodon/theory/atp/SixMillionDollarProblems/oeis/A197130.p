% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A197130.mg.html#A197130
...
thf(c_H1,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F1 @ X27) @ X28) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X27) @ X28)))))))).
thf(c_H2,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_G1 @ X27) @ X28) = X28)))))).
...
thf(c_H6,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F0 @ X27) @ X28) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((c_V1 @ X27) @ X28)) @ X27)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X28) @ X28)))) @ X27))))))).
...
thf(c_H14,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_H3 @ X27) @ X28) = X28)))))).
...
thf(c_H16,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_V3 @ X27) @ X28) = ((c_U3 @ ((c_G3 @ X27) @ X28)) @ ((c_H3 @ X27) @ X28)))))))).
thf(c_H17,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F2 @ X27) @ X28) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((c_V3 @ X27) @ X28)) @ X27)) @ X28)) @ X27))))))).
thf(c_H18,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_G2 @ X27) = X27)))).
thf(c_H19,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_H2 @ X27) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X27))))).
...
thf(c_H21,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_V2 @ X27) = ((c_U2 @ (c_G2 @ X27)) @ (c_H2 @ X27)))))).
thf(c_H22,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_F4 @ X27) = ((add_5FSNo @ X27) @ X27))))).
thf(c_H23,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_G4 @ X27) = X27)))).
thf(c_H24,axiom,(c_H4 = (ordsucc @ c_Empty))).
thf(c_H25,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_U4 @ X27) @ X28) = (((c_If_5Fi @ ((c_SNoLe @ X27) @ c_Empty)) @ X28) @ (c_F4 @ ((c_U4 @ ((add_5FSNo @ X27) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X28))))))))).
thf(c_H26,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_V4 @ X27) = ((c_U4 @ (c_G4 @ X27)) @ c_H4))))).
thf(c_H27,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_FAST @ X27) = ((mul_5FSNo @ (c_V2 @ X27)) @ (c_V4 @ X27)))))).
thf(a197130,conjecture,(! [X27:$i] : (((c_In @ X27) @ int) => (((c_SNoLe @ c_Empty) @ X27) => ((c_SMALL @ X27) = (c_FAST @ X27)))))).
