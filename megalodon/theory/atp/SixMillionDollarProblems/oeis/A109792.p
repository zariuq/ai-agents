% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A109792.mg.html#A109792
...
thf(c_H11,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F0 @ X32) @ X33) = ((add_5FSNo @ ((c_V1 @ X32) @ X33)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X33)) @ X32)))))))).
...
thf(c_H23,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_G4 @ X32) @ X33) = X33)))))).
...
thf(c_H27,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F3 @ X32) @ X33) = ((add_5FSNo @ ((c_V4 @ X32) @ X33)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X33)) @ X32)))))))).
...
thf(a109792,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
