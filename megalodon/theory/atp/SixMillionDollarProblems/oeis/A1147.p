% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1147.mg.html#A1147
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F0 @ X15) @ X16) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X15) @ X16))) @ (minus_5FSNo @ X15)))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ (c_W1 @ X15)) @ (((c_If_5Fi @ ((c_SNoLe @ ((add_5FSNo @ X15) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ c_Empty)) @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
thf(a1147,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
