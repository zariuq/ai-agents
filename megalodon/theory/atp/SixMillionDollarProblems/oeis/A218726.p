% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A218726.mg.html#A218726
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (c_V1 @ X20)) @ (minus_5FSNo @ X20))))))).
...
thf(a218726,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
