% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A25940.mg.html#A25940
...
thf(c_H1,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F2 @ X43) @ X44) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X43) @ X43)) @ X43))) @ X44))))))).
...
thf(c_H9,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F1 @ X43) @ X44) = ((add_5FSNo @ ((c_W2 @ X43) @ X44)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X43) @ X43))) @ X43))))))))).
...
thf(c_H14,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F0 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X43) @ X44)) @ X43)) @ X43)) @ X43))))))).
...
thf(c_H38,axiom,(! [X43:$i] : (((c_In @ X43) @ int) => (! [X44:$i] : (((c_In @ X44) @ int) => (((c_F3 @ X43) @ X44) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X43) @ X44)) @ X43)) @ X43)) @ X43))))))).
...
thf(a25940,conjecture,(! [X43:$i] : (((c_In @ X43) @ int) => (((c_SNoLe @ c_Empty) @ X43) => ((c_SMALL @ X43) = (c_FAST @ X43)))))).
