% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A83812.mg.html#A83812
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((add_5FSNo @ (c_V0 @ X15)) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W1 @ X15)))) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(a83812,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
