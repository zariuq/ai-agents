% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A2674.mg.html#A2674
...
thf(c_H16,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_J2 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X20))))).
...
thf(a2674,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
