% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A187560.mg.html#A187560
...
thf(c_H1,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F0 @ X22) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X22) @ X22)))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((add_5FSNo @ (c_V2 @ X22)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a187560,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
