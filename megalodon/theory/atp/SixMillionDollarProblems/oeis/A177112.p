% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A177112.mg.html#A177112
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X18) @ X19)) @ X19)) @ X18))))))).
thf(c_H2,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G0 @ X18) @ X19) = X19)))))).
thf(c_H3,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H0 @ X18) = X18)))).
thf(c_H4,axiom,(c_I0 = (ordsucc @ c_Empty))).
thf(c_H5,axiom,(c_J0 = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ c_Empty)))).
...
thf(c_H9,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_SMALL @ X18) = ((mul_5FSNo @ ((add_5FSNo @ (c_W0 @ X18)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(c_H17,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_W1 @ X18) = (((c_U1 @ (c_H1 @ X18)) @ c_I1) @ c_J1))))).
thf(c_H18,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_FAST @ X18) = ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ (c_W1 @ X18)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(a177112,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
