% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A199760.mg.html#A199760
...
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((add_5FSNo @ ((mul_5FSNo @ X20) @ X21)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
...
thf(a199760,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
