% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A82032.mg.html#A82032
...
thf(c_H3,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_F1 @ X22) @ X23) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X22) @ X23)))))))).
thf(c_H4,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G1 @ X22) = X22)))).
thf(c_H5,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H6,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_U1 @ X22) @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ X23) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X23)) @ X22)))))))).
...
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_F2 @ X22) @ X23) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X22) @ X23)))))))).
...
thf(c_H15,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_U2 @ X22) @ X23) = (((c_If_5Fi @ ((c_SNoLe @ X22) @ c_Empty)) @ X23) @ ((c_F2 @ ((c_U2 @ ((add_5FSNo @ X22) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X23)) @ X22)))))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (c_V2 @ X22)) @ X22))) @ (c_V3 @ X22)))))).
thf(a82032,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
