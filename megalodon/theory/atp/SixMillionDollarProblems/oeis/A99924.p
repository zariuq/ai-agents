% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A99924.mg.html#A99924
...
thf(c_H1,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F0 @ X18) @ X19) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X19)))))))).
...
thf(c_H4,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I0 @ X18) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X18) @ X18)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H10,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_F1 @ X18) @ X19) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X19))))))).
thf(c_H11,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => (! [X19:$i] : (((c_In @ X19) @ int) => (((c_G1 @ X18) @ X19) = ((add_5FSNo @ X18) @ X19))))))).
thf(c_H12,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_H1 @ X18) = X18)))).
thf(c_H13,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I1 @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18)) @ X18)))))).
thf(c_H14,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_J1 @ X18) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X18))))).
...
thf(a99924,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
