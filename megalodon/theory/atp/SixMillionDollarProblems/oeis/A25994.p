% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A25994.mg.html#A25994
...
thf(c_H45,axiom,(! [X60:$i] : (((c_In @ X60) @ int) => (! [X61:$i] : (((c_In @ X61) @ int) => (((c_F7 @ X60) @ X61) = ((add_5FSNo @ ((add_5FSNo @ ((c_V8 @ X60) @ X61)) @ X60)) @ X60))))))).
...
thf(a25994,conjecture,(! [X60:$i] : (((c_In @ X60) @ int) => (((c_SNoLe @ c_Empty) @ X60) => ((c_SMALL @ X60) = (c_FAST @ X60)))))).
