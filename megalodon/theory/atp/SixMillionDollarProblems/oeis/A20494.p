% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20494.mg.html#A20494
...
thf(c_H16,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F4 @ X50) = ((add_5FSNo @ ((add_5FSNo @ X50) @ X50)) @ X50))))).
thf(c_H17,axiom,(c_G4 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H18,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_H4 @ X50) = X50)))).
thf(c_H19,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_U4 @ X50) @ X51) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X51) @ (c_F4 @ ((c_U4 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51))))))))).
thf(c_H20,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_V4 @ X50) = ((c_U4 @ c_G4) @ (c_H4 @ X50)))))).
thf(c_H21,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F0 @ X50) @ X51) = ((add_5FSNo @ ((c_V1 @ X50) @ X51)) @ (c_V4 @ X50)))))))).
...
thf(a20494,conjecture,(! [X50:$i] : (((c_In @ X50) @ int) => (((c_SNoLe @ c_Empty) @ X50) => ((c_SMALL @ X50) = (c_FAST @ X50)))))).
