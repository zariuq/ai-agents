% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A28403.mg.html#A28403
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V2 @ X22)))))).
thf(a28403,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
