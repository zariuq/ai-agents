% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A18092.mg.html#A18092
...
thf(c_H3,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X33) @ X33))))))).
...
thf(c_H8,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F1 @ X33) @ X34) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((c_V2 @ X33) @ X34)) @ X33)) @ X33)) @ X33))))))).
thf(c_H9,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G1 @ X33) = X33)))).
thf(c_H10,axiom,(c_H1 = (ordsucc @ c_Empty))).
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U1 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34)) @ X33)))))))).
thf(c_H12,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V1 @ X33) = ((c_U1 @ (c_G1 @ X33)) @ c_H1))))).
thf(c_H13,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H0 @ X33) = (c_V1 @ X33))))).
thf(c_H14,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U0 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F0 @ ((c_U0 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H15,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_V0 @ X33) = ((c_U0 @ (c_G0 @ X33)) @ (c_H0 @ X33)))))).
thf(c_H16,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_SMALL @ X33) = (c_V0 @ X33))))).
thf(c_H17,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F3 @ X33) @ X34) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X33) @ X33))) @ X34))))))).
thf(c_H18,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_G3 @ X33) @ X34) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ ((add_5FSNo @ X34) @ X34)) @ X34)))))))).
...
thf(c_H29,axiom,(c_J4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H33,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_FAST @ X33) = ((mul_5FSNo @ (c_W3 @ X33)) @ (c_W4 @ X33)))))).
thf(a18092,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
