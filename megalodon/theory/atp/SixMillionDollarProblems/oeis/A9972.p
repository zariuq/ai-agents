% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9972.mg.html#A9972
...
thf(c_H1,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F1 @ X25) @ X26) = ((add_5FSNo @ ((mul_5FSNo @ X25) @ X25)) @ X26))))))).
...
thf(a9972,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
