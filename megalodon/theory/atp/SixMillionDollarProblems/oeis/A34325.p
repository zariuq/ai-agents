% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A34325.mg.html#A34325
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F0 @ X20) @ X21) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ ((mul_5FSNo @ X20) @ X21)) @ X20)))))))).
...
thf(c_H9,axiom,(c_H1 = (ordsucc @ c_Empty))).
...
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V1 @ X20) = ((c_U1 @ (c_G1 @ X20)) @ c_H1))))).
...
thf(c_H19,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_W2 @ X20) = (((c_U2 @ (c_H2 @ X20)) @ (c_I2 @ X20)) @ c_J2))))).
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ (c_V1 @ X20)) @ (c_W2 @ X20)))))).
thf(a34325,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
