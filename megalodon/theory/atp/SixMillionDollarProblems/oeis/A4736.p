% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A4736.mg.html#A4736
...
thf(c_H1,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F0 @ X12) @ X13) = ((add_5FSNo @ X12) @ (minus_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X12) @ c_Empty)) @ c_Empty) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X13)))))))))).
...
thf(c_H6,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_SMALL @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ (c_V0 @ X12))))))).
thf(c_H7,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => (! [X13:$i] : (((c_In @ X13) @ int) => (((c_F1 @ X12) @ X13) = ((add_5FSNo @ X12) @ (minus_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X12) @ c_Empty)) @ c_Empty) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X13)))))))))).
thf(c_H8,axiom,(c_G1 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(c_H9,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H1 @ X12) = X12)))).
...
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ (c_V1 @ X12))))))).
thf(a4736,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
