% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A233744.mg.html#A233744
...
thf(c_H6,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F1 @ X32) @ X33) = ((add_5FSNo @ ((c_V2 @ X32) @ X33)) @ (minus_5FSNo @ X32)))))))).
...
thf(c_H22,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F4 @ X32) @ X33) = ((add_5FSNo @ ((c_V5 @ X32) @ X33)) @ (minus_5FSNo @ X32)))))))).
...
thf(c_H27,axiom,(! [X32:$i] : (((c_In @ X32) @ int) => (! [X33:$i] : (((c_In @ X33) @ int) => (((c_F3 @ X32) @ X33) = ((add_5FSNo @ ((c_V4 @ X32) @ X33)) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X33)) @ X32)))))))).
...
thf(a233744,conjecture,(! [X32:$i] : (((c_In @ X32) @ int) => (((c_SNoLe @ c_Empty) @ X32) => ((c_SMALL @ X32) = (c_FAST @ X32)))))).
