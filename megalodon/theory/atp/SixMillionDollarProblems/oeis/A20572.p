% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20572.mg.html#A20572
...
thf(c_H1,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_F2 @ X40) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X40) @ X40)) @ X40)))))).
...
thf(c_H11,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F0 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X40) @ X41)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X40) @ X40)) @ X40)))) @ X40))))))).
thf(c_H12,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_G0 @ X40) = X40)))).
thf(c_H13,axiom,(c_H0 = (ordsucc @ c_Empty))).
thf(c_H14,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_U0 @ X40) @ X41) = (((c_If_5Fi @ ((c_SNoLe @ X40) @ c_Empty)) @ X41) @ ((c_F0 @ ((c_U0 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41)) @ X40)))))))).
thf(c_H15,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_V0 @ X40) = ((c_U0 @ (c_G0 @ X40)) @ c_H0))))).
thf(c_H16,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_SMALL @ X40) = (c_V0 @ X40))))).
thf(c_H17,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F5 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X40) @ X40))) @ X40)) @ X41))))))).
thf(c_H18,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_G5 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ X41) @ X41)) @ X41))))))).
thf(c_H19,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_H5 @ X40) = X40)))).
thf(c_H20,axiom,(c_I5 = (ordsucc @ c_Empty))).
thf(c_H21,axiom,(c_J5 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
thf(c_H22,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (! [X42:$i] : (((c_In @ X42) @ int) => ((((c_U5 @ X40) @ X41) @ X42) = (((c_If_5Fi @ ((c_SNoLe @ X40) @ c_Empty)) @ X41) @ ((c_F5 @ (((c_U5 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41) @ X42)) @ (((c_V5 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41) @ X42))))))))))).
thf(c_H23,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (! [X42:$i] : (((c_In @ X42) @ int) => ((((c_V5 @ X40) @ X41) @ X42) = (((c_If_5Fi @ ((c_SNoLe @ X40) @ c_Empty)) @ X42) @ ((c_G5 @ (((c_U5 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41) @ X42)) @ (((c_V5 @ ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X41) @ X42))))))))))).
thf(c_H24,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_W5 @ X40) = (((c_U5 @ (c_H5 @ X40)) @ c_I5) @ c_J5))))).
...
thf(c_H30,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_F4 @ X40) = ((mul_5FSNo @ (c_W5 @ X40)) @ (c_V6 @ X40)))))).
...
thf(c_H35,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F3 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ ((c_V4 @ X40) @ X41)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X40) @ X40)) @ X40)))) @ X40))))))).
...
thf(a20572,conjecture,(! [X40:$i] : (((c_In @ X40) @ int) => (((c_SNoLe @ c_Empty) @ X40) => ((c_SMALL @ X40) = (c_FAST @ X40)))))).
