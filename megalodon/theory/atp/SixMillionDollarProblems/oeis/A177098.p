% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A177098.mg.html#A177098
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X20)))))))).
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F1 @ X20) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X20)) @ X20))))).
thf(c_H7,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(c_H1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H9,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_U1 @ X20) @ X21) = (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ X21) @ (c_F1 @ ((c_U1 @ ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X21))))))))).
thf(c_H10,axiom,(c_V1 = ((c_U1 @ c_G1) @ c_H1))).
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((mul_5FSNo @ (c_V0 @ X20)) @ c_V1))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ (c_W2 @ X20)) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))))) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(a177098,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
