% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A19443.mg.html#A19443
...
thf(c_H6,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F1 @ X40) @ X41) = ((add_5FSNo @ ((c_V2 @ X40) @ X41)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X40) @ X40)) @ X40))))))))).
...
thf(c_H11,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F0 @ X40) @ X41) = ((add_5FSNo @ ((c_V1 @ X40) @ X41)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X40) @ X40))))))))).
...
thf(c_H17,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_F5 @ X40) @ X41) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X40) @ X40)) @ X40)) @ X41))))))).
thf(c_H18,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => (! [X41:$i] : (((c_In @ X41) @ int) => (((c_G5 @ X40) @ X41) = ((add_5FSNo @ X41) @ X41))))))).
...
thf(c_H26,axiom,(! [X40:$i] : (((c_In @ X40) @ int) => ((c_G6 @ X40) = ((add_5FSNo @ X40) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(a19443,conjecture,(! [X40:$i] : (((c_In @ X40) @ int) => (((c_SNoLe @ c_Empty) @ X40) => ((c_SMALL @ X40) = (c_FAST @ X40)))))).
