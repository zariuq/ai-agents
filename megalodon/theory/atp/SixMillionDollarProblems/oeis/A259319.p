% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A259319.mg.html#A259319
...
thf(c_H3,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_H1 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X21) @ X21)))))))).
...
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((mul_5FSNo @ (c_V0 @ X20)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X21) @ X21)) @ X21)) @ X21)) @ X20))))))).
...
thf(a259319,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
