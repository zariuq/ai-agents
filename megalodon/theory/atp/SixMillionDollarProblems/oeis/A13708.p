% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13708.mg.html#A13708
...
thf(c_H2,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_G0 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X15) @ X15)))))).
...
thf(a13708,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
