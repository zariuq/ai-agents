% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A145529.mg.html#A145529
...
thf(c_H1,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((mul_5FSNo @ X33) @ X33))))).
thf(c_H2,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H3,axiom,(c_H2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H4,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U2 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H5,axiom,(c_V2 = ((c_U2 @ c_G2) @ c_H2))).
thf(c_H6,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F1 @ X33) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X33)) @ c_V2)) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
...
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F0 @ X33) @ X34) = ((add_5FSNo @ ((mul_5FSNo @ c_V1) @ X33)) @ (minus_5FSNo @ X34)))))))).
...
thf(c_H15,axiom,(c_J0 = (ordsucc @ c_Empty))).
...
thf(c_H20,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F4 @ X33) = ((mul_5FSNo @ ((mul_5FSNo @ X33) @ X33)) @ X33))))).
thf(c_H21,axiom,(c_G4 = (ordsucc @ c_Empty))).
thf(c_H22,axiom,(c_H4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H25,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F3 @ X33) @ X34) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ c_V4) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))) @ X33)) @ (minus_5FSNo @ X34)))))))).
...
thf(a145529,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
