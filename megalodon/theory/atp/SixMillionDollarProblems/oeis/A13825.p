% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13825.mg.html#A13825
...
thf(c_H2,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G0 @ X22) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X22) @ X22)))) @ X22))))).
...
thf(c_H9,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H2 @ X22) = ((add_5FSNo @ X22) @ X22))))).
...
thf(a13825,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
