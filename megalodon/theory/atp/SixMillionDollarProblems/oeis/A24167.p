% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A24167.mg.html#A24167
...
thf(c_H1,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F1 @ X27) @ X28) = ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ ((mul_5FSNo @ X27) @ X28))))))))).
...
thf(c_H13,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_G3 @ X27) @ X28) = X28)))))).
...
thf(c_H17,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => (! [X28:$i] : (((c_In @ X28) @ int) => (((c_F2 @ X27) @ X28) = ((add_5FSNo @ ((c_V3 @ X27) @ X28)) @ (minus_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ X28)) @ X27))))))))).
...
thf(c_H22,axiom,(! [X27:$i] : (((c_In @ X27) @ int) => ((c_F4 @ X27) = ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ X27)))))).
...
thf(a24167,conjecture,(! [X27:$i] : (((c_In @ X27) @ int) => (((c_SNoLe @ c_Empty) @ X27) => ((c_SMALL @ X27) = (c_FAST @ X27)))))).
