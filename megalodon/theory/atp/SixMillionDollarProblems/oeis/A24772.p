% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A24772.mg.html#A24772
...
thf(c_HH8,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => ((c_In @ ((c_H8 @ X50) @ X51)) @ int)))))).
...
thf(c_HW8,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => ((c_In @ ((c_W8 @ X50) @ X51)) @ int)))))).
...
thf(c_H1,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F2 @ X50) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X50) @ X50)))))))).
thf(c_H2,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_G2 @ X50) @ X51) = X51)))))).
thf(c_H3,axiom,(c_H2 = (ordsucc @ c_Empty))).
thf(c_H4,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_U2 @ X50) @ X51) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X51) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51))))))))).
thf(c_H5,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_V2 @ X50) @ X51) = ((c_U2 @ ((c_G2 @ X50) @ X51)) @ c_H2))))))).
thf(c_H6,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F3 @ X50) = ((add_5FSNo @ ((add_5FSNo @ X50) @ X50)) @ X50))))).
thf(c_H7,axiom,(c_G3 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_H3 @ X50) = X50)))).
...
thf(c_H10,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_V3 @ X50) = ((c_U3 @ c_G3) @ (c_H3 @ X50)))))).
thf(c_H11,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F1 @ X50) @ X51) = ((add_5FSNo @ ((c_V2 @ X50) @ X51)) @ (c_V3 @ X50)))))))).
...
thf(c_H21,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F0 @ X50) @ X51) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X50) @ X51)) @ (minus_5FSNo @ X50))) @ (c_V4 @ X50)))))))).
...
thf(c_H27,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F8 @ X50) @ X51) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ X50) @ X51)))))))).
thf(c_H28,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_G8 @ X50) @ X51) = X51)))))).
thf(c_H29,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_H8 @ X50) @ X51) = X51)))))).
thf(c_H30,axiom,(c_I8 = (ordsucc @ c_Empty))).
thf(c_H31,axiom,(c_J8 = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
thf(c_H32,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (! [X52:$i] : (((c_In @ X52) @ int) => ((((c_U8 @ X50) @ X51) @ X52) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X51) @ ((c_F8 @ (((c_U8 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51) @ X52)) @ (((c_V8 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51) @ X52))))))))))).
thf(c_H33,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (! [X52:$i] : (((c_In @ X52) @ int) => ((((c_V8 @ X50) @ X51) @ X52) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X52) @ ((c_G8 @ (((c_U8 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51) @ X52)) @ (((c_V8 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51) @ X52))))))))))).
thf(c_H34,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_W8 @ X50) @ X51) = (((c_U8 @ ((c_H8 @ X50) @ X51)) @ c_I8) @ c_J8))))))).
thf(c_H35,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F7 @ X50) @ X51) = ((add_5FSNo @ ((add_5FSNo @ ((c_W8 @ X50) @ X51)) @ ((mul_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X50) @ X50)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ X50))))))).
thf(c_H36,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_G7 @ X50) = X50)))).
thf(c_H37,axiom,(c_H7 = (ordsucc @ c_Empty))).
thf(c_H38,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_U7 @ X50) @ X51) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X51) @ ((c_F7 @ ((c_U7 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51)) @ X50)))))))).
thf(c_H39,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_V7 @ X50) = ((c_U7 @ (c_G7 @ X50)) @ c_H7))))).
thf(c_H40,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F6 @ X50) = (c_V7 @ X50))))).
...
thf(c_H45,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F5 @ X50) @ X51) = ((add_5FSNo @ ((add_5FSNo @ ((c_V6 @ X50) @ X51)) @ X50)) @ ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ X50) @ X50)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ X50)) @ (ordsucc @ (ordsucc @ c_Empty)))))))))).
...
thf(a24772,conjecture,(! [X50:$i] : (((c_In @ X50) @ int) => (((c_SNoLe @ c_Empty) @ X50) => ((c_SMALL @ X50) = (c_FAST @ X50)))))).
