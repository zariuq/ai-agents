% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A50621.mg.html#A50621
...
thf(a50621,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
