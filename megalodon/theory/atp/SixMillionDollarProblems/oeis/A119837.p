% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A119837.mg.html#A119837
...
thf(c_H1,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => (! [X16:$i] : (((c_In @ X16) @ int) => (((c_F0 @ X15) @ X16) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X15) @ X16))) @ (minus_5FSNo @ X15))))))))).
thf(c_H2,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_G0 @ X15) = X15)))).
thf(c_H3,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_H0 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ X15)))))).
...
thf(c_H11,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_J1 @ X15) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X15))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ (c_W1 @ X15)) @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ ((mul_5FSNo @ X15) @ X15)))))))).
thf(a119837,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
