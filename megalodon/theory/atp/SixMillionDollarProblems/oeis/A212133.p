% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A212133.mg.html#A212133
...
thf(c_H2,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => ((c_G0 @ X7) = ((add_5FSNo @ X7) @ X7))))).
...
thf(c_H7,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => ((c_FAST @ X7) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X7) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X7)) @ ((add_5FSNo @ ((mul_5FSNo @ X7) @ X7)) @ (minus_5FSNo @ X7)))) @ X7))))).
thf(a212133,conjecture,(! [X7:$i] : (((c_In @ X7) @ int) => (((c_SNoLe @ c_Empty) @ X7) => ((c_SMALL @ X7) = (c_FAST @ X7)))))).
