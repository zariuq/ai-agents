% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A161124.mg.html#A161124
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X15) @ X15))) @ (minus_5FSNo @ X15))) @ (c_W1 @ X15)))))).
thf(a161124,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
