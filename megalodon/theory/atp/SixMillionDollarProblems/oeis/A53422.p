% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A53422.mg.html#A53422
...
thf(a53422,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
