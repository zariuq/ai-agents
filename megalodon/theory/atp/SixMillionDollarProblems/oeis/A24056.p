% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A24056.mg.html#A24056
...
thf(c_H14,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_SMALL @ X28) = ((add_5FSNo @ (c_V0 @ X28)) @ (minus_5FSNo @ (c_W1 @ X28))))))).
...
thf(c_H23,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F3 @ X28) = ((mul_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X28))))).
thf(c_H24,axiom,(c_G3 = (ordsucc @ c_Empty))).
thf(c_H25,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H3 @ X28) = ((mul_5FSNo @ X28) @ X28))))).
...
thf(c_H27,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_V3 @ X28) = ((c_U3 @ c_G3) @ (c_H3 @ X28)))))).
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((add_5FSNo @ (c_W2 @ X28)) @ (minus_5FSNo @ ((mul_5FSNo @ (c_V3 @ X28)) @ X28))))))).
thf(a24056,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
