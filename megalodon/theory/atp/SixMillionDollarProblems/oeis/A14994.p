% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A14994.mg.html#A14994
...
thf(c_H6,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F0 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ (c_V1 @ X20))))))).
...
thf(a14994,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
