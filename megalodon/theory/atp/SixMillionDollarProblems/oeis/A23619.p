% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A23619.mg.html#A23619
...
thf(c_H13,axiom,(! [X18:$i] : (((c_In @ X18) @ int) => ((c_I1 @ X18) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X18) @ X18)))))).
...
thf(a23619,conjecture,(! [X18:$i] : (((c_In @ X18) @ int) => (((c_SNoLe @ c_Empty) @ X18) => ((c_SMALL @ X18) = (c_FAST @ X18)))))).
