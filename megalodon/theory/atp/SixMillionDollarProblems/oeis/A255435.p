% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A255435.mg.html#A255435
...
thf(c_H1,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_F1 @ X17) = ((mul_5FSNo @ X17) @ X17))))).
...
thf(c_H6,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F0 @ X17) @ X18) = ((add_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((c_V1 @ X17) @ X18)) @ X17)) @ X18)) @ X17))))))).
...
thf(c_H12,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => (! [X18:$i] : (((c_In @ X18) @ int) => (((c_F2 @ X17) @ X18) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ ((mul_5FSNo @ X18) @ X18)) @ X18)) @ X18)) @ X18))) @ X17))))))).
...
thf(a255435,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
