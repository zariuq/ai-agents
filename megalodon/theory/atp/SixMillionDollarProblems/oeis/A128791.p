% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A128791.mg.html#A128791
...
thf(c_H6,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_SMALL @ X15) = ((mul_5FSNo @ ((mul_5FSNo @ (c_V0 @ X15)) @ X15)) @ X15))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ ((mul_5FSNo @ X15) @ X15)) @ (c_W1 @ X15)))))).
thf(a128791,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
