% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A20530.mg.html#A20530
...
thf(c_H8,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H0 @ X22) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X22)))))).
...
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ X22) @ X22))) @ X22))))).
...
thf(a20530,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
