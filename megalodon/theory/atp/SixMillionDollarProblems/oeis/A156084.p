% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A156084.mg.html#A156084
...
thf(c_HI3,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_In @ (c_I3 @ X31)) @ int)))).
...
thf(c_H1,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F1 @ X31) @ X32) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X31) @ X31))) @ X32))))))).
...
thf(c_H15,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F2 @ X31) @ X32) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X31) @ X31))) @ X32))))))).
...
thf(c_H23,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => (! [X32:$i] : (((c_In @ X32) @ int) => (((c_F3 @ X31) @ X32) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X31) @ X31))) @ X32))))))).
thf(c_H24,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_G3 @ X31) = X31)))).
thf(c_H25,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_H3 @ X31) = ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(c_H26,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_I3 @ X31) = (((c_If_5Fi @ ((c_SNoLe @ ((add_5FSNo @ X31) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ c_Empty)) @ X31) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))))).
thf(c_H27,axiom,(c_J3 = (ordsucc @ c_Empty))).
...
thf(c_H30,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_W3 @ X31) = (((c_U3 @ (c_H3 @ X31)) @ (c_I3 @ X31)) @ c_J3))))).
thf(c_H31,axiom,(! [X31:$i] : (((c_In @ X31) @ int) => ((c_FAST @ X31) = ((mul_5FSNo @ (c_W2 @ X31)) @ (c_W3 @ X31)))))).
thf(a156084,conjecture,(! [X31:$i] : (((c_In @ X31) @ int) => (((c_SNoLe @ c_Empty) @ X31) => ((c_SMALL @ X31) = (c_FAST @ X31)))))).
