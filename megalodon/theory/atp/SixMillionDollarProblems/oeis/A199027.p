% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A199027.mg.html#A199027
...
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V0 @ X20)))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_W2 @ X20)))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a199027,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
