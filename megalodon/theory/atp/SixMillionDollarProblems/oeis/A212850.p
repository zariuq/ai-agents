% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A212850.mg.html#A212850
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F1 @ X28) = ((add_5FSNo @ X28) @ X28))))).
...
thf(c_H5,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_V1 @ X28) @ X29) = ((c_U1 @ ((c_G1 @ X28) @ X29)) @ (c_H1 @ X28)))))))).
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((add_5FSNo @ ((c_V1 @ X28) @ X29)) @ (minus_5FSNo @ X28)))))))).
thf(c_H7,axiom,(c_G0 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H0 @ X28) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X28))))).
...
thf(c_H14,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_SMALL @ X28) = ((add_5FSNo @ (c_W0 @ X28)) @ (ordsucc @ c_Empty)))))).
...
thf(c_H24,axiom,(c_J3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H28,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_FAST @ X28) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((mul_5FSNo @ ((add_5FSNo @ (c_V2 @ X28)) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))) @ (c_W3 @ X28))))))).
thf(a212850,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
