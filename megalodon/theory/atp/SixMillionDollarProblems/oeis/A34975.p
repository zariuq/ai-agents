% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A34975.mg.html#A34975
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_F1 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X20) @ X20)))))).
...
thf(a34975,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
