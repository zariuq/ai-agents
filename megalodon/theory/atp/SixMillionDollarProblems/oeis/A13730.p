% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13730.mg.html#A13730
...
thf(c_H17,axiom,(! [X17:$i] : (((c_In @ X17) @ int) => ((c_FAST @ X17) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X17)))))).
thf(a13730,conjecture,(! [X17:$i] : (((c_In @ X17) @ int) => (((c_SNoLe @ c_Empty) @ X17) => ((c_SMALL @ X17) = (c_FAST @ X17)))))).
