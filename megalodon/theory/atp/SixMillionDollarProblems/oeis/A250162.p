% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A250162.mg.html#A250162
...
thf(c_H1,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_F0 @ X22) @ X23) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X22) @ (minus_5FSNo @ X23))))))))).
thf(c_H2,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_G0 @ X22) = X22)))).
thf(c_H3,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F1 @ X22) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X22) @ X22)))))).
...
thf(c_H11,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_SMALL @ X22) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V0 @ X22)))))).
thf(c_H12,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_F2 @ X22) = ((add_5FSNo @ ((mul_5FSNo @ X22) @ X22)) @ X22))))).
...
thf(c_H19,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H2 @ X22) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ (c_V3 @ X22))))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((mul_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ (c_V2 @ X22)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ X22)) @ X22)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(a250162,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
