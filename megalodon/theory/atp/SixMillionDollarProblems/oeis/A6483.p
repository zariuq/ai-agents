% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A6483.mg.html#A6483
...
thf(c_H9,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_SMALL @ X23) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_W0 @ X23)))))).
...
thf(c_H23,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => ((c_FAST @ X23) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (c_V1 @ X23)))))).
thf(a6483,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
