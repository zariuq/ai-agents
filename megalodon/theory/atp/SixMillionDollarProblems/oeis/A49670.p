% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A49670.mg.html#A49670
...
thf(c_H3,axiom,(c_H1 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))).
...
thf(c_H10,axiom,(c_J0 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_F3 @ X28) = ((mul_5FSNo @ ((mul_5FSNo @ X28) @ X28)) @ X28))))).
thf(c_H16,axiom,(c_G3 = (ordsucc @ c_Empty))).
thf(c_H17,axiom,(c_H3 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H20,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ c_V3) @ (minus_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))))) @ X28)) @ (minus_5FSNo @ X29)))))))).
...
thf(a49670,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
