% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A16256.mg.html#A16256
...
thf(c_H6,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_F2 @ X25) = ((add_5FSNo @ ((add_5FSNo @ X25) @ X25)) @ X25))))).
thf(c_H7,axiom,(c_G2 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H8,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => ((c_H2 @ X25) = X25)))).
thf(c_H9,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_U2 @ X25) @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X25) @ c_Empty)) @ X26) @ (c_F2 @ ((c_U2 @ ((add_5FSNo @ X25) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X26))))))))).
...
thf(c_H17,axiom,(! [X25:$i] : (((c_In @ X25) @ int) => (! [X26:$i] : (((c_In @ X26) @ int) => (((c_F3 @ X25) @ X26) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((add_5FSNo @ ((add_5FSNo @ X25) @ X25)) @ X25))) @ X26))))))).
...
thf(a16256,conjecture,(! [X25:$i] : (((c_In @ X25) @ int) => (((c_SNoLe @ c_Empty) @ X25) => ((c_SMALL @ X25) = (c_FAST @ X25)))))).
