% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A98255.mg.html#A98255
...
thf(c_H3,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X33)))))).
...
thf(c_H8,axiom,(c_H1 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ c_V2))).
...
thf(c_H11,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F0 @ X33) @ X34) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ c_V1)) @ X33)) @ (minus_5FSNo @ X34)))))))).
...
thf(c_H20,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F4 @ X33) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X33)) @ ((mul_5FSNo @ X33) @ X33)))))).
thf(c_H21,axiom,(c_G4 = (ordsucc @ c_Empty))).
thf(c_H22,axiom,(c_H4 = ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(c_H23,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_U4 @ X33) @ X34) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X34) @ (c_F4 @ ((c_U4 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34))))))))).
thf(c_H24,axiom,(c_V4 = ((c_U4 @ c_G4) @ c_H4))).
thf(c_H25,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (((c_F3 @ X33) @ X34) = ((add_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ c_V4)) @ X33)) @ (minus_5FSNo @ X34)))))))).
thf(c_H26,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G3 @ X33) = X33)))).
thf(c_H27,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_H3 @ X33) = X33)))).
thf(c_H28,axiom,(c_I3 = (ordsucc @ c_Empty))).
thf(c_H29,axiom,(c_J3 = ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ (ordsucc @ c_Empty))))).
...
thf(c_H31,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => (! [X34:$i] : (((c_In @ X34) @ int) => (! [X35:$i] : (((c_In @ X35) @ int) => ((((c_V3 @ X33) @ X34) @ X35) = (((c_If_5Fi @ ((c_SNoLe @ X33) @ c_Empty)) @ X35) @ (c_G3 @ (((c_U3 @ ((add_5FSNo @ X33) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X34) @ X35))))))))))).
...
thf(a98255,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
