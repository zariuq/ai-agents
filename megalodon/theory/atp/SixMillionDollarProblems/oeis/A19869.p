% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A19869.mg.html#A19869
...
thf(c_H16,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F0 @ X50) @ X51) = ((add_5FSNo @ ((add_5FSNo @ ((c_V1 @ X50) @ X51)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X50) @ X50)))) @ X50))))))).
...
thf(c_H22,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F7 @ X50) = ((add_5FSNo @ X50) @ X50))))).
thf(c_H23,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_G7 @ X50) = X50)))).
thf(c_H24,axiom,(c_H7 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H25,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_U7 @ X50) @ X51) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X51) @ (c_F7 @ ((c_U7 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51))))))))).
thf(c_H26,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_V7 @ X50) = ((c_U7 @ (c_G7 @ X50)) @ c_H7))))).
thf(c_H27,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F8 @ X50) @ X51) = ((mul_5FSNo @ X50) @ X51))))))).
thf(c_H28,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_G8 @ X50) @ X51) = X51)))))).
thf(c_H29,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_H8 @ X50) = X50)))).
thf(c_H30,axiom,(c_I8 = (ordsucc @ c_Empty))).
thf(c_H31,axiom,(c_J8 = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty)))))).
...
thf(c_H34,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_W8 @ X50) = (((c_U8 @ (c_H8 @ X50)) @ c_I8) @ c_J8))))).
thf(c_H35,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F6 @ X50) = ((mul_5FSNo @ ((add_5FSNo @ (c_V7 @ X50)) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ (c_W8 @ X50)))))).
...
thf(c_H40,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_F5 @ X50) @ X51) = ((add_5FSNo @ ((add_5FSNo @ ((c_V6 @ X50) @ X51)) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X50) @ X50)))) @ X50))))))).
thf(c_H41,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_G5 @ X50) = X50)))).
...
thf(c_H44,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_V5 @ X50) = ((c_U5 @ (c_G5 @ X50)) @ c_H5))))).
thf(c_H45,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_F4 @ X50) = (c_V5 @ X50))))).
thf(c_H46,axiom,(c_G4 = (ordsucc @ c_Empty))).
thf(c_H47,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_H4 @ X50) = X50)))).
thf(c_H48,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => (! [X51:$i] : (((c_In @ X51) @ int) => (((c_U4 @ X50) @ X51) = (((c_If_5Fi @ ((c_SNoLe @ X50) @ c_Empty)) @ X51) @ (c_F4 @ ((c_U4 @ ((add_5FSNo @ X50) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X51))))))))).
thf(c_H49,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_V4 @ X50) = ((c_U4 @ c_G4) @ (c_H4 @ X50)))))).
thf(c_H50,axiom,(! [X50:$i] : (((c_In @ X50) @ int) => ((c_FAST @ X50) = (c_V4 @ X50))))).
thf(a19869,conjecture,(! [X50:$i] : (((c_In @ X50) @ int) => (((c_SNoLe @ c_Empty) @ X50) => ((c_SMALL @ X50) = (c_FAST @ X50)))))).
