% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A9445.mg.html#A9445
...
thf(c_H8,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_G1 @ X20) = X20)))).
thf(c_H9,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_H1 @ X20) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X20))))).
thf(c_H10,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_U1 @ X20) @ X21) = (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ X21) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X20) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X21)) @ X20)))))))).
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_V1 @ X20) = ((c_U1 @ (c_G1 @ X20)) @ (c_H1 @ X20)))))).
thf(c_H12,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F2 @ X20) @ X21) = ((mul_5FSNo @ X20) @ X21))))))).
thf(c_H13,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_G2 @ X20) @ X21) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X21))))))).
...
thf(c_H16,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_J2 @ X20) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X20))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X20) @ X20))) @ (c_V1 @ X20))) @ (c_W2 @ X20)))))).
thf(a9445,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
