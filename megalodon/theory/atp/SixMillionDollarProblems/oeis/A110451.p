% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A110451.mg.html#A110451
...
thf(c_H7,axiom,(! [X7:$i] : (((c_In @ X7) @ int) => ((c_FAST @ X7) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X7) @ X7))) @ ((mul_5FSNo @ X7) @ X7)))) @ X7))))).
thf(a110451,conjecture,(! [X7:$i] : (((c_In @ X7) @ int) => (((c_SNoLe @ c_Empty) @ X7) => ((c_SMALL @ X7) = (c_FAST @ X7)))))).
