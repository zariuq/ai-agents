% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1026.mg.html#A1026
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ (c_W2 @ X20)) @ ((add_5FSNo @ (((c_If_5Fi @ ((c_SNoLe @ X20) @ c_Empty)) @ c_Empty) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))) @ (ordsucc @ c_Empty))))))).
thf(a1026,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
