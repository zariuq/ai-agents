% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A83297.mg.html#A83297
...
thf(c_H1,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F0 @ X28) @ X29) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X29) @ (minus_5FSNo @ X28))))))))).
thf(c_H2,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F1 @ X28) @ X29) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X29)) @ X28))))))).
thf(c_H3,axiom,(c_G1 = (ordsucc @ (ordsucc @ c_Empty)))).
thf(c_H4,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_H1 @ X28) = X28)))).
thf(c_H5,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_U1 @ X28) @ X29) = (((c_If_5Fi @ ((c_SNoLe @ X28) @ c_Empty)) @ X29) @ ((c_F1 @ ((c_U1 @ ((add_5FSNo @ X28) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ X29)) @ X28)))))))).
thf(c_H6,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_V1 @ X28) = ((c_U1 @ c_G1) @ (c_H1 @ X28)))))).
thf(c_H7,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G0 @ X28) = (c_V1 @ X28))))).
...
thf(c_H15,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => (! [X29:$i] : (((c_In @ X29) @ int) => (((c_F2 @ X28) @ X29) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X29) @ (minus_5FSNo @ X28))) @ X29)) @ X29))))))).
thf(c_H16,axiom,(! [X28:$i] : (((c_In @ X28) @ int) => ((c_G2 @ X28) = ((add_5FSNo @ X28) @ X28))))).
...
thf(a83297,conjecture,(! [X28:$i] : (((c_In @ X28) @ int) => (((c_SNoLe @ c_Empty) @ X28) => ((c_SMALL @ X28) = (c_FAST @ X28)))))).
