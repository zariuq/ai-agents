% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A177074.mg.html#A177074
...
thf(c_H11,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_SMALL @ X20) = ((mul_5FSNo @ ((add_5FSNo @ (c_V0 @ X20)) @ (minus_5FSNo @ (ordsucc @ c_Empty)))) @ c_V1))))).
...
thf(c_H20,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => ((c_FAST @ X20) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty)))) @ ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))) @ ((add_5FSNo @ (c_W2 @ X20)) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))))).
thf(a177074,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
