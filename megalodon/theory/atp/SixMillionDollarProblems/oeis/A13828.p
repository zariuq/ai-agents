% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A13828.mg.html#A13828
...
thf(c_H7,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_G0 @ X33) = ((add_5FSNo @ (c_V1 @ X33)) @ X33))))).
...
thf(c_H12,axiom,(! [X33:$i] : (((c_In @ X33) @ int) => ((c_F2 @ X33) = ((mul_5FSNo @ ((mul_5FSNo @ X33) @ X33)) @ X33))))).
...
thf(a13828,conjecture,(! [X33:$i] : (((c_In @ X33) @ int) => (((c_SNoLe @ c_Empty) @ X33) => ((c_SMALL @ X33) = (c_FAST @ X33)))))).
