% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A64671.mg.html#A64671
...
thf(c_H3,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => (! [X23:$i] : (((c_In @ X23) @ int) => (((c_F1 @ X22) @ X23) = ((add_5FSNo @ ((add_5FSNo @ X22) @ X23)) @ X22))))))).
...
thf(c_H11,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_SMALL @ X22) = ((add_5FSNo @ (c_V0 @ X22)) @ X22))))).
...
thf(c_H19,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_H2 @ X22) = ((add_5FSNo @ (c_V3 @ X22)) @ (minus_5FSNo @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ X22))))))).
...
thf(c_H22,axiom,(! [X22:$i] : (((c_In @ X22) @ int) => ((c_FAST @ X22) = ((add_5FSNo @ (c_V2 @ X22)) @ X22))))).
thf(a64671,conjecture,(! [X22:$i] : (((c_In @ X22) @ int) => (((c_SNoLe @ c_Empty) @ X22) => ((c_SMALL @ X22) = (c_FAST @ X22)))))).
