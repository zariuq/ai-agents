% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A134492.mg.html#A134492
...
thf(c_H1,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F0 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))) @ X27))))))).
...
thf(c_H10,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F1 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))) @ X27))))))).
...
thf(c_H13,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_I1 @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ (ordsucc @ c_Empty)) @ (ordsucc @ (ordsucc @ c_Empty))))))).
...
thf(c_H18,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F2 @ X26) @ X27) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26))) @ X27))))))).
thf(c_H19,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_G2 @ X26) = X26)))).
thf(c_H20,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H2 @ X26) = X26)))).
thf(c_H21,axiom,(c_I2 = c_Empty)).
thf(c_H22,axiom,(c_J2 = (ordsucc @ (ordsucc @ c_Empty)))).
...
thf(c_H26,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_FAST @ X26) = ((mul_5FSNo @ ((mul_5FSNo @ (c_W1 @ X26)) @ (c_W2 @ X26))) @ (ordsucc @ (ordsucc @ c_Empty))))))).
thf(a134492,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
