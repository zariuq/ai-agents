% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A49678.mg.html#A49678
...
thf(c_HI1,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_In @ (c_I1 @ X26)) @ int)))).
...
thf(c_H1,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F0 @ X26) @ X27) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X26) @ X26)) @ X26))) @ (minus_5FSNo @ X27))) @ X26))))))).
...
thf(c_H10,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => (! [X27:$i] : (((c_In @ X27) @ int) => (((c_F1 @ X26) @ X27) = ((add_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ ((add_5FSNo @ X26) @ X26)) @ X26))) @ (minus_5FSNo @ X27))) @ X26))))))).
thf(c_H11,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_G1 @ X26) = X26)))).
thf(c_H12,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H1 @ X26) = ((add_5FSNo @ X26) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(c_H13,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_I1 @ X26) = (((c_If_5Fi @ ((c_SNoLe @ X26) @ c_Empty)) @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (ordsucc @ (ordsucc @ c_Empty))))))))).
...
thf(c_H17,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_W1 @ X26) = (((c_U1 @ (c_H1 @ X26)) @ (c_I1 @ X26)) @ c_J1))))).
...
thf(c_H20,axiom,(! [X26:$i] : (((c_In @ X26) @ int) => ((c_H2 @ X26) = ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X26) @ X26)))))).
...
thf(a49678,conjecture,(! [X26:$i] : (((c_In @ X26) @ int) => (((c_SNoLe @ c_Empty) @ X26) => ((c_SMALL @ X26) = (c_FAST @ X26)))))).
