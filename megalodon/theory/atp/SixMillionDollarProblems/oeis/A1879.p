% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A1879.mg.html#A1879
...
thf(c_H10,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_I1 @ X15) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X15))))).
...
thf(c_H15,axiom,(! [X15:$i] : (((c_In @ X15) @ int) => ((c_FAST @ X15) = ((mul_5FSNo @ ((add_5FSNo @ (ordsucc @ c_Empty)) @ ((add_5FSNo @ X15) @ X15))) @ (c_W1 @ X15)))))).
thf(a1879,conjecture,(! [X15:$i] : (((c_In @ X15) @ int) => (((c_SNoLe @ c_Empty) @ X15) => ((c_SMALL @ X15) = (c_FAST @ X15)))))).
