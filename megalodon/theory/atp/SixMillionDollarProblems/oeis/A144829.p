% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A144829.mg.html#A144829
...
thf(c_H1,axiom,(! [X20:$i] : (((c_In @ X20) @ int) => (! [X21:$i] : (((c_In @ X21) @ int) => (((c_F1 @ X20) @ X21) = ((add_5FSNo @ ((add_5FSNo @ ((add_5FSNo @ X20) @ (minus_5FSNo @ X21))) @ X20)) @ X20))))))).
...
thf(a144829,conjecture,(! [X20:$i] : (((c_In @ X20) @ int) => (((c_SNoLe @ c_Empty) @ X20) => ((c_SMALL @ X20) = (c_FAST @ X20)))))).
