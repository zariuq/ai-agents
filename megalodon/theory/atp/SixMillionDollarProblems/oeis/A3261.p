% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A3261.mg.html#A3261
...
thf(c_H2,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_G0 @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X12))))).
...
thf(c_H9,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_H1 @ X12) = ((add_5FSNo @ (ordsucc @ c_Empty)) @ X12))))).
...
thf(c_H12,axiom,(! [X12:$i] : (((c_In @ X12) @ int) => ((c_FAST @ X12) = ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (c_V1 @ X12))) @ (minus_5FSNo @ (ordsucc @ c_Empty))))))).
thf(a3261,conjecture,(! [X12:$i] : (((c_In @ X12) @ int) => (((c_SNoLe @ c_Empty) @ X12) => ((c_SMALL @ X12) = (c_FAST @ X12)))))).
