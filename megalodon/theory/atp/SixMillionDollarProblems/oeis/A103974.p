% https://mgwiki.github.io/mgw_test/conj/oeis/oeis-A103974.mg.html#A103974
...
thf(c_H1,axiom,(! [X23:$i] : (((c_In @ X23) @ int) => (! [X24:$i] : (((c_In @ X24) @ int) => (((c_F0 @ X23) @ X24) = ((add_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ (minus_5FSNo @ ((add_5FSNo @ ((mul_5FSNo @ (ordsucc @ (ordsucc @ c_Empty))) @ ((add_5FSNo @ X23) @ X23))) @ X24))))))))).
...
thf(c_H5,axiom,(c_J0 = ((add_5FSNo @ c_Empty) @ (minus_5FSNo @ (ordsucc @ c_Empty))))).
...
thf(a103974,conjecture,(! [X23:$i] : (((c_In @ X23) @ int) => (((c_SNoLe @ c_Empty) @ X23) => ((c_SMALL @ X23) = (c_FAST @ X23)))))).
