...
fof(c__5F,axiom,(! [X4] : (c_In(X4,alpha) => c_TransSet(X4)))).
fof(c_H1,axiom,(? [X4] : (c_In(X4,alpha) & (alpha = ordsucc(X4))))).
...
fof(conj_hammer_test_3449,conjecture,(binintersect(ordsucc(beta),beta) = beta)).
