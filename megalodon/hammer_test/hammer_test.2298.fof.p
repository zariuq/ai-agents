...
fof(conj_hammer_test_2298,conjecture,(! [X4] : (nat_5Fp(X4) => ((c_Subq(f_5F27(X4),c_5FX) & infinite(f_5F27(X4))) => (c_Subq(f_5F27(ordsucc(X4)),c_5FX) & infinite(f_5F27(ordsucc(X4)))))))).
