...
fof(c_H1,axiom,c_SNoLt(q,mul_5FSNo(x,y))).
fof(c_Lq1,axiom,c_In(q,c_SNoL(mul_5FSNo(x,y)))).
fof(c_Hv,axiom,c_In(v,c_SNoR(x))).
fof(c_Hw,axiom,c_In(w,c_SNoR(y))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c__5F,axiom,c_In(c_SNoLev(v),c_SNoLev(x))).
fof(c__5F,axiom,c_SNoLt(x,v)).
fof(c_Hw1,axiom,c_SNo(w)).
fof(c__5F,axiom,c_In(c_SNoLev(w),c_SNoLev(y))).
fof(c__5F,axiom,c_SNoLt(y,w)).
fof(c_H2,axiom,c_SNoLe(add_5FSNo(q,mul_5FSNo(v,w)),add_5FSNo(mul_5FSNo(v,y),mul_5FSNo(x,w)))).
...
fof(c_Lmvy,axiom,c_SNo(minus_5FSNo(mul_5FSNo(v,y)))).
fof(c_Lvmx,axiom,c_SNo(add_5FSNo(v,minus_5FSNo(x)))).
fof(c_Lwmy,axiom,c_SNo(add_5FSNo(w,minus_5FSNo(y)))).
fof(c_Hk1,axiom,c_In(k,omega)).
fof(c_Hk2,axiom,c_SNoLe(eps_5F(k),add_5FSNo(v,minus_5FSNo(x)))).
...
fof(c_L1c,axiom,c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(add_5FSNo(k,k_5F27)))).
fof(conj_hammer_test_13973,conjecture,c_SNoLe(add_5FSNo(add_5FSNo(mul_5FSNo(v,w),add_5FSNo(minus_5FSNo(mul_5FSNo(v,y)),minus_5FSNo(mul_5FSNo(x,w)))),add_5FSNo(mul_5FSNo(x,y),q)),mul_5FSNo(x,y))).
