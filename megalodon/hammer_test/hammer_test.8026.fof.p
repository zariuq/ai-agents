...
fof(conj_hammer_test_8026,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,y),add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(u,z))),add_5FSNo(mul_5FSNo(x,y),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(x,z))))).
