...
fof(c_L3,axiom,(! [X10] : (c_In(X10,c_SNoL(x)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(X10,v1)),add_5FSNo(mul_5FSNo(X10,u1),mul_5FSNo(x,v1)))))).
...
fof(conj_hammer_test_7375,conjecture,(c_In(v0,c_SNoL(u0)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
