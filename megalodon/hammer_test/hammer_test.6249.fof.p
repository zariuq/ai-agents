...
fof(c_IH,axiom,(! [X3] : (c_In(X3,beta) => (add_5FSNo(ordsucc(alpha),X3) = ordsucc(add_5FSNo(alpha,X3)))))).
...
fof(c__5F,axiom,(! [X3] : (c_In(X3,c_Empty) => c_SNoLt(add_5FSNo(ordsucc(alpha),beta),X3)))).
...
fof(conj_hammer_test_6249,conjecture,(! [X3] : (c_In(X3,c_SNoS_5F(beta)) => ((w = add_5FSNo(ordsucc(alpha),X3)) => c_SNoLt(w,ordsucc(add_5FSNo(alpha,beta))))))).
