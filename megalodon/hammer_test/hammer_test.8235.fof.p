...
fof(conj_hammer_test_8235,conjecture,(! [X6] : (c_In(X6,c_SNoR(y)) => (! [X7] : (c_In(X7,c_SNoR(x)) => c_In(add_5FSNo(mul_5FSNo(X6,x),add_5FSNo(mul_5FSNo(y,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FL)))))).
