...
fof(c_Hw,axiom,c_In(w,c_SNoR(z))).
...
fof(conj_hammer_test_8733,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(y,w),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(u,z),mul_5FSNo(v,w)))),add_5FSNo(mul_5FSNo(y,w),add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(u,w)))))).
