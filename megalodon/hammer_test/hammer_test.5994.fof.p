...
fof(c_Hwu,axiom,(w = add_5FSNo(x,u))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(y))).
fof(c_Hu3,axiom,c_SNoLt(u,y)).
fof(c_Luy,axiom,c_In(u,c_SNoS_5F(c_SNoLev(y)))).
fof(c_IHu1,axiom,c_SNo(add_5FSNo(x,u))).
fof(c_IHu2,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => c_SNoLt(add_5FSNo(X7,u),add_5FSNo(x,u))))).
fof(c_IHu3,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => c_SNoLt(add_5FSNo(x,u),add_5FSNo(X7,u))))).
fof(c_IHu4,axiom,(! [X7] : (c_In(X7,c_SNoL(u)) => c_SNoLt(add_5FSNo(x,X7),add_5FSNo(x,u))))).
fof(c_IHu5,axiom,(! [X7] : (c_In(X7,c_SNoR(u)) => c_SNoLt(add_5FSNo(x,u),add_5FSNo(x,X7))))).
fof(c_Hv,axiom,c_In(v,c_SNoR(y))).
fof(c_Hzv,axiom,(z = add_5FSNo(x,v))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(y))).
fof(c_Hv3,axiom,c_SNoLt(y,v)).
fof(c_IHv1,axiom,c_SNo(add_5FSNo(x,v))).
fof(c_IHv2,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => c_SNoLt(add_5FSNo(X7,v),add_5FSNo(x,v))))).
fof(c_IHv3,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => c_SNoLt(add_5FSNo(x,v),add_5FSNo(X7,v))))).
fof(c_IHv4,axiom,(! [X7] : (c_In(X7,c_SNoL(v)) => c_SNoLt(add_5FSNo(x,X7),add_5FSNo(x,v))))).
fof(c_IHv5,axiom,(! [X7] : (c_In(X7,c_SNoR(v)) => c_SNoLt(add_5FSNo(x,v),add_5FSNo(x,X7))))).
...
fof(c_Lqy,axiom,c_In(c_SNoLev(q),c_SNoLev(y))).
fof(c_Lqy2,axiom,c_In(q,c_SNoS_5F(c_SNoLev(y)))).
fof(c_IHq1,axiom,c_SNo(add_5FSNo(x,q))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => c_SNoLt(add_5FSNo(X7,q),add_5FSNo(x,q))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => c_SNoLt(add_5FSNo(x,q),add_5FSNo(X7,q))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoL(q)) => c_SNoLt(add_5FSNo(x,X7),add_5FSNo(x,q))))).
fof(c__5F,axiom,(! [X7] : (c_In(X7,c_SNoR(q)) => c_SNoLt(add_5FSNo(x,q),add_5FSNo(x,X7))))).
fof(conj_hammer_test_5994,conjecture,c_SNo(add_5FSNo(x,q))).
