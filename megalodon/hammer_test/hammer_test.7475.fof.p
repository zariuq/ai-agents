...
fof(c_Hzu1,axiom,c_In(z,c_SNoR(u1))).
fof(c_Hzv1,axiom,c_In(z,c_SNoL(v1))).
fof(c_Hza,axiom,c_SNo(z)).
fof(c_Hzb,axiom,c_In(c_SNoLev(z),c_SNoLev(v1))).
fof(c_Hzc,axiom,c_SNoLt(z,v1)).
fof(c_Lz,axiom,c_In(z,c_SNoL(y))).
fof(c_L6,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(u0,z)),add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(u0,u1)))).
fof(c_L7,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(u0,v1)),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,z)))).
fof(conj_hammer_test_7475,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
