...
fof(c_IHm,axiom,c_In(add_5FSNo(minus_5FSNo(n),m),int)).
fof(c_Lmo,axiom,ordinal(m)).
fof(c_LmS,axiom,c_SNo(m)).
fof(c_L1,axiom,(! [X2] : (c_In(X2,omega) => ((add_5FSNo(minus_5FSNo(n),m) = X2) => c_In(add_5FSNo(ordsucc(c_Empty),add_5FSNo(minus_5FSNo(n),m)),int))))).
fof(c_L2,axiom,(! [X2] : (c_In(X2,omega) => ((add_5FSNo(minus_5FSNo(n),m) = minus_5FSNo(X2)) => c_In(add_5FSNo(ordsucc(c_Empty),add_5FSNo(minus_5FSNo(n),m)),int))))).
fof(conj_hammer_test_10676,conjecture,c_In(add_5FSNo(ordsucc(c_Empty),add_5FSNo(minus_5FSNo(n),m)),int)).
