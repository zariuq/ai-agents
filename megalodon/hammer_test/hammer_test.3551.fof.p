...
fof(c_H1,axiom,(? [X8] : (c_In(X8,alpha) & (alpha = ordsucc(X8))))).
fof(c_Hb,axiom,c_In(beta,alpha)).
fof(c_Hab,axiom,(alpha = ordsucc(beta))).
fof(c_Lb,axiom,ordinal(beta)).
fof(c_Lsb,axiom,ordinal(ordsucc(beta))).
fof(c_Lbsb1,axiom,(binintersect(beta,ordsucc(beta)) = beta)).
fof(c_Lbsb2,axiom,(binintersect(ordsucc(beta),beta) = beta)).
fof(c_Hc,axiom,c_In(gamma,ordsucc(beta))).
fof(c_Lc,axiom,ordinal(gamma)).
fof(c_H4,axiom,(gamma = beta)).
fof(c_Hd,axiom,c_In(delta,beta)).
fof(c_H9,axiom,q(delta)).
fof(c_Ld,axiom,ordinal(delta)).
fof(c_H10,axiom,p(delta)).
fof(c_H11,axiom,(delta = beta)).
fof(conj_hammer_test_3551,conjecture,c_In(delta,beta)).
