...
fof(c_H4,axiom,c_In(c_SNoLev(y),c_SNoLev(v))).
fof(c_H5,axiom,c_SNoEq_5F(c_SNoLev(y),v,y)).
fof(c_H6,axiom,nIn(c_SNoLev(y),v)).
fof(c_Lyv,axiom,c_In(y,c_SNoR(v))).
fof(c_L1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(w,y)),add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,y)))).
fof(c_L2,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(u,y)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(w,y)))).
fof(conj_hammer_test_7922,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u,y),add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,y))),add_5FSNo(mul_5FSNo(w,y),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,v))))).
