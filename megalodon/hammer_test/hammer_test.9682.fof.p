...
fof(conj_hammer_test_9682,conjecture,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X9,X8),X7) = mul_5FSNo(X9,mul_5FSNo(X8,X7)))))))))).
