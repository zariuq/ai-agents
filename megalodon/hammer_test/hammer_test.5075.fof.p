...
fof(c_Hn0,axiom,~ (n = c_Empty)).
fof(c_Hm1,axiom,c_In(m,n)).
fof(c_Hm2,axiom,(z = eps_5F(m))).
fof(c_H2,axiom,c_In(k,ordsucc(ordsucc(m)))).
fof(c_L3a,axiom,c_In(ordsucc(m),ordsucc(n))).
fof(c_L3b,axiom,c_Subq(ordsucc(m),ordsucc(n))).
fof(c_H3,axiom,(k = ordsucc(m))).
fof(conj_hammer_test_5075,conjecture,c_In(ordsucc(m),ordsucc(n))).
