...
fof(c__5F,axiom,c_SNoLt(x,u)).
fof(c_Hva,axiom,c_SNo(v)).
fof(c__5F,axiom,c_In(c_SNoLev(v),c_SNoLev(y))).
fof(c__5F,axiom,c_SNoLt(y,v)).
fof(c_Luy,axiom,c_SNo(mul_5FSNo(u,y))).
fof(c_Lxv,axiom,c_SNo(mul_5FSNo(x,v))).
fof(c_Luv,axiom,c_SNo(mul_5FSNo(u,v))).
fof(conj_hammer_test_7755,conjecture,(! [X9] : (c_In(X9,c_SNoR(x)) => (! [X10] : (c_In(X10,c_SNoL(y)) => ((z = add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10))))) => c_SNoLt(w,z))))))).
