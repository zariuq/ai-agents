...
fof(conj_hammer_test_2538,conjecture,(! [X5] : (nat_5Fp(X5) => ((c_Subq(f_5F27(X5),c_5FX) & infinite(f_5F27(X5))) => (c_Subq(f_5F27(ordsucc(X5)),c_5FX) & infinite(f_5F27(ordsucc(X5)))))))).
