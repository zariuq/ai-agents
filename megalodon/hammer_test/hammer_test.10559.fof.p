...
fof(c_H,axiom,((! [X7] : (c_In(X7,c_5FLx) => c_SNo(X7))) & (! [X7] : (c_In(X7,c_5FRx) => c_SNo(X7))))).
fof(c_HLx,axiom,(! [X7] : (c_In(X7,c_5FLx) => c_SNo(X7)))).
fof(c_HRx,axiom,(! [X7] : (c_In(X7,c_5FRx) => c_SNo(X7)))).
fof(c_HLRx_27,axiom,(! [X7] : (c_In(X7,c_5FLx) => (! [X8] : (c_In(X8,c_5FRx) => c_SNoLt(X7,X8)))))).
fof(c_H,axiom,((! [X7] : (c_In(X7,c_5FLy) => c_SNo(X7))) & (! [X7] : (c_In(X7,c_5FRy) => c_SNo(X7))))).
fof(c_HLy,axiom,(! [X7] : (c_In(X7,c_5FLy) => c_SNo(X7)))).
fof(c_HRy,axiom,(! [X7] : (c_In(X7,c_5FRy) => c_SNo(X7)))).
fof(c_HLRy_27,axiom,(! [X7] : (c_In(X7,c_5FLy) => (! [X8] : (c_In(X8,c_5FRy) => c_SNoLt(X7,X8)))))).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx3,axiom,(! [X7] : (c_In(X7,c_5FLx) => c_SNoLt(X7,x)))).
fof(c_Hx4,axiom,(! [X7] : (c_In(X7,c_5FRx) => c_SNoLt(x,X7)))).
fof(c_Hx5,axiom,(! [X7] : (c_SNo(X7) => ((! [X8] : (c_In(X8,c_5FLx) => c_SNoLt(X8,X7))) => ((! [X8] : (c_In(X8,c_5FRx) => c_SNoLt(X7,X8))) => (c_Subq(c_SNoLev(x),c_SNoLev(X7)) & c_SNoEq_5F(c_SNoLev(x),x,X7))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X7] : (c_In(X7,c_5FLy) => c_SNoLt(X7,y)))).
fof(c_Hy4,axiom,(! [X7] : (c_In(X7,c_5FRy) => c_SNoLt(y,X7)))).
fof(c_Hy5,axiom,(! [X7] : (c_SNo(X7) => ((! [X8] : (c_In(X8,c_5FLy) => c_SNoLt(X8,X7))) => ((! [X8] : (c_In(X8,c_5FRy) => c_SNoLt(X7,X8))) => (c_Subq(c_SNoLev(y),c_SNoLev(X7)) & c_SNoEq_5F(c_SNoLev(y),y,X7))))))).
...
fof(c_L1,axiom,(! [X7] : (c_In(X7,c_5FLx) => (! [X8] : (c_In(X8,c_5FRy) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X7,X8)),add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8)))))))).
fof(conj_hammer_test_10559,conjecture,(! [X7] : (c_In(X7,c_5FRx) => (! [X8] : (c_In(X8,c_5FLy) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X7,X8)),add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8)))))))).
