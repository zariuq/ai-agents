...
fof(c_L1,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (! [X4] : (c_In(X4,c_SNoR(y)) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X3,X4)),add_5FSNo(mul_5FSNo(X3,y),mul_5FSNo(x,X4)))))))).
fof(conj_hammer_test_8124,conjecture,(! [X3] : (c_In(X3,c_SNoR(x)) => (! [X4] : (c_In(X4,c_SNoL(y)) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X3,X4)),add_5FSNo(mul_5FSNo(X3,y),mul_5FSNo(x,X4)))))))).
