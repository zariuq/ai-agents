...
fof(conj_hammer_test_8240,conjecture,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X6,y),add_5FSNo(mul_5FSNo(x,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FR_5F27)))))).
