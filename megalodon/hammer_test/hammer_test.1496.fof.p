...
fof(conj_hammer_test_1496,conjecture,(! [X2] : (nat_5Fp(X2) => ((add_5Fnat(add_5Fnat(n,m),X2) = add_5Fnat(n,add_5Fnat(m,X2))) => (add_5Fnat(add_5Fnat(n,m),ordsucc(X2)) = add_5Fnat(n,add_5Fnat(m,ordsucc(X2)))))))).
