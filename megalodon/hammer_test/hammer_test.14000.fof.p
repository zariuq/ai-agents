...
fof(c_Hx6,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(omega)) => ((! [X8] : (c_In(X8,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X7,minus_5FSNo(x))),eps_5F(X8)))) => (X7 = x))))).
fof(c_Hx7,axiom,(! [X7] : (c_In(X7,omega) => (? [X8] : (c_In(X8,c_SNoS_5F(omega)) & (c_SNoLt(X8,x) & c_SNoLt(x,add_5FSNo(X8,eps_5F(X7))))))))).
...
fof(c_Hy6,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(omega)) => ((! [X8] : (c_In(X8,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X7,minus_5FSNo(y))),eps_5F(X8)))) => (X7 = y))))).
fof(c_Hy7,axiom,(! [X7] : (c_In(X7,omega) => (? [X8] : (c_In(X8,c_SNoS_5F(omega)) & (c_SNoLt(X8,y) & c_SNoLt(y,add_5FSNo(X8,eps_5F(X7))))))))).
...
fof(c_Lxy3,axiom,(! [X7] : (c_SNo(X7) => (c_In(c_SNoLev(X7),omega) => c_In(c_SNoLev(X7),c_SNoLev(mul_5FSNo(x,y))))))).
...
fof(c_HLI1,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => (! [X8] : (c_In(X8,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X7,y),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => (! [X8] : (c_In(X8,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X7,y),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => (! [X8] : (c_In(X8,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X7,y),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => (! [X8] : (c_In(X8,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X7,y),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FR)))))).
fof(c_HxyLR,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_Hq1,axiom,c_In(q,c_SNoS_5F(omega))).
fof(c_Hq2,axiom,(! [X7] : (c_In(X7,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(X7))))).
...
fof(conj_hammer_test_14000,conjecture,c_SNo(add_5FSNo(w,minus_5FSNo(y)))).
