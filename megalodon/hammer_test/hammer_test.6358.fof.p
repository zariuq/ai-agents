...
fof(c_IH,axiom,(! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(u))) => (c_In(c_SNoLev(X5),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(X5,add_5FSNo(x,y)) => ((? [X6] : (c_In(X6,c_SNoL(x)) & c_SNoLe(X5,add_5FSNo(X6,y)))) | (? [X6] : (c_In(X6,c_SNoL(y)) & c_SNoLe(X5,add_5FSNo(x,X6)))))))))).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(u,add_5FSNo(x,y))).
fof(c_HNC,axiom,~ ((? [X5] : (c_In(X5,c_SNoL(x)) & c_SNoLe(u,add_5FSNo(X5,y)))) | (? [X5] : (c_In(X5,c_SNoL(y)) & c_SNoLe(u,add_5FSNo(x,X5)))))).
...
fof(c_H1,axiom,c_SNoLt(z,add_5FSNo(x,y))).
fof(c_Lz1,axiom,c_In(z,c_SNoS_5F(c_SNoLev(u)))).
fof(c_Lz2,axiom,c_In(c_SNoLev(z),c_SNoLev(add_5FSNo(x,y)))).
fof(c_H2,axiom,(? [X5] : (c_In(X5,c_SNoL(x)) & c_SNoLe(z,add_5FSNo(X5,y))))).
fof(c_Hv,axiom,c_In(v,c_SNoL(x))).
fof(c_H3,axiom,c_SNoLe(z,add_5FSNo(v,y))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(x))).
fof(c_Hv3,axiom,c_SNoLt(v,x)).
fof(conj_hammer_test_6358,conjecture,c_SNoLe(z,add_5FSNo(v,y))).
