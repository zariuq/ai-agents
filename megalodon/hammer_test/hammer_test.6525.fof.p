...
fof(c_Hu,axiom,c_In(u,c_SNoL(add_5FSNo(x,y)))).
fof(c_Hwu,axiom,(w = add_5FSNo(u,z))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(u,add_5FSNo(x,y))).
fof(conj_hammer_test_6525,conjecture,((? [X5] : (c_In(X5,c_SNoL(y)) & c_SNoLe(u,add_5FSNo(x,X5)))) => c_SNoLt(add_5FSNo(u,z),add_5FSNo(x,add_5FSNo(y,z))))).
