...
fof(conj_hammer_test_8089,conjecture,(! [X2] : (c_In(X2,c_SNoL(mul_5FSNo(x,y))) => ((? [X3] : (c_In(X3,c_SNoL(x)) & (? [X4] : (c_In(X4,c_SNoL(y)) & c_SNoLe(add_5FSNo(X2,mul_5FSNo(X3,X4)),add_5FSNo(mul_5FSNo(X3,y),mul_5FSNo(x,X4))))))) | (? [X3] : (c_In(X3,c_SNoR(x)) & (? [X4] : (c_In(X4,c_SNoR(y)) & c_SNoLe(add_5FSNo(X2,mul_5FSNo(X3,X4)),add_5FSNo(mul_5FSNo(X3,y),mul_5FSNo(x,X4))))))))))).
