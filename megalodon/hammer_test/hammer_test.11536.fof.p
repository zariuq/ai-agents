...
fof(c_Hm,axiom,c_In(m,omega)).
fof(c_Hn,axiom,c_In(n,omega)).
fof(c_Lmn1,axiom,c_In(add_5FSNo(m,n),omega)).
fof(c_Lmn2,axiom,nat_5Fp(add_5FSNo(m,n))).
fof(c_Lem,axiom,c_SNo(eps_5F(m))).
fof(c_Len,axiom,c_SNo(eps_5F(n))).
fof(c_Lemen,axiom,c_SNo(mul_5FSNo(eps_5F(m),eps_5F(n)))).
fof(c_Lemn,axiom,c_SNo(eps_5F(add_5FSNo(m,n)))).
fof(c_L2m,axiom,c_SNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),m))).
fof(conj_hammer_test_11536,conjecture,(mul_5FSNo(eps_5F(m),eps_5F(n)) = eps_5F(add_5FSNo(m,n)))).
