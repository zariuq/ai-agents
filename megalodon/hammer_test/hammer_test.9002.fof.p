...
fof(conj_hammer_test_9002,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(y,w)))),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(x,w))))).
