...
fof(c_IHLx,axiom,(! [X1] : (c_In(X1,c_SNoL(x)) => ((c_SNo(minus_5FSNo(X1)) & (! [X2] : (c_In(X2,c_SNoL(X1)) => c_SNoLt(minus_5FSNo(X1),minus_5FSNo(X2))))) & (! [X2] : (c_In(X2,c_SNoR(X1)) => c_SNoLt(minus_5FSNo(X2),minus_5FSNo(X1)))))))).
fof(conj_hammer_test_5539,conjecture,(! [X1] : (c_In(X1,c_SNoR(x)) => ((c_SNo(minus_5FSNo(X1)) & (! [X2] : (c_In(X2,c_SNoL(X1)) => c_SNoLt(minus_5FSNo(X1),minus_5FSNo(X2))))) & (! [X2] : (c_In(X2,c_SNoR(X1)) => c_SNoLt(minus_5FSNo(X2),minus_5FSNo(X1)))))))).
