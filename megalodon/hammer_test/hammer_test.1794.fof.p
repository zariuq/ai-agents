...
fof(c_IHn,axiom,(! [X4] : (equip(X4,n) => equip(c_Power(X4),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
...
fof(c_L1,axiom,(? [X4] : c_In(X4,c_5FX))).
...
fof(c_H,axiom,((! [X4] : (c_In(X4,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X4),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)))) & (! [X4] : (c_In(X4,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X4) = f(X5)) => (X4 = X5)))))))).
fof(c_Hf1,axiom,(! [X4] : (c_In(X4,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X4),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
fof(c_Hf2,axiom,(! [X4] : (c_In(X4,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X4) = f(X5)) => (X4 = X5))))))).
fof(c_Hf3,axiom,(! [X4] : (c_In(X4,exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => (? [X5] : (c_In(X5,c_Power(setminus(c_5FX,c_Sing(x)))) & (f(X5) = X4)))))).
fof(conj_hammer_test_1794,conjecture,(! [X4] : (c_In(X4,c_Power(setminus(c_5FX,c_Sing(x)))) => nat_5Fp(f(X4))))).
