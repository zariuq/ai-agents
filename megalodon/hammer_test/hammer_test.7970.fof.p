...
fof(conj_hammer_test_7970,conjecture,(c_In(c_SNoLev(y),c_SNoLev(v)) => (c_SNoEq_5F(c_SNoLev(y),v,y) => (nIn(c_SNoLev(y),v) => c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,v)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,v))))))).
