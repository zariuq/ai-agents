...
fof(c_LI,axiom,(! [X2] : (c_SNo(X2) => (c_In(c_SNoLev(X2),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(add_5FSNo(x,y),X2) => ((? [X3] : (c_In(X3,c_SNoR(x)) & c_SNoLe(add_5FSNo(X3,y),X2))) | (? [X3] : (c_In(X3,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X3),X2))))))))).
fof(conj_hammer_test_6431,conjecture,(! [X2] : (c_In(X2,c_SNoR(add_5FSNo(x,y))) => ((? [X3] : (c_In(X3,c_SNoR(x)) & c_SNoLe(add_5FSNo(X3,y),X2))) | (? [X3] : (c_In(X3,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X3),X2))))))).
