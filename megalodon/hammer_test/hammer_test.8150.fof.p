...
fof(c_L1,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(x,X7)))))))).
fof(c_L2,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(u,mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(x,X7)))))))).
...
fof(conj_hammer_test_8150,conjecture,c_SNoLt(z,mul_5FSNo(x,y))).
