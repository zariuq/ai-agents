...
fof(c_H2_27,axiom,~ (? [X5] : (c_Subq(X5,c_5FX_5F27) & (? [X6] : (c_In(X6,c_5FX_5F27) & ((nIn(X6,X5) & infinite(X5)) & (! [X7] : (c_Subq(X7,X5) => (equip(X7,n) => (c_5FC(binunion(X7,c_Sing(c_X6))) = c)))))))))).
fof(conj_hammer_test_2354,conjecture,(? [X5] : c_In(X5,c_5FX_5F27))).
