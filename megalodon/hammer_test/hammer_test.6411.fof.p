...
fof(c_IH,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(u))) => (c_In(c_SNoLev(X3),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(add_5FSNo(x,y),X3) => ((? [X4] : (c_In(X4,c_SNoR(x)) & c_SNoLe(add_5FSNo(X4,y),X3))) | (? [X4] : (c_In(X4,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X4),X3))))))))).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(add_5FSNo(x,y),u)).
fof(c_HNC,axiom,~ ((? [X3] : (c_In(X3,c_SNoR(x)) & c_SNoLe(add_5FSNo(X3,y),u))) | (? [X3] : (c_In(X3,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X3),u))))).
fof(conj_hammer_test_6411,conjecture,c_SNoCutP(c_SNoL(u),c_SNoR(u))).
