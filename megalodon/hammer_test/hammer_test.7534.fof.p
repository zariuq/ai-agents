...
fof(conj_hammer_test_7534,conjecture,(c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,u1),mul_5FSNo(x,v1))) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
