...
fof(conj_hammer_test_7002,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNo(X4) => (c_SNoLt(add_5FSNo(X1,X0),add_5FSNo(X2,X3)) => c_SNoLt(add_5FSNo(X0,add_5FSNo(X4,X1)),add_5FSNo(X2,add_5FSNo(X3,X4))))))))))))))).
