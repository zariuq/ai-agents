...
fof(conj_hammer_test_14353,conjecture,(c_SNoLe(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(w0,w1)))),ap(hL,add_5FSNo(k0,k1))) => c_SNoLe(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(w0,w1)))),ap(hL,add_5FSNo(k0,k1))))).
