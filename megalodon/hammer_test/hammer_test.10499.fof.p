...
fof(c_H,axiom,((! [X6] : (c_In(X6,c_5FLx) => c_SNo(X6))) & (! [X6] : (c_In(X6,c_5FRx) => c_SNo(X6))))).
fof(c_HLx,axiom,(! [X6] : (c_In(X6,c_5FLx) => c_SNo(X6)))).
fof(c_HRx,axiom,(! [X6] : (c_In(X6,c_5FRx) => c_SNo(X6)))).
fof(c_HLRx_27,axiom,(! [X6] : (c_In(X6,c_5FLx) => (! [X7] : (c_In(X7,c_5FRx) => c_SNoLt(X6,X7)))))).
fof(c_H,axiom,((! [X6] : (c_In(X6,c_5FLy) => c_SNo(X6))) & (! [X6] : (c_In(X6,c_5FRy) => c_SNo(X6))))).
fof(c_HLy,axiom,(! [X6] : (c_In(X6,c_5FLy) => c_SNo(X6)))).
fof(c_HRy,axiom,(! [X6] : (c_In(X6,c_5FRy) => c_SNo(X6)))).
fof(c_HLRy_27,axiom,(! [X6] : (c_In(X6,c_5FLy) => (! [X7] : (c_In(X7,c_5FRy) => c_SNoLt(X6,X7)))))).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx3,axiom,(! [X6] : (c_In(X6,c_5FLx) => c_SNoLt(X6,x)))).
fof(c_Hx4,axiom,(! [X6] : (c_In(X6,c_5FRx) => c_SNoLt(x,X6)))).
fof(c_Hx5,axiom,(! [X6] : (c_SNo(X6) => ((! [X7] : (c_In(X7,c_5FLx) => c_SNoLt(X7,X6))) => ((! [X7] : (c_In(X7,c_5FRx) => c_SNoLt(X6,X7))) => (c_Subq(c_SNoLev(x),c_SNoLev(X6)) & c_SNoEq_5F(c_SNoLev(x),x,X6))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X6] : (c_In(X6,c_5FLy) => c_SNoLt(X6,y)))).
fof(c_Hy4,axiom,(! [X6] : (c_In(X6,c_5FRy) => c_SNoLt(y,X6)))).
fof(c_Hy5,axiom,(! [X6] : (c_SNo(X6) => ((! [X7] : (c_In(X7,c_5FLy) => c_SNoLt(X7,X6))) => ((! [X7] : (c_In(X7,c_5FRy) => c_SNoLt(X6,X7))) => (c_Subq(c_SNoLev(y),c_SNoLev(X6)) & c_SNoEq_5F(c_SNoLev(y),y,X6))))))).
fof(c_Lxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(conj_hammer_test_10499,conjecture,(! [X6] : (c_In(X6,c_SNoL(mul_5FSNo(x,y))) => ((? [X7] : (c_In(X7,c_5FLx) & (? [X8] : (c_In(X8,c_5FLy) & c_SNoLe(add_5FSNo(X6,mul_5FSNo(X7,X8)),add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8))))))) | (? [X7] : (c_In(X7,c_5FRx) & (? [X8] : (c_In(X8,c_5FRy) & c_SNoLe(add_5FSNo(X6,mul_5FSNo(X7,X8)),add_5FSNo(mul_5FSNo(X7,y),mul_5FSNo(x,X8))))))))))).
