...
fof(conj_hammer_test_10737,conjecture,(! [X1] : (nat_5Fp(X1) => ((? [X2] : (c_In(X2,omega) & (? [X3] : (c_In(X3,n) & (X1 = add_5Fnat(mul_5Fnat(X2,n),X3)))))) => (? [X2] : (c_In(X2,omega) & (? [X3] : (c_In(X3,n) & (ordsucc(X1) = add_5Fnat(mul_5Fnat(X2,n),X3)))))))))).
