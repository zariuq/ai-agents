...
fof(conj_hammer_test_6643,conjecture,(! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(x))) => ((u = add_5FSNo(X4,y)) => (c_SNo(X4) => (c_In(c_SNoLev(X4),c_SNoLev(x)) => (c_SNoLt(X4,x) => (c_In(v,ordsucc(c_SNoLev(add_5FSNo(X4,y)))) => c_In(v,add_5FSNo(c_SNoLev(x),c_SNoLev(y))))))))))).
