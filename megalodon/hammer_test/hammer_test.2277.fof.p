...
fof(c_IHn,axiom,(? [X5] : (c_Subq(X5,c_5FX) & equip(X5,n)))).
fof(c_HY,axiom,c_Subq(c_5FY,c_5FX)).
fof(c_HYn,axiom,equip(c_5FY,n)).
fof(c_H,axiom,((! [X5] : (c_In(X5,c_5FY) => c_In(f(X5),n))) & (! [X5] : (c_In(X5,c_5FY) => (! [X6] : (c_In(X6,c_5FY) => ((f(c_X5) = f(X6)) => (X5 = X6)))))))).
fof(c_Hf1,axiom,(! [X5] : (c_In(X5,c_5FY) => c_In(f(X5),n)))).
fof(c_Hf2,axiom,(! [X5] : (c_In(X5,c_5FY) => (! [X6] : (c_In(X6,c_5FY) => ((f(c_X5) = f(X6)) => (X5 = X6))))))).
fof(c_Hf3,axiom,(! [X5] : (c_In(X5,n) => (? [X6] : (c_In(X6,c_5FY) & (f(X6) = X5)))))).
fof(c_L1,axiom,(? [X5] : (c_In(X5,c_5FX) & nIn(X5,c_5FY)))).
fof(c_HzX,axiom,c_In(z,c_5FX)).
fof(c_HzY,axiom,nIn(z,c_5FY)).
fof(conj_hammer_test_2277,conjecture,equip(binunion(c_5FY,c_Sing(z)),ordsucc(n))).
