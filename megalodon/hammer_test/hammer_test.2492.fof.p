...
fof(c_H1,axiom,(! [X9] : (c_Subq(X9,c_5FX) => (equip(X9,ordsucc(n)) => c_In(c_5FC(X9),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X9] : (c_Subq(X9,c_5FX) & (? [X10] : (c_In(X10,ordsucc(c)) & (infinite(X9) & (! [X11] : (c_Subq(X11,X9) => (equip(X11,ordsucc(n)) => (c_5FC(X11) = X10)))))))))).
fof(c_HX_27X,axiom,c_Subq(c_5FX_5F27,c_5FX)).
fof(c_HX_27,axiom,infinite(c_5FX_5F27)).
fof(c_H2_27,axiom,~ (? [X9] : (c_Subq(X9,c_5FX_5F27) & (? [X10] : (c_In(X10,c_5FX_5F27) & ((nIn(X10,X9) & infinite(X9)) & (! [X11] : (c_Subq(X11,X9) => (equip(X11,n) => (c_5FC(binunion(X11,c_Sing(c_X10))) = c)))))))))).
fof(c_L1a,axiom,(? [X9] : c_In(X9,c_5FX_5F27))).
fof(c_Hx,axiom,c_In(x,c_5FX_5F27)).
fof(c_LX_27xinf,axiom,infinite(setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_L1b,axiom,(! [X9] : (c_Subq(X9,c_5FX_5F27) => (infinite(X9) => (? [X10] : (c_Subq(X10,X9) & (? [X11] : (c_In(X11,X9) & ((nIn(X11,X10) & infinite(X10)) & (! [X12] : (c_Subq(X12,X10) => (equip(X12,n) => c_In(c_5FC(binunion(X12,c_Sing(c_X11))),c))))))))))))).
fof(c_H,axiom,((! [X9] : (nat_5Fp(X9) => (c_Subq(f_5F27(X9),c_5FX_5F27) & infinite(f_5F27(X9))))) & (! [X9] : (c_In(X9,omega) => (! [X10] : (c_In(X10,omega) => (c_Subq(X9,X10) => c_Subq(f_5F27(X10),f_5F27(c_X9))))))))).
fof(c_Hf_271,axiom,(! [X9] : (nat_5Fp(X9) => (c_Subq(f_5F27(X9),c_5FX_5F27) & infinite(f_5F27(X9)))))).
fof(c_Hgf_27mm_27Subq,axiom,(! [X9] : (c_In(X9,omega) => (! [X10] : (c_In(X10,omega) => (c_Subq(X9,X10) => c_Subq(f_5F27(X10),f_5F27(c_X9)))))))).
fof(c_HYSn,axiom,equip(c_5FY,ordsucc(n))).
fof(c_H,axiom,((! [X9] : (c_In(X9,ordsucc(n)) => c_In(h(X9),c_5FY))) & (! [X9] : (c_In(X9,ordsucc(n)) => (! [X10] : (c_In(X10,ordsucc(n)) => ((h(c_X9) = h(X10)) => (X9 = X10)))))))).
fof(c__5F,axiom,(! [X9] : (c_In(X9,c_5FY) => (? [X10] : (c_In(X10,ordsucc(n)) & (h(X10) = X9)))))).
fof(c_Hh1,axiom,(! [X9] : (c_In(X9,ordsucc(n)) => c_In(h(X9),c_5FY)))).
fof(c__5F,axiom,(! [X9] : (c_In(X9,ordsucc(n)) => (! [X10] : (c_In(X10,ordsucc(n)) => ((h(c_X9) = h(X10)) => (X9 = X10))))))).
fof(conj_hammer_test_2492,conjecture,c_In(h(n),c_5FY)).
