...
fof(c_H1,axiom,(! [X8] : (c_Subq(X8,c_5FX) => (equip(X8,ordsucc(n)) => c_In(c_5FC(X8),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X8] : (c_Subq(X8,c_5FX) & (? [X9] : (c_In(X9,ordsucc(c)) & (infinite(X8) & (! [X10] : (c_Subq(X10,X8) => (equip(X10,ordsucc(n)) => (c_5FC(X10) = X9)))))))))).
fof(c_HX_27X,axiom,c_Subq(c_5FX_5F27,c_5FX)).
fof(c_HX_27,axiom,infinite(c_5FX_5F27)).
fof(c_H2_27,axiom,~ (? [X8] : (c_Subq(X8,c_5FX_5F27) & (? [X9] : (c_In(X9,c_5FX_5F27) & ((nIn(X9,X8) & infinite(X8)) & (! [X10] : (c_Subq(X10,X8) => (equip(X10,n) => (c_5FC(binunion(X10,c_Sing(c_X9))) = c)))))))))).
fof(c_L1a,axiom,(? [X8] : c_In(X8,c_5FX_5F27))).
fof(c_Hx,axiom,c_In(x,c_5FX_5F27)).
fof(c_LX_27xinf,axiom,infinite(setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H3,axiom,~ (! [X8] : (c_Subq(X8,c_5FX_5F27) => (infinite(X8) => (? [X9] : (c_Subq(X9,X8) & (? [X10] : (c_In(X10,X8) & ((nIn(X10,X9) & infinite(X9)) & (! [X11] : (c_Subq(X11,X9) => (equip(X11,n) => c_In(c_5FC(binunion(X11,c_Sing(c_X10))),c))))))))))))).
fof(c_HH_27X_27,axiom,c_Subq(c_5FH_5F27,setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H,axiom,(? [X8] : (c_In(X8,ordsucc(c)) & (infinite(c_5FH_5F27) & (! [X9] : (c_Subq(X9,c_5FH_5F27) => (equip(X9,n) => (c_5FC(binunion(X9,c_Sing(x))) = X8)))))))).
fof(c_Hi,axiom,c_In(i,ordsucc(c))).
fof(c_H,axiom,(infinite(c_5FH_5F27) & (! [X8] : (c_Subq(X8,c_5FH_5F27) => (equip(X8,n) => (c_5FC(binunion(X8,c_Sing(x))) = i)))))).
fof(c_HH_27inf,axiom,infinite(c_5FH_5F27)).
fof(c_HH_27hom,axiom,(! [X8] : (c_Subq(X8,c_5FH_5F27) => (equip(X8,n) => (c_5FC(binunion(X8,c_Sing(x))) = i))))).
fof(conj_hammer_test_2397,conjecture,((i = c) => $false)).
