...
fof(conj_hammer_test_9678,conjecture,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X8,y),X7) = mul_5FSNo(X8,mul_5FSNo(y,X7)))))))).
