...
fof(conj_hammer_test_7885,conjecture,c_SNoLt(add_5FSNo(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,v)),add_5FSNo(mul_5FSNo(w,z),mul_5FSNo(w,z))),add_5FSNo(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(u,z)),add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,z))))).
