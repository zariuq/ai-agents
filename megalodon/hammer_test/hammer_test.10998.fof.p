...
fof(c_L1,axiom,(r = add_5FSNo(mul_5FSNo(add_5FSNo(ordsucc(c_Empty),minus_5FSNo(mul_5FSNo(q,m))),a),mul_5FSNo(minus_5FSNo(mul_5FSNo(q,n)),b)))).
fof(conj_hammer_test_10998,conjecture,divides_5Fint(d,a)).
