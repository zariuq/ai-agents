...
fof(conj_hammer_test_7682,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => c_SNo(add_5FSNo(mul_5FSNo(X2,X1),add_5FSNo(mul_5FSNo(X0,X3),minus_5FSNo(mul_5FSNo(X2,X3)))))))))))))).
