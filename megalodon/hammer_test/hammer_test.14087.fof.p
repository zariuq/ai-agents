...
fof(c_L1g,axiom,c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(add_5FSNo(k,k_5F27)))).
fof(conj_hammer_test_14087,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(eps_5F(k),eps_5F(k_5F27)),mul_5FSNo(x,y)),add_5FSNo(mul_5FSNo(add_5FSNo(v,minus_5FSNo(x)),add_5FSNo(y,minus_5FSNo(w))),mul_5FSNo(x,y)))).
