...
fof(c_H1,axiom,(! [X10] : (c_Subq(X10,c_5FX) => (equip(X10,ordsucc(n)) => c_In(c_5FC(X10),ordsucc(c)))))).
fof(c_H2,axiom,~ (? [X10] : (c_Subq(X10,c_5FX) & (? [X11] : (c_In(X11,ordsucc(c)) & (infinite(X10) & (! [X12] : (c_Subq(X12,X10) => (equip(X12,ordsucc(n)) => (c_5FC(X12) = X11)))))))))).
fof(c_HX_27X,axiom,c_Subq(c_5FX_5F27,c_5FX)).
fof(c_HX_27,axiom,infinite(c_5FX_5F27)).
fof(c_H2_27,axiom,~ (? [X10] : (c_Subq(X10,c_5FX_5F27) & (? [X11] : (c_In(X11,c_5FX_5F27) & ((nIn(X11,X10) & infinite(X10)) & (! [X12] : (c_Subq(X12,X10) => (equip(X12,n) => (c_5FC(binunion(X12,c_Sing(c_X11))) = c)))))))))).
fof(c_L1a,axiom,(? [X10] : c_In(X10,c_5FX_5F27))).
fof(c_Hx,axiom,c_In(x,c_5FX_5F27)).
fof(c_LX_27xinf,axiom,infinite(setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H3,axiom,~ (! [X10] : (c_Subq(X10,c_5FX_5F27) => (infinite(X10) => (? [X11] : (c_Subq(X11,X10) & (? [X12] : (c_In(X12,X10) & ((nIn(X12,X11) & infinite(X11)) & (! [X13] : (c_Subq(X13,X11) => (equip(X13,n) => c_In(c_5FC(binunion(X13,c_Sing(c_X12))),c))))))))))))).
fof(c_HH_27X_27,axiom,c_Subq(c_5FH_5F27,setminus(c_5FX_5F27,c_Sing(x)))).
fof(c_H,axiom,(? [X10] : (c_In(X10,ordsucc(c)) & (infinite(c_5FH_5F27) & (! [X11] : (c_Subq(X11,c_5FH_5F27) => (equip(X11,n) => (c_5FC(binunion(X11,c_Sing(x))) = X10)))))))).
fof(c_Hi,axiom,c_In(i,ordsucc(c))).
fof(c_H,axiom,(infinite(c_5FH_5F27) & (! [X10] : (c_Subq(X10,c_5FH_5F27) => (equip(X10,n) => (c_5FC(binunion(X10,c_Sing(x))) = i)))))).
fof(c_HH_27inf,axiom,infinite(c_5FH_5F27)).
fof(c_HH_27hom,axiom,(! [X10] : (c_Subq(X10,c_5FH_5F27) => (equip(X10,n) => (c_5FC(binunion(X10,c_Sing(x))) = i))))).
fof(c_H4,axiom,c_In(i,c)).
fof(c_HZX_27,axiom,c_Subq(c_5FZ,c_5FX_5F27)).
fof(c_HZ,axiom,infinite(c_5FZ)).
fof(c_H5,axiom,~ (? [X10] : (c_Subq(X10,c_5FZ) & (? [X11] : (c_In(X11,c_5FZ) & ((nIn(X11,X10) & infinite(X10)) & (! [X12] : (c_Subq(X12,X10) => (equip(X12,n) => c_In(c_5FC(binunion(X12,c_Sing(c_X11))),c)))))))))).
fof(c_L1b1,axiom,(? [X10] : c_In(X10,c_5FZ))).
...
fof(conj_hammer_test_2391,conjecture,c_Subq(setminus(c_5FZ,c_Sing(y)),c_5FX)).
