...
fof(c__5F,axiom,ordinal(alpha)).
fof(c_Hb1,axiom,ordinal(beta)).
fof(c_IH,axiom,(! [X6] : (c_In(X6,beta) => (c_In(X6,alpha) => (p(X6) <=> q(X6)))))).
fof(c_Hb2,axiom,c_In(beta,alpha)).
fof(conj_hammer_test_3968,conjecture,(p(beta) <=> q(beta))).
