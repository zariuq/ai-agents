...
fof(c_H1,axiom,(! [X1] : (! [X2] : (! [X3] : (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X1))) => c_5FP(X4,X2,X3))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X2))) => c_5FP(c_X1,X4,X3))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(c_X1,X2,X4))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X1))) => (! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(X2))) => c_5FP(X4,X5,X3))))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X1))) => (! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(X4,c_X2,X5))))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X2))) => (! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(c_X1,X4,X5))))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X1))) => (! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(X2))) => (! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(X4,X5,X6))))))) => c_5FP(X1,X2,X3))))))))))))))).
fof(c_L1,axiom,(! [X1] : (ordinal(X1) => (! [X2] : (ordinal(X2) => (! [X3] : (ordinal(X3) => (! [X4] : (c_In(X4,c_SNoS_5F(X1)) => (! [X5] : (c_In(X5,c_SNoS_5F(X2)) => (! [X6] : (c_In(X6,c_SNoS_5F(X3)) => c_5FP(X4,X5,X6)))))))))))))).
fof(conj_hammer_test_5469,conjecture,(! [X1] : (! [X2] : (! [X3] : (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => c_5FP(X1,X2,X3)))))))).
