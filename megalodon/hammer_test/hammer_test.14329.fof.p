...
fof(c_Hw,axiom,c_In(w,c_5FL)).
fof(c_Hw0,axiom,c_In(w0,c_SNoL(x))).
fof(c_Hw1,axiom,c_In(w1,c_SNoL(y))).
fof(c_Hwe,axiom,(w = add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(w0,w1)))))).
...
fof(c_LhLk0k1,axiom,c_SNo(ap(hL,add_5FSNo(k0,k1)))).
fof(c_Lw0y,axiom,c_SNo(mul_5FSNo(w0,y))).
fof(c_Lxw1,axiom,c_SNo(mul_5FSNo(x,w1))).
fof(c_Lw0w1,axiom,c_SNo(mul_5FSNo(w0,w1))).
fof(c_Lmw0w1,axiom,c_SNo(minus_5FSNo(mul_5FSNo(w0,w1)))).
fof(c_Lw0yxw1mw0w1,axiom,c_SNo(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(w0,w1)))))).
fof(c_H1,axiom,c_SNoLt(ap(hL,add_5FSNo(k0,k1)),add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(w0,w1)))))).
fof(conj_hammer_test_14329,conjecture,c_SNoLt(add_5FSNo(ap(hL,add_5FSNo(k0,k1)),eps_5F(add_5FSNo(k0,k1))),add_5FSNo(add_5FSNo(mul_5FSNo(w0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(w0,w1)))),eps_5F(add_5FSNo(k0,k1))))).
