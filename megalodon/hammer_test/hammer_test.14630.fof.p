...
fof(c_Hz0,axiom,c_In(z0,c_SNoR(x))).
fof(c_Hw1,axiom,c_In(w1,c_SNoL(y))).
fof(c_Hze,axiom,(z = add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(z0,w1)))))).
fof(c_Hk0,axiom,c_In(k0,omega)).
fof(c_Hk0b,axiom,c_SNoLe(eps_5F(k0),add_5FSNo(z0,minus_5FSNo(x)))).
fof(c_Hk1,axiom,c_In(k1,omega)).
fof(c_Hk1b,axiom,c_SNoLe(eps_5F(k1),add_5FSNo(y,minus_5FSNo(w1)))).
fof(c_Hz01,axiom,c_SNo(z0)).
fof(c_Hz02,axiom,c_In(c_SNoLev(z0),c_SNoLev(x))).
fof(c_Hz03,axiom,c_SNoLt(x,z0)).
fof(c_Hw11,axiom,c_SNo(w1)).
fof(c_Hw12,axiom,c_In(c_SNoLev(w1),c_SNoLev(y))).
fof(c_Hw13,axiom,c_SNoLt(w1,y)).
...
fof(c_Lz0y,axiom,c_SNo(mul_5FSNo(z0,y))).
fof(c_Lxw1,axiom,c_SNo(mul_5FSNo(x,w1))).
fof(c_Lz0w1,axiom,c_SNo(mul_5FSNo(z0,w1))).
fof(c_Lmz0w1,axiom,c_SNo(minus_5FSNo(mul_5FSNo(z0,w1)))).
fof(c_Lz0yxw1mz0w1,axiom,c_SNo(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(z0,w1)))))).
fof(c_H1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(z0,w1)))),ap(hR,add_5FSNo(k0,k1)))).
fof(conj_hammer_test_14630,conjecture,c_SNoLt(add_5FSNo(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(z0,w1)))),minus_5FSNo(eps_5F(add_5FSNo(k0,k1)))),add_5FSNo(ap(hR,add_5FSNo(k0,k1)),minus_5FSNo(eps_5F(add_5FSNo(k0,k1)))))).
