...
fof(c_Lu1v1lt,axiom,c_SNoLt(u1,v1)).
fof(c_L3,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(X11,v1)),add_5FSNo(mul_5FSNo(X11,u1),mul_5FSNo(x,v1)))))).
...
fof(c_L6,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(v0,u1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(z,u1)))).
fof(c_L7,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(z,u1)),add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(u0,u1)))).
fof(c_Lz,axiom,c_In(z,c_SNoL(x))).
fof(conj_hammer_test_7386,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
