...
fof(conj_hammer_test_13962,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(eps_5F(k),eps_5F(k_5F27)),q),add_5FSNo(mul_5FSNo(add_5FSNo(v,minus_5FSNo(x)),add_5FSNo(w,minus_5FSNo(y))),q))).
