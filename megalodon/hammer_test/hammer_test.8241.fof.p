...
fof(c_IHx,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(X6,y) = mul_5FSNo(y,X6))))).
fof(c_IHy,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(x,X6) = mul_5FSNo(X6,x))))).
fof(c_IHxy,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(x))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(X6,X7) = mul_5FSNo(X7,X6))))))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X6,y),add_5FSNo(mul_5FSNo(x,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X6,y),add_5FSNo(mul_5FSNo(x,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X6,y),add_5FSNo(mul_5FSNo(x,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X6,y),add_5FSNo(mul_5FSNo(x,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FR)))))).
fof(c_Hxye,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_HL_27R_27,axiom,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
fof(c_HL_27I1,axiom,(! [X6] : (c_In(X6,c_SNoL(y)) => (! [X7] : (c_In(X7,c_SNoL(x)) => c_In(add_5FSNo(mul_5FSNo(X6,x),add_5FSNo(mul_5FSNo(y,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FL_5F27)))))).
fof(c_HL_27I2,axiom,(! [X6] : (c_In(X6,c_SNoR(y)) => (! [X7] : (c_In(X7,c_SNoR(x)) => c_In(add_5FSNo(mul_5FSNo(X6,x),add_5FSNo(mul_5FSNo(y,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FL_5F27)))))).
fof(c_HR_27I1,axiom,(! [X6] : (c_In(X6,c_SNoL(y)) => (! [X7] : (c_In(X7,c_SNoR(x)) => c_In(add_5FSNo(mul_5FSNo(X6,x),add_5FSNo(mul_5FSNo(y,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FR_5F27)))))).
fof(c_HR_27I2,axiom,(! [X6] : (c_In(X6,c_SNoR(y)) => (! [X7] : (c_In(X7,c_SNoL(x)) => c_In(add_5FSNo(mul_5FSNo(X6,x),add_5FSNo(mul_5FSNo(y,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FR_5F27)))))).
fof(c_Hyxe,axiom,(mul_5FSNo(y,x) = c_SNoCut(c_5FL_5F27,c_5FR_5F27))).
fof(c_LLL_27,axiom,(c_5FL = c_5FL_5F27)).
fof(conj_hammer_test_8241,conjecture,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X6,y),add_5FSNo(mul_5FSNo(x,X7),minus_5FSNo(mul_5FSNo(X6,X7)))),c_5FR_5F27)))))).
