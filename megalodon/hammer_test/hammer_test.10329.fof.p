...
fof(c_HLRx,axiom,c_SNoCutP(c_5FLx,c_5FRx)).
fof(c_HLRy,axiom,c_SNoCutP(c_5FLy,c_5FRy)).
fof(c_Hxe,axiom,(x = c_SNoCut(c_5FLx,c_5FRx))).
fof(c_Hye,axiom,(y = c_SNoCut(c_5FLy,c_5FRy))).
fof(c_H,axiom,((! [X13] : (c_In(X13,c_5FLx) => c_SNo(X13))) & (! [X13] : (c_In(X13,c_5FRx) => c_SNo(X13))))).
fof(c_HLRx1,axiom,(! [X13] : (c_In(X13,c_5FLx) => c_SNo(X13)))).
fof(c_HLRx2,axiom,(! [X13] : (c_In(X13,c_5FRx) => c_SNo(X13)))).
fof(c_HLRx3,axiom,(! [X13] : (c_In(X13,c_5FLx) => (! [X14] : (c_In(X14,c_5FRx) => c_SNoLt(X13,X14)))))).
fof(c_H,axiom,((! [X13] : (c_In(X13,c_5FLy) => c_SNo(X13))) & (! [X13] : (c_In(X13,c_5FRy) => c_SNo(X13))))).
fof(c_HLRy1,axiom,(! [X13] : (c_In(X13,c_5FLy) => c_SNo(X13)))).
fof(c_HLRy2,axiom,(! [X13] : (c_In(X13,c_5FRy) => c_SNo(X13)))).
fof(c_HLRy3,axiom,(! [X13] : (c_In(X13,c_5FLy) => (! [X14] : (c_In(X14,c_5FRy) => c_SNoLt(X13,X14)))))).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx3,axiom,(! [X13] : (c_In(X13,c_5FLx) => c_SNoLt(X13,x)))).
fof(c_Hx4,axiom,(! [X13] : (c_In(X13,c_5FRx) => c_SNoLt(x,X13)))).
fof(c_Hx5,axiom,(! [X13] : (c_SNo(X13) => ((! [X14] : (c_In(X14,c_5FLx) => c_SNoLt(X14,X13))) => ((! [X14] : (c_In(X14,c_5FRx) => c_SNoLt(X13,X14))) => (c_Subq(c_SNoLev(x),c_SNoLev(X13)) & c_SNoEq_5F(c_SNoLev(x),x,X13))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X13] : (c_In(X13,c_5FLy) => c_SNoLt(X13,y)))).
fof(c_Hy4,axiom,(! [X13] : (c_In(X13,c_5FRy) => c_SNoLt(y,X13)))).
fof(c_Hy5,axiom,(! [X13] : (c_SNo(X13) => ((! [X14] : (c_In(X14,c_5FLy) => c_SNoLt(X14,X13))) => ((! [X14] : (c_In(X14,c_5FRy) => c_SNoLt(X13,X14))) => (c_Subq(c_SNoLev(y),c_SNoLev(X13)) & c_SNoEq_5F(c_SNoLev(y),y,X13))))))).
fof(c_HLR_27,axiom,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
fof(c_HL_27I1,axiom,(! [X13] : (c_In(X13,c_SNoL(x)) => (! [X14] : (c_In(X14,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X13,y),add_5FSNo(mul_5FSNo(x,X14),minus_5FSNo(mul_5FSNo(X13,X14)))),c_5FL_5F27)))))).
fof(c_HL_27I2,axiom,(! [X13] : (c_In(X13,c_SNoR(x)) => (! [X14] : (c_In(X14,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X13,y),add_5FSNo(mul_5FSNo(x,X14),minus_5FSNo(mul_5FSNo(X13,X14)))),c_5FL_5F27)))))).
fof(c_HR_27I1,axiom,(! [X13] : (c_In(X13,c_SNoL(x)) => (! [X14] : (c_In(X14,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X13,y),add_5FSNo(mul_5FSNo(x,X14),minus_5FSNo(mul_5FSNo(X13,X14)))),c_5FR_5F27)))))).
fof(c_HR_27I2,axiom,(! [X13] : (c_In(X13,c_SNoR(x)) => (! [X14] : (c_In(X14,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X13,y),add_5FSNo(mul_5FSNo(x,X14),minus_5FSNo(mul_5FSNo(X13,X14)))),c_5FR_5F27)))))).
fof(c_HLR_27eq,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL_5F27,c_5FR_5F27))).
fof(c_Hz,axiom,c_In(z,c_5FR_5F27)).
...
fof(c_Hw0a,axiom,c_SNo(w0)).
fof(c_Hw0b,axiom,c_In(c_SNoLev(w0),c_SNoLev(x))).
fof(c_Hw0c,axiom,c_SNoLt(w0,x)).
fof(c_Hz1a,axiom,c_SNo(z1)).
fof(c_Hz1b,axiom,c_In(c_SNoLev(z1),c_SNoLev(y))).
fof(c_Hz1c,axiom,c_SNoLt(y,z1)).
fof(c_L6,axiom,(? [X13] : (c_In(X13,c_5FLx) & c_SNoLe(w0,X13)))).
fof(c_L7,axiom,(? [X13] : (c_In(X13,c_5FRy) & c_SNoLe(X13,z1)))).
fof(c_Hw0_271,axiom,c_In(w0_5F27,c_5FLx)).
fof(c_Hw0_272,axiom,c_SNoLe(w0,w0_5F27)).
fof(c_Hz1_271,axiom,c_In(z1_5F27,c_5FRy)).
fof(c_Hz1_272,axiom,c_SNoLe(z1_5F27,z1)).
fof(conj_hammer_test_10329,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(w0_5F27,y),add_5FSNo(mul_5FSNo(x,z1_5F27),mul_5FSNo(w0,z1))),add_5FSNo(mul_5FSNo(x,z1_5F27),add_5FSNo(mul_5FSNo(w0_5F27,z1),mul_5FSNo(w0,y))))).
