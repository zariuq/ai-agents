...
fof(c_Hv,axiom,c_In(v,c_SNoR(add_5FSNo(x,y)))).
...
fof(c_Hv3,axiom,c_SNoLt(add_5FSNo(x,y),v)).
...
fof(c_H1,axiom,(? [X9] : (c_In(X9,c_SNoR(y)) & c_SNoLe(add_5FSNo(x,X9),v)))).
fof(c_Hu,axiom,c_In(u,c_SNoR(y))).
fof(c_Hvu,axiom,c_SNoLe(add_5FSNo(x,u),v)).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(y))).
fof(c_Hu3,axiom,c_SNoLt(y,u)).
fof(c_Luw,axiom,c_SNo(mul_5FSNo(u,w))).
fof(c_Luz,axiom,c_SNo(mul_5FSNo(u,z))).
fof(c_Lxu,axiom,c_SNo(add_5FSNo(x,u))).
fof(conj_hammer_test_8844,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(y,z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(u,w)))),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(u,z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(y,w)))))).
