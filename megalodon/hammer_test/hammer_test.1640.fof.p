...
fof(c_Hmn,axiom,c_Subq(m,n)).
fof(conj_hammer_test_1640,conjecture,(! [X2] : (nat_5Fp(X2) => (c_Subq(mul_5Fnat(m,X2),mul_5Fnat(n,X2)) => c_Subq(mul_5Fnat(m,ordsucc(X2)),mul_5Fnat(n,ordsucc(X2))))))).
