...
fof(c_H1,axiom,c_SNoLt(add_5FSNo(x,a),add_5FSNo(w,v))).
fof(c_H2,axiom,c_SNoLt(y,add_5FSNo(a,u))).
fof(conj_hammer_test_6909,conjecture,c_SNoLt(add_5FSNo(y,x),add_5FSNo(u,add_5FSNo(v,w)))).
