...
fof(c_H2,axiom,(! [X1] : (nat_5Fp(X1) => (p(X1) => p(ordsucc(X1)))))).
fof(c_L1,axiom,(nat_5Fp(c_Empty) & p(c_Empty))).
fof(c_L2,axiom,(! [X1] : ((nat_5Fp(X1) & p(X1)) => (nat_5Fp(ordsucc(X1)) & p(ordsucc(X1)))))).
fof(conj_hammer_test_757,conjecture,(! [X1] : (nat_5Fp(X1) => p(X1)))).
