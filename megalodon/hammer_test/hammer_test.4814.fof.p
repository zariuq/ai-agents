...
fof(c__5F,axiom,(! [X3] : (c_In(X3,alpha) => c_TransSet(X3)))).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_Hz2,axiom,c_In(c_SNoLev(z),ordsucc(alpha))).
fof(c_La1,axiom,c_SNo(alpha)).
fof(c_La2,axiom,(c_SNoLev(alpha) = alpha)).
fof(c_Hz3,axiom,(c_SNoLev(z) = alpha)).
fof(c_H1,axiom,~ c_SNoLe(z,alpha)).
fof(c_Hb,axiom,ordinal(beta)).
fof(conj_hammer_test_4814,conjecture,((! [X3] : (c_In(X3,beta) => (c_In(X3,alpha) => c_In(X3,z)))) => (c_In(beta,alpha) => c_In(beta,z)))).
