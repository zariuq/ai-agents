...
fof(c_IHx,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(X7,mul_5FSNo(y,z)) = mul_5FSNo(mul_5FSNo(X7,y),z))))).
fof(c_IHy,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(x,mul_5FSNo(X7,z)) = mul_5FSNo(mul_5FSNo(x,X7),z))))).
fof(c_IHz,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(x,mul_5FSNo(y,X7)) = mul_5FSNo(mul_5FSNo(x,y),X7))))).
fof(c_IHxy,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(x))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(X7,mul_5FSNo(X8,z)) = mul_5FSNo(mul_5FSNo(X7,X8),z))))))).
fof(c_IHxz,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(x))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(X7,mul_5FSNo(y,X8)) = mul_5FSNo(mul_5FSNo(X7,y),X8))))))).
fof(c_IHyz,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(x,mul_5FSNo(X7,X8)) = mul_5FSNo(mul_5FSNo(x,X7),X8))))))).
fof(c_IHxyz,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(x))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(X7,mul_5FSNo(X8,X9)) = mul_5FSNo(mul_5FSNo(X7,X8),X9))))))))).
fof(c_Lxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Lyz,axiom,c_SNo(mul_5FSNo(y,z))).
fof(c_Lxyz1,axiom,c_SNo(mul_5FSNo(x,mul_5FSNo(y,z)))).
fof(c_Lxyz2,axiom,c_SNo(mul_5FSNo(mul_5FSNo(x,y),z))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => (! [X8] : (c_In(X8,c_SNoL(mul_5FSNo(y,z))) => c_In(add_5FSNo(mul_5FSNo(X7,mul_5FSNo(y,z)),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => (! [X8] : (c_In(X8,c_SNoR(mul_5FSNo(y,z))) => c_In(add_5FSNo(mul_5FSNo(X7,mul_5FSNo(y,z)),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X7] : (c_In(X7,c_SNoL(x)) => (! [X8] : (c_In(X8,c_SNoR(mul_5FSNo(y,z))) => c_In(add_5FSNo(mul_5FSNo(X7,mul_5FSNo(y,z)),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X7] : (c_In(X7,c_SNoR(x)) => (! [X8] : (c_In(X8,c_SNoL(mul_5FSNo(y,z))) => c_In(add_5FSNo(mul_5FSNo(X7,mul_5FSNo(y,z)),add_5FSNo(mul_5FSNo(x,X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FR)))))).
fof(c_HE,axiom,(mul_5FSNo(x,mul_5FSNo(y,z)) = c_SNoCut(c_5FL,c_5FR))).
fof(c_HLR_27,axiom,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
fof(c_HLI1_27,axiom,(! [X7] : (c_In(X7,c_SNoL(mul_5FSNo(x,y))) => (! [X8] : (c_In(X8,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X7,z),add_5FSNo(mul_5FSNo(mul_5FSNo(x,y),X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FL_5F27)))))).
fof(c_HLI2_27,axiom,(! [X7] : (c_In(X7,c_SNoR(mul_5FSNo(x,y))) => (! [X8] : (c_In(X8,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X7,z),add_5FSNo(mul_5FSNo(mul_5FSNo(x,y),X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FL_5F27)))))).
fof(c_HRI1_27,axiom,(! [X7] : (c_In(X7,c_SNoL(mul_5FSNo(x,y))) => (! [X8] : (c_In(X8,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X7,z),add_5FSNo(mul_5FSNo(mul_5FSNo(x,y),X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FR_5F27)))))).
fof(c_HRI2_27,axiom,(! [X7] : (c_In(X7,c_SNoR(mul_5FSNo(x,y))) => (! [X8] : (c_In(X8,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X7,z),add_5FSNo(mul_5FSNo(mul_5FSNo(x,y),X8),minus_5FSNo(mul_5FSNo(X7,X8)))),c_5FR_5F27)))))).
fof(c_HE_27,axiom,(mul_5FSNo(mul_5FSNo(x,y),z) = c_SNoCut(c_5FL_5F27,c_5FR_5F27))).
fof(c_LMLt_27,axiom,(! [X7] : (! [X8] : (! [X9] : (! [X10] : (c_SNo(X7) => (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_SNoLt(X9,X7) => (c_SNoLt(X10,X8) => c_SNoLt(add_5FSNo(mul_5FSNo(X8,X9),mul_5FSNo(X10,X7)),add_5FSNo(mul_5FSNo(X8,X7),mul_5FSNo(X10,X9)))))))))))))).
fof(c_LMLe_27,axiom,(! [X7] : (! [X8] : (! [X9] : (! [X10] : (c_SNo(X7) => (c_SNo(X8) => (c_SNo(X9) => (c_SNo(X10) => (c_SNoLe(X9,X7) => (c_SNoLe(X10,X8) => c_SNoLe(add_5FSNo(mul_5FSNo(X8,X9),mul_5FSNo(X10,X7)),add_5FSNo(mul_5FSNo(X8,X7),mul_5FSNo(X10,X9)))))))))))))).
fof(c_LIHx_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X7,y),z) = mul_5FSNo(X7,mul_5FSNo(y,z)))))).
fof(c_LIHy_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(mul_5FSNo(x,X7),z) = mul_5FSNo(x,mul_5FSNo(X7,z)))))).
fof(c_LIHz_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(mul_5FSNo(x,y),X7) = mul_5FSNo(x,mul_5FSNo(y,X7)))))).
fof(c_LIHyx_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X8,X7),z) = mul_5FSNo(X8,mul_5FSNo(X7,z)))))))).
fof(c_LIHzx_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X8,y),X7) = mul_5FSNo(X8,mul_5FSNo(y,X7)))))))).
fof(c_LIHzy_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(mul_5FSNo(x,X8),X7) = mul_5FSNo(x,mul_5FSNo(X8,X7)))))))).
fof(c_LIHzyx_27,axiom,(! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(mul_5FSNo(X9,X8),X7) = mul_5FSNo(X9,mul_5FSNo(X8,X7)))))))))).
fof(conj_hammer_test_9685,conjecture,c_SNoCutP(c_5FL_5F27,c_5FR_5F27)).
