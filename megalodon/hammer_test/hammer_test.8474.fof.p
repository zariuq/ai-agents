...
fof(c_IHx,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(add_5FSNo(X9,y),z) = add_5FSNo(mul_5FSNo(X9,z),mul_5FSNo(y,z)))))).
fof(c_IHy,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(add_5FSNo(x,X9),z) = add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(X9,z)))))).
fof(c_IHz,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(x,y),X9) = add_5FSNo(mul_5FSNo(x,X9),mul_5FSNo(y,X9)))))).
fof(c_IHxy,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(x))) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(add_5FSNo(X9,X10),z) = add_5FSNo(mul_5FSNo(X9,z),mul_5FSNo(X10,z)))))))).
fof(c_IHxz,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(x))) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(X9,y),X10) = add_5FSNo(mul_5FSNo(X9,X10),mul_5FSNo(y,X10)))))))).
fof(c_IHyz,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(x,X9),X10) = add_5FSNo(mul_5FSNo(x,X10),mul_5FSNo(X9,X10)))))))).
fof(c_IHxyz,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(x))) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(y))) => (! [X11] : (c_In(X11,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(X9,X10),X11) = add_5FSNo(mul_5FSNo(X9,X11),mul_5FSNo(X10,X11)))))))))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X9] : (c_In(X9,c_SNoL(add_5FSNo(x,y))) => (! [X10] : (c_In(X10,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X9,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X9] : (c_In(X9,c_SNoR(add_5FSNo(x,y))) => (! [X10] : (c_In(X10,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X9,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X9] : (c_In(X9,c_SNoL(add_5FSNo(x,y))) => (! [X10] : (c_In(X10,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X9,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X9] : (c_In(X9,c_SNoR(add_5FSNo(x,y))) => (! [X10] : (c_In(X10,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X9,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FR)))))).
fof(c_HE,axiom,(mul_5FSNo(add_5FSNo(x,y),z) = c_SNoCut(c_5FL,c_5FR))).
fof(c_Lxy,axiom,c_SNo(add_5FSNo(x,y))).
fof(c_Lxyz,axiom,c_SNo(mul_5FSNo(add_5FSNo(x,y),z))).
fof(c_Lxz,axiom,c_SNo(mul_5FSNo(x,z))).
fof(c_Lyz,axiom,c_SNo(mul_5FSNo(y,z))).
fof(c_Lxzyz,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(y,z)))).
fof(c_Hu,axiom,c_In(u,c_5FL)).
fof(c_Hv,axiom,c_In(v,c_SNoL(add_5FSNo(x,y)))).
fof(c_Hw,axiom,c_In(w,c_SNoL(z))).
fof(c_Hue,axiom,(u = add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),w),minus_5FSNo(mul_5FSNo(v,w)))))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c_Hv2,axiom,c_In(c_SNoLev(v),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hv3,axiom,c_SNoLt(v,add_5FSNo(x,y))).
fof(c_Hw1,axiom,c_SNo(w)).
fof(c_Hw2,axiom,c_In(c_SNoLev(w),c_SNoLev(z))).
fof(c_Hw3,axiom,c_SNoLt(w,z)).
fof(c_Lxw,axiom,c_SNo(mul_5FSNo(x,w))).
fof(c_Lyw,axiom,c_SNo(mul_5FSNo(y,w))).
fof(c_Lvz,axiom,c_SNo(mul_5FSNo(v,z))).
fof(c_Lxyw,axiom,c_SNo(mul_5FSNo(add_5FSNo(x,y),w))).
fof(c_Lxwyw,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(y,w)))).
fof(c_Lvw,axiom,c_SNo(mul_5FSNo(v,w))).
fof(c_Lvzxwyw,axiom,c_SNo(add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(y,w))))).
fof(c_Lxzyzvw,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(y,z),mul_5FSNo(v,w))))).
fof(c_H1,axiom,(? [X9] : (c_In(X9,c_SNoL(y)) & c_SNoLe(v,add_5FSNo(x,X9))))).
fof(c_Hu,axiom,c_In(u,c_SNoL(y))).
fof(c_Hvu,axiom,c_SNoLe(v,add_5FSNo(x,u))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(y))).
fof(c_Hu3,axiom,c_SNoLt(u,y)).
fof(c_Luw,axiom,c_SNo(mul_5FSNo(u,w))).
fof(c_Luz,axiom,c_SNo(mul_5FSNo(u,z))).
fof(c_Lxu,axiom,c_SNo(add_5FSNo(x,u))).
fof(conj_hammer_test_8474,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(u,z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(y,w)))),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(y,z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(u,w)))))).
