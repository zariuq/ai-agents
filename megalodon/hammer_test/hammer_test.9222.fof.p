...
fof(c_Hu,axiom,c_In(u,c_SNoR(mul_5FSNo(y,z)))).
...
fof(c_Hu3,axiom,c_SNoLt(mul_5FSNo(y,z),u)).
fof(c_Hv,axiom,c_In(v,c_SNoR(y))).
fof(c_Hw,axiom,c_In(w,c_SNoL(z))).
fof(c_Hvw,axiom,c_SNoLe(add_5FSNo(mul_5FSNo(v,z),mul_5FSNo(y,w)),add_5FSNo(u,mul_5FSNo(v,w)))).
...
fof(conj_hammer_test_9222,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(add_5FSNo(x,y),z),add_5FSNo(mul_5FSNo(v,w),mul_5FSNo(x,w))),add_5FSNo(mul_5FSNo(v,z),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(x,w),mul_5FSNo(y,w)))))).
