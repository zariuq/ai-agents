...
fof(conj_hammer_test_14211,conjecture,c_SNo(mul_5FSNo(mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty))))),mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))))).
