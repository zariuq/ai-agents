...
fof(c_L3,axiom,(! [X10] : (c_In(X10,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,X10)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,X10)))))).
...
fof(conj_hammer_test_7570,conjecture,(c_In(u1,c_SNoL(v1)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
