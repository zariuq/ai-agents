...
fof(c_IHn,axiom,(! [X6] : (equip(X6,n) => equip(c_Power(X6),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
fof(c_H1,axiom,equip(c_5FX,ordsucc(n))).
fof(c_L2nN,axiom,nat_5Fp(exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_L2no,axiom,ordinal(exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_L1,axiom,(? [X6] : c_In(X6,c_5FX))).
fof(c_L2,axiom,equip(setminus(c_5FX,c_Sing(x)),n)).
fof(c_LIH,axiom,equip(c_Power(setminus(c_5FX,c_Sing(x))),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_H,axiom,((! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X6),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)))) & (! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X6) = f(X7)) => (X6 = X7)))))))).
fof(c_Hf1,axiom,(! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => c_In(f(X6),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
fof(c_Hf2,axiom,(! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => (! [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) => ((f(c_X6) = f(X7)) => (X6 = X7))))))).
fof(c_Hf3,axiom,(! [X6] : (c_In(X6,exp_5Fnat(ordsucc(ordsucc(c_Empty)),n)) => (? [X7] : (c_In(X7,c_Power(setminus(c_5FX,c_Sing(x)))) & (f(X7) = X6)))))).
fof(c_LfN,axiom,(! [X6] : (c_In(X6,c_Power(setminus(c_5FX,c_Sing(x)))) => nat_5Fp(f(X6))))).
fof(c_HY,axiom,c_In(c_5FY,c_Power(c_5FX))).
fof(c_HZ,axiom,c_In(c_5FZ,c_Power(c_5FX))).
fof(c_LYx,axiom,c_In(setminus(c_5FY,c_Sing(x)),c_Power(setminus(c_5FX,c_Sing(x))))).
fof(c_LZx,axiom,c_In(setminus(c_5FZ,c_Sing(x)),c_Power(setminus(c_5FX,c_Sing(x))))).
fof(c_LfYx2n,axiom,c_In(f(setminus(c_5FY,c_Sing(x))),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_LfYxN,axiom,nat_5Fp(f(setminus(c_5FY,c_Sing(x))))).
fof(c_LfZx2n,axiom,c_In(f(setminus(c_Z,c_Sing(x))),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
fof(c_LfZxN,axiom,nat_5Fp(f(setminus(c_Z,c_Sing(x))))).
fof(c_H2,axiom,c_In(x,c_5FY)).
fof(c_H3,axiom,nIn(x,c_5FZ)).
fof(conj_hammer_test_1836,conjecture,c_In(c_5FZ,c_Power(setminus(c_5FX,c_Sing(x))))).
