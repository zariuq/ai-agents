...
fof(conj_hammer_test_7671,conjecture,(! [X5] : (c_In(X5,c_SNoL(x)) => (! [X6] : (c_In(X6,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X5,y),mul_5FSNo(x,X6)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X5,X6)))))))).
