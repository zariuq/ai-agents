...
fof(c_IHalpha,axiom,(! [X1] : (c_In(X1,alpha) => (! [X2] : (ordinal(X1) => (ordinal(X2) => ((c_In(X1,X2) | (X1 = X2)) | c_In(X2,X1)))))))).
fof(conj_hammer_test_1173,conjecture,(! [X1] : ((! [X2] : (c_In(X2,X1) => (ordinal(alpha) => (ordinal(X2) => ((c_In(alpha,X2) | (alpha = X2)) | c_In(X2,alpha)))))) => (ordinal(alpha) => (ordinal(X1) => ((c_In(alpha,X1) | (alpha = X1)) | c_In(X1,alpha))))))).
