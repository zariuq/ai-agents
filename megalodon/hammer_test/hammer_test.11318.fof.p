...
fof(c_L2,axiom,(? [X6] : ((ordinal(X6) & (prime_5Fnat(X6) & divides_5Fnat(X6,n))) & (! [X7] : (c_In(X7,X6) => ~ (prime_5Fnat(X7) & divides_5Fnat(X7,n))))))).
...
fof(c_Hpleast,axiom,(! [X6] : (c_In(X6,p) => ~ (prime_5Fnat(X6) & divides_5Fnat(X6,n))))).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c__5F,axiom,(! [X6] : (c_In(X6,omega) => (divides_5Fnat(X6,p) => ((X6 = ordsucc(c_Empty)) | (X6 = p)))))).
fof(c_HpN,axiom,c_In(p,omega)).
fof(c_H1p,axiom,c_In(ordsucc(c_Empty),p)).
fof(c__5F,axiom,(c_In(p,omega) & c_In(n,omega))).
fof(c_H,axiom,(? [X6] : (c_In(X6,omega) & (mul_5Fnat(p,X6) = n)))).
...
fof(c_Lf1,axiom,(! [X6] : (c_In(X6,k) => prime_5Fnat(f(X6))))).
fof(c_Lf2,axiom,(! [X6] : (c_In(X6,k) => c_In(f(X6),omega)))).
fof(c_Hgk,axiom,(g(k) = p)).
fof(c_Hgi,axiom,(! [X6] : (c_In(X6,k) => (g(X6) = f(X6))))).
fof(conj_hammer_test_11318,conjecture,c_In(ordsucc(k),omega)).
