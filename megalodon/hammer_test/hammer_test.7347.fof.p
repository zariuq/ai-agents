...
fof(c_Hz,axiom,c_In(z,c_SNoL(x))).
fof(c_Lzu1,axiom,c_SNo(mul_5FSNo(z,u1))).
fof(c_Lzv1,axiom,c_SNo(mul_5FSNo(z,v1))).
fof(c_Hwv1,axiom,c_In(w,c_SNoL(v1))).
fof(c_Hwu1,axiom,c_In(w,c_SNoR(u1))).
fof(c_Hwu1a,axiom,c_SNo(w)).
fof(c_Hwu1b,axiom,c_In(c_SNoLev(w),c_SNoLev(u1))).
fof(c_Hwu1c,axiom,c_SNoLt(u1,w)).
fof(c_LwSy,axiom,c_In(w,c_SNoS_5F(c_SNoLev(y)))).
fof(conj_hammer_test_7347,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(z,v1)),add_5FSNo(mul_5FSNo(z,u1),mul_5FSNo(x,v1)))).
