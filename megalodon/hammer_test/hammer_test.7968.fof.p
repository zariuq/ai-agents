...
fof(conj_hammer_test_7968,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(x,y),add_5FSNo(mul_5FSNo(u,z),mul_5FSNo(x,v))),add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,v))))).
