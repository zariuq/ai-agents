...
fof(c_Lab1,axiom,c_SNo(add_5FSNo(alpha,beta))).
fof(c_Lab2,axiom,ordinal(c_SNoLev(add_5FSNo(alpha,beta)))).
fof(c_Hy,axiom,c_In(y,c_SNoS_5F(c_SNoLev(add_5FSNo(alpha,beta))))).
fof(c_Hy1,axiom,c_In(c_SNoLev(y),c_SNoLev(add_5FSNo(alpha,beta)))).
fof(c_Hy2,axiom,ordinal(c_SNoLev(y))).
fof(c_Hy3,axiom,c_SNo(y)).
fof(c_Hy4,axiom,c_SNo_5F(c_SNoLev(y),y)).
fof(c_H1,axiom,(c_SNoLt(y,add_5FSNo(alpha,beta)) | (y = add_5FSNo(alpha,beta)))).
fof(conj_hammer_test_6188,conjecture,c_SNoLt(y,add_5FSNo(alpha,beta))).
