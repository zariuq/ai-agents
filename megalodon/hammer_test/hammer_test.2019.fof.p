...
fof(c_H2,axiom,(! [X1] : (! [X2] : (finite(X1) => (nIn(X2,X1) => (p(c_X1) => p(binunion(c_X1,c_Sing(X2))))))))).
fof(c_L1,axiom,(! [X1] : (nat_5Fp(X1) => (! [X2] : (equip(X2,X1) => p(X2)))))).
fof(conj_hammer_test_2019,conjecture,(! [X1] : (finite(X1) => p(X1)))).
