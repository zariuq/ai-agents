...
fof(c_HC,axiom,((! [X3] : (c_In(X3,c_5FL) => c_SNo(X3))) & (! [X3] : (c_In(X3,c_5FR) => c_SNo(X3))))).
fof(c_HL,axiom,(! [X3] : (c_In(X3,c_5FL) => c_SNo(X3)))).
fof(c_HR,axiom,(! [X3] : (c_In(X3,c_5FR) => c_SNo(X3)))).
fof(c_HLR,axiom,(! [X3] : (c_In(X3,c_5FL) => (! [X4] : (c_In(X4,c_5FR) => c_SNoLt(X3,X4)))))).
fof(c_LNoC,axiom,c_SNo(c_SNoCut(c_5FL,c_5FR))).
fof(c_LLC,axiom,ordinal(c_SNoLev(c_SNoCut(c_5FL,c_5FR)))).
fof(c_LL,axiom,(! [X3] : (c_In(X3,c_5FL) => c_SNoLt(X3,c_SNoCut(c_5FL,c_5FR))))).
fof(c_LR,axiom,(! [X3] : (c_In(X3,c_5FR) => c_SNoLt(c_SNoCut(c_5FL,c_5FR),X3)))).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_H10,axiom,(! [X3] : (c_In(X3,c_5FL) => c_SNoLt(X3,z)))).
fof(c_H11,axiom,(! [X3] : (c_In(X3,c_5FR) => c_SNoLt(z,X3)))).
fof(c_LLz,axiom,ordinal(c_SNoLev(z))).
fof(conj_hammer_test_4387,conjecture,$false).
