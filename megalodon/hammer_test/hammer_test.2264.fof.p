...
fof(c_IHn,axiom,(? [X4] : (c_Subq(X4,c_5FX) & equip(X4,n)))).
fof(c_HY,axiom,c_Subq(c_5FY,c_5FX)).
fof(c_HYn,axiom,equip(c_5FY,n)).
fof(c_H,axiom,((! [X4] : (c_In(X4,c_5FY) => c_In(f(X4),n))) & (! [X4] : (c_In(X4,c_5FY) => (! [X5] : (c_In(X5,c_5FY) => ((f(c_X4) = f(X5)) => (X4 = X5)))))))).
fof(c_Hf1,axiom,(! [X4] : (c_In(X4,c_5FY) => c_In(f(X4),n)))).
fof(c_Hf2,axiom,(! [X4] : (c_In(X4,c_5FY) => (! [X5] : (c_In(X5,c_5FY) => ((f(c_X4) = f(X5)) => (X4 = X5))))))).
fof(c_Hf3,axiom,(! [X4] : (c_In(X4,n) => (? [X5] : (c_In(X5,c_5FY) & (f(X5) = X4)))))).
fof(conj_hammer_test_2264,conjecture,(? [X4] : (c_In(X4,c_5FX) & nIn(X4,c_5FY)))).
