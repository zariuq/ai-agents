...
fof(c_H1,axiom,(! [X3] : (! [X4] : (! [X5] : (c_SNo(X3) => (c_SNo(X4) => (c_SNo(X5) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(X6,X4,X5))) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X4))) => c_5FP(c_X3,X6,X5))) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X5))) => c_5FP(c_X3,X4,X6))) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X3))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(X4))) => c_5FP(X6,X7,X5))))) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X3))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(X5))) => c_5FP(X6,c_X4,X7))))) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X4))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(X5))) => c_5FP(c_X3,X6,X7))))) => ((! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(X3))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(X4))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(X5))) => c_5FP(X6,X7,X8))))))) => c_5FP(X3,X4,X5))))))))))))))).
fof(c_Ha,axiom,ordinal(alpha)).
fof(c_IHa,axiom,(! [X3] : (c_In(X3,alpha) => (! [X4] : (ordinal(X4) => (! [X5] : (ordinal(X5) => (! [X6] : (c_In(X6,c_SNoS_5F(X3)) => (! [X7] : (c_In(X7,c_SNoS_5F(X4)) => (! [X8] : (c_In(X8,c_SNoS_5F(X5)) => c_5FP(X6,X7,X8)))))))))))))).
fof(c_Hb,axiom,ordinal(beta)).
fof(c_IHb,axiom,(! [X3] : (c_In(X3,beta) => (! [X4] : (ordinal(X4) => (! [X5] : (c_In(X5,c_SNoS_5F(alpha)) => (! [X6] : (c_In(X6,c_SNoS_5F(X3)) => (! [X7] : (c_In(X7,c_SNoS_5F(X4)) => c_5FP(X5,X6,X7)))))))))))).
fof(conj_hammer_test_5467,conjecture,(! [X3] : (ordinal(X3) => ((! [X4] : (c_In(X4,X3) => (! [X5] : (c_In(X5,c_SNoS_5F(alpha)) => (! [X6] : (c_In(X6,c_SNoS_5F(beta)) => (! [X7] : (c_In(X7,c_SNoS_5F(X4)) => c_5FP(X5,X6,X7))))))))) => (! [X4] : (c_In(X4,c_SNoS_5F(alpha)) => (! [X5] : (c_In(X5,c_SNoS_5F(beta)) => (! [X6] : (c_In(X6,c_SNoS_5F(X3)) => c_5FP(X4,X5,X6))))))))))).
