...
fof(c_H1,axiom,c_SNoLe(add_5FSNo(c_5FM(v,add_5FSNo(c_5FM(w1,z),c_5FM(y,w2))),c_5FM(x,add_5FSNo(w,c_5FM(w1,w2)))),add_5FSNo(c_5FM(x,add_5FSNo(c_5FM(w1,z),c_5FM(y,w2))),c_5FM(v,add_5FSNo(w,c_5FM(w1,w2)))))).
fof(c_H2,axiom,c_SNoLt(add_5FSNo(c_5FM(add_5FSNo(c_5FM(v,y),c_5FM(x,w1)),z),c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(v,w1)),w2)),add_5FSNo(c_5FM(add_5FSNo(c_5FM(x,y),c_5FM(v,w1)),z),c_5FM(add_5FSNo(c_5FM(v,y),c_5FM(x,w1)),w2)))).
...
fof(conj_hammer_test_9360,conjecture,c_SNoLe(add_5FSNo(add_5FSNo(c_5FM(v,c_5FM(y,z)),c_5FM(x,w)),add_5FSNo(c_5FM(v,c_5FM(w1,z)),add_5FSNo(c_5FM(v,c_5FM(y,w2)),c_5FM(x,c_5FM(w1,w2))))),add_5FSNo(c_5FM(v,c_5FM(y,z)),add_5FSNo(c_5FM(x,c_5FM(w1,z)),add_5FSNo(c_5FM(x,c_5FM(y,w2)),add_5FSNo(c_5FM(v,w),c_5FM(v,c_5FM(w1,w2)))))))).
