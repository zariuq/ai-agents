...
fof(c_L2,axiom,(? [X5] : ((ordinal(X5) & (prime_5Fnat(X5) & divides_5Fnat(X5,n))) & (! [X6] : (c_In(X6,X5) => ~ (prime_5Fnat(X6) & divides_5Fnat(X6,n))))))).
...
fof(c_Hpleast,axiom,(! [X5] : (c_In(X5,p) => ~ (prime_5Fnat(X5) & divides_5Fnat(X5,n))))).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c__5F,axiom,(! [X5] : (c_In(X5,omega) => (divides_5Fnat(X5,p) => ((X5 = ordsucc(c_Empty)) | (X5 = p)))))).
fof(c_HpN,axiom,c_In(p,omega)).
fof(c_H1p,axiom,c_In(ordsucc(c_Empty),p)).
fof(c__5F,axiom,(c_In(p,omega) & c_In(n,omega))).
fof(c_H,axiom,(? [X5] : (c_In(X5,omega) & (mul_5Fnat(p,X5) = n)))).
...
fof(c_Lf1,axiom,(! [X5] : (c_In(X5,k) => prime_5Fnat(f(X5))))).
fof(conj_hammer_test_11305,conjecture,(! [X5] : (c_In(X5,k) => c_In(f(X5),omega)))).
