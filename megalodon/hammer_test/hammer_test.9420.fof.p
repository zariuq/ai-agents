...
fof(conj_hammer_test_9420,conjecture,(! [X8] : (c_In(X8,c_SNoR(y)) => (! [X9] : (c_In(X9,c_SNoR(z)) => (c_SNoLe(add_5FSNo(w,c_5FM(X8,X9)),add_5FSNo(c_5FM(X8,z),c_5FM(y,X9))) => c_SNoLt(u,c_5FM(c_5FM(x,y),z)))))))).
