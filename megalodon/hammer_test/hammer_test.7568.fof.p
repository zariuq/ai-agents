...
fof(c_Hzc,axiom,c_SNoLt(u1,z)).
fof(c_Lz,axiom,c_In(z,c_SNoR(y))).
fof(c_L6,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,z)),add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(v0,u1)))).
fof(c_L7,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(v0,z)))).
fof(conj_hammer_test_7568,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1))))).
