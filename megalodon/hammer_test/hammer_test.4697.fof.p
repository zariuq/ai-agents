...
fof(conj_hammer_test_4697,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNoCutP(X0,X1) => (c_SNoCutP(X2,X3) => ((! [X4] : (c_In(X4,X0) => c_SNoLt(X4,c_SNoCut(X2,X3)))) => ((! [X4] : (c_In(X4,X1) => c_SNoLt(c_SNoCut(X2,X3),X4))) => ((! [X4] : (c_In(X4,X2) => c_SNoLt(X4,c_SNoCut(X0,X1)))) => ((! [X4] : (c_In(X4,X3) => c_SNoLt(c_SNoCut(X0,X1),X4))) => (c_SNoCut(X0,X1) = c_SNoCut(X2,X3))))))))))))).
