...
fof(c_Ln1,axiom,nat_5Fp(n)).
fof(c_Ln2,axiom,ordinal(n)).
fof(c_Ln3,axiom,c_SNo(n)).
fof(c_L1,axiom,(! [X1] : (nat_5Fp(X1) => (add_5Fnat(n,X1) = add_5FSNo(n,X1))))).
fof(conj_hammer_test_6281,conjecture,(! [X1] : (c_In(X1,omega) => (add_5Fnat(n,X1) = add_5FSNo(n,X1))))).
