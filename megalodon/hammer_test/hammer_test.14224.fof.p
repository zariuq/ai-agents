...
fof(conj_hammer_test_14224,conjecture,c_SNoLt(mul_5FSNo(mul_5FSNo(eps_5F(c_5FN),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty))))),q_5F27),eps_5F(add_5FSNo(k,ordsucc(ordsucc(c_Empty)))))).
