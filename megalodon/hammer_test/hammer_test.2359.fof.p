...
fof(c_H2_27,axiom,~ (? [X6] : (c_Subq(X6,c_5FX_5F27) & (? [X7] : (c_In(X7,c_5FX_5F27) & ((nIn(X7,X6) & infinite(X6)) & (! [X8] : (c_Subq(X8,X6) => (equip(X8,n) => (c_5FC(binunion(X8,c_Sing(c_X7))) = c)))))))))).
fof(c_L1a,axiom,(? [X6] : c_In(X6,c_5FX_5F27))).
fof(c_Hx,axiom,c_In(x,c_5FX_5F27)).
fof(conj_hammer_test_2359,conjecture,infinite(setminus(c_5FX_5F27,c_Sing(x)))).
