...
fof(c_IHx,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(X3,ordsucc(c_Empty)) = X3)))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (! [X4] : (c_In(X4,c_SNoL(ordsucc(c_Empty))) => c_In(add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),add_5FSNo(mul_5FSNo(x,X4),minus_5FSNo(mul_5FSNo(X3,X4)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X3] : (c_In(X3,c_SNoR(x)) => (! [X4] : (c_In(X4,c_SNoR(ordsucc(c_Empty))) => c_In(add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),add_5FSNo(mul_5FSNo(x,X4),minus_5FSNo(mul_5FSNo(X3,X4)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (! [X4] : (c_In(X4,c_SNoR(ordsucc(c_Empty))) => c_In(add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),add_5FSNo(mul_5FSNo(x,X4),minus_5FSNo(mul_5FSNo(X3,X4)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X3] : (c_In(X3,c_SNoR(x)) => (! [X4] : (c_In(X4,c_SNoL(ordsucc(c_Empty))) => c_In(add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),add_5FSNo(mul_5FSNo(x,X4),minus_5FSNo(mul_5FSNo(X3,X4)))),c_5FR)))))).
fof(c_Hx1e,axiom,(mul_5FSNo(x,ordsucc(c_Empty)) = c_SNoCut(c_5FL,c_5FR))).
fof(c_Hx1,axiom,c_SNo(mul_5FSNo(x,ordsucc(c_Empty)))).
fof(c_Hx11,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (! [X4] : (c_In(X4,c_SNoL(ordsucc(c_Empty))) => c_SNoLt(add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),mul_5FSNo(x,X4)),add_5FSNo(mul_5FSNo(x,ordsucc(c_Empty)),mul_5FSNo(X3,X4)))))))).
fof(c_Hx12,axiom,(! [X3] : (c_In(X3,c_SNoR(x)) => (! [X4] : (c_In(X4,c_SNoR(ordsucc(c_Empty))) => c_SNoLt(add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),mul_5FSNo(x,X4)),add_5FSNo(mul_5FSNo(x,ordsucc(c_Empty)),mul_5FSNo(X3,X4)))))))).
fof(c_Hx13,axiom,(! [X3] : (c_In(X3,c_SNoL(x)) => (! [X4] : (c_In(X4,c_SNoR(ordsucc(c_Empty))) => c_SNoLt(add_5FSNo(mul_5FSNo(x,ordsucc(c_Empty)),mul_5FSNo(X3,X4)),add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),mul_5FSNo(x,X4)))))))).
fof(c_Hx14,axiom,(! [X3] : (c_In(X3,c_SNoR(x)) => (! [X4] : (c_In(X4,c_SNoL(ordsucc(c_Empty))) => c_SNoLt(add_5FSNo(mul_5FSNo(x,ordsucc(c_Empty)),mul_5FSNo(X3,X4)),add_5FSNo(mul_5FSNo(X3,ordsucc(c_Empty)),mul_5FSNo(x,X4)))))))).
fof(c_L0L1,axiom,c_In(c_Empty,c_SNoL(ordsucc(c_Empty)))).
fof(conj_hammer_test_8205,conjecture,(! [X3] : (c_In(X3,c_5FL) => c_SNoLt(X3,c_SNoCut(c_SNoL(x),c_SNoR(x)))))).
