...
fof(conj_hammer_test_5696,conjecture,(c_Subq(c_SNoLev(c_SNoCut(c_5FL,c_5FR)),c_SNoLev(minus_5FSNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR))))) & c_SNoEq_5F(c_SNoLev(c_SNoCut(c_5FL,c_5FR)),c_SNoCut(c_5FL,c_5FR),minus_5FSNo(minus_5FSNo(c_SNoCut(c_5FL,c_5FR)))))).
