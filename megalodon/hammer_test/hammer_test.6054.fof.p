...
fof(conj_hammer_test_6054,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNoLt(X0,X2) => (c_SNoLt(X1,X3) => c_SNoLt(add_5FSNo(X0,X1),add_5FSNo(X2,X3))))))))))))).
