...
fof(c_Hf1,axiom,(! [X5] : (c_Subq(X5,c_5FX) => (infinite(X5) => (c_Subq(f(X5),X5) & infinite(f(X5))))))).
fof(c_Hg1,axiom,(! [X5] : (c_Subq(X5,c_5FX) => (infinite(X5) => (c_In(g(X5),X5) & nIn(g(X5),f(X5))))))).
fof(c_Hf_270,axiom,(f_5F27(c_Empty) = f(c_5FX))).
fof(c_Hf_27S,axiom,(! [X5] : (nat_5Fp(X5) => (f_5F27(ordsucc(X5)) = f(f_5F27(X5)))))).
fof(c_Lf_271,axiom,(! [X5] : (nat_5Fp(X5) => (c_Subq(f_5F27(X5),c_5FX) & infinite(f_5F27(X5)))))).
fof(c_Hm,axiom,c_In(m,omega)).
fof(conj_hammer_test_2304,conjecture,(! [X5] : (nat_5Fp(X5) => (c_Subq(f_5F27(add_5Fnat(m,X5)),f_5F27(m)) => c_Subq(f_5F27(add_5Fnat(m,ordsucc(X5))),f_5F27(m)))))).
