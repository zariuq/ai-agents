...
fof(c_Hx,axiom,(x = c_SNoCut(c_5FLx,c_5FRx))).
fof(c_Hy,axiom,(y = c_SNoCut(c_5FLy,c_5FRy))).
fof(c_H,axiom,((! [X12] : (c_In(X12,c_5FLx) => c_SNo(X12))) & (! [X12] : (c_In(X12,c_5FRx) => c_SNo(X12))))).
fof(c_HLx,axiom,(! [X12] : (c_In(X12,c_5FLx) => c_SNo(X12)))).
fof(c_HRx,axiom,(! [X12] : (c_In(X12,c_5FRx) => c_SNo(X12)))).
fof(c_HLRx_27,axiom,(! [X12] : (c_In(X12,c_5FLx) => (! [X13] : (c_In(X13,c_5FRx) => c_SNoLt(X12,X13)))))).
fof(c_H,axiom,((! [X12] : (c_In(X12,c_5FLy) => c_SNo(X12))) & (! [X12] : (c_In(X12,c_5FRy) => c_SNo(X12))))).
fof(c_HLy,axiom,(! [X12] : (c_In(X12,c_5FLy) => c_SNo(X12)))).
fof(c_HRy,axiom,(! [X12] : (c_In(X12,c_5FRy) => c_SNo(X12)))).
fof(c_HLRy_27,axiom,(! [X12] : (c_In(X12,c_5FLy) => (! [X13] : (c_In(X13,c_5FRy) => c_SNoLt(X12,X13)))))).
fof(c_Hx1,axiom,c_SNo(x)).
fof(c_Hx3,axiom,(! [X12] : (c_In(X12,c_5FLx) => c_SNoLt(X12,x)))).
fof(c_Hx4,axiom,(! [X12] : (c_In(X12,c_5FRx) => c_SNoLt(x,X12)))).
fof(c_Hx5,axiom,(! [X12] : (c_SNo(X12) => ((! [X13] : (c_In(X13,c_5FLx) => c_SNoLt(X13,X12))) => ((! [X13] : (c_In(X13,c_5FRx) => c_SNoLt(X12,X13))) => (c_Subq(c_SNoLev(x),c_SNoLev(X12)) & c_SNoEq_5F(c_SNoLev(x),x,X12))))))).
fof(c_Hy1,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X12] : (c_In(X12,c_5FLy) => c_SNoLt(X12,y)))).
fof(c_Hy4,axiom,(! [X12] : (c_In(X12,c_5FRy) => c_SNoLt(y,X12)))).
fof(c_Hy5,axiom,(! [X12] : (c_SNo(X12) => ((! [X13] : (c_In(X13,c_5FLy) => c_SNoLt(X13,X12))) => ((! [X13] : (c_In(X13,c_5FRy) => c_SNoLt(X12,X13))) => (c_Subq(c_SNoLev(y),c_SNoLev(X12)) & c_SNoEq_5F(c_SNoLev(y),y,X12))))))).
fof(c_Lxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Hu1,axiom,c_SNo(u)).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(mul_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(u,mul_5FSNo(x,y))).
fof(c_L1,axiom,(! [X12] : (c_In(X12,c_5FLx) => (! [X13] : (c_In(X13,c_5FLy) => c_SNoLt(add_5FSNo(mul_5FSNo(X12,y),mul_5FSNo(x,X13)),add_5FSNo(u,mul_5FSNo(X12,X13)))))))).
fof(c_L2,axiom,(! [X12] : (c_In(X12,c_5FRx) => (! [X13] : (c_In(X13,c_5FRy) => c_SNoLt(add_5FSNo(mul_5FSNo(X12,y),mul_5FSNo(x,X13)),add_5FSNo(u,mul_5FSNo(X12,X13)))))))).
fof(c_LxLy_27I,axiom,(! [X12] : (c_In(X12,c_5FLx) => (! [X13] : (c_In(X13,c_5FLy) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FLxLy_5F27)))))).
fof(c_RxRy_27I,axiom,(! [X12] : (c_In(X12,c_5FRx) => (! [X13] : (c_In(X13,c_5FRy) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FRxRy_5F27)))))).
fof(c_LxRy_27I,axiom,(! [X12] : (c_In(X12,c_5FLx) => (! [X13] : (c_In(X13,c_5FRy) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FLxRy_5F27)))))).
fof(c_RxLy_27I,axiom,(! [X12] : (c_In(X12,c_5FRx) => (! [X13] : (c_In(X13,c_5FLy) => c_In(add_5FSNo(mul_5FSNo(X12,y),add_5FSNo(mul_5FSNo(x,X13),minus_5FSNo(mul_5FSNo(X12,X13)))),c_5FRxLy_5F27)))))).
fof(c_HSC,axiom,c_SNoCutP(binunion(c_5FLxLy_5F27,c_5FRxRy_5F27),binunion(c_5FLxRy_5F27,c_5FRxLy_5F27))).
fof(c_HE,axiom,(mul_5FSNo(x,y) = c_SNoCut(binunion(c_5FLxLy_5F27,c_5FRxRy_5F27),binunion(c_5FLxRy_5F27,c_5FRxLy_5F27)))).
fof(c_Hz,axiom,c_In(z,c_SNoR(u))).
fof(c_Hz1,axiom,c_SNo(z)).
fof(c_Hz2,axiom,c_In(c_SNoLev(z),c_SNoLev(u))).
fof(c_Hz3,axiom,c_SNoLt(u,z)).
fof(c_H1,axiom,c_SNoLt(z,mul_5FSNo(x,y))).
fof(conj_hammer_test_10495,conjecture,c_SNoLt(mul_5FSNo(x,y),z)).
