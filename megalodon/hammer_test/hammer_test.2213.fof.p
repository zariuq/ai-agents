...
fof(c_H1,axiom,finite(primes)).
fof(c_Hn,axiom,c_In(n,omega)).
fof(c_H2,axiom,equip(primes,n)).
fof(c_H,axiom,((! [X2] : (c_In(X2,n) => c_In(f(X2),primes))) & (! [X2] : (c_In(X2,n) => (! [X3] : (c_In(X3,n) => ((f(c_X2) = f(X3)) => (X2 = X3)))))))).
fof(c_Hf1,axiom,(! [X2] : (c_In(X2,n) => c_In(f(X2),primes)))).
fof(c_Hf2,axiom,(! [X2] : (c_In(X2,n) => (! [X3] : (c_In(X3,n) => ((f(c_X2) = f(X3)) => (X2 = X3))))))).
fof(c_Hf3,axiom,(! [X2] : (c_In(X2,primes) => (? [X3] : (c_In(X3,n) & (f(X3) = X2)))))).
fof(c_L1,axiom,(! [X2] : (c_In(X2,n) => nat_5Fp(f(X2))))).
fof(c_H1,axiom,c_In(c_Empty,primes)).
fof(conj_hammer_test_2213,conjecture,$false).
