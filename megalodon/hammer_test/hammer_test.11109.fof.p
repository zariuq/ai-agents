...
fof(c_Hp,axiom,prime_5Fnat(p)).
fof(c_Ha,axiom,c_In(a,int)).
fof(c_Hb,axiom,c_In(b,int)).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c_Hp1,axiom,c_In(p,omega)).
fof(c_Hp2,axiom,c_In(ordsucc(c_Empty),p)).
fof(c_Hp3,axiom,(! [X5] : (c_In(X5,omega) => (divides_5Fnat(X5,p) => ((X5 = ordsucc(c_Empty)) | (X5 = p)))))).
fof(c_H1,axiom,divides_5Fint(p,mul_5FSNo(a,b))).
fof(c_LaS,axiom,c_SNo(a)).
fof(c_LbS,axiom,c_SNo(b)).
fof(c_LpZ,axiom,c_In(p,int)).
fof(c_H2,axiom,~ divides_5Fint(p,a)).
fof(c_L1,axiom,gcd_5Freln(p,a,ordsucc(c_Empty))).
fof(c_L2,axiom,~ ((p = c_Empty) & (a = c_Empty))).
fof(c_HBezout1,axiom,(gcd_5Freln(p,a,ordsucc(c_Empty)) => ((int_5Flin_5Fcomb(p,a,ordsucc(c_Empty)) & c_SNoLt(c_Empty,ordsucc(c_Empty))) & (! [X5] : (int_5Flin_5Fcomb(p,a,X5) => (c_SNoLt(c_Empty,X5) => c_SNoLe(ordsucc(c_Empty),X5))))))).
fof(c__5F,axiom,(((int_5Flin_5Fcomb(p,a,ordsucc(c_Empty)) & c_SNoLt(c_Empty,ordsucc(c_Empty))) & (! [X5] : (int_5Flin_5Fcomb(p,a,X5) => (c_SNoLt(c_Empty,X5) => c_SNoLe(ordsucc(c_Empty),X5))))) => gcd_5Freln(p,a,ordsucc(c_Empty)))).
fof(c_H,axiom,(int_5Flin_5Fcomb(p,a,ordsucc(c_Empty)) & c_SNoLt(c_Empty,ordsucc(c_Empty)))).
fof(c_H3,axiom,int_5Flin_5Fcomb(p,a,ordsucc(c_Empty))).
fof(c__5F,axiom,c_SNoLt(c_Empty,ordsucc(c_Empty))).
fof(c_H4,axiom,(! [X5] : (int_5Flin_5Fcomb(p,a,X5) => (c_SNoLt(c_Empty,X5) => c_SNoLe(ordsucc(c_Empty),X5))))).
fof(c_Hm,axiom,c_In(m,int)).
fof(c_Hn,axiom,c_In(n,int)).
fof(c_H5,axiom,(add_5FSNo(mul_5FSNo(m,p),mul_5FSNo(n,a)) = ordsucc(c_Empty))).
fof(c_LnS,axiom,c_SNo(n)).
fof(c_L3,axiom,(add_5FSNo(mul_5FSNo(b,mul_5FSNo(m,p)),mul_5FSNo(b,mul_5FSNo(n,a))) = b)).
fof(conj_hammer_test_11109,conjecture,divides_5Fint(p,b)).
