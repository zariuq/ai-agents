...
fof(c_IHx0,axiom,c_SNo(mul_5FSNo(u0,u1))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoL(u0)) => (! [X11] : (c_In(X11,c_SNoL(u1)) => c_SNoLt(add_5FSNo(mul_5FSNo(X10,u1),mul_5FSNo(u0,X11)),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(X10,X11)))))))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoR(u0)) => (! [X11] : (c_In(X11,c_SNoR(u1)) => c_SNoLt(add_5FSNo(mul_5FSNo(X10,u1),mul_5FSNo(u0,X11)),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(X10,X11)))))))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoL(u0)) => (! [X11] : (c_In(X11,c_SNoR(u1)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(X10,X11)),add_5FSNo(mul_5FSNo(X10,u1),mul_5FSNo(u0,X11)))))))).
fof(c__5F,axiom,(! [X10] : (c_In(X10,c_SNoR(u0)) => (! [X11] : (c_In(X11,c_SNoL(u1)) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(X10,X11)),add_5FSNo(mul_5FSNo(X10,u1),mul_5FSNo(u0,X11)))))))).
fof(conj_hammer_test_7260,conjecture,c_SNo(mul_5FSNo(u0,u1))).
