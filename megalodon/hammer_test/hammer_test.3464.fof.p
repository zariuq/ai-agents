...
fof(c__5F,axiom,(! [X5] : (c_In(X5,alpha) => c_TransSet(X5)))).
fof(c_H1,axiom,(? [X5] : (c_In(X5,alpha) & (alpha = ordsucc(X5))))).
...
fof(c_H2,axiom,(p(beta) & ~ (beta = beta))).
fof(conj_hammer_test_3464,conjecture,$false).
