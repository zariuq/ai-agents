...
fof(c_HLR1,axiom,((! [X3] : (c_In(X3,c_5FL) => c_SNo(X3))) & (! [X3] : (c_In(X3,c_5FR) => c_SNo(X3))))).
fof(c_HLR1,axiom,(! [X3] : (c_In(X3,c_5FL) => c_SNo(X3)))).
fof(c_HLR2,axiom,(! [X3] : (c_In(X3,c_5FR) => c_SNo(X3)))).
fof(c_HLR3,axiom,(! [X3] : (c_In(X3,c_5FL) => (! [X4] : (c_In(X4,c_5FR) => c_SNoLt(X3,X4)))))).
fof(c_HvLR,axiom,(v = c_SNoCut(c_5FL,c_5FR))).
fof(conj_hammer_test_5729,conjecture,c_SNo(c_SNoCut(c_5FL,c_5FR))).
