...
fof(c_IH,axiom,(! [X1] : (nat_5Fp(X1) => (c_Subq(n,X1) => (? [X2] : (nat_5Fp(X2) & (X1 = add_5Fnat(X2,n)))))))).
fof(conj_hammer_test_1555,conjecture,(! [X1] : (nat_5Fp(X1) => (c_Subq(ordsucc(n),ordsucc(X1)) => (? [X2] : (nat_5Fp(X2) & (ordsucc(X1) = add_5Fnat(X2,ordsucc(n))))))))).
