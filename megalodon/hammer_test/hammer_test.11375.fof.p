...
fof(c_H1,axiom,c_In(c_Empty,n)).
fof(c_Ln,axiom,c_In(n,omega)).
fof(c_H2,axiom,~ (n = ordsucc(c_Empty))).
fof(c_LnS,axiom,c_SNo(n)).
fof(c_Lno,axiom,ordinal(n)).
fof(c_L1,axiom,c_In(ordsucc(c_Empty),n)).
fof(c_L2,axiom,(? [X9] : ((ordinal(X9) & (prime_5Fnat(X9) & divides_5Fnat(X9,n))) & (! [X10] : (c_In(X10,X9) => ~ (prime_5Fnat(X10) & divides_5Fnat(X10,n))))))).
fof(c_H,axiom,(ordinal(p) & (prime_5Fnat(p) & divides_5Fnat(p,n)))).
fof(c_Hpo,axiom,ordinal(p)).
fof(c_H,axiom,(prime_5Fnat(p) & divides_5Fnat(p,n))).
fof(c_Hpp,axiom,prime_5Fnat(p)).
fof(c_Hpn,axiom,divides_5Fnat(p,n)).
fof(c_Hpleast,axiom,(! [X9] : (c_In(X9,p) => ~ (prime_5Fnat(X9) & divides_5Fnat(X9,n))))).
fof(c_H,axiom,(c_In(p,omega) & c_In(ordsucc(c_Empty),p))).
fof(c__5F,axiom,(! [X9] : (c_In(X9,omega) => (divides_5Fnat(X9,p) => ((X9 = ordsucc(c_Empty)) | (X9 = p)))))).
fof(c_HpN,axiom,c_In(p,omega)).
fof(c_H1p,axiom,c_In(ordsucc(c_Empty),p)).
fof(c__5F,axiom,(c_In(p,omega) & c_In(n,omega))).
fof(c_H,axiom,(? [X9] : (c_In(X9,omega) & (mul_5Fnat(p,X9) = n)))).
fof(c_Hm,axiom,c_In(m,omega)).
fof(c_Hpm,axiom,(mul_5FSNo(p,m) = n)).
fof(c_LmS,axiom,c_SNo(m)).
fof(c_LmN,axiom,nat_5Fp(m)).
fof(c_Lmo,axiom,ordinal(m)).
fof(c_LpS,axiom,c_SNo(p)).
fof(c_LpN,axiom,nat_5Fp(p)).
fof(c_Lpo,axiom,ordinal(p)).
fof(c_Lmp,axiom,(mul_5FSNo(m,p) = n)).
fof(c_L1p,axiom,c_SNoLt(ordsucc(c_Empty),p)).
fof(c_Lmpos,axiom,c_SNoLt(c_Empty,m)).
fof(c_L3,axiom,c_SNoLt(m,n)).
fof(c_L4,axiom,c_In(m,n)).
fof(c_L5,axiom,c_In(c_Empty,m)).
fof(c_Hk,axiom,c_In(k,omega)).
fof(c_LkN,axiom,nat_5Fp(k)).
fof(c_Lf1,axiom,(! [X9] : (c_In(X9,k) => prime_5Fnat(f(X9))))).
fof(c_Lf2,axiom,(! [X9] : (c_In(X9,k) => c_In(f(X9),omega)))).
fof(c_Hgk,axiom,(g(k) = p)).
fof(c_Hgi,axiom,(! [X9] : (c_In(X9,k) => (g(X9) = f(X9))))).
fof(c_Hk_27,axiom,c_In(k_5F27,omega)).
fof(c_Lg_271,axiom,(! [X9] : (c_In(X9,k_5F27) => prime_5Fnat(g_5F27(X9))))).
fof(c_Lg_272,axiom,(! [X9] : (c_In(X9,k_5F27) => c_In(g_5F27(X9),omega)))).
fof(c_Lk_27N,axiom,nat_5Fp(k_5F27)).
fof(c_H,axiom,(? [X9] : (nat_5Fp(X9) & (k_5F27 = ordsucc(X9))))).
fof(c_Hk_27_27,axiom,nat_5Fp(k_5F27_5F27)).
fof(c_Hk_27k_27_27,axiom,(k_5F27 = ordsucc(k_5F27_5F27))).
fof(c_L7a,axiom,(prime_5Fnat(g_5F27(k_27_27)) & (! [X9] : (c_In(X9,k_5F27_5F27) => c_SNoLe(g_5F27(k_5F27_5F27),g_5F27(X9)))))).
fof(c_Hg_27k_27_27P,axiom,prime_5Fnat(g_5F27(k_27_27))).
fof(c_Hg_27k_27_27minimal,axiom,(! [X9] : (c_In(X9,k_5F27_5F27) => c_SNoLe(g_5F27(k_5F27_5F27),g_5F27(X9))))).
fof(c_H,axiom,(c_In(g_5F27(k_27_27),omega) & c_In(ordsucc(c_Empty),g_5F27(k_27_27)))).
fof(c__5F,axiom,(! [X9] : (c_In(X9,omega) => (divides_5Fnat(X9,g_5F27(k_5F27_5F27)) => ((X9 = ordsucc(c_Empty)) | (X9 = g_5F27(k_5F27_5F27))))))).
fof(c_H4,axiom,c_In(g_5F27(k_27_27),omega)).
fof(c_H5,axiom,c_In(ordsucc(c_Empty),g_5F27(k_27_27))).
fof(c_Lg_27k_27_27N,axiom,nat_5Fp(g_5F27(k_27_27))).
fof(c_Lg_27k_27_27o,axiom,ordinal(g_5F27(k_27_27))).
fof(c_Lg_27k_27_27S,axiom,c_SNo(g_5F27(k_27_27))).
fof(c_L7b,axiom,divides_5Fnat(g_5F27(k_27_27),n)).
fof(c_L7e,axiom,(! [X9] : (c_In(X9,k_5F27_5F27) => c_In(g_5F27(X9),int)))).
fof(conj_hammer_test_11375,conjecture,(g_5F27(k_27_27) = p)).
