...
fof(c_IHx,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (mul_5FSNo(add_5FSNo(X8,y),z) = add_5FSNo(mul_5FSNo(X8,z),mul_5FSNo(y,z)))))).
fof(c_IHy,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(add_5FSNo(x,X8),z) = add_5FSNo(mul_5FSNo(x,z),mul_5FSNo(X8,z)))))).
fof(c_IHz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(x,y),X8) = add_5FSNo(mul_5FSNo(x,X8),mul_5FSNo(y,X8)))))).
fof(c_IHxy,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (mul_5FSNo(add_5FSNo(X8,X9),z) = add_5FSNo(mul_5FSNo(X8,z),mul_5FSNo(X9,z)))))))).
fof(c_IHxz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(X8,y),X9) = add_5FSNo(mul_5FSNo(X8,X9),mul_5FSNo(y,X9)))))))).
fof(c_IHyz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(y))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(x,X8),X9) = add_5FSNo(mul_5FSNo(x,X9),mul_5FSNo(X8,X9)))))))).
fof(c_IHxyz,axiom,(! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(x))) => (! [X9] : (c_In(X9,c_SNoS_5F(c_SNoLev(y))) => (! [X10] : (c_In(X10,c_SNoS_5F(c_SNoLev(z))) => (mul_5FSNo(add_5FSNo(X8,X9),X10) = add_5FSNo(mul_5FSNo(X8,X10),mul_5FSNo(X9,X10)))))))))).
fof(c_HLR,axiom,c_SNoCutP(c_5FL,c_5FR)).
fof(c_HLI1,axiom,(! [X8] : (c_In(X8,c_SNoL(add_5FSNo(x,y))) => (! [X9] : (c_In(X9,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X8,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X8] : (c_In(X8,c_SNoR(add_5FSNo(x,y))) => (! [X9] : (c_In(X9,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X8,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X8] : (c_In(X8,c_SNoL(add_5FSNo(x,y))) => (! [X9] : (c_In(X9,c_SNoR(z)) => c_In(add_5FSNo(mul_5FSNo(X8,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X8] : (c_In(X8,c_SNoR(add_5FSNo(x,y))) => (! [X9] : (c_In(X9,c_SNoL(z)) => c_In(add_5FSNo(mul_5FSNo(X8,z),add_5FSNo(mul_5FSNo(add_5FSNo(x,y),X9),minus_5FSNo(mul_5FSNo(X8,X9)))),c_5FR)))))).
...
fof(conj_hammer_test_8759,conjecture,c_SNo(add_5FSNo(mul_5FSNo(x,z),add_5FSNo(mul_5FSNo(y,z),mul_5FSNo(v,w))))).
