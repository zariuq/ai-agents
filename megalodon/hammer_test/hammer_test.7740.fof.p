...
fof(conj_hammer_test_7740,conjecture,(! [X9] : (c_In(X9,c_SNoL(x)) => (! [X10] : (c_In(X10,c_SNoR(y)) => ((z = add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10))))) => c_SNoLt(w,z))))))).
