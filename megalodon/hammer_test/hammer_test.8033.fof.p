...
fof(conj_hammer_test_8033,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNoLe(X2,X0) => (c_SNoLe(X3,X1) => c_SNoLe(add_5FSNo(mul_5FSNo(X2,X1),mul_5FSNo(X0,X3)),add_5FSNo(mul_5FSNo(X0,X1),mul_5FSNo(X2,X3)))))))))))))).
