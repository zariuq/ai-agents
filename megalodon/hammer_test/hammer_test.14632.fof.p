...
fof(conj_hammer_test_14632,conjecture,(c_SNoLe(ap(hR,add_5FSNo(k0,k1)),add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(z0,w1))))) => c_SNoLe(ap(hR,add_5FSNo(k0,k1)),add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,w1),minus_5FSNo(mul_5FSNo(z0,w1))))))).
