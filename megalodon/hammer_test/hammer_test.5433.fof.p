...
fof(c_H1,axiom,(! [X2] : (! [X3] : (c_SNo(X2) => (c_SNo(X3) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X2))) => c_5FP(X4,X3))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(c_X2,X4))) => ((! [X4] : (c_In(X4,c_SNoS_5F(c_SNoLev(X2))) => (! [X5] : (c_In(X5,c_SNoS_5F(c_SNoLev(X3))) => c_5FP(X4,X5))))) => c_5FP(X2,X3))))))))).
fof(c_Ha,axiom,ordinal(alpha)).
fof(c_IHa,axiom,(! [X2] : (c_In(X2,alpha) => (! [X3] : (ordinal(X3) => (! [X4] : (c_In(X4,c_SNoS_5F(X2)) => (! [X5] : (c_In(X5,c_SNoS_5F(X3)) => c_5FP(X4,X5)))))))))).
fof(conj_hammer_test_5433,conjecture,(! [X2] : (ordinal(X2) => ((! [X3] : (c_In(X3,X2) => (! [X4] : (c_In(X4,c_SNoS_5F(alpha)) => (! [X5] : (c_In(X5,c_SNoS_5F(X3)) => c_5FP(X4,X5))))))) => (! [X3] : (c_In(X3,c_SNoS_5F(alpha)) => (! [X4] : (c_In(X4,c_SNoS_5F(X2)) => c_5FP(X3,X4))))))))).
