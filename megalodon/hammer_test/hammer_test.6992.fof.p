...
fof(conj_hammer_test_6992,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (! [X4] : (! [X5] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (c_SNo(X4) => (c_SNo(X5) => (c_SNoLt(X0,X3) => (c_SNoLt(X1,X4) => (c_SNoLt(X2,X5) => c_SNoLt(add_5FSNo(X0,add_5FSNo(X1,X2)),add_5FSNo(X3,add_5FSNo(X4,X5))))))))))))))))))).
