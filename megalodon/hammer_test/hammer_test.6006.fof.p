...
fof(c_IHu2,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => c_SNoLt(add_5FSNo(X6,u),add_5FSNo(x,u))))).
fof(c_IHu3,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => c_SNoLt(add_5FSNo(x,u),add_5FSNo(X6,u))))).
fof(c_IHu4,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => c_SNoLt(add_5FSNo(x,X6),add_5FSNo(x,u))))).
fof(c_IHu5,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => c_SNoLt(add_5FSNo(x,u),add_5FSNo(x,X6))))).
...
fof(c_IHv2,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => c_SNoLt(add_5FSNo(X6,v),add_5FSNo(x,v))))).
fof(c_IHv3,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => c_SNoLt(add_5FSNo(x,v),add_5FSNo(X6,v))))).
fof(c_IHv4,axiom,(! [X6] : (c_In(X6,c_SNoL(v)) => c_SNoLt(add_5FSNo(x,X6),add_5FSNo(x,v))))).
fof(c_IHv5,axiom,(! [X6] : (c_In(X6,c_SNoR(v)) => c_SNoLt(add_5FSNo(x,v),add_5FSNo(x,X6))))).
fof(c_Luv,axiom,c_SNoLt(u,v)).
fof(conj_hammer_test_6006,conjecture,(c_In(c_SNoLev(u),c_SNoLev(v)) => (c_SNoEq_5F(c_SNoLev(u),u,v) => (c_In(c_SNoLev(u),v) => c_SNoLt(add_5FSNo(x,u),add_5FSNo(x,v)))))).
