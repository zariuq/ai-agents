...
fof(c_HLI1,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X11,y),add_5FSNo(mul_5FSNo(x,X12),minus_5FSNo(mul_5FSNo(X11,X12)))),c_5FR)))))).
fof(c_Hxy,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_LLx,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => (! [X12] : (c_SNo(X12) => c_SNo(mul_5FSNo(X11,X12))))))).
fof(c_LRx,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => (! [X12] : (c_SNo(X12) => c_SNo(mul_5FSNo(X11,X12))))))).
fof(c_LLxy,axiom,(! [X11] : (c_In(X11,c_SNoL(x)) => c_SNo(mul_5FSNo(X11,y))))).
fof(c_LRxy,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => c_SNo(mul_5FSNo(X11,y))))).
fof(c_LxLy,axiom,(! [X11] : (c_In(X11,c_SNoL(y)) => c_SNo(mul_5FSNo(x,X11))))).
fof(c_LxRy,axiom,(! [X11] : (c_In(X11,c_SNoR(y)) => c_SNo(mul_5FSNo(x,X11))))).
fof(c_Hu,axiom,c_In(u,c_5FL)).
fof(c_Hv,axiom,c_In(v,c_5FR)).
fof(c_Hu0,axiom,c_In(u0,c_SNoR(x))).
fof(c_Hu1,axiom,c_In(u1,c_SNoR(y))).
fof(c_Hue,axiom,(u = add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),minus_5FSNo(mul_5FSNo(u0,u1)))))).
fof(c_Hu0a,axiom,c_SNo(u0)).
fof(c_Hu0b,axiom,c_In(c_SNoLev(u0),c_SNoLev(x))).
fof(c_Hu0c,axiom,c_SNoLt(x,u0)).
fof(c_Hu1a,axiom,c_SNo(u1)).
fof(c_Hu1b,axiom,c_In(c_SNoLev(u1),c_SNoLev(y))).
fof(c_Hu1c,axiom,c_SNoLt(y,u1)).
fof(c_Hv0,axiom,c_In(v0,c_SNoR(x))).
fof(c_Hv1,axiom,c_In(v1,c_SNoL(y))).
fof(c_Hve,axiom,(v = add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),minus_5FSNo(mul_5FSNo(v0,v1)))))).
fof(c_Hv0a,axiom,c_SNo(v0)).
fof(c_Hv0b,axiom,c_In(c_SNoLev(v0),c_SNoLev(x))).
fof(c_Hv0c,axiom,c_SNoLt(x,v0)).
fof(c_Hv1a,axiom,c_SNo(v1)).
fof(c_Hv1b,axiom,c_In(c_SNoLev(v1),c_SNoLev(y))).
fof(c_Hv1c,axiom,c_SNoLt(v1,y)).
fof(c_Lu0y,axiom,c_SNo(mul_5FSNo(u0,y))).
fof(c_Lxu1,axiom,c_SNo(mul_5FSNo(x,u1))).
fof(c_Lu0u1,axiom,c_SNo(mul_5FSNo(u0,u1))).
fof(c_Lv0y,axiom,c_SNo(mul_5FSNo(v0,y))).
fof(c_Lxv1,axiom,c_SNo(mul_5FSNo(x,v1))).
fof(c_Lv0v1,axiom,c_SNo(mul_5FSNo(v0,v1))).
fof(c_Lu0v1,axiom,c_SNo(mul_5FSNo(u0,v1))).
fof(c_Lv0u1,axiom,c_SNo(mul_5FSNo(v0,u1))).
fof(c_Luv,axiom,((u = add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),minus_5FSNo(mul_5FSNo(u0,u1))))) => ((v = add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),minus_5FSNo(mul_5FSNo(v0,v1))))) => (c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))) => c_SNoLt(u,v))))).
fof(c_Lv1u1lt,axiom,c_SNoLt(v1,u1)).
fof(c_L3,axiom,(! [X11] : (c_In(X11,c_SNoR(x)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(X11,v1)),add_5FSNo(mul_5FSNo(X11,u1),mul_5FSNo(x,v1)))))).
fof(c_L3u0,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(u0,v1)),add_5FSNo(mul_5FSNo(u0,u1),mul_5FSNo(x,v1)))).
fof(c_L3v0,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,u1),mul_5FSNo(x,v1)))).
fof(c_L3u0imp,axiom,(c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,v1))) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
fof(c_L3v0imp,axiom,(c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,u1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,u1))) => c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),add_5FSNo(mul_5FSNo(x,u1),mul_5FSNo(v0,v1))),add_5FSNo(mul_5FSNo(v0,y),add_5FSNo(mul_5FSNo(x,v1),mul_5FSNo(u0,u1)))))).
fof(c_Hzu0,axiom,c_In(z,c_SNoR(u0))).
fof(c_Hzv0,axiom,c_In(z,c_SNoL(v0))).
fof(c_Hza,axiom,c_SNo(z)).
fof(c_Hzb,axiom,c_In(c_SNoLev(z),c_SNoLev(u0))).
fof(c_Hzc,axiom,c_SNoLt(u0,z)).
fof(c_Lz,axiom,c_In(z,c_SNoR(x))).
fof(c_L6,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(z,v1)),add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(u0,v1)))).
fof(c__5F,axiom,c_SNo(mul_5FSNo(v0,y))).
fof(c_IHx1,axiom,(! [X11] : (c_In(X11,c_SNoL(v0)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(v0,X12)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X11,X12)))))))).
fof(c__5F,axiom,(! [X11] : (c_In(X11,c_SNoR(v0)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(v0,X12)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X11,X12)))))))).
fof(c__5F,axiom,(! [X11] : (c_In(X11,c_SNoL(v0)) => (! [X12] : (c_In(X12,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X11,X12)),add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(v0,X12)))))))).
fof(c__5F,axiom,(! [X11] : (c_In(X11,c_SNoR(v0)) => (! [X12] : (c_In(X12,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(X11,X12)),add_5FSNo(mul_5FSNo(X11,y),mul_5FSNo(v0,X12)))))))).
fof(conj_hammer_test_7651,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(z,y),mul_5FSNo(v0,v1)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(z,v1)))).
