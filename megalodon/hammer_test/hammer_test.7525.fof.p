...
fof(c_Hz,axiom,c_In(z,c_SNoR(y))).
fof(c_Hza,axiom,c_SNo(z)).
fof(c_Hzb,axiom,c_In(c_SNoLev(z),c_SNoLev(y))).
fof(c_Hzc,axiom,c_SNoLt(y,z)).
fof(c_Lu0z,axiom,c_SNo(mul_5FSNo(u0,z))).
fof(c_Lv0z,axiom,c_SNo(mul_5FSNo(v0,z))).
fof(c_Hwu0,axiom,c_In(w,c_SNoL(u0))).
fof(c_Hwv0,axiom,c_In(w,c_SNoR(v0))).
fof(c_Hwu0a,axiom,c_SNo(w)).
fof(c_Hwu0b,axiom,c_In(c_SNoLev(w),c_SNoLev(u0))).
fof(c_Hwu0c,axiom,c_SNoLt(w,u0)).
fof(c_LLevwLevx,axiom,c_In(c_SNoLev(w),c_SNoLev(x))).
fof(conj_hammer_test_7525,conjecture,c_SNoLt(add_5FSNo(mul_5FSNo(u0,y),mul_5FSNo(v0,z)),add_5FSNo(mul_5FSNo(v0,y),mul_5FSNo(u0,z)))).
