...
fof(c_Hwe,axiom,(w = add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(z0,z1)))))).
...
fof(c_Lz0z1,axiom,c_SNo(mul_5FSNo(z0,z1))).
fof(c_Lmz0z1,axiom,c_SNo(minus_5FSNo(mul_5FSNo(z0,z1)))).
fof(c_Lz0yxz1mz0z1,axiom,c_SNo(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(z0,z1)))))).
fof(c_H1,axiom,c_SNoLt(ap(hL,add_5FSNo(k0,k1)),add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(z0,z1)))))).
fof(conj_hammer_test_14415,conjecture,c_SNoLt(add_5FSNo(ap(hL,add_5FSNo(k0,k1)),eps_5F(add_5FSNo(k0,k1))),add_5FSNo(add_5FSNo(mul_5FSNo(z0,y),add_5FSNo(mul_5FSNo(x,z1),minus_5FSNo(mul_5FSNo(z0,z1)))),eps_5F(add_5FSNo(k0,k1))))).
