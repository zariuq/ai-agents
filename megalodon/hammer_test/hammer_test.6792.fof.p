...
fof(conj_hammer_test_6792,conjecture,(! [X0] : (! [X1] : (! [X2] : (! [X3] : (c_SNo(X0) => (c_SNo(X1) => (c_SNo(X2) => (c_SNo(X3) => (add_5FSNo(X0,add_5FSNo(X1,add_5FSNo(X2,X3))) = add_5FSNo(add_5FSNo(X0,add_5FSNo(X1,X2)),X3))))))))))).
