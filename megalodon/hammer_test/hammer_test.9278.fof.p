...
fof(c_SNo_5FM,axiom,(! [X6] : (! [X7] : (c_SNo(X6) => (c_SNo(X7) => c_SNo(c_5FM(X6,X7))))))).
fof(c_DL,axiom,(! [X6] : (! [X7] : (! [X8] : (c_SNo(X6) => (c_SNo(X7) => (c_SNo(X8) => (c_5FM(c_X6,add_5FSNo(X7,X8)) = add_5FSNo(c_5FM(c_X6,X7),c_5FM(c_X6,X8)))))))))).
fof(c_DR,axiom,(! [X6] : (! [X7] : (! [X8] : (c_SNo(X6) => (c_SNo(X7) => (c_SNo(X8) => (c_5FM(add_5FSNo(c_X6,X7),X8) = add_5FSNo(c_5FM(c_X6,X8),c_5FM(X7,X8)))))))))).
fof(c_M_5FLt,axiom,(! [X6] : (! [X7] : (! [X8] : (! [X9] : (c_SNo(X6) => (c_SNo(X7) => (c_SNo(X8) => (c_SNo(X9) => (c_SNoLt(X8,X6) => (c_SNoLt(X9,X7) => c_SNoLt(add_5FSNo(c_5FM(X8,c_X7),c_5FM(c_X6,X9)),add_5FSNo(c_5FM(c_X6,c_X7),c_5FM(X8,X9)))))))))))))).
fof(c_M_5FLe,axiom,(! [X6] : (! [X7] : (! [X8] : (! [X9] : (c_SNo(X6) => (c_SNo(X7) => (c_SNo(X8) => (c_SNo(X9) => (c_SNoLe(X8,X6) => (c_SNoLe(X9,X7) => c_SNoLe(add_5FSNo(c_5FM(X8,c_X7),c_5FM(c_X6,X9)),add_5FSNo(c_5FM(c_X6,c_X7),c_5FM(X8,X9)))))))))))))).
fof(c_Hx,axiom,c_SNo(x)).
fof(c_Hy,axiom,c_SNo(y)).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_IHx,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(x))) => (c_5FM(X6,c_5FM(y,z)) = c_5FM(c_5FM(X6,y),z))))).
fof(c_IHy,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(y))) => (c_5FM(x,c_5FM(X6,z)) = c_5FM(c_5FM(x,X6),z))))).
fof(c_IHz,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(x,c_5FM(y,X6)) = c_5FM(c_5FM(x,y),X6))))).
fof(c_IHxy,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(x))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (c_5FM(X6,c_5FM(X7,z)) = c_5FM(c_5FM(X6,X7),z))))))).
fof(c_IHxz,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(x))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(X6,c_5FM(y,X7)) = c_5FM(c_5FM(X6,y),X7))))))).
fof(c_IHyz,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(y))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(x,c_5FM(X6,X7)) = c_5FM(c_5FM(x,X6),X7))))))).
fof(c_IHxyz,axiom,(! [X6] : (c_In(X6,c_SNoS_5F(c_SNoLev(x))) => (! [X7] : (c_In(X7,c_SNoS_5F(c_SNoLev(y))) => (! [X8] : (c_In(X8,c_SNoS_5F(c_SNoLev(z))) => (c_5FM(c_X6,c_5FM(X7,X8)) = c_5FM(c_5FM(c_X6,X7),X8))))))))).
fof(c_Hu,axiom,c_In(u,c_5FL)).
fof(c_Lxy,axiom,c_SNo(c_5FM(x,y))).
fof(c_Lyz,axiom,c_SNo(c_5FM(y,z))).
fof(conj_hammer_test_9278,conjecture,c_SNo(c_5FM(c_5FM(x,y),z))).
