...
fof(c_Hy,axiom,c_SNo(y)).
fof(c_Hu,axiom,c_SNo(u)).
fof(c_Hv,axiom,c_SNo(v)).
fof(c_Hux,axiom,c_SNoLt(u,x)).
fof(c_Hvy,axiom,c_SNoLt(v,y)).
fof(c_Hxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Hxy1,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(x,X7)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X6,X7)))))))).
fof(c_Hxy2,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(x,X7)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X6,X7)))))))).
fof(c_Hxy3,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(x,X7)))))))).
fof(c_Hxy4,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(x,X7)))))))).
fof(c_Huy,axiom,c_SNo(mul_5FSNo(u,y))).
fof(c_Huy1,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(u,X7)),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X6,X7)))))))).
fof(c_Huy2,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(u,X7)),add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X6,X7)))))))).
fof(c_Huy3,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => (! [X7] : (c_In(X7,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(u,X7)))))))).
fof(c_Huy4,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => (! [X7] : (c_In(X7,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,y),mul_5FSNo(u,X7)))))))).
fof(c_Hxv,axiom,c_SNo(mul_5FSNo(x,v))).
fof(c_Hxv1,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(x,X7)),add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X6,X7)))))))).
fof(c_Hxv2,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(x,X7)),add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X6,X7)))))))).
fof(c_Hxv3,axiom,(! [X6] : (c_In(X6,c_SNoL(x)) => (! [X7] : (c_In(X7,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(x,X7)))))))).
fof(c_Hxv4,axiom,(! [X6] : (c_In(X6,c_SNoR(x)) => (! [X7] : (c_In(X7,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(x,X7)))))))).
fof(c_Huv,axiom,c_SNo(mul_5FSNo(u,v))).
fof(c_Huv1,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => (! [X7] : (c_In(X7,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(u,X7)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X6,X7)))))))).
fof(c_Huv2,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => (! [X7] : (c_In(X7,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(u,X7)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X6,X7)))))))).
fof(c_Huv3,axiom,(! [X6] : (c_In(X6,c_SNoL(u)) => (! [X7] : (c_In(X7,c_SNoR(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(u,X7)))))))).
fof(c_Huv4,axiom,(! [X6] : (c_In(X6,c_SNoR(u)) => (! [X7] : (c_In(X7,c_SNoL(v)) => c_SNoLt(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(X6,X7)),add_5FSNo(mul_5FSNo(X6,v),mul_5FSNo(u,X7)))))))).
fof(c_Luyxv,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(x,v)))).
fof(c_Lxyuv,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,v)))).
fof(c_Hw1,axiom,c_SNo(w)).
fof(c_Hw2,axiom,c_In(c_SNoLev(w),binintersect(c_SNoLev(u),c_SNoLev(x)))).
fof(c_Hw3,axiom,c_SNoEq_5F(c_SNoLev(w),w,u)).
fof(c_Hw4,axiom,c_SNoEq_5F(c_SNoLev(w),w,x)).
fof(c_Hw5,axiom,c_SNoLt(u,w)).
fof(c_Hw6,axiom,c_SNoLt(w,x)).
fof(c_Hw7,axiom,nIn(c_SNoLev(w),u)).
fof(c_Hw8,axiom,c_In(c_SNoLev(w),x)).
fof(c_Hw2a,axiom,c_In(c_SNoLev(w),c_SNoLev(u))).
fof(c_Hw2b,axiom,c_In(c_SNoLev(w),c_SNoLev(x))).
fof(c_Lwx,axiom,c_In(w,c_SNoL(x))).
fof(c_Lwu,axiom,c_In(w,c_SNoR(u))).
fof(c_Lwy,axiom,c_SNo(mul_5FSNo(w,y))).
fof(c_Lwv,axiom,c_SNo(mul_5FSNo(w,v))).
fof(c_Lwyxv,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(x,v)))).
fof(c_Lwyuv,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(u,v)))).
fof(c_Lxywv,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(w,v)))).
fof(c_Luywv,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(w,v)))).
fof(c_Luvwy,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(w,y)))).
fof(c_Lwvxy,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,y)))).
fof(c_Lxvwy,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(w,y)))).
fof(c_Lwvuy,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(u,y)))).
fof(c_Hz1,axiom,c_SNo(z)).
fof(c_Hz2,axiom,c_In(c_SNoLev(z),binintersect(c_SNoLev(v),c_SNoLev(y)))).
fof(c_Hz3,axiom,c_SNoEq_5F(c_SNoLev(z),z,v)).
fof(c_Hz4,axiom,c_SNoEq_5F(c_SNoLev(z),z,y)).
fof(c_Hz5,axiom,c_SNoLt(v,z)).
fof(c_Hz6,axiom,c_SNoLt(z,y)).
fof(c_Hz7,axiom,nIn(c_SNoLev(z),v)).
fof(c_Hz8,axiom,c_In(c_SNoLev(z),y)).
fof(c_Hz2a,axiom,c_In(c_SNoLev(z),c_SNoLev(v))).
fof(c_Hz2b,axiom,c_In(c_SNoLev(z),c_SNoLev(y))).
fof(c_Lzy,axiom,c_In(z,c_SNoL(y))).
fof(c_Lzv,axiom,c_In(z,c_SNoR(v))).
fof(c_Lxz,axiom,c_SNo(mul_5FSNo(x,z))).
fof(c_Luz,axiom,c_SNo(mul_5FSNo(u,z))).
fof(c_Lwz,axiom,c_SNo(mul_5FSNo(w,z))).
fof(c_L1,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(x,z)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(w,z)))).
fof(c_L2,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(u,z)),add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(w,z)))).
fof(c_L3,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(w,z)),add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,z)))).
fof(c_L4,axiom,c_SNoLt(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(w,z)),add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(u,z)))).
fof(c_Lwzwz,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,z),mul_5FSNo(w,z)))).
fof(c_Lwyuz,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(u,z)))).
fof(c_Lwvxz,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,z)))).
fof(c_Luywz,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,y),mul_5FSNo(w,z)))).
fof(c_Lxvwz,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,v),mul_5FSNo(w,z)))).
fof(c_Lwvuz,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(u,z)))).
fof(c_Lxyxz,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(x,z)))).
fof(c_Lwyxz,axiom,c_SNo(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(x,z)))).
fof(c_Lxywz,axiom,c_SNo(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(w,z)))).
fof(c_Luvwz,axiom,c_SNo(add_5FSNo(mul_5FSNo(u,v),mul_5FSNo(w,z)))).
fof(conj_hammer_test_7886,conjecture,c_SNoLt(add_5FSNo(add_5FSNo(mul_5FSNo(w,y),mul_5FSNo(u,z)),add_5FSNo(mul_5FSNo(w,v),mul_5FSNo(x,z))),add_5FSNo(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(u,v)),add_5FSNo(mul_5FSNo(w,z),mul_5FSNo(w,z))))).
