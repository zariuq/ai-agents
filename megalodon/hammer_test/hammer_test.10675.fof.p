...
fof(conj_hammer_test_10675,conjecture,(! [X2] : (c_In(X2,omega) => ((add_5FSNo(minus_5FSNo(n),m) = minus_5FSNo(X2)) => c_In(add_5FSNo(ordsucc(c_Empty),add_5FSNo(minus_5FSNo(n),m)),int))))).
