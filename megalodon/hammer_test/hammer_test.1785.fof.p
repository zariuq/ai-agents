...
fof(c_IHn,axiom,(! [X3] : (equip(X3,n) => equip(c_Power(X3),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))))).
...
fof(c_L1,axiom,(? [X3] : c_In(X3,c_5FX))).
fof(c_L2,axiom,equip(setminus(c_5FX,c_Sing(x)),n)).
fof(conj_hammer_test_1785,conjecture,equip(c_Power(setminus(c_5FX,c_Sing(x))),exp_5Fnat(ordsucc(ordsucc(c_Empty)),n))).
