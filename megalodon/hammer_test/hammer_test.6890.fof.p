...
fof(c_H1,axiom,c_SNoLt(add_5FSNo(x,u),add_5FSNo(z,v))).
fof(c_H2,axiom,c_SNoLt(add_5FSNo(y,v),add_5FSNo(w,u))).
fof(conj_hammer_test_6890,conjecture,c_SNoLt(add_5FSNo(add_5FSNo(x,y),add_5FSNo(u,v)),add_5FSNo(add_5FSNo(z,w),add_5FSNo(u,v)))).
