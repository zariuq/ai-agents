...
fof(c_IHLx,axiom,(! [X5] : (c_In(X5,c_SNoL(x)) => ((c_SNo(minus_5FSNo(X5)) & (! [X6] : (c_In(X6,c_SNoL(X5)) => c_SNoLt(minus_5FSNo(X5),minus_5FSNo(X6))))) & (! [X6] : (c_In(X6,c_SNoR(X5)) => c_SNoLt(minus_5FSNo(X6),minus_5FSNo(X5)))))))).
fof(c_IHRx,axiom,(! [X5] : (c_In(X5,c_SNoR(x)) => ((c_SNo(minus_5FSNo(X5)) & (! [X6] : (c_In(X6,c_SNoL(X5)) => c_SNoLt(minus_5FSNo(X5),minus_5FSNo(X6))))) & (! [X6] : (c_In(X6,c_SNoR(X5)) => c_SNoLt(minus_5FSNo(X6),minus_5FSNo(X5)))))))).
...
fof(c_H2,axiom,(c_SNo(minus_5FSNo(v)) & (! [X5] : (c_In(X5,c_SNoL(v)) => c_SNoLt(minus_5FSNo(v),minus_5FSNo(X5)))))).
fof(c_H2,axiom,c_SNo(minus_5FSNo(v))).
fof(c_H3,axiom,(! [X5] : (c_In(X5,c_SNoL(v)) => c_SNoLt(minus_5FSNo(v),minus_5FSNo(X5))))).
fof(c_H4,axiom,(! [X5] : (c_In(X5,c_SNoR(v)) => c_SNoLt(minus_5FSNo(X5),minus_5FSNo(v))))).
fof(c_H5,axiom,(c_SNo(minus_5FSNo(u)) & (! [X5] : (c_In(X5,c_SNoL(u)) => c_SNoLt(minus_5FSNo(u),minus_5FSNo(X5)))))).
fof(c_H5,axiom,c_SNo(minus_5FSNo(u))).
fof(c_H6,axiom,(! [X5] : (c_In(X5,c_SNoL(u)) => c_SNoLt(minus_5FSNo(u),minus_5FSNo(X5))))).
fof(c_H7,axiom,(! [X5] : (c_In(X5,c_SNoR(u)) => c_SNoLt(minus_5FSNo(X5),minus_5FSNo(u))))).
fof(c_Lvu,axiom,c_SNoLt(v,u)).
fof(conj_hammer_test_5599,conjecture,(c_In(c_SNoLev(v),c_SNoLev(u)) => (c_SNoEq_5F(c_SNoLev(v),v,u) => (c_In(c_SNoLev(v),u) => c_SNoLt(minus_5FSNo(u),minus_5FSNo(v)))))).
