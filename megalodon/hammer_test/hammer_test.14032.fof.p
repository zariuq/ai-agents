...
fof(c_Hx6,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(omega)) => ((! [X10] : (c_In(X10,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X9,minus_5FSNo(x))),eps_5F(X10)))) => (X9 = x))))).
fof(c_Hx7,axiom,(! [X9] : (c_In(X9,omega) => (? [X10] : (c_In(X10,c_SNoS_5F(omega)) & (c_SNoLt(X10,x) & c_SNoLt(x,add_5FSNo(X10,eps_5F(X9))))))))).
...
fof(c_Hy6,axiom,(! [X9] : (c_In(X9,c_SNoS_5F(omega)) => ((! [X10] : (c_In(X10,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(X9,minus_5FSNo(y))),eps_5F(X10)))) => (X9 = y))))).
fof(c_Hy7,axiom,(! [X9] : (c_In(X9,omega) => (? [X10] : (c_In(X10,c_SNoS_5F(omega)) & (c_SNoLt(X10,y) & c_SNoLt(y,add_5FSNo(X10,eps_5F(X9))))))))).
...
fof(c_Lxy3,axiom,(! [X9] : (c_SNo(X9) => (c_In(c_SNoLev(X9),omega) => c_In(c_SNoLev(X9),c_SNoLev(mul_5FSNo(x,y))))))).
...
fof(c_HLI1,axiom,(! [X9] : (c_In(X9,c_SNoL(x)) => (! [X10] : (c_In(X10,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FL)))))).
fof(c_HLI2,axiom,(! [X9] : (c_In(X9,c_SNoR(x)) => (! [X10] : (c_In(X10,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FL)))))).
fof(c_HRI1,axiom,(! [X9] : (c_In(X9,c_SNoL(x)) => (! [X10] : (c_In(X10,c_SNoR(y)) => c_In(add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FR)))))).
fof(c_HRI2,axiom,(! [X9] : (c_In(X9,c_SNoR(x)) => (! [X10] : (c_In(X10,c_SNoL(y)) => c_In(add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10)))),c_5FR)))))).
fof(c_HxyLR,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_Hq1,axiom,c_In(q,c_SNoS_5F(omega))).
fof(c_Hq2,axiom,(! [X9] : (c_In(X9,omega) => c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(X9))))).
...
fof(c_H1,axiom,c_SNoLt(mul_5FSNo(x,y),q)).
fof(c_Lq2,axiom,c_In(q,c_SNoR(mul_5FSNo(x,y)))).
fof(c_Hv,axiom,c_In(v,c_SNoL(x))).
fof(c_Hw,axiom,c_In(w,c_SNoR(y))).
fof(c_Hv1,axiom,c_SNo(v)).
fof(c__5F,axiom,c_In(c_SNoLev(v),c_SNoLev(x))).
fof(c__5F,axiom,c_SNoLt(v,x)).
fof(c_Hw1,axiom,c_SNo(w)).
fof(c__5F,axiom,c_In(c_SNoLev(w),c_SNoLev(y))).
fof(c__5F,axiom,c_SNoLt(y,w)).
fof(c_H2,axiom,c_SNoLe(add_5FSNo(mul_5FSNo(v,y),mul_5FSNo(x,w)),add_5FSNo(q,mul_5FSNo(v,w)))).
fof(c_Lvy,axiom,c_SNo(mul_5FSNo(v,y))).
fof(c_Lxw,axiom,c_SNo(mul_5FSNo(x,w))).
fof(c_Lmxw,axiom,c_SNo(minus_5FSNo(mul_5FSNo(x,w)))).
fof(c_Lvw,axiom,c_SNo(mul_5FSNo(v,w))).
fof(c_Lmvw,axiom,c_SNo(minus_5FSNo(mul_5FSNo(v,w)))).
fof(c_Lxmv,axiom,c_SNo(add_5FSNo(x,minus_5FSNo(v)))).
fof(c_Lwmy,axiom,c_SNo(add_5FSNo(w,minus_5FSNo(y)))).
fof(c_Hk1,axiom,c_In(k,omega)).
fof(c_Hk2,axiom,c_SNoLe(eps_5F(k),add_5FSNo(x,minus_5FSNo(v)))).
fof(c_Hk_271,axiom,c_In(k_5F27,omega)).
fof(c_Hk_272,axiom,c_SNoLe(eps_5F(k_5F27),add_5FSNo(w,minus_5FSNo(y)))).
fof(c_Lek,axiom,c_SNo(eps_5F(k))).
fof(c_Lek_27,axiom,c_SNo(eps_5F(k_5F27))).
fof(c_Lkk_27,axiom,c_In(add_5FSNo(k,k_5F27),omega)).
fof(c_Lekk_27,axiom,c_SNo(eps_5F(add_5FSNo(k,k_5F27)))).
fof(c_Lekek_27,axiom,c_SNo(mul_5FSNo(eps_5F(k),eps_5F(k_5F27)))).
fof(c_L1e,axiom,c_SNoLt(abs_5FSNo(add_5FSNo(q,minus_5FSNo(mul_5FSNo(x,y)))),eps_5F(add_5FSNo(k,k_5F27)))).
fof(conj_hammer_test_14032,conjecture,c_SNoLe(add_5FSNo(mul_5FSNo(eps_5F(k),eps_5F(k_5F27)),mul_5FSNo(x,y)),add_5FSNo(mul_5FSNo(add_5FSNo(x,minus_5FSNo(v)),add_5FSNo(w,minus_5FSNo(y))),mul_5FSNo(x,y)))).
