...
fof(c_He,axiom,(mul_5FSNo(x,y) = c_SNoCut(c_5FL,c_5FR))).
fof(c_Hxy,axiom,c_SNo(mul_5FSNo(x,y))).
fof(c_Hxy1,axiom,(! [X9] : (c_In(X9,c_SNoL(x)) => (! [X10] : (c_In(X10,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X9,y),mul_5FSNo(x,X10)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X9,X10)))))))).
fof(c_Hxy2,axiom,(! [X9] : (c_In(X9,c_SNoR(x)) => (! [X10] : (c_In(X10,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(X9,y),mul_5FSNo(x,X10)),add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X9,X10)))))))).
fof(c_Hxy3,axiom,(! [X9] : (c_In(X9,c_SNoL(x)) => (! [X10] : (c_In(X10,c_SNoR(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X9,X10)),add_5FSNo(mul_5FSNo(X9,y),mul_5FSNo(x,X10)))))))).
fof(c_Hxy4,axiom,(! [X9] : (c_In(X9,c_SNoR(x)) => (! [X10] : (c_In(X10,c_SNoL(y)) => c_SNoLt(add_5FSNo(mul_5FSNo(x,y),mul_5FSNo(X9,X10)),add_5FSNo(mul_5FSNo(X9,y),mul_5FSNo(x,X10)))))))).
fof(c_Hw,axiom,c_In(w,c_5FL)).
fof(c_Hz,axiom,c_In(z,c_5FR)).
fof(c_Hu,axiom,c_In(u,c_SNoL(x))).
fof(c_Hv,axiom,c_In(v,c_SNoL(y))).
fof(c_Hwe,axiom,(w = add_5FSNo(mul_5FSNo(u,y),add_5FSNo(mul_5FSNo(x,v),minus_5FSNo(mul_5FSNo(u,v)))))).
fof(c_Hua,axiom,c_SNo(u)).
fof(c__5F,axiom,c_In(c_SNoLev(u),c_SNoLev(x))).
fof(c__5F,axiom,c_SNoLt(u,x)).
fof(c_Hva,axiom,c_SNo(v)).
fof(c__5F,axiom,c_In(c_SNoLev(v),c_SNoLev(y))).
fof(c__5F,axiom,c_SNoLt(v,y)).
fof(c_Luy,axiom,c_SNo(mul_5FSNo(u,y))).
fof(c_Lxv,axiom,c_SNo(mul_5FSNo(x,v))).
fof(c_Luv,axiom,c_SNo(mul_5FSNo(u,v))).
fof(conj_hammer_test_7741,conjecture,(! [X9] : (c_In(X9,c_SNoR(x)) => (! [X10] : (c_In(X10,c_SNoL(y)) => ((z = add_5FSNo(mul_5FSNo(X9,y),add_5FSNo(mul_5FSNo(x,X10),minus_5FSNo(mul_5FSNo(X9,X10))))) => c_SNoLt(w,z))))))).
