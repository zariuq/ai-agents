...
fof(c_Hp3,axiom,(! [X3] : (c_In(X3,omega) => (divides_5Fnat(X3,p) => ((X3 = ordsucc(c_Empty)) | (X3 = p)))))).
...
fof(c_H3,axiom,((p = c_Empty) & (a = c_Empty))).
fof(conj_hammer_test_11090,conjecture,$false).
