...
fof(conj_hammer_test_11998,conjecture,c_In(add_5FSNo(mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),l),m),mul_5FSNo(exp_5FSNo_5Fnat(ordsucc(ordsucc(c_Empty)),k),n)),int)).
