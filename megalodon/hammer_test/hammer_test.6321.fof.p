...
fof(c_IH,axiom,(! [X3] : (c_In(X3,c_SNoS_5F(c_SNoLev(u))) => (c_In(c_SNoLev(X3),c_SNoLev(add_5FSNo(x,y))) => (c_SNoLt(X3,add_5FSNo(x,y)) => ((? [X4] : (c_In(X4,c_SNoL(x)) & c_SNoLe(X3,add_5FSNo(X4,y)))) | (? [X4] : (c_In(X4,c_SNoL(y)) & c_SNoLe(X3,add_5FSNo(x,X4)))))))))).
fof(c_Hu2,axiom,c_In(c_SNoLev(u),c_SNoLev(add_5FSNo(x,y)))).
fof(c_Hu3,axiom,c_SNoLt(u,add_5FSNo(x,y))).
fof(c_HNC,axiom,~ ((? [X3] : (c_In(X3,c_SNoL(x)) & c_SNoLe(u,add_5FSNo(X3,y)))) | (? [X3] : (c_In(X3,c_SNoL(y)) & c_SNoLe(u,add_5FSNo(x,X3)))))).
fof(conj_hammer_test_6321,conjecture,c_SNoCutP(c_SNoL(u),c_SNoR(u))).
