...
fof(c_Hy,axiom,c_SNo_5Fmin_5Fof(c_SNoR(x),y)).
fof(c_H,axiom,(c_In(y,c_SNoR(x)) & c_SNo(y))).
fof(c_Hy1,axiom,c_In(y,c_SNoR(x))).
fof(c_Hy2,axiom,c_SNo(y)).
fof(c_Hy3,axiom,(! [X3] : (c_In(X3,c_SNoR(x)) => (c_SNo(X3) => c_SNoLe(y,X3))))).
fof(c_Hy1a,axiom,c_SNo(y)).
fof(c_Hy1b,axiom,c_In(c_SNoLev(y),c_SNoLev(x))).
fof(c_Hy1c,axiom,c_SNoLt(x,y)).
fof(c_Hz,axiom,c_SNo(z)).
fof(c_H1,axiom,c_SNoLt(z,x)).
fof(c_H2,axiom,c_SNoLt(add_5FSNo(x,x),add_5FSNo(y,z))).
fof(c_Lmx,axiom,c_SNo(minus_5FSNo(x))).
fof(c_Lmy,axiom,c_SNo(minus_5FSNo(y))).
fof(c_Lmz,axiom,c_SNo(minus_5FSNo(z))).
fof(c_Lxx,axiom,c_SNo(add_5FSNo(x,x))).
fof(c_Lyz,axiom,c_SNo(add_5FSNo(y,z))).
fof(c_L1,axiom,c_SNo_5Fmax_5Fof(c_SNoL(minus_5FSNo(x)),minus_5FSNo(y))).
fof(conj_hammer_test_11854,conjecture,(? [X3] : (c_In(X3,c_SNoL(z)) & (add_5FSNo(y,X3) = add_5FSNo(x,x))))).
