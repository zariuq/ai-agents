...
fof(c_Hx,axiom,c_In(x,c_SNoS_5F(omega))).
fof(c_Hy,axiom,c_In(y,c_SNoS_5F(omega))).
fof(c_Hx1,axiom,c_In(c_SNoLev(x),omega)).
fof(c_Hx2,axiom,ordinal(c_SNoLev(x))).
fof(c_Hx3,axiom,c_SNo(x)).
fof(c_Hx4,axiom,c_SNo_5F(c_SNoLev(x),x)).
fof(c_Hy1,axiom,c_In(c_SNoLev(y),omega)).
fof(c_Hy2,axiom,ordinal(c_SNoLev(y))).
fof(c_Hy3,axiom,c_SNo(y)).
fof(c_Hy4,axiom,c_SNo_5F(c_SNoLev(y),y)).
fof(conj_hammer_test_6775,conjecture,c_SNo_5F(c_SNoLev(add_5FSNo(x,y)),add_5FSNo(x,y))).
