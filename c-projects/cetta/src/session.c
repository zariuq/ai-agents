...
static const CettaSurfacePolicy CETTA_SURFACE_POLICIES[] = {
    ...
    {"space-engine", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"space-match-backend", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
    {"space-set-match-backend!", CETTA_PROFILE_MASK_HE_EXTENDED_PLUS, "clean_primary_extension"},
