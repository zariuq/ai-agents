...
OUT_TABLES = MODELS_DIR / "mash_knn_tables.pkl"
OUT_META = MODELS_DIR / "mash_knn_tables_meta.json"
...
def load_dependency_events(problem_conj_name):
    """
...
def main():
    ...
    events, event_meta = load_dependency_events(problem_conj_name)
