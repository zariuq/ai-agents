...
\textbf{Files}:
\begin{itemize}
\item \texttt{Core/Algebra.lean} --- \texttt{SeparationBilateralProp} definition
...
\begin{definition}[\texttt{SeparationBilateralProp}]
...
\begin{theorem}[\texttt{separationBilateralProp\_of\_noAnomalousPairs}]
\textbf{Lines 563--570, Additive/Proofs/GridInduction/Comparison.lean}

\texttt{NoAnomalousPairs} implies \texttt{SeparationBilateralProp}.
\end{theorem}
...
so the negative branch is vacuously true and \texttt{SeparationBilateralProp} reduces to
