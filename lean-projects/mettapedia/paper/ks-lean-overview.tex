...
proof via Eric Luap's \texttt{OrderedSemigroups} library.\footnote{\url{https://github.com/ericluap/OrderedSemigroups}}
...
\textbf{Eric Luap's OrderedSemigroups library}~\cite{Luap2024} formalizes these results:

\begin{lstlisting}[caption={NAP $\Rightarrow$ Commutativity (Luap, Archimedean.lean:355--394)},numbers=none]
...
\begin{lstlisting}[caption={NAP $\Rightarrow$ Archimedean (Luap, Archimedean.lean:396--399)},numbers=none]
