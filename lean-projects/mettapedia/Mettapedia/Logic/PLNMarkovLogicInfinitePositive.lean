import Mettapedia.Logic.PLNMarkovLogicInfiniteDLR
...
namespace Mettapedia.Logic.PLNMarkovLogicInfinitePositive
...
noncomputable def finiteVolumeSpecification
  ...
  PLNMarkovLogicInfiniteDLR.finiteVolumeSpecification M.toInfiniteGroundMLNSpec
...
theorem finiteVolumeSpecification_queryProb_eq_finiteVolume
  ...
  exact PLNMarkovLogicInfiniteDLR.finiteVolumeSpecification_queryProb_eq_finiteVolume
    M.toInfiniteGroundMLNSpec Λ ξ (finiteVolumePartition_ne_zero M Λ ξ) q

end StrictlyPositiveInfiniteGroundMLNSpec

end Mettapedia.Logic.PLNMarkovLogicInfinitePositive
