import Mettapedia.Logic.PLNMarkovLogicInfiniteClusterFrontend
import Mettapedia.Logic.PLNMarkovLogicCountableProjectiveLimit
...
namespace Mettapedia.Logic.PLNMarkovLogicInfiniteLimitFamily
...
open Mettapedia.Logic.PLNMarkovLogicCountableProjectiveLimit
...
instance projectiveLimitMeasure_isProbability
  ...
  letI : ∀ n, IsProbabilityMeasure
      (Mettapedia.Logic.PLNMarkovLogicCountableProjectiveExtension.prefixFamily e P n) :=
    fun n =>
      Mettapedia.Logic.PLNMarkovLogicCountableProjectiveExtension.prefixFamily_isProbability
        e P n
  letI : IsProbabilityMeasure
      (natProjectiveLimit
        (μ := Mettapedia.Logic.PLNMarkovLogicCountableProjectiveExtension.prefixFamily e P)) := by
    delta natProjectiveLimit
    infer_instance
  unfold projectiveLimitMeasure countableProjectiveLimit
  unfold Mettapedia.Logic.PLNMarkovLogicCountableProjectiveExtension.transportMeasure
...
theorem MarginalClusterPoint.tendsto_limitMarginal_localConstraintSet
    ...
    {M : Mettapedia.Logic.PLNMarkovLogicInfinitePositive.StrictlyPositiveInfiniteGroundMLNSpec Atom ClauseId}
    {ξ : BoundaryCondition Atom}
    {μ : Measure (InfiniteWorld Atom)}
    (h : Mettapedia.Logic.PLNMarkovLogicInfiniteClusterFrontend.RegionExhaustion.MarginalClusterPoint E M ξ μ)
    (Λ : Region Atom) (q : LocalConstraintQuery Atom Λ) :
    Tendsto
      (fun n =>
...
theorem CylinderClusterPoint.tendsto_limitMarginal_localQueryEvent
    ...
    {ξ : BoundaryCondition Atom}
    {μ : Measure (InfiniteWorld Atom)}
    (h : Mettapedia.Logic.PLNMarkovLogicInfiniteClusterFrontend.RegionExhaustion.CylinderClusterPoint E M ξ μ)
    (Λ : Region Atom) (q : LocalConstraintQuery Atom Λ) :
    Tendsto
...
end Mettapedia.Logic.PLNMarkovLogicInfiniteLimitFamily
