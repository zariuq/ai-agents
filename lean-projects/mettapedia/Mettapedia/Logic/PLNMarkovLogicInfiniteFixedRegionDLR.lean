import Mettapedia.Logic.PLNMarkovLogicInfiniteCylinderDLR
...
namespace Mettapedia.Logic.PLNMarkovLogicInfiniteFixedRegionDLR
...
theorem holds_congr_of_agreeOnAtoms
  ...
  · intro h
    ...
    | pos a =>
        have ha :
            a ∈ C.atoms :=
          Mettapedia.Logic.PLNMarkovLogicClauseSemantics.GroundClause.atom_mem_atoms hl
...
theorem finiteVolumeWorldMeasure_subregion_cylinder_dlr
  ...
  have hμ :
    ...
    unfold PLNMarkovLogicInfiniteWorldMeasures.finiteVolumeWorldPMF
    symm
    simpa using
...
theorem eventually_finiteVolumeKernelSequence_subregion_cylinder_dlr
  ...
  simpa [Mettapedia.Logic.PLNMarkovLogicInfiniteExhaustion.RegionExhaustion.finiteVolumeKernelSequence] using
...
end Mettapedia.Logic.PLNMarkovLogicInfiniteFixedRegionDLR
