...
import Mettapedia.Logic.PLNMarkovLogicInfiniteCompactness
import Mettapedia.Logic.PLNMarkovLogicInfiniteFixedRegionDLR
...
namespace Mettapedia.Logic.PLNMarkovLogicInfiniteExistence
...
open Mettapedia.Logic.PLNMarkovLogicInfiniteCompactness
open Mettapedia.Logic.PLNMarkovLogicInfiniteFixedRegionDLR
open Mettapedia.Logic.PLNMarkovLogicInfiniteExhaustion.RegionExhaustion
open Mettapedia.Logic.PLNMarkovLogicInfiniteProjective.RegionExhaustion
open Mettapedia.Logic.PLNMarkovLogicInfiniteCompactness.RegionExhaustion
...
theorem exists_fixedRegionCylinderDLR_of_tendsto_stageProbabilityFamily
  ...
  have hQ :
      MeasureTheory.IsProjectiveMeasureFamily
        (ι := Atom)
        (α :=
          Mettapedia.Logic.PLNMarkovLogicInfiniteProjective.RegionExhaustion.BoolCoord Atom)
        Q := by
    simpa [Q] using
...
end Mettapedia.Logic.PLNMarkovLogicInfiniteExistence
