...
namespace Mettapedia.Logic.MarkovLogicInfiniteContent
...
noncomputable def limitContent
  ...
  familyContent
    (Mettapedia.Logic.MarkovLogicInfiniteLimitFamily.RegionExhaustion.limitMarginal μ)
    (Mettapedia.Logic.MarkovLogicInfiniteLimitFamily.RegionExhaustion.isProjectiveMeasureFamily_limitMarginal μ)
...
theorem limitContent_localQueryEvent
  ...
  familyContent_localQueryEvent
    (P := Mettapedia.Logic.MarkovLogicInfiniteLimitFamily.RegionExhaustion.limitMarginal μ)
    (hP := Mettapedia.Logic.MarkovLogicInfiniteLimitFamily.RegionExhaustion.isProjectiveMeasureFamily_limitMarginal μ)
    Λ q
...
theorem stageContent_localQueryEvent
  ...
  familyContent_localQueryEvent
    (P := Mettapedia.Logic.MarkovLogicInfiniteProjective.RegionExhaustion.stageMarginal
      E M ξ n)
    (hP := Mettapedia.Logic.MarkovLogicInfiniteProjective.RegionExhaustion.isProjectiveMeasureFamily_stageMarginal
      E M ξ n)
    Λ q

end RegionExhaustion

end Mettapedia.Logic.MarkovLogicInfiniteContent
