...
namespace Mettapedia.Logic.PLNMarkovLogicInfiniteGlobalDLR
...
theorem projectiveLimitMeasure_localQueryDLRConsistent_of_eq
    ...
    {μ : Measure (InfiniteWorld Atom)}
    [IsProbabilityMeasure μ]
    (hμ : Mettapedia.Logic.PLNMarkovLogicInfiniteClusterFrontend.RegionExhaustion.CylinderClusterPoint E M ξ μ)
    (e : ℕ ≃ Atom)
...
theorem projectiveLimitMeasure_localQueryDLRConsistent_of_marginalClusterPoint
    ...
    {μ : Measure (InfiniteWorld Atom)}
    [IsProbabilityMeasure μ]
    (hμ : Mettapedia.Logic.PLNMarkovLogicInfiniteClusterFrontend.RegionExhaustion.MarginalClusterPoint E M ξ μ)
    (e : ℕ ≃ Atom)
    (P : ∀ I : Finset Atom, Measure (∀ i : I,
      Mettapedia.Logic.PLNMarkovLogicInfiniteLimitFamily.RegionExhaustion.BoolCoord Atom i))
    [∀ I, IsProbabilityMeasure (P I)]
...
end Mettapedia.Logic.PLNMarkovLogicInfiniteGlobalDLR
