import Mettapedia.Logic.MarkovLogicInfiniteContent
...
namespace Mettapedia.Logic.MarkovLogicInfiniteCylinderDLR
...
open Mettapedia.Logic.MarkovLogicInfiniteContent
open Mettapedia.Logic.MarkovLogicInfiniteLimitFamily
open Mettapedia.Logic.MarkovLogicInfiniteGlobalDLR
...
open Mettapedia.Logic.MarkovLogicInfiniteContent.RegionExhaustion
open Mettapedia.Logic.MarkovLogicInfiniteLimitFamily.RegionExhaustion
open Mettapedia.Logic.MarkovLogicInfiniteGlobalDLR.RegionExhaustion
      ...
      (fun n => stageContent E M ξ n (MeasureTheory.cylinder Λ S)) =
        (fun n =>
          E.finiteVolumeKernelSequence M ξ n
            (Mettapedia.Logic.MarkovLogicInfiniteWorldMeasures.localQueryEvent Λ q)) := by
    funext n
...
end Mettapedia.Logic.MarkovLogicInfiniteCylinderDLR
