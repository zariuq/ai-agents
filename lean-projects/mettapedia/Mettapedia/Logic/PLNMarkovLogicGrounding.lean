...
`GroundMLN` clause-native core from `PLNMarkovLogicClauseSemantics`.
...
namespace Mettapedia.Logic.PLNMarkovLogicGrounding
...
end Mettapedia.Logic.PLNMarkovLogicGrounding
