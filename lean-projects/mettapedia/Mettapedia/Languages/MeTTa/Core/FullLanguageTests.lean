...
open Mettapedia.Languages.MeTTa.Core.FullLanguageDef

namespace Mettapedia.Languages.MeTTa.Core.FullLanguageTests
...
end Mettapedia.Languages.MeTTa.Core.FullLanguageTests
