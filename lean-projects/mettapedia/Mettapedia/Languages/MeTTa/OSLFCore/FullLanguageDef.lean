...
namespace Mettapedia.Languages.MeTTa.OSLFCore.FullLanguageDef
...
def mettaFullLegacyRelEnv : RelationEnv := Mettapedia.Languages.MeTTa.OSLFCore.Premises.mettaFullRelEnv
...
end Mettapedia.Languages.MeTTa.OSLFCore.FullLanguageDef
