...
namespace Mettapedia.Languages.GF.HandCrafted.English.Verbs
...
def dress_V : EnglishVerb := regV "dress"
...
def dress_V2 : EnglishV2 := mkV2 dress_V
...
end Mettapedia.Languages.GF.HandCrafted.English.Verbs
