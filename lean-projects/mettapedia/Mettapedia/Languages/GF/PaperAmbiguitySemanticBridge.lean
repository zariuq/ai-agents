...
import Mettapedia.Languages.GF.English.ContextualDisambiguation
...
open Mettapedia.Languages.GF.English.ContextualDisambiguation
...
theorem english_telescope_instrument_scene_values :
    @gfEvidenceDenote TelescopeState
      Mettapedia.Languages.GF.English.ContextualDisambiguation.instEvidenceTypeTelescopeState
      Mettapedia.Languages.GF.English.ContextualDisambiguation.instWorldModelTelescopeStateGFPattern
...
theorem english_anna_baby_in_crib_scene_values :
    @gfEvidenceDenote AnnaState
      Mettapedia.Languages.GF.English.ContextualDisambiguation.instEvidenceTypeAnnaState
      Mettapedia.Languages.GF.English.ContextualDisambiguation.instWorldModelAnnaStateGFPattern
