...
implementation of \MeTTa{}---comprising 14{,}624 lines across 47 files with zero
...
\code{Core.lean}              & 215 & \code{PrologGoal} inductive & 0 \\
\code{Eval.lean}              & 404 & Prolog evaluation relation & 0 \\
\code{Prolog.lean}            & 49  & module re-export & 0 \\
\hline
...
\hline
\textbf{Total (47 files)} & \textbf{14{,}624} & & \textbf{0} \\
\hline
\end{tabularx}
\normalsize
...
\code{Logic/Prolog/Core.lean} (215 lines) defines a Prolog-style goal language
(re-exported via \code{Logic/Prolog/Prolog.lean} and referenced by
...
14{,}624 lines across 47 files with zero sorries and zero custom axioms.
