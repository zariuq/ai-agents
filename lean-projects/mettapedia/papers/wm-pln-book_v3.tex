...
now carry non-trivial witnesses via \code{Witnessed₀}.%
\footnote{Formalized in
...
\item \textbf{Home-security force escalation.}  Actions: observe / warn /
  ...
  \code{WitnessedForCandidateSet₀} machinery works on a live choice set.
\end{itemize}
\noindent
...
antihypertensive effects~\cite{Militante2004Taurine}.  The
