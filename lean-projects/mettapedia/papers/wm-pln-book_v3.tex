...
A useful future-work witness for the infinitary side is the magnet.
The same local rule---neighboring spins prefer to agree---can have one
global Gibbs state above the critical temperature and two extremal
global Gibbs states below it.  In the shared abstraction sought here,
that is exactly the place where phase transition, non-unique projective
extension, and spontaneous imprecision meet: a precise local
specification has a credal set of global completions.  This is not part
of the current Walley package; it is the didactic witness for the
future \code{ProjectiveLimitCredalSet} target connecting infinite MLNs,
natural extension, Dobrushin uniqueness, and imprecise de~Finetti.
