...
probabilities. The formalization comprises approximately 1{,}160 lines of
Lean with zero unproven assumptions (\texttt{sorry}), covering BDD
construction correctness, Weighted Model Counting, and compilation
soundness and completeness. All 27 ProbMeTTa test cases pass, and 7
...
\item A formal proof that ProbMeTTa correctly computes ProbLog probabilities
...
approximately 1{,}160 lines across 6 files with zero \texttt{sorry}
...
A formal proof in Lean~4 (1{,}160 lines, 0~\texttt{sorry}) covers BDD
construction, Weighted Model Counting, and compilation soundness and
completeness. Kernel-checked conformance tests link the abstract proof
to the concrete MeTTa implementation. All 27 ProbMeTTa tests pass.
