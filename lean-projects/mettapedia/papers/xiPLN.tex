...
\hline
HOL/FOL implication closure wrappers into WM consequence rules \newline
\textit{Tags: [PLNBook-Ch8], [HOL], [FOL], [WMConsequenceRule], [closure]} &
...
\code{qfm\_composedInterval\_iff\_of\_signatureEq} \\
\hline
HOL/FOL consequence closure into WM/PLN transport (categorical surface) & Consequence wrappers are not only generic: concrete HOL and FOL fixture theorems consume the categorical endpoint layer & \code{multiset\_strength\_le\_of\_pointwise\_categorical},
\code{multiset\_strength\_le\_of\_consequence\_categorical},
\code{ch8\_hol\_categorical\_wrapper\_bool\_fixture},
\code{ch8\_fol\_categorical\_consequence\_singleton\_fixture} \\
\hline
