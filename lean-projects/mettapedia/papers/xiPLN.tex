...
\codepath{Mettapedia/Logic/PLNChapter12Canary.lean},
\codepath{Mettapedia/Logic/PLNChapter12Regression.lean},
...
\codepath{Mettapedia/Logic/PLNChapter13InferenceControl.lean},
\codepath{Mettapedia/Logic/PLNChapter13Canary.lean},
\codepath{Mettapedia/Logic/PLNChapter13Regression.lean},
...
\emph{formalized ASSOC-core coverage}: the ASSOC-channel path is now wired through typed WM semantics,
Solomonoff log-ratio correspondence, linked/linked-strong one-call canonical API transport, and
executable positive/negative canary regression. Remaining work is mainly PAT/mixed-policy parity.
