...
\codepath{Mettapedia/Logic/PLNLargeScaleInferenceCounterexamples.lean}. & Partial (counterexample-first core formalized) \\
\hline
...
\hline
Confidence transport under WM query equivalence \newline
\textit{Tags: [PLNBook-Ch8], [WM-queryEq], [confidence]} &
