...
\item The \textbf{multiset semantics is uniform-weight}: each pointed model
  contributes one count. Source reliability, weighting, dependence, and
  correlation are not yet modelled.
\item A \textbf{weighted/source-dependent multiset semantics} with
  dependence correction has not yet been formalized.
\end{enumerate}
