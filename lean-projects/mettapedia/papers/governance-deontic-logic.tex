...
Our formalization proves the algebraic properties that their implementation
asserts operationally --- in particular, the \DTS{} interdefinability relations
and the evidence lattice monotonicity.
...
(i)~probabilistic evidence integration connecting \DTS{} strength values
to \PLN{} posterior-mean evidence;
(ii)~instantiation of the governance accessibility model with richer reactive
languages beyond the minimal \code{GovNormCycle}; and
