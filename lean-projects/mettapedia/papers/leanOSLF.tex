...
(ix) a MeTTa Core interpreter specification with confluence and progress; and
...
Hyperon Experimental MeTTa (3{,}839 lines, 0~sorries), including:
\begin{itemize}
...
The formalization (\codepath{PathMap/}, 1{,}890 lines, 0~sorries)
