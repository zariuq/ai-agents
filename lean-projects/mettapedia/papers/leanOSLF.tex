...
from rewrite rules.  Our formalization spans 42{,}200+ lines across 120 Lean files
(91 in the core \OSLF{} tree, 29 in the process-calculi layer),
...
(iii) the abstract \OSLF{} framework instantiated for \emph{six} languages
(\rhocalc{}-calculus, lambda calculus, Petri nets, TinyML, MeTTaMinimal, and
MeTTaFull), each with \emph{fully proven} Galois connections $\Dia \dashv \Bx$;
...
\item[\checkmark] \textbf{Milestone 5}: Language instances.
  Six languages---lambda calculus, Petri nets, \rhocalc{}-calculus, TinyML,
  MeTTaMinimal, and MeTTaFull---each with auto-generated \code{OSLFTypeSystem}
...
spanning 42{,}200+ lines of Lean~4 across 120 files with 0~sorries and 0~custom axioms.
...
The full type synthesis pipeline is validated by six language instances
(\rhocalc{}-calculus, lambda calculus, Petri nets, TinyML, MeTTaMinimal, and
MeTTaFull), each with auto-proven Galois connections.  TinyML demonstrates the
