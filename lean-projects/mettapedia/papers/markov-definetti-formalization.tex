...
Higher-order WM bridge & UniversalPredictionHigherOrderMarkovWMBridge.lean & 365 \\
Other & (11 files) & 1,496 \\
\midrule
\textbf{Total} & \textbf{33 files} & \textbf{26,665} \\
\bottomrule
\end{tabular}
...
File: \texttt{UniversalPredictionHigherOrderMarkovWMBridge.lean} (365 lines, 0~\texttt{sorry}).
