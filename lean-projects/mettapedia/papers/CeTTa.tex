...
against the legacy one-step path and oracle bags, not yet Lean-proven).
...
the witnesses to fail (the successor set must go empty; normal-form must
...
(non-hot) one-step and reflection surfaces now; a
...
object.  An evaluate-by-iterating-one-step mode is planned purely
