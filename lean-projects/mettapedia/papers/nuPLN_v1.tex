...
The remaining mathematical gap is now explicit: deriving the constructor
payload in \texttt{BuildRowKernelOnRecurrentExtension} from recurrence
and exchangeability alone, without adding ad-hoc assumptions.
