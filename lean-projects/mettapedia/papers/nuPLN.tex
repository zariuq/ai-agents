...
Current scope note: the bridge theorem is conditional on the recurrent latent-coherence
constructor interface used in the Fortini development.  This keeps the theorem honest and
machine-checkable while isolating the exact remaining derivation gap to be minimized.
